package com.sulake.habbo.toolbar
{
   ...
   public class HabboToolbar extends Component implements IHabboToolbar
   {
      ...
      private var var_908:ExtraToolsExtension;
      
      private var _connection:IConnection;
      
      private var _catalog:IHabboCatalog;
      
      private var var_1676:PurseExtension;
      
      private var var_1675:ClubStatusBarExtension;
      ...
      {
         if(this.var_268 && this._windowManager && this._config && this._localization && this.var_13 && this._catalog)
         {
      ...
      private function onAuthenticationOK(param1:IMessageEvent) : void
      {
         ...
         if(this._config && this._config.getKey("client.logout.enabled","false") == "CanCreateRoomEvent")
         {
            this.var_908 = new ExtraToolsExtension(this,this._windowManager,this._assetLibrary,events,this._config);
            if(this._config.getBoolean("club.membership.extend.promotion.enabled",false))
            {
               this.var_1675 = new ClubStatusBarExtension(this._windowManager,assets,events,this._config,this._localization,this.var_13,this._catalog,this._connection);
            }
            this.var_1676 = new PurseExtension(this._windowManager,this._assetLibrary,events,this._config,this._catalog);
         }
         if(this._view == null)
         {
      ...
      private function toolbarExtensionVisible(param1:Boolean) : void
      {
         ...
         if(param1)
         {
            this.var_908.showRoomInfo();
         }
         else
         {
            this.var_908.hideRoomInfo();
         }
      }
