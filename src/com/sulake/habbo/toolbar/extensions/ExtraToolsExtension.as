package com.sulake.habbo.toolbar.extensions
{
   ...
   public class ExtraToolsExtension
   {
      ...
      private static const const_1679:uint = 16777215;
      
      private static const const_1681:uint = 12247545;
      
      private static const const_1680:String = "HELP";
      
      private static const const_1682:String = "ROOMINFO";
      ...
      private var var_373:IWindow;
      
      private var var_705:IWindowContainer;
      
      private const const_765:int = 42;
      ...
      public function ExtraToolsExtension(param1:HabboToolbar, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IEventDispatcher, param5:IHabboConfigurationManager)
      {
         ...
         this.var_373 = this._window.findChildByName("roominfo_region");
      ...
      {
         this.var_62.removeListItem(this.var_373);
      }
      
      public function showRoomInfo() : void
      {
         this.var_62.addListItemAt(this.var_373,0);
      }
      ...
      private function createWindow(param1:String) : IWindow
      {
         ...
         _loc3_.x = _loc4_.width - _loc3_.width - this.const_972;
         _loc3_.y = this.const_765;
      ...
      private function showConfirmation() : void
      {
         if(!this.var_705)
         {
            this.var_705 = this.createWindow("logout_confirmation_xml") as IWindowContainer;
         }
      }
      ...
      private function onClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "logout_region":
               ...
               break;
            case "help_region":
               this._toolbar.toggleWindowVisibility(const_1680);
               break;
            case "roominfo_region":
               this._toolbar.toggleWindowVisibility(const_1682);
               break;
            case "confirm":
               if(false)
               {
