package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarView
   {
      ...
      private static const const_1474:Point = new Point(3,3);
      
      private static const const_1528:uint = 7433577;
      
      private static const const_1530:uint = 5723213;
      
      private static const const_477:String = "_hover";
      
      private static const const_475:String = "_normal";
      
      private static const const_476:int = 5;
      
      private static const const_1533:int = 600;
      
      private static const const_1531:int = 80;
      
      private static const const_1526:int = 74;
      
      private static const ICON_SPACING_NORMAL:int = 10;
      
      private static const const_1532:int = -2;
      
      private static const const_1529:int = 5;
      ...
      public function ToolbarView(param1:HabboToolbar, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IConnection, param5:IHabboCatalog, param6:IEventDispatcher, param7:IHabboConfigurationManager)
      {
         ...
         this._window.position = const_1474;
         this._window.addEventListener(WindowEvent.const_556,this.onParentResized);
         ...
         {
            this.setIconHoverState(_loc11_,const_475);
         }
         ...
         this.var_213.x = _loc13_.width - this.var_213.width - const_476;
         this.var_213.y = const_476;
         this.var_2542 = this.isNewItemsNotificationEnabled();
      ...
      private function checkSize(param1:Boolean = false) : void
      {
         ...
         var _loc2_:* = this._windowManager.getDesktop(2).height < const_1533;
         if(!param1 && _loc2_ == this.var_1523)
         {
            return;
         }
         this.var_1523 = _loc2_;
         var _loc3_:int = !!_loc2_ ? int(const_1526) : int(const_1531);
         var _loc4_:int = !!_loc2_ ? int(const_1532) : int(ICON_SPACING_NORMAL);
         ...
         while(_loc7_ < _loc5_.length)
         {
            ...
            _loc6_.y = const_1529 + _loc7_ * (_loc3_ + _loc4_);
            _loc7_++;
         }
         this._window.height = _loc6_.rectangle.bottom + const_1527;
      }
      ...
      private function onCatalogEvent(param1:CatalogEvent) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case CatalogEvent.CATALOG_NEW_ITEMS_SHOW:
               if(this.var_213 != null && this.var_2542)
               {
      ...
      public function setToolbarState(param1:String) : void
      {
         ...
         switch(param1)
         {
            case HabboToolbarEnum.const_954:
               _loc3_ = false;
               break;
            case HabboToolbarEnum.const_857:
               _loc3_ = true;
         }
      ...
      private function setIconHoverState(param1:IBitmapWrapperWindow, param2:String) : void
      {
         ...
         {
            _loc4_ = param2 == const_477 ? this.var_1524 : this.var_1525;
         }
         else
         {
      ...
      private function setIconBgHoverState(param1:IWindowContainer, param2:String) : void
      {
         ...
         if(param2 == const_477)
         {
            param1.color = const_1528;
         }
         else
         {
            param1.color = const_1530;
         }
      }
      ...
      public function getIconVerticalLocation(param1:String) : int
      {
         switch(param1)
         {
            case HabboToolbarIconEnum.NAVIGATOR:
               return !!this.var_1523 ? 45 : 50;
            case HabboToolbarIconEnum.QUESTS:
               return !!this.var_1523 ? 125 : 140;
            default:
               return 0;
         }
      }
      ...
      private function setMeMenuIconBitmaps(param1:BitmapData) : void
      {
         ...
         this.var_1525 = this.addShadow(param1,new Point(2,3),4280426782);
         if(this.var_1524)
         {
            this.var_1524.dispose();
         }
         this.var_1524 = this.addShadow(param1,new Point(4,5),4281150249);
         param1.dispose();
      }
      ...
      public function getUnseenItemCounter(param1:String) : IWindowContainer
      {
         ...
         var _loc2_:IWindowContainer = this.var_1011.getValue(param1) as IWindowContainer;
         if(!_loc2_)
         {
      ...
      {
         return this._config.getKey("toolbar.new_additions.notification.enabled","false") == "CanCreateRoomEvent";
      }
   }
}
