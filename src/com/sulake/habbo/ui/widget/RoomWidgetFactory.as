package com.sulake.habbo.ui.widget
{
   ...
   public class RoomWidgetFactory extends Component implements IRoomWidgetFactory
   {
      ...
      private var var_3080:IAssetLibrary;
      ...
      public function RoomWidgetFactory(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_3080 = param1.root.assets;
      ...
      public function createWidget(param1:String, param2:IRoomWidgetHandler) : IRoomWidget
      {
         ...
         switch(param1)
         {
            case RoomWidgetEnum.const_464:
               _loc3_ = new RoomChatWidget(param2,this._windowManager,assets,this.var_73,this.var_153,this.var_2629++,this,this._questEngine);
               break;
            case RoomWidgetEnum.const_337:
               _loc3_ = new RoomChatInputWidget(param2,this._windowManager,assets,this.var_73,this.var_153,this);
               break;
            case RoomWidgetEnum.const_557:
               _loc3_ = new InfostandWidget(param2,this._windowManager,assets,this.var_73,this.var_153,this._catalog);
               break;
            case RoomWidgetEnum.const_631:
               _loc3_ = new MeMenuWidget(param2,this._windowManager,assets,this.var_73,events,this.var_153);
               break;
            ...
            case RoomWidgetEnum.const_553:
               _loc3_ = new TeaserFurniWidget(param2,this._windowManager,assets,this.var_73,this.var_153,this.var_13);
               break;
            ...
            case RoomWidgetEnum.const_662:
               _loc3_ = new LoadingBarWidget(param2,this._windowManager,assets,this.var_73,this.var_153);
               break;
            case RoomWidgetEnum.const_594:
               _loc3_ = new RoomQueueWidget(param2,this._windowManager,assets,this.var_73,this.var_153);
               break;
            case RoomWidgetEnum.const_139:
               _loc3_ = new VoteWidget(param2,this._windowManager,assets,this.var_73,this.var_153);
               break;
            ...
            case RoomWidgetEnum.const_124:
               _loc3_ = new AvatarInfoWidget(param2,this._windowManager,assets,this.var_153,this.var_73,this);
               break;
            ...
            case RoomWidgetEnum.const_625:
               _loc3_ = new PlayListEditorWidget(param2,this._windowManager,this._soundManager,assets,this.var_73,this.var_153,this._catalog);
               break;
