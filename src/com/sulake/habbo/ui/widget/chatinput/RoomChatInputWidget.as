package com.sulake.habbo.ui.widget.chatinput
{
   ...
   public class RoomChatInputWidget extends RoomWidgetBase
   {
      ...
      private static const const_1543:int = 5000;
      ...
      private var var_327:Timer = null;
      ...
      {
         return getTimer() - this.var_2611 > const_1543;
      }
      
      public function setLastPasteTime() : void
      {
         this.var_2611 = getTimer();
      }
      ...
      public function sendChat(param1:String, param2:int, param3:String = "") : void
      {
         ...
         var _loc4_:RoomWidgetChatMessage = new RoomWidgetChatMessage(RoomWidgetChatMessage.const_800,param1,param2,param3);
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetRoomObjectUpdateEvent.const_161,this.onRoomObjectDeselected);
         param1.addEventListener(RoomWidgetChatInputContentUpdateEvent.const_770,this.onChatInputUpdate);
         param1.addEventListener(RoomWidgetUserInfoUpdateEvent.const_148,this.onUserInfo);
         param1.addEventListener(RoomWidgetFloodControlEvent.const_782,this.onFloodControl);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetRoomObjectUpdateEvent.const_161,this.onRoomObjectDeselected);
         param1.removeEventListener(RoomWidgetChatInputContentUpdateEvent.const_770,this.onChatInputUpdate);
         param1.removeEventListener(RoomWidgetUserInfoUpdateEvent.const_148,this.onUserInfo);
         param1.removeEventListener(RoomWidgetFloodControlEvent.const_782,this.onFloodControl);
      }
      ...
      private function onChatInputUpdate(param1:RoomWidgetChatInputContentUpdateEvent) : void
      {
         ...
         switch(param1.messageType)
         {
            case RoomWidgetChatInputContentUpdateEvent.const_1188:
               ...
               break;
            case RoomWidgetChatInputContentUpdateEvent.const_1911:
         }
      }
      ...
      private function onReleaseTimerTick(param1:TimerEvent) : void
      {
         if(this._visualization != null)
         {
            this._visualization.updateBlockText(this.var_327.repeatCount - this.var_327.currentCount);
         }
      }
      ...
      public function onFloodControl(param1:RoomWidgetFloodControlEvent) : void
      {
         ...
         {
            this.var_327 = new Timer(1000,param1.seconds);
            this.var_327.addEventListener(TimerEvent.TIMER,this.onReleaseTimerTick);
            this.var_327.addEventListener(TimerEvent.TIMER_COMPLETE,this.onReleaseTimerComplete);
         }
         this.var_327.start();
         if(this._visualization != null)
         {
