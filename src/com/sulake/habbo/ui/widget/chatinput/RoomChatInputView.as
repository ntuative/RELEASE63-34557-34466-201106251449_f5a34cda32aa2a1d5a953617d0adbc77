package com.sulake.habbo.ui.widget.chatinput
{
   ...
   public class RoomChatInputView
   {
      ...
      private static const const_1569:int = 250;
      
      private static const const_1571:int = 0;
      
      private static const BOTTOM_MARGIN:int = 55;
      
      private static const const_1570:String = "${widgets.chatinput.say}";
      ...
      public function RoomChatInputView(param1:RoomChatInputWidget)
      {
         super();
         this._widget = param1;
         this.var_1281 = param1.localizations.getKey("widgets.chatinput.mode.whisper",":tell");
         this.var_2713 = param1.localizations.getKey("widgets.chatinput.mode.shout",":shout");
         this.var_2714 = param1.localizations.getKey("widgets.chatinput.mode.speak",":speak");
         this.var_392 = new Timer(1000,1);
         this.var_392.addEventListener(TimerEvent.TIMER_COMPLETE,this.onTypingTimerComplete);
         this.var_470 = new Timer(10000,1);
         this.var_470.addEventListener(TimerEvent.TIMER_COMPLETE,this.onIdleTimerComplete);
         this.createWindow();
      }
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_470.reset();
            this.var_470.removeEventListener(TimerEvent.TIMER_COMPLETE,this.onIdleTimerComplete);
            this.var_470 = null;
         }
      }
      ...
      private function createWindow() : void
      {
         ...
         this.var_1985 = this._window.findChildByName("input_border");
         this._button = this._window.findChildByName("send_button");
         this.var_1984 = this._window.findChildByName("send_button_text");
         this.var_1569 = this._window.findChildByName("block_text");
         this.var_1984.caption = const_1570;
         ...
         this.var_28.addEventListener(WindowKeyboardEvent.const_181,this.windowKeyEventProcessor);
         this.var_28.addEventListener(WindowKeyboardEvent.const_354,this.keyUpHandler);
         this.var_28.addEventListener(WindowEvent.const_110,this.onInputChanged);
         this._window.findChildByName("send_button").addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onSend);
         this.var_1570 = true;
         this.var_685 = "";
         this._window.addEventListener(WindowEvent.const_556,this.updatePosition);
         this._window.addEventListener(WindowEvent.const_506,this.updatePosition);
      }
      ...
      private function updatePosition(param1:WindowEvent = null) : void
      {
         ...
         var _loc4_:int = (this._window.desktop.width - this.var_1985.width) / 2 - _loc3_;
         var _loc5_:int = this._window.desktop.width - this._window.width - const_1569 - _loc3_;
         this._window.x = Math.max(Math.min(_loc4_,_loc5_),const_1571);
      }
      ...
      private function windowKeyEventProcessor(param1:WindowEvent = null, param2:IWindow = null) : void
      {
         ...
         if(_loc3_ == Keyboard.BACKSPACE)
         {
            if(this.var_28 != null)
            {
               ...
               _loc8_ = _loc7_.split(" ");
               if(_loc8_[0] == this.var_1281 && _loc8_.length == 3 && _loc8_[2] == "")
               {
                  this.var_28.text = "";
                  this.var_685 = "";
               }
      ...
      private function onInputChanged(param1:WindowEvent) : void
      {
         ...
         {
            if(_loc2_.text.length > this.var_685.length + 1)
            {
      ...
      private function sendTypingMessage() : void
      {
         ...
         var _loc1_:RoomWidgetChatTypingMessage = new RoomWidgetChatTypingMessage(this.var_684);
