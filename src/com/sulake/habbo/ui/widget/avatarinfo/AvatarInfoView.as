package com.sulake.habbo.ui.widget.avatarinfo
{
   ...
   public class AvatarInfoView implements IDisposable
   {
      ...
      protected static const const_2064:uint = 4288230144;
      
      protected static const const_1424:uint = 16777215;
      
      protected static const const_1422:uint = 9552639;
      
      protected static const const_2061:uint = 16777215;
      
      protected static const const_2062:uint = 5789011;
      
      protected static const const_2063:uint = 13947341;
      
      protected static const const_2065:uint = 5789011;
      
      private static const const_1719:int = 25;
      ...
      protected var var_513:Timer;
      
      protected var var_3062:int = 3000;
      ...
      {
         this.var_2265 = new FixedSizeStack(const_1719);
         super();
         this._widget = param1;
         this.var_1152 = true;
         this.var_1710 = false;
      ...
      public static function setup(param1:AvatarInfoView, param2:int, param3:String, param4:int, param5:int, param6:Boolean = false) : void
      {
         ...
         param1.var_1712 = param5;
         param1.var_2426 = param4;
         param1.var_2266 = param6;
         ...
         if(param1.var_1152)
         {
            if(!param1.var_513)
            {
               param1.var_513 = new Timer(param1.var_3062,1);
               param1.var_513.addEventListener(TimerEvent.TIMER_COMPLETE,param1.onTimerComplete);
            }
            param1.var_513.reset();
            param1.var_513.start();
         }
         param1.updateWindow();
      }
      ...
      public function dispose() : void
      {
         ...
         if(this.var_513)
         {
            this.var_513.removeEventListener(TimerEvent.TIMER_COMPLETE,this.onTimerComplete);
            this.var_513.reset();
            this.var_513 = null;
         }
         this._disposed = true;
      ...
      {
         this._widget.messageListener.processWidgetMessage(new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_604));
      ...
      public function update(param1:Rectangle, param2:Point, param3:uint) : void
      {
         ...
         if(this.var_1711)
         {
            ...
            this._blend = 1 - this.var_1709 / Number(this.var_3061);
         }
         else
         {
            this._blend = 1;
         ...
         if(!this.var_2174 || this.var_2177)
         {
            _loc4_ = -this.var_189.height;
            if(this.var_1712 == RoomObjectTypeEnum.const_132 || this.var_1712 == RoomObjectTypeEnum.const_555)
            {
            ...
            if(_loc6_ < this.var_2267 - const_1161)
            {
               _loc6_ = this.var_2267 - const_1161;
            }
         ...
         this.var_189.blend = this._blend;
         this.show();
      }
