package com.sulake.habbo.ui.widget.memenu
{
   ...
   public class MeMenuWidget extends RoomWidgetBase
   {
      ...
      public static const const_615:String = "me_menu_my_clothes_view";
      
      public static const const_1247:String = "me_menu_dance_moves_view";
      
      public static const const_958:String = "me_menu_settings_view";
      
      public static const const_846:String = "me_menu_sound_settings";
      
      private static const const_1127:Point = new Point(95,440);
      ...
      public function MeMenuWidget(param1:IRoomWidgetHandler, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager, param5:IEventDispatcher, param6:IHabboConfigurationManager)
      {
         ...
         if(false)
         {
            this.var_2793 = param6.getBoolean("client.news.embed.enabled",false);
         }
         this.var_1849 = this._config.getBoolean("menu.own_avatar.enabled",false);
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetWaveUpdateEvent.const_978,this.onWaveEvent);
         param1.addEventListener(RoomWidgetDanceUpdateEvent.const_925,this.onDanceEvent);
         param1.addEventListener(RoomWidgetUpdateEffectsUpdateEvent.const_877,this.onUpdateEffects);
         param1.addEventListener(RoomWidgetToolbarClickedUpdateEvent.const_872,this.onToolbarClicked);
         param1.addEventListener(RoomWidgetAvatarEditorUpdateEvent.const_1300,this.onAvatarEditorClosed);
         param1.addEventListener(RoomWidgetAvatarEditorUpdateEvent.const_1280,this.onHideAvatarEditor);
         param1.addEventListener(RoomWidgetRoomObjectUpdateEvent.const_161,this.onAvatarDeselected);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetWaveUpdateEvent.const_978,this.onWaveEvent);
         param1.removeEventListener(RoomWidgetDanceUpdateEvent.const_925,this.onDanceEvent);
         param1.removeEventListener(RoomWidgetUpdateEffectsUpdateEvent.const_877,this.onUpdateEffects);
         param1.removeEventListener(RoomWidgetToolbarClickedUpdateEvent.const_872,this.onToolbarClicked);
         param1.removeEventListener(RoomWidgetRoomObjectUpdateEvent.const_161,this.onAvatarDeselected);
         param1.removeEventListener(RoomWidgetHabboClubUpdateEvent.const_280,this.onHabboClubEvent);
         param1.removeEventListener(RoomWidgetAvatarEditorUpdateEvent.const_1300,this.onHideAvatarEditor);
         param1.removeEventListener(RoomWidgetAvatarEditorUpdateEvent.const_1280,this.onAvatarEditorClosed);
      ...
      private function onUserInfo(param1:RoomWidgetUserInfoUpdateEvent) : void
      {
         ...
         if(!(this.var_569 && this.var_54.window.name == const_615))
         {
            _loc2_ = new RoomWidgetRequestWidgetMessage(RoomWidgetRequestWidgetMessage.const_786);
      ...
      private function onSettingsUpdate(param1:RoomWidgetSettingsUpdateEvent) : void
      {
         ...
         if(this.var_54.window.name == const_846)
         {
      ...
      private function onTutorialEvent(param1:RoomWidgetTutorialEvent) : void
      {
         switch(param1.type)
         {
            case RoomWidgetTutorialEvent.const_530:
               Logger.log("* MeMenuWidget: onHighlightClothesIcon " + this.var_569 + " view: " + this.var_54.window.name);
               if(this.var_569 != true || this.var_54.window.name != const_199)
               {
                  return;
               }
      ...
      private function onToolbarClicked(param1:RoomWidgetToolbarClickedUpdateEvent) : void
      {
         ...
         if(this.var_569)
         {
            _loc2_ = new RoomWidgetMeMenuMessage(RoomWidgetMeMenuMessage.const_824);
            if(messageListener != null)
            {
               messageListener.processWidgetMessage(_loc2_);
            }
      ...
      {
         if(this.var_54 != null && this.var_54.window.name != const_615)
         {
            this.hide();
         }
      }
      ...
      {
         var _loc2_:* = param1.daysLeft != this.var_1604;
         this.var_1604 = param1.daysLeft;
         this.var_2792 = param1.periodsLeft;
         this.var_3088 = param1.pastPeriods;
         this.var_2795 = param1.allowClubDances;
         _loc2_ = Boolean(_loc2_ || param1.clubLevel != this.var_2044);
         this.var_2044 = param1.clubLevel;
         if(_loc2_)
         {
            if(this.var_54 != null)
            {
