package com.sulake.habbo.ui.widget.roomchat
{
   ...
   public class RoomChatHistoryViewer implements IDisposable
   {
      ...
      private static const const_1566:int = 18;
      ...
      public function RoomChatHistoryViewer(param1:RoomChatWidget, param2:IHabboWindowManager, param3:IWindowContainer, param4:IAssetLibrary)
      {
         ...
         this.var_196.state = RoomChatHistoryPulldown.const_247;
         ...
         this.var_53 = param2.createWindow("chatscroller","",HabboWindowType.const_1214,HabboWindowStyle.const_47,0 | 0,new Rectangle(param3.rectangle.right - SCROLLBAR_WIDTH,param3.y,SCROLLBAR_WIDTH,param3.height - 0),null,0) as IScrollbarWindow;
      ...
      public function set visible(param1:Boolean) : void
      {
         ...
         this.var_196.state = param1 == true ? 0 : int(RoomChatHistoryPulldown.const_247);
      }
      ...
      public function get visible() : Boolean
      {
         ...
         return this.var_196.state == RoomChatHistoryPulldown.const_421 || this.var_196.state == RoomChatHistoryPulldown.const_490;
      }
      ...
      {
         if(!this.var_465 && !this.var_1860)
         {
            this.var_465 = true;
            this.setHistoryViewerScrollbar(true);
            this.var_196.state = RoomChatHistoryPulldown.const_421;
            if(this._widget != null)
            {
      ...
      public function containerResized(param1:Rectangle, param2:Boolean = false) : void
      {
         if(this.var_53 != null)
         {
            ...
            if(param2)
            {
               this.var_53.scrollV = this.var_675;
            }
         }
         if(this.var_196 != null)
         {
      ...
      private function processDrag(param1:Number, param2:Boolean = false) : void
      {
         ...
         if(this.var_466 > 0 && param2)
         {
            if(this.var_1956)
            {
               if(Math.abs(param1 - this.var_466) <= const_1287)
               {
                  return;
               }
               this.var_1956 = false;
            ...
            if(this.var_465)
            {
               ...
               _loc5_ = (param1 - this.var_466) / this.var_53.height;
               _loc3_ = this.var_675 - _loc5_ / _loc4_;
               _loc3_ = Math.max(0,_loc3_);
               _loc3_ = Math.min(1,_loc3_);
               _loc6_ = param1 - this.var_466;
               _loc7_ = true;
               _loc8_ = true;
               if(this.var_53.scrollV < 1 - const_1566 / this.var_53.scrollable.scrollableRegion.height)
               {
                  _loc8_ = false;
               }
               if(_loc8_ || this.var_1957)
               {
      ...
      public function beginDrag(param1:Number, param2:Boolean = false) : void
      {
         ...
         if(this.var_53 != null)
         {
            this.var_675 = this.var_53.scrollV;
         }
         if(this.var_53 != null)
         {
      ...
      private function moveHistoryScroll() : void
      {
         ...
         var _loc1_:Number = this.var_675 - this.var_53.scrollV;
         if(_loc1_ == 0)
         {
            return;
         }
