package com.sulake.habbo.ui.widget.playlisteditor
{
   ...
   public class MusicInventoryStatusView
   {
      ...
      public static const const_910:String = "MISV_BUY_MORE";
      
      public static const const_1016:String = "MISV_PREVIEW_PLAYING";
      ...
      private var var_2091:ITextWindow;
      ...
      public function selectView(param1:String) : void
      {
         ...
         this._container.addChildAt(this.var_479[param1] as IWindowContainer,0);
         this.var_54 = param1;
      }
      ...
      public function set authorName(param1:String) : void
      {
         ...
         this.var_2091.text = param1;
      }
      
      public function setPreviewPlayingBackgroundImage(param1:BitmapData, param2:Boolean = true) : void
      {
         this.blitBackgroundImage(const_1016,"preview_play_background_image",param1);
      ...
      {
         this.blitBackgroundImage(const_910,"get_more_music_background_image",param1);
         if(param2 && param1 != null)
         {
            param1.dispose();
         }
      ...
      private function createWindows() : void
      {
         ...
         if(_loc1_ != null)
         {
            this.var_479.add(const_1016,_loc1_);
            this.var_2090 = _loc1_.getChildByName("preview_play_track_name") as ITextWindow;
            this.var_2091 = _loc1_.getChildByName("preview_play_author_name") as ITextWindow;
            ...
            this.setPreviewPlayingBackgroundImage(this._widget.getImageGalleryAssetBitmap(PlayListEditorWidgetAssetsEnum.const_641));
         ...
         if(_loc1_ != null)
         {
            this.var_479.add(const_910,_loc1_);
            ...
            this.setGetMoreMusicBackgroundImage(this._widget.getImageGalleryAssetBitmap(PlayListEditorWidgetAssetsEnum.const_534));
         }
      }
      ...
      {
         var _loc6_:* = null;
         var _loc4_:IWindowContainer = this.var_479[param1] as IWindowContainer;
         if(_loc4_ == null)
         {
            return;
         }
