package com.sulake.habbo.ui.widget.playlisteditor
{
   ...
   public class PlayListStatusView
   {
      ...
      public static const const_794:String = "PLSV_ADD_SONGS";
      
      public static const const_1193:String = "PLSV_START_PLAYBACK";
      
      public static const const_558:String = "PLSV_NOW_PLAYING";
      ...
      {
         if(this.var_54 != const_558)
         {
            return;
         }
         var _loc2_:IWindowContainer = this.var_479[this.var_54];
      ...
      public function set addSongsBackgroundImage(param1:BitmapData) : void
      {
         ...
         var _loc2_:IWindowContainer = this.var_479[const_794];
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function createWindows() : void
      {
         ...
         if(_loc1_ != null)
         {
            this.var_479.add(const_558,_loc1_);
