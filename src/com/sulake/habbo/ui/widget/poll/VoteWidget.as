package com.sulake.habbo.ui.widget.poll
{
   ...
   public class VoteWidget extends RoomWidgetBase
   {
      ...
      private var var_1587:int = 30000;
      ...
      public function VoteWidget(param1:IRoomWidgetHandler, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager, param5:IHabboConfigurationManager)
      {
         ...
         {
            this.var_1587 = int(this._config.getKey("vote.time.limit","30000"));
         }
      }
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_176.reset();
            this.var_176.removeEventListener(TimerEvent.TIMER,this.updateEvent);
            this.var_176 = null;
         }
         this._config = null;
         super.dispose();
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetVoteUpdateEvent.const_171,this.showVoteResult);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetVoteUpdateEvent.const_171,this.showVoteResult);
      }
      ...
      private function showVoteQuestion(param1:RoomWidgetVoteUpdateEvent) : void
      {
         ...
         if(this.var_176 == null)
         {
            ...
            this.var_176.addEventListener(TimerEvent.TIMER,this.updateEvent);
         }
         this.var_2014 = getTimer();
         this.var_176.reset();
         this.var_176.start();
      ...
      private function updateTimerView() : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc6_ = Math.max((this.var_1587 - _loc1_) / 1000,0);
      ...
      {
         var _loc2_:int = getTimer() - this.var_2014;
         if(_loc2_ > this.var_1587)
         {
            this.vote();
            return;
         }
