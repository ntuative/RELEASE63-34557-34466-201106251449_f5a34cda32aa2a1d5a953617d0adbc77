package com.sulake.habbo.ui.widget.poll
{
   ...
   public class PollOfferDialog implements IPollDialog
   {
      ...
      public static const const_1933:String = "POLL_OFFER_STATE_OK";
      
      public static const const_981:String = "POLL_OFFER_STATE_CANCEL";
      ...
      private function onOk(param1:WindowEvent) : void
      {
         ...
         this._state = const_1933;
         this._widget.messageListener.processWidgetMessage(new RoomWidgetPollMessage(RoomWidgetPollMessage.const_781,this._id));
      }
