package com.sulake.habbo.ui.widget.poll
{
   ...
   public class PollSession implements IDisposable
   {
      ...
      private var var_1262:PollWidget;
      ...
      {
         this.hideOffer();
         this.var_554 = new PollOfferDialog(this._id,param1,this.var_1262);
         this.var_554.start();
      }
      ...
      public function showContent(param1:String, param2:String, param3:Array) : void
      {
         ...
         this.var_553 = new PollContentDialog(this._id,param1,param3,this.var_1262);
         this.var_553.start();
      }
      ...
      {
         this.var_1262.windowManager.alert("${poll_thanks_title}",this.var_2024,0,function(param1:IAlertDialog, param2:WindowEvent):void
         {
            param1.dispose();
         });
      }
