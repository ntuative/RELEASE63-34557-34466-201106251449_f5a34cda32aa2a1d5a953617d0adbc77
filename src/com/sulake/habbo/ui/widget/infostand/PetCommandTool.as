package com.sulake.habbo.ui.widget.infostand
{
   ...
   public class PetCommandTool
   {
      ...
      private const const_2380:int = 1100;
      ...
      public function PetCommandTool(param1:InfostandWidget)
      {
         ...
         this.var_406 = new Timer(this.const_2380);
      ...
      public function showCommandToolForPet(param1:int, param2:String, param3:BitmapData = null) : void
      {
         ...
         var _loc6_:CommandConfiguration = this.var_1349.getValue(param1) as CommandConfiguration;
         if(_loc6_ == null)
         {
            this.disableAllButtons();
            this.requestEnabledCommands(this.var_583);
         }
         else
         {
      ...
      {
         var _loc2_:CommandConfiguration = this.var_1349.getValue(this.var_583) as CommandConfiguration;
      ...
      {
         this.var_1349.remove(param1);
         this.var_1349.add(param1,param2);
         if(param1 != this.var_583)
         {
            return;
         }
      ...
      {
         var _loc2_:RoomWidgetPetCommandMessage = new RoomWidgetPetCommandMessage(RoomWidgetPetCommandMessage.const_961,param1);
      ...
      private function createCommandWindow() : void
      {
         ...
         this.var_43.setParamFlag(WindowParam.const_101,true);
         ...
         this.var_43.position = const_1474;
      }
      ...
      private function openInfoWindow() : void
      {
         ...
         if(this.var_486 == null)
         {
            ...
            this.var_486 = this._widget.windowManager.buildFromXML(_loc1_.content as XML) as IFrameWindow;
            if(this.var_486 == null)
            {
               throw new Error("Failed to construct command info window from XML!");
            }
            this.var_486.x = 200;
            this.var_486.procedure = this.onInfoWindowProcedure;
         }
         else
         {
      ...
      private function onCommandWindowProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(_loc3_ != null && _loc3_.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            {
               this._widget.messageListener.processWidgetMessage(new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_262,this.var_583));
            }
            else if(param2.name.indexOf("btn_cmd_") > -1)
            {
               ...
               _loc7_ = new RoomWidgetPetCommandMessage(RoomWidgetPetCommandMessage.const_547,this.var_583,this.var_2073 + " " + _loc6_);
      ...
      private function onTrainButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc6_:RoomWidgetPetCommandMessage = new RoomWidgetPetCommandMessage(RoomWidgetPetCommandMessage.const_547,this.var_583,this.var_2073 + " " + _loc5_);
