package com.sulake.habbo.ui.widget.infostand
{
   ...
   public class InfoStandPetView
   {
      ...
      private static const const_1549:int = 16;
      
      private static const const_696:int = 4;
      
      private static const const_1551:uint = 14342874;
      
      private static const const_1557:uint = 3815994;
      
      private static const const_1555:uint = 2085362;
      
      private static const const_1548:uint = 39616;
      
      private static const const_1547:uint = 10513106;
      
      private static const const_1558:uint = 8734654;
      
      private static const const_1550:uint = 9094430;
      
      private static const const_1552:uint = 6200576;
      
      private static const const_1556:String = "happiness";
      
      private static const const_1554:String = "experience";
      
      private static const const_1553:String = "energy";
      
      private static const const_1560:int = 250;
      ...
      private var var_216:PetCommandTool;
      ...
      public function update(param1:InfoStandPetData) : void
      {
         ...
         this.updateStateElement(const_1556,param1.nutrition,param1.nutritionMax,const_1548,const_1555);
         this.updateStateElement(const_1554,param1.experience,param1.experienceMax,const_1558,const_1547);
         this.updateStateElement(const_1553,param1.energy,param1.energyMax,const_1552,const_1550);
         ...
         this.updateWindow();
         this.var_583 = param1.id;
         this._petData.remove(param1.id);
         this._petData.add(param1.id,param1);
         if(this.var_216 && this.var_216.isVisible() && param1.isOwnPet)
         {
            this.var_216.showCommandToolForPet(param1.id,param1.name,param1.image);
         }
      }
      ...
      public function updateEnabledTrainingCommands(param1:int, param2:CommandConfiguration) : void
      {
         ...
         this.var_216.setEnabledCommands(param1,param2);
      }
      ...
      private function createPercentageBar(param1:int, param2:int, param3:uint, param4:uint) : BitmapData
      {
         ...
         var _loc7_:BitmapData = new BitmapData(const_1559,const_1549,false);
         _loc7_.fillRect(new Rectangle(0,0,_loc7_.width,_loc7_.height),const_1551);
      ...
      private function openTrainView() : void
      {
         if(this.var_216 == null)
         {
            this.var_216 = new PetCommandTool(this._widget);
         }
         var _loc1_:InfoStandPetData = this._petData.getValue(this.var_583) as InfoStandPetData;
         if(_loc1_ != null)
         {
            this.var_216.showWindow(true);
            this.var_216.showCommandToolForPet(_loc1_.id,_loc1_.name,_loc1_.image);
         }
      }
      ...
      protected function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc4_.name)
         {
            case "btn_pick":
               _loc3_ = "null";
               if(this.var_216 && this.var_216.getPetId() == this.var_583)
               {
                  this.var_216.showWindow(false);
               }
               break;
            case "btn_train":
               this.openTrainView();
      ...
      private function arrangeButtons() : void
      {
         ...
         for each(_loc5_ in _loc2_)
         {
            if(_loc5_.visible)
            {
               ...
               {
                  _loc3_ = _loc1_;
                  _loc4_ += const_1082 + const_1083;
               }
               _loc5_.x = _loc3_ - _loc5_.width;
               _loc5_.y = _loc4_;
               _loc3_ = _loc5_.x - const_1083;
            }
         }
         this.var_107.height = _loc4_ + const_1082;
         this.updateWindow();
      }
   }
}
