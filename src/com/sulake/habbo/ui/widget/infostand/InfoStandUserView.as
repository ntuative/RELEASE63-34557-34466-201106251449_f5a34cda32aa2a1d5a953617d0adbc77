package com.sulake.habbo.ui.widget.infostand
{
   ...
   public class InfoStandUserView
   {
      ...
      private var var_977:TagListRenderer;
      ...
      private const const_1081:int = 5;
      
      private const const_2366:int = 3;
      
      private const const_1542:int = 11184810;
      
      private const const_1541:int = 16777215;
      
      private const const_2363:int = 2000;
      
      private const const_2365:int = 50;
      
      private const const_2364:int = 23;
      ...
      public function InfoStandUserView(param1:InfostandWidget, param2:String)
      {
         ...
         this.var_977 = new TagListRenderer(param1,this.onTagSelected);
         this.var_2609 = !this._widget.config.getBoolean("menu.avatar.enabled",false);
      }
      ...
      public function set realName(param1:String) : void
      {
         ...
         _loc2_.height = _loc2_.textHeight + this.const_1081;
      ...
      public function setMotto(param1:String, param2:Boolean) : void
      {
         ...
         if(param2)
         {
            ...
            if(param1 == "")
            {
               ...
               _loc5_.textColor = this.const_1542;
            }
            else
            {
               _loc5_.textColor = this.const_1541;
            }
            _loc5_.enable();
         }
         else
         ...
         _loc5_.text = param1;
         _loc5_.height = Math.min(_loc5_.textHeight + this.const_1081,this.const_2365);
         _loc5_.height = Math.max(_loc5_.height,this.const_2364);
         _loc3_.height = _loc5_.height + this.const_2366;
         if(param2)
         {
            _loc5_.addEventListener(WindowKeyboardEvent.const_354,this.onMottoKeyboard);
            _loc5_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onMottoClicked);
         }
         else
         {
            _loc5_.removeEventListener(WindowKeyboardEvent.const_354,this.onMottoClicked);
         }
         this.updateWindow();
      }
      ...
      public function setTags(param1:Array, param2:Array = null) : void
      {
         ...
         if(param1.length != 0)
         {
            _loc3_.height = this.var_977.renderTags(param1,_loc3_,param2);
            _loc4_.height = 1;
         }
         else
         {
      ...
      protected function onMottoKeyboard(param1:WindowKeyboardEvent) : void
      {
         ...
         {
            _loc6_ = getTimer();
            if(_loc6_ - this.var_2610 > this.const_2363 && _loc4_ != this._widget.localizations.getKey("infostand.motto.change"))
            {
               ...
               _loc3_.textColor = this.const_1541;
            }
         }
         else
         {
            _loc3_.textColor = this.const_1542;
         }
      }
