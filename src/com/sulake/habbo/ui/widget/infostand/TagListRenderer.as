package com.sulake.habbo.ui.widget.infostand
{
   ...
   public class TagListRenderer
   {
      ...
      private var var_1158:Rectangle = null;
      ...
      public function renderTags(param1:Array, param2:IWindowContainer, param3:Array) : int
      {
         ...
         this._offsetX = 0;
         this.var_1157 = 0;
         this.var_1158 = param2.rectangle.clone();
         this.var_1158.height = 150;
         var _loc5_:int = 0;
      ...
      {
         if(param1.width > this.var_1158.width)
         {
            return false;
         }
         if(this.var_1157 + param1.height > this.var_1158.height)
         {
            return false;
         }
         if(this._offsetX + param1.width > this.var_1158.width)
         {
            this._offsetX = 0;
            this.var_1157 += param1.height + this.const_2344;
            return this.fit(param1);
         }
         param1.offset(this._offsetX,this.var_1157);
         this._offsetX += param1.width + this.const_2343;
         return true;
      }
      ...
      {
         var _loc2_:* = null;
         if(this.var_1552 != null && this.var_1552.indexOf(param1) != -1)
         {
         ...
         _loc3_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.var_183);
