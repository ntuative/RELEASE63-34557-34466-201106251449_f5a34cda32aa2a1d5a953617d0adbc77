package com.sulake.habbo.ui.widget.infostand
{
   ...
   public class InfostandWidget extends RoomWidgetBase
   {
      ...
      private const const_2092:String = "infostand_user_view";
      
      private const const_2090:String = "infostand_furni_view";
      
      private const const_2088:String = "infostand_pet_view";
      
      private const const_2091:String = "infostand_bot_view";
      
      private const const_2087:String = "infostand_jukebox_view";
      
      private const const_2089:String = "infostand_songdisk_view";
      ...
      private var var_1037:InfoStandJukeboxView;
      
      private var var_1036:InfoStandSongDiskView;
      
      private var var_2697:Array;
      
      private var var_1565:InfostandUserData;
      
      private var var_709:InfostandFurniData;
      ...
      public function InfostandWidget(param1:IRoomWidgetHandler, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager, param5:IHabboConfigurationManager, param6:IHabboCatalog)
      {
         ...
         this.var_1276 = new InfoStandFurniView(this,this.const_2090,this._catalog);
         this.var_198 = new InfoStandUserView(this,this.const_2092);
         this.var_391 = new InfoStandPetView(this,this.const_2088,this._catalog);
         this.var_467 = new InfoStandBotView(this,this.const_2091);
         this.var_1037 = new InfoStandJukeboxView(this,this.const_2087,this._catalog);
         this.var_1036 = new InfoStandSongDiskView(this,this.const_2089,this._catalog);
         this.var_1565 = new InfostandUserData();
         this.var_709 = new InfostandFurniData();
         this._petData = new InfoStandPetData();
         this.var_176 = new Timer(this.const_2371);
         this.var_176.addEventListener(TimerEvent.TIMER,this.onUpdateTimer);
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetRoomObjectUpdateEvent.const_161,this.onClose);
         ...
         param1.addEventListener(RoomWidgetFurniInfoUpdateEvent.const_326,this.onFurniInfo);
         ...
         param1.addEventListener(RoomWidgetUserBadgesUpdateEvent.const_176,this.onUserBadges);
         param1.addEventListener(RoomWidgetBadgeImageUpdateEvent.const_867,this.onBadgeImage);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetRoomObjectUpdateEvent.const_161,this.onClose);
         ...
         param1.removeEventListener(RoomWidgetFurniInfoUpdateEvent.const_326,this.onFurniInfo);
         ...
         param1.removeEventListener(RoomWidgetUserBadgesUpdateEvent.const_176,this.onUserBadges);
         param1.removeEventListener(RoomWidgetBadgeImageUpdateEvent.const_867,this.onBadgeImage);
      ...
      private function onUpdateTimer(param1:TimerEvent) : void
      {
         ...
         messageListener.processWidgetMessage(new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_262,this.var_391.getCurrentPetId()));
      }
      ...
      private function onFurniInfo(param1:RoomWidgetFurniInfoUpdateEvent) : void
      {
         ...
         if(param1.extraParam == RoomWidgetInfostandExtraParamEnum.const_589)
         {
            this.var_1037.update(param1);
            this.selectView(this.const_2087);
         }
         else if(param1.extraParam.indexOf(RoomWidgetInfostandExtraParamEnum.const_408) != -1)
         {
            this.var_1036.update(param1);
      ...
      private function onUserTags(param1:RoomWidgetUserTagsUpdateEvent) : void
      {
         ...
         {
            this.var_198.setTags(param1.tags,this.var_2697);
         }
      }
      ...
      {
         var _loc2_:RoomWidgetRoomObjectMessage = new RoomWidgetRoomObjectMessage(RoomWidgetRoomObjectMessage.const_642,param1.id,param1.category);
      ...
      private function onSongUpdate(param1:RoomWidgetSongUpdateEvent) : void
      {
         ...
         this.var_1036.updateSongInfo(param1);
      }
