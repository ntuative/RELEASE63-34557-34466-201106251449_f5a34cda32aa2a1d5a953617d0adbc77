package com.sulake.habbo.ui.widget.loadingbar
{
   ...
   public class LoadingBarWidget extends RoomWidgetBase
   {
      ...
      private var var_579:Sprite = null;
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_579.removeEventListener(MouseEvent.CLICK,this.clickHandler);
            this.var_579 = null;
         }
         if(this.var_47 != null)
         {
      ...
      private function onShowInterstitial(param1:RoomWidgetInterstitialUpdateEvent) : void
      {
         ...
         if(this.var_579 == null)
         {
            this.var_579 = new Sprite();
            this.var_579.addChild(new Bitmap(this.var_47));
            this.var_579.addEventListener(MouseEvent.CLICK,this.clickHandler);
         }
         else
         {
            _loc5_ = this.var_579.getChildAt(0) as Bitmap;
            if(_loc5_ != null)
            {
               _loc5_.bitmapData = this.var_47;
            }
         }
         _loc2_.setDisplayObject(this.var_579);
      ...
      private function clickHandler(param1:Event) : void
      {
         if(this.var_1333 != "")
         {
            HabboWebTools.openWebPage(this.var_1333);
         }
      }
   }
}
