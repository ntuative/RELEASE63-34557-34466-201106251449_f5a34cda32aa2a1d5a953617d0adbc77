package com.sulake.habbo.ui.widget.furniture.teaser
{
   ...
   public class TeaserFurniWidget extends RoomWidgetBase
   {
      ...
      private const const_2350:int = 0;
      
      private const const_2354:int = 1;
      
      private const const_2358:int = 2;
      
      private const const_2356:int = 3;
      
      private const const_2355:int = 4;
      
      private const const_2352:int = 5;
      
      private const const_2078:String = "deco_img";
      
      private const const_2072:String = "dialog_bg";
      
      private const const_2353:String = "%campaign%_dialog_bg.png";
      
      private const const_388:String = "%campaign%_gift_package.png";
      
      private const const_2351:String = "%campaign%_gift_content.png";
      ...
      public function TeaserFurniWidget(param1:IRoomWidgetHandler, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager, param5:IHabboConfigurationManager, param6:IHabboInventory)
      {
         ...
         this.var_1507 = this.var_153.getKey("image.library.url","http://images.habbo.com/c_images/");
         this.var_1507 += "Viral/";
      }
      ...
      override public function dispose() : void
      {
         ...
         var _loc1_:int = 0;
         while(_loc1_ < this.var_1508.length)
         {
            _loc2_ = this.var_1508.pop();
            _loc2_.dispose();
            _loc1_++;
         }
         this.var_153 = null;
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetTeaserDataUpdateEvent.const_659,this.onObjectUpdate);
         param1.addEventListener(RoomWidgetTeaserDataUpdateEvent.const_739,this.onObjectUpdate);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetTeaserDataUpdateEvent.const_659,this.onObjectUpdate);
      }
      ...
      private function onObjectUpdate(param1:RoomWidgetTeaserDataUpdateEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetTeaserDataUpdateEvent.const_659:
            ...
            case RoomWidgetTeaserDataUpdateEvent.const_868:
               ...
               this._shareId = null;
               this.var_1505 = param1.itemCategory;
               break;
            case RoomWidgetTeaserDataUpdateEvent.const_739:
         ...
         if(this._window && (this.var_1506 != _loc2_ || _loc3_ != this.var_193))
         {
            this._window.dispose();
            this._window = null;
         }
         ...
         if(!this._window)
         {
            switch(this.var_1506)
            {
               ...
               case this.const_2075:
                  if(this.var_430 == this.const_2350)
                  {
                  ...
                  else if(this.var_430 == this.const_2354)
                  {
                     ...
                     _loc2_ = this.const_2351;
                  }
                  else if(this.var_430 == this.const_2358)
                  {
                  ...
                  else if(this.var_430 == this.const_2352)
                  {
                     _loc1_ = assets.getAssetByName("notification_gift_alert") as XmlAsset;
            ...
            _loc5_ = this.const_2353.replace("%campaign%",this.var_193);
            this.setDecoImage(_loc5_,this.const_2072);
            _loc2_ = _loc2_.replace("%campaign%",this.var_193);
            this.setDecoImage(_loc2_,this.const_2078);
            if(_loc3_)
            {
      ...
      private function onTeaserOkButton(param1:WindowEvent) : void
      {
         ...
         {
            _loc2_ = new RoomWidgetViralFurniMessage(RoomWidgetViralFurniMessage.const_907);
      ...
      private function onOpenButton(param1:WindowEvent) : void
      {
         ...
         if(this.var_13)
         {
            if(this.var_1505 != 0)
            {
               this.var_13.toggleInventoryPage(this.var_1505 == 1 ? "null" : InventoryCategory.const_133);
            }
         }
      ...
      private function sendConversionPoint(param1:String, param2:String, param3:String = "") : void
      {
         ...
         if(messageListener != null)
         {
            _loc4_ = new RoomWidgetConversionPointMessage(RoomWidgetConversionPointMessage.const_949,"ViralGift",param1,param2,param3);
      ...
      private function setDecoImage(param1:String, param2:String) : void
      {
         ...
         if(!_loc4_)
         {
            this.var_1508.push(new ImageDownloader(this,_assets,this.var_193,this.var_1507,param1,param2));
            return;
         }
