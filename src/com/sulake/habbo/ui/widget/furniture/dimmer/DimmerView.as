package com.sulake.habbo.ui.widget.furniture.dimmer
{
   ...
   public class DimmerView
   {
      ...
      private function createWindow() : void
      {
         ...
         this._window = this._widget.windowManager.createWindow("dimmerui_container","",HabboWindowType.const_74,HabboWindowStyle.const_31,0 | 0,new Rectangle(const_1476,const_1475,2,2),null,0) as IWindowContainer;
         ...
         if(_loc1_ != null)
         {
            this.var_463 = new DimmerViewAlphaSlider(this,_loc1_ as IWindowContainer,this._widget.assets);
         }
      ...
      private function selectPreset(param1:int) : void
      {
         ...
         this.var_1555 = _loc2_.light;
         if(this.var_463 != null)
         {
            this.var_463.setValue(this.var_1555);
         }
         this.var_537 = this.colors.indexOf(_loc2_.color);
         if(this.var_672 != null)
         {
            this.var_672.setSelectedColorIndex(this.var_537);
         }
      ...
      private function get windowXML() : XML
      {
         ...
         this.var_1554 = XML(_loc1_.content);
         return this.var_1554;
      }
      ...
      public function set selectedType(param1:int) : void
      {
         ...
         if(this.var_463 != null)
         {
            this.var_463.min = this._widget.minLights[param1 - 1];
         }
      }
