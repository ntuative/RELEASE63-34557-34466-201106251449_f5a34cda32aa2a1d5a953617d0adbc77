package com.sulake.habbo.ui.widget.furniture.welcomegift
{
   ...
   public class WelcomeGiftWidget extends RoomWidgetBase
   {
      ...
      private const const_685:String = "welcome_gift_email_unverified";
      
      private const const_1053:String = "welcome_gift_email_verified";
      
      private const const_1453:String = "welcome_gift_email_change";
      
      private const const_2346:int = 4;
      ...
      private function createMainView() : void
      {
         ...
         if(this.var_1172)
         {
            this.setViewState(this.const_1053);
         }
         else
         {
            this.setViewState(this.const_685);
         }
      }
      ...
      private function setViewState(param1:String) : void
      {
         ...
         switch(param1)
         {
            case this.const_685:
               ...
               this._view.findChildByName("edit").setParamFlag(WindowParam.const_30,this.var_956);
               break;
      ...
      {
         this.setViewState(this.const_1453);
      }
      
      private function openGift(param1:WindowMouseEvent) : void
      {
         messageListener.processWidgetMessage(new RoomWidgetFurniActionMessage(RoomWidgetFurniActionMessage.const_825,this._furniId,0));
         this.disposeView();
      }
      
      private function cancelEmailChange(param1:WindowMouseEvent) : void
      {
         this.setViewState(!!this.var_1172 ? this.const_1053 : this.const_685);
      }
      ...
      private function saveEmail(param1:WindowMouseEvent) : void
      {
         ...
         this.var_1450 = _loc2_.text;
         messageListener.processWidgetMessage(new RoomWidgetChangeEmailMessage(this.var_1450));
      }
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetChangeEmailResultEvent.const_851,this.emailChangeHandler);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetChangeEmailResultEvent.const_851,this.emailChangeHandler);
      }
      ...
      private function updateEventHandler(param1:RoomWidgetWelcomeGiftUpdateEvent) : void
      {
         switch(param1.type)
         {
            case RoomWidgetWelcomeGiftUpdateEvent.const_593:
               this.var_1449 = param1.email;
               this.var_1172 = param1.isVerified;
      ...
      private function emailChangeHandler(param1:RoomWidgetChangeEmailResultEvent) : void
      {
         if(param1.result == 0)
         {
            this.var_1449 = this.var_1450;
            this.setViewState(this.const_685);
         }
         else
         {
            if(param1.result == this.const_2346)
            {
               this.var_956 = false;
            }
      ...
      private function showEmailChangeError(param1:int) : void
      {
         ...
         this.setCaption("email_input",this.var_1450);
