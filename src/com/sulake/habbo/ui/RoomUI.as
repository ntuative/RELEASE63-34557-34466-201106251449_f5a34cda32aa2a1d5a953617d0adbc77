package com.sulake.habbo.ui
{
   ...
   public class RoomUI extends ComponentContext implements IRoomUI, IUpdateReceiver
   {
      ...
      private var var_1209:IRoomWidgetFactory;
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_1000.release(new IIDHabboModeration());
            this.var_1000 = null;
         }
         ...
         if(this.var_1226)
         {
            this.var_1226.release(new IIDHabboUserDefinedRoomEvents());
            this.var_1226 = null;
         }
         this.var_1594 = null;
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         {
            this.var_325.events.addEventListener(InterstitialEvent.const_496,this.interstitialCompleteEventHandler);
            this.var_325.events.addEventListener(InterstitialEvent.const_541,this.adEventHandler);
            this.var_325.events.addEventListener(AdEvent.const_503,this.adEventHandler);
         }
      }
      ...
      private function onHabboModerationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1000 = param2 as IHabboModeration;
         Logger.log("XXXX GOT HABBO MODERATION: " + this.var_1000);
      }
      ...
      private function registerSessionEvents() : void
      {
         if(this.var_16)
         {
            this.var_16.events.addEventListener(RoomSessionEvent.const_294,this.roomSessionStateEventHandler);
            ...
            this.var_16.events.addEventListener(RoomSessionChatEvent.const_209,this.roomSessionEventHandler);
            this.var_16.events.addEventListener(RoomSessionChatEvent.const_537,this.roomSessionEventHandler);
            this.var_16.events.addEventListener(RoomSessionUserBadgesEvent.const_176,this.roomSessionEventHandler);
            ...
            this.var_16.events.addEventListener(RoomSessionPetPackageEvent.const_634,this.roomSessionEventHandler);
            this.var_16.events.addEventListener(RoomSessionViralFurniStatusEvent.const_653,this.roomSessionEventHandler);
            this.var_16.events.addEventListener(RoomSessionViralFurniStatusEvent.const_569,this.roomSessionEventHandler);
            this.var_16.events.addEventListener(RoomSessionErrorMessageEvent.const_286,this.roomSessionDialogEventHandler);
            this.var_16.events.addEventListener(RoomSessionErrorMessageEvent.const_293,this.roomSessionDialogEventHandler);
            this.var_16.events.addEventListener(RoomSessionErrorMessageEvent.const_1004,this.roomSessionDialogEventHandler);
            this.var_16.events.addEventListener(RoomSessionErrorMessageEvent.const_1184,this.roomSessionDialogEventHandler);
            this.var_16.events.addEventListener(RoomSessionErrorMessageEvent.const_1394,this.roomSessionDialogEventHandler);
            ...
            this.var_16.events.addEventListener(RoomSessionErrorMessageEvent.const_255,this.roomSessionDialogEventHandler);
            ...
            this.var_16.events.addEventListener(RoomSessionErrorMessageEvent.const_785,this.roomSessionDialogEventHandler);
            this.var_16.events.addEventListener(RoomSessionErrorMessageEvent.const_827,this.roomSessionDialogEventHandler);
            this.var_16.events.addEventListener(RoomSessionQueueEvent.const_566,this.roomSessionEventHandler);
            ...
            this.var_16.events.addEventListener(RoomSessionPollEvent.const_164,this.roomSessionEventHandler);
            this.var_16.events.addEventListener(RoomSessionDimmerPresetsEvent.const_601,this.roomSessionEventHandler);
            this.var_16.events.addEventListener(RoomSessionFriendRequestEvent.const_155,this.roomSessionEventHandler);
            this.var_16.events.addEventListener(RoomSessionUserNotificationEvent.const_134,this.roomSessionEventHandler);
            this.var_16.events.addEventListener(RoomSessionUserDataUpdateEvent.const_123,this.roomSessionEventHandler);
            this.var_16.events.addEventListener(RoomSessionDanceEvent.const_145,this.roomSessionEventHandler);
         }
      }
      ...
      private function roomSessionStateEventHandler(param1:RoomSessionEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionEvent.const_294:
               this.createDesktop(param1.session);
               break;
            case RoomSessionEvent.const_73:
               this._toolbar.setToolbarState(HabboToolbarEnum.const_857);
               break;
            case RoomSessionEvent.const_86:
               if(param1.session != null)
               {
                  ...
                  this._toolbar.setToolbarState(HabboToolbarEnum.const_954);
               }
         }
      }
      ...
      private function roomSessionDialogEventHandler(param1:RoomSessionEvent) : void
      {
         ...
         switch(event.type)
         {
            ...
            case RoomSessionErrorMessageEvent.const_293:
               ...
               break;
            case RoomSessionErrorMessageEvent.const_1004:
      ...
      private function interstitialCompleteEventHandler(param1:InterstitialEvent) : void
      {
         ...
         var _loc2_:String = this.getRoomIdentifier(this._interstitialRoomId,this.var_2509);
      ...
      private function onUserDefinedRoomEventsReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1226 = param2 as IHabboUserDefinedRoomEvents;
      }
      ...
      private function initializeRoomEngineEvents() : void
      {
         ...
         {
            this._roomEngine.events.addEventListener(RoomEngineEvent.const_766,this.roomEngineEventHandler);
            this._roomEngine.events.addEventListener(RoomEngineEvent.const_191,this.roomEventHandler);
            this._roomEngine.events.addEventListener(RoomEngineEvent.const_369,this.roomEventHandler);
            this._roomEngine.events.addEventListener(RoomEngineEvent.const_515,this.roomEngineEventHandler);
            this._roomEngine.events.addEventListener(RoomEngineEvent.const_598,this.roomEngineEventHandler);
            ...
            this._roomEngine.events.addEventListener(RoomEngineObjectEvent.const_618,this.roomObjectEventHandler);
            ...
            this._roomEngine.events.addEventListener(RoomEngineSoundMachineEvent.const_301,this.roomObjectEventHandler);
         }
      }
      ...
      private function roomEngineEventHandler(param1:RoomEngineEvent) : void
      {
         ...
         if(param1.type == RoomEngineEvent.const_766)
         {
            if(this.var_16 != null)
            {
               this.var_16.roomEngineReady = true;
         ...
         else if(param1.type == RoomEngineEvent.const_598 || param1.type == RoomEngineEvent.const_515)
         {
      ...
      private function roomEventHandler(param1:RoomEngineEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineEvent.const_191:
               _loc5_ = false;
               _loc3_.createRoomView(this.method_8(param1.roomId,param1.roomCategory));
               if(this._roomEngine != null)
               {
               ...
               _loc3_.disposeWidget(RoomWidgetEnum.const_594);
               ...
               _loc3_.createWidget(RoomWidgetEnum.const_746);
               ...
               if(this.var_1514 != RoomDesktop.const_657)
               {
                  _loc3_.initializeWidget(RoomWidgetEnum.const_338,this.var_1514);
               }
               if(this.var_325 != null)
               {
               ...
               break;
            case RoomEngineEvent.const_369:
      ...
      public function createDesktop(param1:IRoomSession) : IRoomDesktop
      {
         ...
         _loc3_.roomWidgetFactory = this.var_1209;
         _loc3_.sessionDataManager = this.var_417;
         _loc3_.roomSessionManager = this.var_16;
         _loc3_.friendList = this._friendList;
         _loc3_.avatarRenderManager = this.var_1121;
         ...
         _loc3_.moderation = this.var_1000;
         _loc3_.config = this._config;
         _loc3_.soundManager = this._soundManager;
         _loc3_.habboTracking = this._habboTracking;
         _loc3_.userDefinedRoomEvents = this.var_1226;
         ...
         if(_loc3_.showInterstitial())
         {
            ...
            this.var_2509 = param1.roomCategory;
         }
         else
         {
            this.var_1513 = false;
      ...
      public function disposeDesktop(param1:String) : void
      {
         ...
         if(_loc2_ != null)
         {
            ...
            if(_loc3_ != RoomDesktop.const_657)
            {
      ...
      public function method_8(param1:int, param2:int) : int
      {
         return 1;
      }
