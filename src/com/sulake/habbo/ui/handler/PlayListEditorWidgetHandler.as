package com.sulake.habbo.ui.handler
{
   ...
   public class PlayListEditorWidgetHandler implements IRoomWidgetHandler
   {
      ...
      private var var_1464:IMessageEvent;
      
      private var var_1775:IMessageEvent;
      
      private var var_1774:IMessageEvent;
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         ...
         if(this._container.soundManager)
         {
            ...
            this._container.soundManager.events.addEventListener(PlayListStatusEvent.const_174,this.processSoundManagerEvent);
      ...
      {
         this.var_1464 = new FurniListUpdateEvent(this.onFurniListUpdated);
         this.var_1775 = new FurniListRemoveEvent(this.onFurniListUpdated);
         this.var_1774 = new FurniListInsertEvent(this.onFurniListUpdated);
         this._connection = param1;
         this._connection.addMessageEvent(this.var_1464);
         this._connection.addMessageEvent(this.var_1775);
         this._connection.addMessageEvent(this.var_1774);
      }
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this._connection)
            {
               this._connection.removeMessageEvent(this.var_1464);
               this._connection.removeMessageEvent(this.var_1775);
               this._connection.removeMessageEvent(this.var_1774);
            }
            ...
            if(this._container)
            {
               if(this._container.soundManager)
               {
                  if(this._container.soundManager.events)
                  {
                     ...
                     this._container.soundManager.events.removeEventListener(PlayListStatusEvent.const_174,this.processSoundManagerEvent);
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_1019,RoomWidgetPlayListModificationMessage.const_844,RoomWidgetPlayListModificationMessage.const_852,RoomWidgetPlayListPlayStateMessage.const_912,RoomWidgetPlayListUserActionMessage.const_968];
      }
         ...
         switch(param1.type)
         {
            case RoomWidgetFurniToWidgetMessage.const_1019:
               ...
               if(_loc3_ != null)
               {
                  ...
                  if(_loc7_)
                  {
                     _loc8_ = new RoomWidgetPlayListEditorEvent(RoomWidgetPlayListEditorEvent.const_887,_loc2_.id);
                     this._container.events.dispatchEvent(_loc8_);
                  }
               }
               break;
            case RoomWidgetPlayListModificationMessage.const_844:
               ...
               break;
            case RoomWidgetPlayListModificationMessage.const_852:
               ...
               break;
            case RoomWidgetPlayListPlayStateMessage.const_912:
               ...
               break;
            case RoomWidgetPlayListUserActionMessage.const_968:
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomEngineSoundMachineEvent.const_301);
         return _loc1_;
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineSoundMachineEvent.const_301:
               ...
               _loc3_ = new RoomWidgetPlayListEditorEvent(RoomWidgetPlayListEditorEvent.const_869,_loc2_.objectId);
      ...
      private function onFurniListUpdated(param1:IMessageEvent) : void
      {
         if(this._container != null)
         {
            ...
            {
               this._container.events.dispatchEvent(new RoomWidgetPlayListEditorEvent(RoomWidgetPlayListEditorEvent.const_837,-1));
            }
         }
      }
      ...
      private function processSoundManagerEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case SongDiskInventoryReceivedEvent.SONG_DISK_INVENTORY_RECEIVED:
               this._container.events.dispatchEvent(new RoomWidgetPlayListEditorEvent(RoomWidgetPlayListEditorEvent.const_1029));
               break;
            case PlayListStatusEvent.const_106:
               ...
               break;
            case PlayListStatusEvent.const_174:
               this._container.events.dispatchEvent(new RoomWidgetPlayListEditorEvent(RoomWidgetPlayListEditorEvent.const_174));
               break;
