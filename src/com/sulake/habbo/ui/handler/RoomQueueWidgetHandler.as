package com.sulake.habbo.ui.handler
{
   ...
   public class RoomQueueWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetRoomQueueMessage.const_753:
            ...
            case RoomWidgetRoomQueueMessage.const_853:
               this._container.roomSession.changeQueue(RoomSessionQueueEvent.const_1171);
               break;
            case RoomWidgetRoomQueueMessage.const_898:
               if(this._container.catalog != null)
               {
                  this._container.catalog.openCatalogPage(CatalogPageName.const_140,true);
               }
         }
         return null;
      }
      ...
      {
         return [RoomSessionQueueEvent.const_566];
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionQueueEvent.const_566:
               ...
               {
                  case RoomSessionQueueEvent.const_1171:
                     _loc3_ = "null";
                     break;
               ...
               if(_loc5_.length > 1)
               {
                  if(_loc4_ && _loc2_.queueTypes.indexOf(RoomSessionQueueEvent.const_1312) != -1)
                  {
                     _loc6_ = _loc2_.getQueueSize(RoomSessionQueueEvent.const_1312) + 1;
                     _loc7_ = true;
                  }
                  else
                  {
                     _loc6_ = _loc2_.getQueueSize(RoomSessionQueueEvent.const_1825) + 1;
                  }
               }
               else
               {
