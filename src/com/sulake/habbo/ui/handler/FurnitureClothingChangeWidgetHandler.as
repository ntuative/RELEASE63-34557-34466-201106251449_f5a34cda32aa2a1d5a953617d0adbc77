package com.sulake.habbo.ui.handler
{
   ...
   public class FurnitureClothingChangeWidgetHandler implements IRoomWidgetHandler, IHabboAvatarEditorDataSaver
   {
      ...
      private static const const_1574:String = "hd-99999-99999.lg-270-62";
      
      private static const const_1573:String = "hd-99999-99999.ch-630-62.lg-695-62";
      ...
      public function dispose() : void
      {
         ...
         {
            this._container.avatarEditor.close(AvatarEditorInstanceId.const_463);
         }
         this.var_1148 = true;
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_792,RoomWidgetClothingChangeMessage.const_1011,RoomWidgetAvatarEditorMessage.const_500];
      }
            ...
            case RoomWidgetFurniToWidgetMessage.const_792:
               ...
               if(_loc2_ != null)
               {
                  ...
                  if(_loc3_ != null)
                  {
                     ...
                     if(_loc7_)
                     {
                        _loc4_ = new RoomWidgetClothingChangeUpdateEvent(RoomWidgetClothingChangeUpdateEvent.const_445,_loc5_.id,_loc5_.category,_loc5_.roomId,_loc5_.roomCategory);
                        this._container.events.dispatchEvent(_loc4_);
                     }
                  }
               }
               break;
            case RoomWidgetClothingChangeMessage.const_1011:
               ...
               if(_loc2_ != null)
               {
                  ...
                  if(_loc3_ != null)
                  {
                     ...
                     _loc8_ = "null";
                     _loc9_ = _loc3_.getString(RoomObjectVariableEnum.const_1286);
                     ...
                     {
                        _loc8_ = "null";
                        _loc9_ = _loc3_.getString(RoomObjectVariableEnum.const_1251);
                        if(_loc9_ == null || _loc9_ == "")
                        {
                           _loc9_ = const_1573;
                        }
                     }
                     if(this._container.avatarEditor.openEditor(AvatarEditorInstanceId.const_463,this,[AvatarEditorFigureCategory.const_272,AvatarEditorFigureCategory.const_748],false,"${widget.furni.clothingchange.editor.title}"))
                     {
                        this._container.avatarEditor.loadAvatarInEditor(AvatarEditorInstanceId.const_463,_loc9_,_loc8_,HabboClubLevelEnum.const_54);
                        _loc4_ = new RoomWidgetClothingChangeUpdateEvent(RoomWidgetClothingChangeUpdateEvent.const_445,_loc6_.objectId,_loc6_.objectCategory,_loc6_.roomId,_loc6_.roomCategory);
                        this._container.events.dispatchEvent(_loc4_);
                     }
                  }
               }
