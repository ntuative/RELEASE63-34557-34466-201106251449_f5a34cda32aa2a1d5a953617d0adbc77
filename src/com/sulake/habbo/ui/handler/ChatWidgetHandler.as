package com.sulake.habbo.ui.handler
{
   ...
   public class ChatWidgetHandler implements IRoomWidgetHandler, IPetImageListener, IAvatarImageListener, IGetImageListener
   {
      ...
      private var var_857:Point = null;
      ...
      public function dispose() : void
      {
         ...
         {
            _loc1_ = 0;
            while(_loc1_ < this.var_476.length)
            {
               _loc2_ = this.var_476.getWithIndex(_loc1_) as BitmapData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      {
         return [RoomWidgetChatMessage.const_800,RoomWidgetChatSelectAvatarMessage.const_841];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetChatMessage.const_800:
                     ...
                     if(_loc5_.length > 0)
                     {
                        ...
                        switch(_loc6_.toLowerCase())
                        {
                           ...
                           case ":sign":
                              ...
                              return null;
                           case ":chooser":
                              if(this._container.sessionDataManager.hasUserRight("fuse_habbo_chooser",HabboClubLevelEnum.const_35) || this._container.sessionDataManager.hasSecurity(SecurityLevelEnum.const_1362))
                              {
                              ...
                              return null;
                           case ":furni":
                              if(this._container.sessionDataManager.hasUserRight("fuse_furni_chooser",HabboClubLevelEnum.const_35) || this._container.sessionDataManager.hasSecurity(SecurityLevelEnum.const_1362))
                              {
                                 _loc4_ = new RoomWidgetRequestWidgetMessage(RoomWidgetRequestWidgetMessage.const_567);
                                 this._container.processWidgetMessage(_loc4_);
                              }
                              return null;
                           case ":pickall":
               ...
               break;
            case RoomWidgetChatSelectAvatarMessage.const_841:
                  ...
                  if(_loc4_ != null)
                  {
                     ...
                     if(_loc5_ != null)
                     {
                        ...
                        if(_loc10_ != null)
                        {
                           ...
                           if(_loc10_.type == RoomObjectTypeEnum.const_229)
                           {
                              _loc13_ = this.var_333.getValue(this.getPetFigureString(_loc16_)) as BitmapData;
                           }
                           else
                           {
                              _loc13_ = this.var_476.getValue(_loc16_) as BitmapData;
                           }
                           ...
                           if(_loc13_ == null)
                           {
                              if(this._container.avatarRenderManager != null)
                              {
                                 switch(_loc10_.type)
                                 {
                                    case RoomObjectTypeEnum.const_229:
                                 ...
                                 if(_loc13_ != null)
                                 {
                                    ...
                                    {
                                       this.var_476.add(_loc16_,_loc13_);
                                    }
                                 }
                              }
                           }
      ...
      private function updateWidgetPosition() : void
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(this.var_1316 > 0)
            {
               _loc5_ = Number(_loc4_.scale / this.var_1316);
            }
            if(this.var_857 == null)
            {
               ...
               this.var_565.y = 0;
               this.var_565.z = 0;
               this.var_857 = _loc4_.getScreenPoint(this.var_565);
               this.var_1316 = _loc4_.scale - 10;
            }
            _loc6_ = "";
            _loc7_ = null;
            this.var_565.x = 0;
            this.var_565.y = 0;
            this.var_565.z = 0;
            _loc8_ = _loc4_.getScreenPoint(this.var_565);
            if(_loc8_ != null)
            {
               ...
               if(_loc8_.x != this.var_857.x || _loc8_.y != this.var_857.y)
               {
                  _loc10_ = PointMath.sub(_loc8_,PointMath.mul(this.var_857,_loc5_));
      ...
      public function avatarImageReady(param1:String) : void
      {
         ...
         if(this.var_476)
         {
            _loc2_ = this.var_476.remove(param1) as BitmapData;
            if(_loc2_ != null)
            {
               this.var_1315.push(_loc2_);
            }
      ...
      private function getPetImage(param1:String) : BitmapData
      {
         ...
         else
         {
            ...
            if(_loc9_ != null)
            {
               ...
               if(_loc9_.id > 0)
               {
                  this.var_2040.add(_loc9_.id,param1);
               }
            }
         }
         return _loc2_;
      ...
      {
         var _loc3_:String = this.var_2040.remove(param1);
         if(_loc3_ != null)
         {
