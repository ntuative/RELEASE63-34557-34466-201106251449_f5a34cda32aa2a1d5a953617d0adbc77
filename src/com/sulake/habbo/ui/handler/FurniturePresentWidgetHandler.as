package com.sulake.habbo.ui.handler
{
   ...
   public class FurniturePresentWidgetHandler implements IRoomWidgetHandler, IGetImageListener
   {
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_830,RoomWidgetPresentOpenMessage.const_197];
      }
            ...
            case RoomWidgetFurniToWidgetMessage.const_830:
               ...
               if(_loc3_ != null)
               {
                  ...
                  if(_loc5_ != null)
                  {
                     ...
                     _loc8_ = _loc5_.getString(RoomObjectVariableEnum.const_375);
                  ...
                  if(_loc2_ != null)
                  {
                     ...
                     switch(_loc2_.itemType)
                     {
                        case ProductTypeEnum.const_63:
                           ...
                           {
                              _loc5_ = new RoomWidgetPresentDataUpdateEvent(RoomWidgetPresentDataUpdateEvent.const_638,0,this._container.localization.getKey("inventory.furni.item.floor.name"),false,null);
                           }
                           ...
                           {
                              _loc5_ = new RoomWidgetPresentDataUpdateEvent(RoomWidgetPresentDataUpdateEvent.const_586,0,this._container.localization.getKey("inventory.furni.item.wallpaper.name"),false,null);
                           }
                           else
                           {
                              if(_loc3_ != null && _loc3_.name == const_1505)
                              {
                                 break;
                              }
                        ...
                        case ProductTypeEnum.const_379:
                           _loc5_ = new RoomWidgetPresentDataUpdateEvent(RoomWidgetPresentDataUpdateEvent.const_577,0,this._container.localization.getKey("widget.furni.present.hc"),false,null);
                           break;
                        default:
