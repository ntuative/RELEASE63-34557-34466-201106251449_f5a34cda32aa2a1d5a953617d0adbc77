package com.sulake.habbo.ui.handler
{
   ...
   public class InfoStandWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function InfoStandWidgetHandler(param1:IHabboMusicController)
      {
         ...
         {
            this.var_254.events.addEventListener(NowPlayingEvent.const_103,this.onNowPlayingChanged);
            this.var_254.events.addEventListener(SongInfoReceivedEvent.const_98,this.onSongInfoReceivedEvent);
         }
      }
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(this._container != null)
         {
            if(this._container.sessionDataManager != null)
            {
               ...
               this._container.sessionDataManager.events.removeEventListener(BadgeImageReadyEvent.const_218,this.onBadgeImage);
            }
         ...
         if(this._container.sessionDataManager != null)
         {
            ...
            this._container.sessionDataManager.events.addEventListener(BadgeImageReadyEvent.const_218,this.onBadgeImage);
         }
         if(this._container.roomSessionManager != null)
         {
      ...
      public function dispose() : void
      {
         ...
         {
            _loc1_ = this.var_707.length - 1;
            while(_loc1_ >= 0)
            {
               _loc2_ = this.var_707.getWithIndex(_loc1_);
               if(_loc2_)
               {
                  _loc2_.dispose();
               }
         ...
         if(this.var_254 != null)
         {
            this.var_254.events.removeEventListener(NowPlayingEvent.const_103,this.onNowPlayingChanged);
            this.var_254.events.removeEventListener(SongInfoReceivedEvent.const_98,this.onSongInfoReceivedEvent);
            this.var_254 = null;
         }
         this.var_1148 = true;
         this.container = null;
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetRoomObjectMessage.const_642);
         _loc1_.push(RoomWidgetRoomObjectMessage.const_880);
         ...
         _loc1_.push(RoomWidgetFurniActionMessage.const_928);
         _loc1_.push(RoomWidgetFurniActionMessage.const_829);
         _loc1_.push(RoomWidgetFurniActionMessage.const_832);
         _loc1_.push(RoomWidgetFurniActionMessage.const_1328);
         _loc1_.push(RoomWidgetRoomTagSearchMessage.const_956);
         _loc1_.push(RoomWidgetGetBadgeDetailsMessage.const_917);
         _loc1_.push(RoomWidgetGetBadgeImageMessage.const_932);
         ...
         _loc1_.push(RoomWidgetUserActionMessage.const_1962);
         _loc1_.push(RoomWidgetPetCommandMessage.const_547);
         _loc1_.push(RoomWidgetPetCommandMessage.const_961);
         _loc1_.push(RoomWidgetUserActionMessage.const_652);
         _loc1_.push(RoomWidgetUserActionMessage.const_262);
         _loc1_.push(RoomWidgetChangeMottoMessage.const_1024);
         return _loc1_;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(_loc4_.type == RoomWidgetUserActionMessage.const_668)
            {
               _loc3_ = this._container.roomSession.userDataManager.getUserDataByIndex(_loc2_);
            }
            else if(param1.type == RoomWidgetUserActionMessage.const_262 || param1.type == RoomWidgetUserActionMessage.const_652 || param1.type == RoomWidgetUserActionMessage.const_561)
            {
         ...
         switch(param1.type)
         {
            case RoomWidgetRoomObjectMessage.const_642:
               return this.handleGetObjectInfoMessage(param1 as RoomWidgetRoomObjectMessage);
            case RoomWidgetRoomObjectMessage.const_880:
            ...
            case RoomWidgetUserActionMessage.const_669:
               _loc8_ = new RoomWidgetChatInputContentUpdateEvent(RoomWidgetChatInputContentUpdateEvent.const_1188,_loc3_.name);
            ...
            case RoomWidgetUserActionMessage.const_561:
               ...
               break;
            case RoomWidgetFurniActionMessage.const_928:
            ...
            case RoomWidgetFurniActionMessage.const_832:
               ...
               break;
            case RoomWidgetFurniActionMessage.const_1328:
               ...
               break;
            case RoomWidgetUserActionMessage.const_262:
               ...
               break;
            case RoomWidgetRoomTagSearchMessage.const_956:
               ...
               break;
            case RoomWidgetGetBadgeDetailsMessage.const_917:
               ...
               break;
            case RoomWidgetGetBadgeImageMessage.const_932:
      ...
      private function handleGetObjectInfoMessage(param1:RoomWidgetRoomObjectMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.category)
         {
            ...
            case RoomObjectCategoryEnum.const_26:
               ...
               _loc6_ = new RoomWidgetFurniInfoUpdateEvent(RoomWidgetFurniInfoUpdateEvent.const_326);
               _loc6_.id = param1.id;
               _loc6_.category = param1.category;
               _loc7_ = this._container.roomEngine.getRoomObject(_loc2_,_loc3_,param1.id,param1.category);
               _loc8_ = _loc7_.getModel();
               if(_loc8_.getString(RoomWidgetInfostandExtraParamEnum.const_456) != null)
               {
                  _loc6_.extraParam = _loc8_.getString(RoomWidgetInfostandExtraParamEnum.const_456);
               }
               else if(_loc8_.getNumber(RoomObjectVariableEnum.const_986) == 1)
               {
               ...
               _loc10_ = _loc8_.getNumber(RoomObjectVariableEnum.const_1179);
               _loc11_ = _loc8_.getNumber(RoomObjectVariableEnum.const_1212);
               ...
               if(_loc6_.extraParam != null && _loc6_.extraParam.length > 0)
               {
                  ...
                  _loc28_ = "";
                  _loc29_ = "";
                  if(_loc6_.extraParam == RoomWidgetInfostandExtraParamEnum.const_589)
                  {
                  ...
                  else if(_loc6_.extraParam.indexOf(RoomWidgetInfostandExtraParamEnum.const_408) == 0)
                  {
                     _loc31_ = _loc6_.extraParam.substr(RoomWidgetInfostandExtraParamEnum.const_408.length);
            ...
            case RoomObjectCategoryEnum.const_29:
               ...
               if(_loc12_.type == RoomObjectTypeEnum.const_229)
               {
               ...
               {
                  if(_loc12_.type != RoomObjectTypeEnum.const_555)
                  {
                     return null;
                  }
                  _loc13_ = "null";
               ...
               if(_loc13_ == RoomWidgetUserInfoUpdateEvent.const_148)
               {
                  ...
                  if(_loc17_ != null)
                  {
                     _loc38_ = _loc17_.getModel().getString(RoomObjectVariableEnum.const_1006);
                  ...
                  if(!_loc35_)
                  {
                     _loc14_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_849;
                  }
               ...
               if(_loc13_ == RoomWidgetUserInfoUpdateEvent.BOT)
               {
                  ...
                  _loc15_.push(RoomWidgetUserInfoUpdateEvent.const_1961);
               }
               else
               {
      ...
      {
         return [RoomSessionUserBadgesEvent.const_176];
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionUserBadgesEvent.const_176:
      ...
      private function onPetInfo(param1:RoomSessionPetInfoUpdateEvent) : void
      {
         ...
         var _loc7_:BitmapData = this.var_707.getValue(_loc4_) as BitmapData;
         if(_loc7_ == null)
         {
            _loc7_ = this.getPetImage(_loc4_);
            this.var_707.add(_loc4_,_loc7_);
         }
         if(this._container != null && this._container.events != null)
         {
            ...
            if(_loc13_ != null)
            {
               ...
               if(_loc14_ != null)
               {
                  _loc15_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_1006);
      ...
      private function onNowPlayingChanged(param1:NowPlayingEvent) : void
      {
         ...
         if(this.var_254 != null)
         {
            ...
            this._container.events.dispatchEvent(new RoomWidgetSongUpdateEvent(RoomWidgetSongUpdateEvent.const_430,_loc2_,_loc3_,_loc4_));
         }
      }
