   ...
   public class AvatarInfoWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(this._container)
         {
            ...
            this._container.sessionDataManager.events.removeEventListener(UserNameUpdateEvent.const_1007,this.onUserNameUpdate);
         }
         this._container = param1;
         if(this._container)
         {
            this._container.toolbar.events.addEventListener(HabboToolbarEvent.const_49,this.onToolbarClicked);
            this._container.sessionDataManager.events.addEventListener(UserNameUpdateEvent.const_1007,this.onUserNameUpdate);
         }
      }
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetRoomObjectMessage.const_939);
      ...
      public function getProcessedEvents() : Array
      {
         ...
         _loc1_.push(RoomSessionDanceEvent.const_145);
         return _loc1_;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetRoomObjectMessage.const_939:
               this.dispatchOwnAvatarInfo();
               break;
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionUserDataUpdateEvent.const_123:
               ...
               break;
            case RoomSessionDanceEvent.const_145:
