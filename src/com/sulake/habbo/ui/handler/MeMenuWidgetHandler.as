package com.sulake.habbo.ui.handler
{
   ...
   public class MeMenuWidgetHandler implements IRoomWidgetHandler, IAvatarImageListener
   {
      ...
      public function dispose() : void
      {
         ...
         {
            this._container.avatarEditor.close(AvatarEditorInstanceId.const_205);
         }
         this.var_1148 = true;
         this.container = null;
         this.var_13 = null;
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(this._container != null)
         {
            ...
            {
               this._container.sessionDataManager.events.removeEventListener(HabboSessionFigureUpdatedEvent.const_360,this.onFigureUpdate);
            }
            if(this.var_13 && !this.var_13.disposed && this.var_13.events)
            {
               this.var_13.events.removeEventListener(HabboInventoryEffectsEvent.const_259,this.onAvatarEffectsChanged);
               this.var_13.events.removeEventListener(HabboInventoryHabboClubEvent.const_428,this.onHabboClubSubscriptionChanged);
            }
            ...
            {
               this._container.habboHelp.events.removeEventListener(HabboHelpTutorialEvent.const_943,this.onHelpTutorialEvent);
         ...
         {
            this._container.sessionDataManager.events.addEventListener(HabboSessionFigureUpdatedEvent.const_360,this.onFigureUpdate);
         }
         this.var_13 = this._container.inventory;
         if(this.var_13 != null)
         {
            this.var_13.events.addEventListener(HabboInventoryEffectsEvent.const_259,this.onAvatarEffectsChanged);
            this.var_13.events.addEventListener(HabboInventoryHabboClubEvent.const_428,this.onHabboClubSubscriptionChanged);
         }
         ...
         {
            this._container.habboHelp.events.addEventListener(HabboHelpTutorialEvent.const_943,this.onHelpTutorialEvent);
      ...
      private function setMeMenuToolbarIcon() : void
      {
         ...
         if(this._container.avatarRenderManager != null)
         {
            ...
            if(_loc3_ != this.var_1559)
            {
               ...
               this.var_1965 = _loc1_;
               this.var_1964 = _loc2_;
            }
            else
            {
               _loc1_ = this.var_1965;
               _loc2_ = this.var_1964;
            }
         }
         if(this._toolbar != null)
         {
            if(_loc1_ != null && _loc2_ != null)
            {
               if(_loc1_.height > const_480)
               {
                  ...
                  if(_loc2_.height > const_480 - const_1087)
                  {
                     _loc8_.offset(0,_loc2_.height - const_480 + const_1087);
                  }
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetWaveMessage.const_935);
         _loc1_.push(RoomWidgetDanceMessage.const_936);
         _loc1_.push(RoomWidgetGetEffectsMessage.const_1014);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_1344);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_1248);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_1254);
         _loc1_.push(RoomWidgetOpenInventoryMessage.const_863);
         _loc1_.push(RoomWidgetOpenCatalogMessage.const_930);
         _loc1_.push(RoomWidgetStopEffectMessage.const_1026);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_1907);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_1351);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_500);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_1854);
         _loc1_.push(RoomWidgetSelectOutfitMessage.const_1409);
         _loc1_.push(RoomWidgetShowOwnRoomsMessage.const_788);
         _loc1_.push(RoomWidgetRequestWidgetMessage.const_786);
         _loc1_.push(RoomWidgetMeMenuMessage.const_824);
         _loc1_.push(RoomWidgetGetSettingsMessage.const_1008);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_1806);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_921);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_979);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_1372);
         _loc1_.push(RoomWidgetRequestWidgetMessage.const_398);
         return _loc1_;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetRequestWidgetMessage.const_786:
               ...
               break;
            case RoomWidgetWaveMessage.const_935:
               if(this._container != null && this._container.roomSession != null)
               {
                  this._container.roomSession.sendWaveMessage();
               }
               break;
            case RoomWidgetDanceMessage.const_936:
               if(this._container != null && this._container.roomSession != null)
               {
               ...
               break;
            case RoomWidgetGetEffectsMessage.const_1014:
               if(this.var_13 != null)
               {
               ...
               break;
            case RoomWidgetSelectEffectMessage.const_1344:
               if(this.var_13 != null)
               {
               ...
               break;
            case RoomWidgetSelectEffectMessage.const_1248:
               if(this.var_13 != null)
               {
               ...
               break;
            case RoomWidgetOpenCatalogMessage.const_930:
               _loc2_ = param1 as RoomWidgetOpenCatalogMessage;
               if(this._catalog != null && _loc2_.pageKey == RoomWidgetOpenCatalogMessage.const_1347)
               {
                  this._catalog.openCatalogPage(CatalogPageName.const_140,true);
               }
               break;
            case RoomWidgetOpenInventoryMessage.const_863:
               ...
               if(this.var_13 != null)
               {
                  ...
                  {
                     case RoomWidgetOpenInventoryMessage.const_1810:
                        this._catalog.openCatalogPage(CatalogPageName.const_1240,true);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1365:
                        this.var_13.toggleInventoryPage(InventoryCategory.const_235);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1910:
                        this.var_13.toggleInventoryPage(InventoryCategory.const_69);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_2003:
                        break;
                     default:
               ...
               break;
            case RoomWidgetSelectEffectMessage.const_1254:
            case RoomWidgetStopEffectMessage.const_1026:
               ...
               break;
            case RoomWidgetNavigateToRoomMessage.const_1351:
            ...
            case RoomWidgetShowOwnRoomsMessage.const_788:
               ...
               break;
            case RoomWidgetMeMenuMessage.const_824:
            ...
            case RoomWidgetAvatarEditorMessage.const_500:
               ...
               if(this._container)
               {
                  this._container.avatarEditor.openEditor(AvatarEditorInstanceId.const_205,null,null,true);
                  this._container.avatarEditor.loadOwnAvatarInEditor(AvatarEditorInstanceId.const_205);
            ...
            case RoomWidgetGetSettingsMessage.const_1008:
               ...
               break;
            case RoomWidgetStoreSettingsMessage.const_921:
            ...
            case RoomWidgetAvatarEditorMessage.const_1372:
               if(this._container.habboHelp && this._container.habboHelp.events)
               {
                  this._container.habboHelp.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_518));
               }
               break;
            default:
      ...
      private function onHelpTutorialEvent(param1:HabboHelpTutorialEvent) : void
      {
         ...
         switch(param1.type)
         {
            case HabboHelpTutorialEvent.const_131:
               ...
               break;
            case HabboHelpTutorialEvent.const_943:
               this._container.events.dispatchEvent(new RoomWidgetTutorialEvent(RoomWidgetTutorialEvent.const_530));
         }
      }
