package com.sulake.habbo.ui.handler
{
   ...
   public class FurnitureTeaserWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_975,RoomWidgetViralFurniMessage.const_907,RoomWidgetViralFurniMessage.const_197];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetFurniToWidgetMessage.const_975:
               ...
               if(_loc3_ != null)
               {
                  ...
                  if(_loc5_ != null)
                  {
                     ...
                     _loc7_ = new RoomWidgetTeaserDataUpdateEvent(RoomWidgetTeaserDataUpdateEvent.const_659);
                     _loc8_ = "+";
               ...
               break;
            case RoomWidgetViralFurniMessage.const_907:
      ...
      {
         return [RoomSessionViralFurniStatusEvent.const_653,RoomSessionViralFurniStatusEvent.const_569];
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionViralFurniStatusEvent.const_653:
               ...
               _loc3_ = new RoomWidgetTeaserDataUpdateEvent(RoomWidgetTeaserDataUpdateEvent.const_739);
               ...
               break;
            case RoomSessionViralFurniStatusEvent.const_569:
               _loc2_ = param1 as RoomSessionViralFurniStatusEvent;
