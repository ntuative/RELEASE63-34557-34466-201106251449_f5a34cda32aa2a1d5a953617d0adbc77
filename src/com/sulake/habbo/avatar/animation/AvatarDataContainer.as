package com.sulake.habbo.avatar.animation
{
   ...
   public class AvatarDataContainer implements IAvatarDataContainer
   {
      ...
      public function AvatarDataContainer(param1:XML)
      {
         ...
         this.var_760 = new ColorTransform(this.var_1978,this.var_1979,this.var_1980,this._alphaMultiplier);
         this.var_1278 = this.generatePaletteMapForGrayscale(this.var_2702,this.var_2701);
      }
      ...
      {
         return this.var_1278.getValue("reds") as Array;
      }
      
      public function get greens() : Array
      {
         return this.var_1278.getValue("greens") as Array;
      }
      
      public function get blues() : Array
      {
         return this.var_1278.getValue("blues") as Array;
      }
      
      public function get alphas() : Array
      {
         return this.var_1278.getValue("alphas") as Array;
      }
