package com.sulake.habbo.avatar.cache
{
   ...
   public class AvatarImageCache
   {
      ...
      private static const const_2108:int = 60000;
       
      
      private var _structure:AvatarStructure;
      
      private var var_1535:IAvatarImage;
      ...
      private var var_473:AvatarImageBodyPartContainer;
      
      private var var_1689:String;
      
      private var var_140:AvatarImagePartContainer;
      
      private var var_3023:Point;
      ...
      private var var_1132:BitmapData;
      
      private var var_3024:ByteArray;
      
      private var var_3022:ImageData;
      
      private var var_1104:PaletteMap;
      ...
      public function dispose() : void
      {
         ...
         {
            _loc2_ = this.var_307.getKeys();
            for each(_loc3_ in _loc2_)
            {
               _loc1_ = this.var_307.getValue(_loc3_) as AvatarImageBodyPartCache;
               if(_loc1_ != null)
               {
                  _loc1_.dispose();
               }
      ...
      public function disposeInactiveActions(param1:int = 60000) : void
      {
         ...
         var _loc4_:Array = this.var_307.getKeys();
         for each(_loc5_ in _loc4_)
         {
            _loc3_ = this.var_307.getValue(_loc5_) as AvatarImageBodyPartCache;
            if(_loc3_ != null)
            {
      ...
      public function resetBodyPartCache(param1:IActiveActionData) : void
      {
         var _loc2_:* = null;
         var _loc4_:* = null;
         var _loc3_:Array = this.var_307.getKeys();
         for each(_loc4_ in _loc3_)
         {
            _loc2_ = this.var_307.getValue(_loc4_) as AvatarImageBodyPartCache;
            if(_loc2_ != null)
            {
      ...
      public function setGeometryType(param1:String) : void
      {
         ...
         if(this.var_917 == GeometryType.const_1396 && param1 == GeometryType.const_1176 || this.var_917 == GeometryType.const_1176 && param1 == GeometryType.const_1396)
         {
            this.var_917 = param1;
            this.var_97 = null;
            return;
      ...
      public function getImageContainer(param1:String, param2:int) : AvatarImageBodyPartContainer
      {
         ...
         if(this._bodyPartCache == null)
         {
            ...
            this.var_307.add(param1,this._bodyPartCache);
         }
            ...
            if(this.var_424.definition.isAnimation)
            {
               ...
               if(_loc12_ != null)
               {
                  ...
                  if(_loc14_ != null)
                  {
                     ...
                     if(_loc14_.type == AnimationLayerData.const_883)
                     {
                        if(_loc14_.action != null)
                        {
                     ...
                     else if(_loc14_.type == AnimationLayerData.const_501)
                     {
                        _loc3_ = _loc11_;
                     }
         ...
         if(_loc10_ == null)
         {
            _loc15_ = this._structure.getParts(param1,this.var_1535.getFigure(),_loc5_,this.var_917,_loc3_,_loc6_,_loc7_);
            _loc10_ = new AvatarImageDirectionCache(_loc15_);
            _loc9_.updateDirectionCache(_loc3_,_loc10_);
         }
         this.var_473 = _loc10_.getImageContainer(_loc4_);
         if(this.var_473 == null)
         {
            _loc16_ = _loc10_.getPartList();
            this.var_473 = this.renderBodyPart(_loc3_,_loc16_,_loc4_,this.var_424);
            if(this.var_473 == null)
            {
               return null;
            }
            _loc10_.updateImageContainer(this.var_473,_loc4_);
         }
         this.var_473.offset = _loc8_;
         return this.var_473;
      }
      
      public function getBodyPartCache(param1:String) : AvatarImageBodyPartCache
      {
         var _loc2_:AvatarImageBodyPartCache = this.var_307.getValue(param1) as AvatarImageBodyPartCache;
         if(_loc2_ == null)
         {
            _loc2_ = new AvatarImageBodyPartCache();
            this.var_307.add(param1,_loc2_);
         }
         return _loc2_;
      }
      ...
      private function renderBodyPart(param1:int, param2:Array, param3:int, param4:IActiveActionData) : AvatarImageBodyPartContainer
      {
         ...
         if(!this.var_97)
         {
            this.var_97 = this._structure.getCanvas(this._scale,this.var_917);
            if(!this.var_97)
            {
               return null;
            }
            this.var_3023 = new Point(0,this.var_97.height - int(this.var_97.width / 4));
         }
         var _loc5_:int = param1;
         var _loc6_:Boolean = AvatarDirectionAngle.const_1909[param1];
         var _loc9_:String = param4.definition.assetPartDefinition;
         var _loc10_:String = param4.definition.state;
         var _loc11_:Boolean = _loc10_ == AvatarAction.const_991 || _loc10_ == AvatarAction.const_460;
         ...
         while(_loc8_ >= 0)
         {
            ...
            {
               this.var_1689 = this.var_140.bodyPartId;
               this.var_207 = this.var_140.partType;
               this.var_2192 = this.var_140.partId;
               ...
               if(_loc6_)
               {
                  ...
                  else
                  {
                     ...
                     if(this.var_140.flippedPartType != this.var_207)
                     {
                        this.var_207 = this.var_140.flippedPartType;
                     }
                  }
               }
               this.var_1690 = this._scale + "_" + this.var_140.action.assetPartDefinition + "_" + this.var_207 + "_" + this.var_2192 + "_" + _loc5_ + "_" + this._frame;
               this.var_500 = this._assets.getAssetByName(this.var_1690) as BitmapDataAsset;
               if(this.var_500 == null)
               {
                  this.var_1690 = this._scale + "_std_" + this.var_207 + "_" + this.var_2192 + "_" + _loc5_ + "_0";
                  this.var_500 = this._assets.getAssetByName(this.var_1690) as BitmapDataAsset;
               }
               if(!(!this.var_500 || !this.var_500.content))
               {
                  ...
                  {
                     this.var_1104 = this._structure.renderManager.paletteManager.getPalette(this.var_140.paletteMapId);
                     if(this.var_1104 != null)
                     {
                        this.var_1132 = this.var_500.content as BitmapData;
                        this.var_206 = new BitmapData(this.var_1132.width,this.var_1132.height);
                        this.var_3024 = this.var_1104.colorize(this.var_1132.getPixels(this.var_1132.rect));
                        this.var_206.setPixels(this.var_206.rect,this.var_3024);
                     }
                     else
                     {
                        this.var_206 = (this.var_500.content as BitmapData).clone();
                     }
                  }
                  else
                  {
                  ...
                  if(_loc11_ && (this.var_1689 == AvatarBodyPartType.const_272 || this.var_1689 == AvatarBodyPartType.const_1821 || this.var_1689 == AvatarBodyPartType.const_1860) && this.var_140.color != null)
                  {
                     _loc16_ = 0.7;
                     ...
                     this.var_206.colorTransform(this.var_206.rect,_loc18_);
                  }
                  else if(this.var_140.isColorable && this.var_140.color != null)
                  {
                     this.var_206.colorTransform(this.var_206.rect,this.var_140.color.colorTransform);
                  }
                  if(this.var_140.isBlendable)
                  {
                     this.var_206.colorTransform(this.var_206.rect,this.var_140.blendTransform);
                  }
                  this.var_1131 = this.var_500.offset.clone();
                  if(_loc7_)
                  {
                     if(this._scale == AvatarScaleType.const_62)
                     {
                  ...
                  this.var_3022 = new ImageData(this.var_206,this.var_1131,_loc7_);
                  this.var_1133.push(this.var_3022);
               }
            }
            _loc8_--;
         }
         ...
         var _loc13_:ImageData = this.createUnionImage(this.var_1133,_loc6_);
         var _loc14_:Point = new Point(-1 * _loc13_.regpoint.x,this.var_3023.y - _loc13_.regpoint.y);
         if(_loc6_)
         {
            if(this._scale == AvatarScaleType.const_62)
            {
         ...
         _loc8_ = this.var_1133.length - 1;
         while(_loc8_ >= 0)
         {
            _loc15_ = this.var_1133.pop();
            if(_loc15_)
            {
               _loc15_.dispose();
            }
