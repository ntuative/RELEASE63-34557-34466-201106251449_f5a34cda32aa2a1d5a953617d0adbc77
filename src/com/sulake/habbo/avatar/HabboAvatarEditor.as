package com.sulake.habbo.avatar
{
   ...
   public class HabboAvatarEditor
   {
      ...
      private static const const_1510:String = "hr-100.hd-180-7.ch-215-66.lg-270-79.sh-305-62.ha-1002-70.wa-2007";
      
      private static const const_1509:String = "hr-515-33.hd-600-1.ch-635-70.lg-716-66-62.sh-735-68";
      ...
      private var var_543:HabboAvatarEditorManager;
      
      private var var_998:IFigureData;
      ...
      private var var_1223:IHabboAvatarEditorDataSaver = null;
      ...
      public function HabboAvatarEditor(param1:uint, param2:HabboAvatarEditorManager)
      {
         ...
         this.var_543 = param2;
         this.var_998 = this.var_543.avatarRenderManager.getFigureData(AvatarType.const_135);
      }
      ...
      private function init(param1:Array = null) : void
      {
         ...
         this.var_645["null"] = new FigureData(this);
         this.var_645["null"] = new FigureData(this);
         var _loc2_:FigureData = this.var_645["null"];
         var _loc3_:FigureData = this.var_645["null"];
         _loc2_.loadAvatarData(const_1510,FigureData.const_90);
         _loc3_.loadAvatarData(const_1509,FigureData.FEMALE);
         this.var_116 = new Map();
         this.var_542 = new Map();
         this.var_116.add(AvatarEditorFigureCategory.const_937,new BodyModel(this));
         this.var_116.add(AvatarEditorFigureCategory.const_57,new HeadModel(this));
         this.var_116.add(AvatarEditorFigureCategory.const_272,new TorsoModel(this));
         this.var_116.add(AvatarEditorFigureCategory.const_748,new LegsModel(this));
         ...
         this.var_542.add(AvatarEditorSideCategory.const_119,new WardrobeModel(this));
         this.var_542.add(AvatarEditorSideCategory.const_493,new ClubPromoModel(this));
      ...
      public function loadAvatarInEditor(param1:String, param2:String, param3:int = 0) : void
      {
         ...
         if(this.var_815 != param3)
         {
            this.var_815 = param3;
            _loc4_ = true;
         }
         var _loc5_:FigureData = this.var_645[param2];
         if(_loc5_ == null)
         {
            return;
         }
      ...
      public function getFigureSetType(param1:String) : ISetType
      {
         ...
         return this.var_998.getSetType(param1);
      }
      ...
      public function getPalette(param1:int) : IPalette
      {
         ...
         return this.var_998.getPalette(param1);
      }
      ...
      private function selectDefaultCategory(param1:Array) : void
      {
         ...
         {
            this.toggleAvatarEditorPage(AvatarEditorFigureCategory.const_937);
         }
      }
      ...
      {
         return this.var_645[this.var_1033];
      }
      ...
      public function saveCurrentSelection() : void
      {
         ...
         {
            this.var_1223.saveFigure(_loc1_,_loc2_);
         }
         else
         {
            _loc3_ = new UpdateFigureDataMessageComposer(_loc1_,_loc2_);
            this.var_543.communication.getHabboMainConnection(null).send(_loc3_);
            _loc3_.dispose();
            _loc3_ = null;
         }
      }
      ...
      public function generateDataContent(param1:IAvatarEditorCategoryModel, param2:String) : CategoryData
      {
         ...
         if(_loc8_ != null)
         {
            ...
            _loc12_ = this.isClubTryoutAllowed() && this.var_1855;
            for each(_loc13_ in _loc9_.colors)
            {
               if(_loc13_.isSelectable && (_loc12_ || this.var_815 >= _loc13_.clubLevel))
               {
                  _loc17_ = 0;
                  while(_loc17_ < const_689)
                  {
            ...
            {
               _loc20_ = 2;
               _loc14_ = this.var_543.avatarRenderManager.getMandatoryAvatarPartSetIds(this.gender,_loc20_);
            }
            else
            {
               _loc14_ = this.var_543.avatarRenderManager.getMandatoryAvatarPartSetIds(this.gender,this.clubMemberLevel);
            }
            _loc15_ = Boolean(_loc14_.indexOf(param2) == -1);
            if(_loc15_)
            {
               _loc21_ = this.var_543.assets.getAssetByName("removeSelection") as BitmapDataAsset;
               if(_loc21_)
               {
            ...
            {
               _loc23_ = false;
               if(_loc6_.gender == FigureData.const_2004)
               {
                  _loc23_ = true;
               }
               ...
               if(_loc6_.isSelectable && _loc23_ && (_loc12_ || this.var_815 >= _loc6_.clubLevel))
               {
      ...
      {
         return this.var_543.configuration.getBoolean("avatareditor.allowclubtryout",false);
      }
      ...
      public function getDefaultColour(param1:String) : int
      {
         ...
         if(_loc2_ != null)
         {
            ...
            {
               if(_loc4_.isSelectable && this.var_815 >= _loc4_.clubLevel)
               {
                  return _loc4_.id;
               }
            }
      ...
      public function get wardrobe() : WardrobeModel
      {
         ...
         return this.var_542.getValue(AvatarEditorSideCategory.const_119);
      }
