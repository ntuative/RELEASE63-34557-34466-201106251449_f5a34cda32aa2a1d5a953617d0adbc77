package com.sulake.habbo.avatar.common
{
   ...
   public class CategoryData
   {
      ...
      public function dispose() : void
      {
         ...
         if(this.var_289)
         {
            for each(_loc2_ in this.var_289 as Array)
            {
               if(_loc2_)
               {
      ...
      public function selectColorIds(param1:Array) : void
      {
         ...
         this.var_256 = new Array(param1.length);
         var _loc3_:int = 0;
      ...
      public function selectPartIndex(param1:int) : AvatarEditorGridPartItem
      {
         ...
         if(this.var_1068 >= 0 && this._parts.length > this.var_1068)
         {
            _loc2_ = this._parts[this.var_1068];
            if(_loc2_)
            {
               _loc2_.isSelected = false;
            }
      ...
      public function selectColorIndex(param1:int, param2:int) : AvatarEditorGridColorItem
      {
         ...
         this.deselectColorIndex(this.var_256[param2],param2);
         this.var_256[param2] = param1;
      ...
      public function getSelectedColorIds() : Array
      {
         ...
         if(!this.var_289 || this.var_289.length == 0)
         {
            return null;
         }
         var _loc1_:Array = this.var_289[0] as Array;
         ...
         {
            _loc7_ = this.var_289[_loc5_];
            if(!(!_loc7_ || _loc7_.length <= _loc5_))
            {
               if(_loc7_.length > this.var_256[_loc5_])
               {
                  _loc8_ = _loc7_[this.var_256[_loc5_]] as AvatarEditorGridColorItem;
      ...
      public function getSelectedColor(param1:int) : AvatarEditorGridColorItem
      {
         ...
         if(!_loc2_ || _loc2_.length <= this.var_256[param1])
         {
            return null;
         }
         return _loc2_[this.var_256[param1]] as AvatarEditorGridColorItem;
      }
      ...
      public function getPalette(param1:int) : Array
      {
         ...
         if(this.var_289.length <= param1)
         {
            return null;
         }
         return this.var_289[param1] as Array;
      }
      
      public function getCurrentPart() : AvatarEditorGridPartItem
      {
         return this._parts[this.var_1068] as AvatarEditorGridPartItem;
      }
