package com.sulake.habbo.avatar.common
{
   ...
   public class AvatarEditorGridColorItem
   {
      ...
      private var var_1039:IPartColor;
      ...
      public function AvatarEditorGridColorItem(param1:IWindowContainer, param2:IAvatarEditorCategoryModel, param3:IPartColor)
      {
         ...
         this.var_616 = _loc4_.content as BitmapData;
         ...
         this.var_953 = _loc6_.content as BitmapData;
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc1_ != null)
         {
            _loc1_.bitmap = new BitmapData(this.var_616.width,this.var_616.height,true,0);
            _loc1_.bitmap.copyPixels(this.var_616,this.var_616.rect,new Point(0,0));
         }
         ...
         if(_loc2_ != null)
         {
            ...
            _loc5_.colorTransform(_loc5_.rect,this.var_1039.colorTransform);
         ...
         if(_loc3_ != null)
         {
            if(this._isSelected)
            {
               _loc3_.bitmap = new BitmapData(this.var_953.width,this.var_953.height,true,16777215);
               _loc3_.bitmap.copyPixels(this.var_953,this.var_953.rect,new Point(0,0),null,null,true);
               _loc3_.visible = true;
            }
            else
            {
         ...
         if(_loc4_)
         {
            if(this.var_1039)
            {
               switch(this.var_1039.clubLevel)
               {
                  case HabboClubLevelEnum.const_54:
                     _loc4_.visible = false;
                     break;
                  case HabboClubLevelEnum.const_35:
                     _loc4_.style = HabboIconType.const_1032;
                     _loc4_.visible = true;
                     break;
                  case HabboClubLevelEnum.const_46:
                     _loc4_.style = HabboIconType.const_809;
                     _loc4_.visible = true;
               }
            }
            else
