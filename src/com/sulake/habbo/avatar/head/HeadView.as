   ...
   public class HeadView extends CategoryBaseView implements IAvatarEditorCategoryView
   {
      ...
      override public function init() : void
      {
         ...
         if(!var_41)
         {
            ...
            var_41["null"] = new AvatarEditorGridView(var_77,FigureData.const_210,_windowManager,_assetLibrary);
            var_41["null"] = new AvatarEditorGridView(var_77,FigureData.const_297,_windowManager,_assetLibrary);
            var_41["null"] = new AvatarEditorGridView(var_77,FigureData.const_278,_windowManager,_assetLibrary);
            var_41["null"] = new AvatarEditorGridView(var_77,FigureData.const_264,_windowManager,_assetLibrary);
         ...
         if(var_77 && var_165 == "")
         {
            var_77.switchCategory(FigureData.const_210);
         }
      }
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               case "tab_hair":
                  ...
                  break;
               case "tab_hat":
                  this.switchCategory(FigureData.const_297);
                  break;
