package com.sulake.habbo.avatar
{
   ...
   public class PetImage implements IAvatarImage, IDisposable
   {
      ...
      private var var_307:AvatarImageCache;
      ...
      public function getImage(param1:String, param2:Boolean) : BitmapData
      {
         ...
         while(_loc7_ >= 0)
         {
            ...
            _loc9_ = _loc3_.getImageContainer(_loc8_,this.var_694);
            if(_loc9_ && _loc9_.image && _loc9_.method_1)
            {
               ...
               {
                  _loc18_ = _loc15_[0];
                  _loc19_ = _loc18_.getFrameIndex(this.var_694);
      ...
      public function getCroppedImage(param1:String) : BitmapData
      {
         ...
         while(_loc7_ >= 0)
         {
            ...
            _loc10_ = _loc2_.getImageContainer(_loc9_,this.var_694);
            if(_loc10_ != null)
            {
               ...
               _loc12_ = _loc10_.method_1.clone();
               ...
               {
                  _loc19_ = _loc16_[0];
                  _loc20_ = _loc19_.getFrameIndex(this.var_694);
      ...
      public function appendAction(param1:String, ... rest) : Boolean
      {
         ...
         this.var_568 = this.var_568 + param1 + _loc3_;
         switch(param1)
         {
            case AvatarAction.const_458:
               switch(_loc3_)
               {
                  ...
                  case AvatarAction.const_1812:
                  case AvatarAction.const_1998:
                  case AvatarAction.const_1999:
      ...
      private function resetActions() : Boolean
      {
         ...
         this.setActionToParts(this.var_957);
         this.getCache().resetBodyPartCache(this.var_957);
         return true;
      }
      ...
      private function sortActions() : void
      {
         ...
         this.var_1452 = this._structure.sortActions(this.var_357);
         ...
         {
            this.var_905 = this._structure.getCanvasOffsets(this.var_1452,this._scale,this.var_101);
         }
      }
      ...
      private function setActionsToParts() : void
      {
         ...
         for each(_loc1_ in this.var_1452)
         {
            if(!(!_loc1_ || !_loc1_.definition))
            {
               ...
               if(_loc1_.actionType == AvatarAction.const_248)
               {
                  this.var_958 = true;
               }
         ...
         if(_loc2_ != null)
         {
            ...
            if(_loc3_ != null)
            {
               for each(_loc4_ in _loc3_.parts)
               {
                  if(_loc4_.type == "pbd")
                  {
                     this.var_1279 = _loc4_.id;
                     this.var_1751 = _loc4_.breed;
                     break;
                  }
               }
            }
