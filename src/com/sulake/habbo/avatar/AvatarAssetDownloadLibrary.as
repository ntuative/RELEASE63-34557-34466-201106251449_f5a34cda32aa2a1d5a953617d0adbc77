package com.sulake.habbo.avatar
{
   ...
   public class AvatarAssetDownloadLibrary extends EventDispatcher
   {
      ...
      private static var var_1908:int = 1;
      ...
      public function AvatarAssetDownloadLibrary(param1:String, param2:String, param3:String, param4:IAssetLibrary)
      {
         ...
         this.var_1238 = param3 + this.var_825 + ".swf";
      ...
      {
         Core.error("Could not load avatar asset library " + this.var_825 + " from URL " + this.var_1238,false,Core.const_1308);
      }
