   ...
   public class TorsoView extends CategoryBaseView implements IAvatarEditorCategoryView
   {
      ...
      override public function init() : void
      {
         ...
         if(!var_41)
         {
            ...
            var_41["null"] = new AvatarEditorGridView(var_77,FigureData.const_285,_windowManager,_assetLibrary);
            var_41["null"] = new AvatarEditorGridView(var_77,FigureData.const_204,_windowManager,_assetLibrary);
            var_41["null"] = new AvatarEditorGridView(var_77,FigureData.const_287,_windowManager,_assetLibrary);
         ...
         if(var_77 && var_165 == "")
         {
            var_77.switchCategory(FigureData.const_204);
         }
      }
