package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomCreateViewCtrl
   {
      ...
      private var var_1273:TextFieldManager;
      
      private var var_46:Array;
      
      private var var_1272:RoomLayout;
      ...
      public function RoomCreateViewCtrl(param1:HabboNavigator)
      {
         ...
         this.var_680 = new Timer(100);
         this.var_680.addEventListener(TimerEvent.TIMER,this.updateArrowPos);
      ...
      public function dispose() : void
      {
         if(this.var_680)
         {
            this.var_680.removeEventListener(TimerEvent.TIMER,this.updateArrowPos);
            this.var_680.reset();
            this.var_680 = null;
         }
      }
      ...
      {
         var _loc3_:IBitmapWrapperWindow = IBitmapWrapperWindow(this.var_1272.view.findChildByName("select_arrow"));
         var _loc6_:int = Math.abs(_loc3_.y - 0) < 2 || Math.abs(_loc3_.y - 15) < 2 ? 1 : 2;
         _loc3_.y += !!this.var_1972 ? _loc6_ : -_loc6_;
         if(_loc3_.y < 0)
         {
            this.var_1972 = true;
            _loc3_.y = 1;
      ...
      private function prepare() : void
      {
         ...
         this.var_1273 = new TextFieldManager(this._navigator,ITextFieldWindow(this.var_197.findChildByName("room_name_input")),25,null,this._navigator.getText("navigator.createroom.roomnameinfo"));
      ...
      {
         this.var_1273.goBackToInitialState();
         this.var_1273.input.textBackgroundColor = 4294967295;
         this.var_1272 = this.var_46[0];
         this.refreshRoomThumbnails();
      ...
      {
         return IWindowContainer(this._navigator.windowManager.createWindow("","",HabboWindowType.const_74,HabboWindowStyle.const_31,HabboWindowParam.const_64,new Rectangle(0,0,100,300)));
      }
      
      private function isMandatoryFieldsFilled() : Boolean
      {
         return Boolean(this.var_1273.checkMandatory(this._navigator.getText("navigator.createroom.nameerr")));
      }
      ...
      {
         var _loc2_:String = this.var_1273.getText();
         var _loc3_:String = "model_" + this.var_1272.name;
