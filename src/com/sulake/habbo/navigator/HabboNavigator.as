package com.sulake.habbo.navigator
{
   ...
   public class HabboNavigator extends Component implements IHabboNavigator
   {
      ...
      private var var_739:RoomInfoViewCtrl;
      
      private var var_1397:RoomCreateViewCtrl;
      ...
      public function HabboNavigator(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_739 = new RoomInfoViewCtrl(this);
         this.var_1397 = new RoomCreateViewCtrl(this);
         this.var_2791 = new RoomThumbnailRenderer(this);
         this.var_985 = new GuestRoomPasswordInput(this);
         this.var_316 = new GuestRoomDoorbell(this);
         this.var_433 = new Tabs(this);
         this.var_1396 = new OfficialRoomEntryManager(this);
      }
      ...
      public function performTagSearch(param1:String) : void
      {
         ...
         this.var_350.startSearch(Tabs.const_233,Tabs.const_419,param1);
      ...
      public function showOwnRooms() : void
      {
         ...
         this.var_350.startSearch(Tabs.const_249,Tabs.const_318);
         this.var_433.getTab(Tabs.const_249).tabPageDecorator.tabSelected();
      }
