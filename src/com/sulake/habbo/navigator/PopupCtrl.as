package com.sulake.habbo.navigator
{
   ...
   public class PopupCtrl
   {
      ...
      public function PopupCtrl(param1:HabboNavigator, param2:int, param3:int, param4:String)
      {
         ...
         this.var_438.addEventListener(TimerEvent.TIMER,this.onDisplayTimer);
      ...
      public function dispose() : void
      {
         ...
         if(this.var_438)
         {
            this.var_438.removeEventListener(TimerEvent.TIMER,this.onDisplayTimer);
            this.var_438.reset();
            this.var_438 = null;
         }
         if(this.var_369)
      ...
      public function showPopup(param1:IWindow) : void
      {
         if(this.var_58 == null)
         {
            ...
            this.var_58.setParamFlag(HabboWindowParam.const_43,true);
         ...
         this.var_58.x = _loc2_.x + this.var_2358 + param1.width;
