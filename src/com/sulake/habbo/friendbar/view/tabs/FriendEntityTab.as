package com.sulake.habbo.friendbar.view.tabs
{
   ...
   public class FriendEntityTab extends Tab
   {
      ...
      private static const const_1677:String = "entity_xml";
      
      private static const const_1676:String = "facebook_piece_xml";
      
      private static const const_1678:String = "controls_piece_xml";
      ...
      protected static const const_1419:String = "facebook";
      
      protected static const const_1421:String = "controls";
      
      protected static const const_319:String = "canvas";
      
      protected static const const_684:String = "name";
      
      protected static const const_1164:String = "btn_message";
      ...
      protected static const const_650:String = "notification";
      
      private static const const_77:uint = 10338138;
      
      private static const const_1052:uint = 13891476;
      
      private static const const_1136:String = null;
      
      private static const const_720:String = "icon_tag_notify";
      ...
      private static function purgeEntityPieces(param1:IWindowContainer) : void
      {
         ...
         var _loc4_:* = [];
         _loc2_.groupListItemsWithTag(const_650,_loc4_);
         if(_loc4_.length > 0)
         {
      ...
      override public function select(param1:Boolean) : void
      {
         ...
         if(!selected)
         {
            ...
            {
               _loc3_ = WINDOWING.buildFromXML(ASSETS.getAssetByName(const_1676).content as XML) as IWindowContainer;
               _loc3_.name = const_1419;
               _loc6_ = _loc3_.getChildByName(const_684) as ITextWindow;
               _loc6_.caption = this.friend.realName;
               if(!_loc6_.wordWrap)
               {
                  var_2227.crop(_loc6_);
               }
            ...
            {
               _loc3_ = WINDOWING.buildFromXML(ASSETS.getAssetByName(const_1678).content as XML) as IWindowContainer;
               _loc3_.name = const_1421;
               _loc8_ = _loc3_.getChildByName(const_1164);
               if(_loc8_)
               {
      ...
      protected function refresh() : void
      {
         ...
         if(this.var_168)
         {
            ...
            _loc1_ = IItemListWindow(_window.getChildByName(const_1040)).getListItemByName(const_468) as IWindowContainer;
            _loc1_.findChildByName(const_684).caption = this.var_168.name;
            var_2227.crop(_loc1_.getChildByName(const_684) as ITextWindow);
      ...
      {
         var _loc1_:IWindowContainer = false ? const_486.pop() : WINDOWING.buildFromXML(ASSETS.getAssetByName(const_1677).content as XML) as IWindowContainer;
         ...
         if(!disposed && !recycled)
         {
            switch(param1.window.name)
            {
               ...
               case const_1039:
                  ...
                  if(var_353 && this.var_168)
                  {
                     var_353.startConversation(this.var_168.id);
                     this.deselect(true);
               ...
               case const_1420:
                  if(var_353 && this.var_168)
                  {
                     var_353.followToRoom(this.var_168.id);
                     this.deselect(true);
                  }
            }
         }
      ...
      public function addNotificationToken(param1:FriendNotification, param2:Boolean) : void
      {
         ...
         var _loc5_:String = const_1136;
         switch(param1.typeCode)
         {
            case FriendNotification.const_1407:
            ...
            case FriendNotification.TYPE_ACHIEVEMENT:
               ...
               _loc5_ = const_720;
               break;
            case FriendNotification.const_1292:
