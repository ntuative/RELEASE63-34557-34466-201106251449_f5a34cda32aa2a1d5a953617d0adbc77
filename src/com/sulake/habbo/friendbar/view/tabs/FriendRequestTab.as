package com.sulake.habbo.friendbar.view.tabs
{
   ...
   public class FriendRequestTab extends FriendEntityTab
   {
      ...
      protected static const const_2053:String = "friend_request_tab_xml";
      
      protected static const const_465:String = "bubble";
      
      protected static const const_1164:String = "message";
      ...
      {
         var _loc3_:* = null;
         var _loc2_:FriendRequestTab = !!var_1441 ? var_1441 : new FriendRequestTab();
      ...
      {
         var _loc6_:* = null;
         var _loc1_:IWindowContainer = WINDOWING.buildFromXML(ASSETS.getAssetByName(const_2053).content as XML) as IWindowContainer;
         ...
         var _loc7_:IRegionWindow = WINDOWING.create("ICON",WindowType.const_327,WindowStyle.const_102,WindowParam.const_30,new Rectangle(0,0,25,25)) as IRegionWindow;
         _loc7_.mouseThreshold = 0;
         var _loc8_:IBitmapWrapperWindow = WINDOWING.create("BITMAP",WindowType.const_429,WindowStyle.const_102,WindowParam.const_33,new Rectangle(0,0,25,25)) as IBitmapWrapperWindow;
      ...
      private function bubbleEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            {
               case const_2041:
                  var_353.acceptFriendRequest(var_168.id);
                  break;
               case const_1413:
                  if(selected)
                  {
                  ...
                  break;
               case const_1036:
                  var_353.declineFriendRequest(var_168.id);
            }
         }
         ...
         else if(param1.type == WindowMouseEvent.const_25)
         {
            if(param2.name == const_1036)
            {
               ITextWindow(IWindowContainer(param2).getChildByName(REGION_REJECT_TEXT)).textColor = const_1441;
            }
         }
      }
