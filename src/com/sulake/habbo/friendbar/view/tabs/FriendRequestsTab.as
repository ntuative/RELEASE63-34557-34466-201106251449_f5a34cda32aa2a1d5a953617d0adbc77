package com.sulake.habbo.friendbar.view.tabs
{
   ...
   public class FriendRequestsTab extends Tab
   {
      ...
      protected static const const_2043:String = "friend_requests_tab_xml";
      ...
      protected static const const_2045:String = "badge_counter";
      
      protected static const const_2042:String = "button_accept_all";
      
      protected static const const_2044:String = "click_area_discard_all";
      
      protected static const const_1413:String = "button_close";
      
      protected static const const_2041:String = "button_accept";
      
      protected static const const_1033:String = "click_area_discard";
      
      protected static const const_1412:String = "text_discard";
      
      private static var var_1441:FriendRequestsTab;
      
      private static const const_77:uint = 4294625561;
      
      private static const const_1052:uint = 4294957414;
      
      private static const const_1443:uint = 4289431312;
      
      private static const const_1442:uint = 4290616362;
      
      private static const REGION_REJECT_COLOR_EXPOSED:uint = 16770666;
      
      private static const const_1441:uint = 16777215;
      ...
      {
         var _loc2_:FriendRequestsTab = !!var_1441 ? var_1441 : new FriendRequestsTab();
         _loc2_.var_164 = false;
         _loc2_._requests = param1;
         _loc2_._window.findChildByName(const_2045).caption = String(param1.length);
         return _loc2_;
      }
               ...
               if(_loc2_)
               {
                  ...
                  if(!this.var_1737)
                  {
                     ...
                     if(_loc3_)
                     {
                        ...
                        {
                           _loc4_ = this.var_1168.clone() as IWindowContainer;
                           _loc4_.color = _loc8_ % 2 == 0 ? uint(const_1443) : uint(const_1442);
      ...
      {
         var _loc5_:* = null;
         var _loc1_:IWindowContainer = WINDOWING.buildFromXML(ASSETS.getAssetByName(const_2043).content as XML) as IWindowContainer;
         ...
         this.var_1168 = _loc7_.removeListItemAt(0) as IWindowContainer;
         return _loc1_;
      }
      ...
      private function bubbleEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               case const_1413:
                  ...
                  break;
               case const_2042:
                  var_353.acceptAllFriendRequests();
                  break;
               case const_2044:
                  var_353.declineAllFriendRequests();
                  break;
               case const_2041:
                  var_353.acceptFriendRequest(param2.parent.id);
                  break;
               case const_1033:
                  var_353.declineFriendRequest(param2.parent.id);
            }
         }
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            ...
            {
               ITextWindow(IWindowContainer(param2).getChildByName(const_1412)).textColor = REGION_REJECT_COLOR_EXPOSED;
            }
         }
         else if(param1.type == WindowMouseEvent.const_25)
         {
            if(param2.name == const_1033)
            {
               ITextWindow(IWindowContainer(param2).getChildByName(const_1412)).textColor = const_1441;
            }
         }
      }
