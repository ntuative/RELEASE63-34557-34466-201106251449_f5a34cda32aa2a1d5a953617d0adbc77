package com.sulake.habbo.quest
{
   ...
   public class FriendlyTime
   {
      ...
      private static const const_1076:int = 60;
      
      private static const const_1075:int = 3600;
      
      private static const const_1515:int = 3 * const_1076;
      
      private static const const_1516:int = 3 * const_1075;
      ...
      {
         if(param2 > const_1516)
         {
            return getLocalization(param1,"friendlytime.hours",Math.round(param2 / const_1075));
         }
         if(param2 > const_1515)
         {
            return getLocalization(param1,"friendlytime.minutes",Math.round(param2 / const_1076));
         }
