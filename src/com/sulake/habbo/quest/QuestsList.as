package com.sulake.habbo.quest
{
   ...
   public class QuestsList implements IDisposable
   {
      ...
      private static const const_1517:int = 10;
      
      private static const const_1518:int = 10;
      
      private static const const_1519:int = 30;
      ...
      public function onToolbarClick() : void
      {
         ...
         {
            this.var_819 = new WindowToggle(this._window,this._window.desktop,this.requestQuests,this.close);
         }
         this.var_819.toggle();
         this.var_1879 = false;
      }
      ...
      private function refresh(param1:Boolean) : void
      {
         ...
         while(true)
         {
            if(_loc2_ < this.var_1522.length)
            {
               this.refreshEntry(true,_loc2_,this.var_1522[_loc2_],param1);
            }
            else
            {
      ...
      private function prepareWindow() : void
      {
         ...
         this._window.center();
         this.var_62.spacing = const_1517;
      }
      ...
      public function createListEntry() : IWindowContainer
      {
         ...
         _loc6_.x = _loc3_.width - _loc6_.width - const_1518;
         ...
         _loc3_.x = _loc2_.x + _loc2_.width + const_1520;
      ...
      public function setEntryHeight(param1:IWindowContainer) : void
      {
         ...
         _loc2_.findChildByName("completion_txt").y = _loc2_.height - const_1519;
      ...
      private function onWindowClose(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            if(_loc3_ && this.var_1879 && !this.var_1880)
            {
               this.var_1879 = false;
