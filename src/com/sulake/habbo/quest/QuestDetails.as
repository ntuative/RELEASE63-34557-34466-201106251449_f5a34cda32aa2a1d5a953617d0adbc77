package com.sulake.habbo.quest
{
   ...
   public class QuestDetails implements IDisposable
   {
      ...
      private static const const_1496:int = 56;
      ...
      private static const const_1726:Array = ["PLACE_ITEM","PLACE_FLOOR","PLACE_WALLPAPER","PET_DRINK","PET_EAT"];
      ...
      public function onQuest(param1:QuestMessageData) : void
      {
         ...
         else if(this.var_124 == null || this.var_124.id != param1.id)
         {
            this.close();
         }
      }
      ...
      private function openDetails(param1:QuestMessageData) : void
      {
         ...
         var _loc2_:* = this.var_124.waitPeriodSeconds > 0;
         ...
         if(!_loc2_)
         {
            ...
            _loc3_.height = _loc3_.textHeight + const_1458;
         }
         _loc3_.visible = !_loc2_;
         var _loc5_:int = this.getTextHeight(_loc3_) - _loc4_;
         var _loc6_:int = this.setupLink("link_region",_loc3_.y + _loc3_.height + const_732);
         ...
         this._window.height = _loc8_.height + const_1496;
      ...
      private function setupLink(param1:String, param2:int) : int
      {
         ...
         {
            _loc7_ = const_732 + _loc6_.height;
         }
         if(!_loc5_ && _loc6_.visible)
         {
            _loc7_ = -const_732 - _loc6_.height;
      ...
      {
         return this.var_124.waitPeriodSeconds < 1 && const_1726.indexOf(this.var_124.type) > -1;
      }
      
      private function hasNavigatorLink() : Boolean
      {
         var _loc1_:Boolean = this._questEngine.localization.hasKey(this.var_124.getCampaignLocalizationKey() + ".searchtag");
         var _loc2_:Boolean = this._questEngine.localization.hasKey(this.var_124.getCampaignLocalizationKey() + ".searchtag");
         return this.var_124.waitPeriodSeconds < 1 && (_loc1_ || _loc2_);
      }
      ...
      private function onLinkProc(param1:WindowEvent, param2:IWindow = null) : void
      {
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            {
               this._questEngine.openNavigator(this.var_124);
            }
         }
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         this.var_1517 = NextQuestTimer.const_775;
         var _loc2_:Boolean = this._questEngine.questController.questsList.refreshDelay(this._window,this.var_124);
         if(_loc2_)
         {
            this.openDetails(this.var_124);
         }
      }
   }
}
