package com.sulake.habbo.quest
{
   ...
   public class HabboQuestEngine extends Component implements IHabboQuestEngine, IUpdateReceiver
   {
      ...
      private static const const_1447:int = 800;
      
      private static const const_1448:int = 15;
      
      private static const const_1446:int = 300;
      ...
      private var var_1169:QuestController;
      
      private var var_949:AchievementController;
      ...
      public function HabboQuestEngine(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_1169 = new QuestController(this);
         this.var_949 = new AchievementController(this);
         ...
         registerUpdateReceiver(this,const_1449);
      }
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_417.events.removeEventListener(BadgeImageReadyEvent.const_218,this.var_949.onBadgeImageReady);
      ...
      private function onSessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_417.events.addEventListener(BadgeImageReadyEvent.const_218,this.var_949.onBadgeImageReady);
      }
      ...
      private function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         if(param1.type == HabboToolbarEvent.const_49)
         {
            ...
            {
               this.var_1169.onToolbarClick();
            }
            if(param1.iconId == HabboToolbarIconEnum.ACHIEVEMENTS)
            {
               this.var_949.onToolbarClick();
            }
         }
      }
      ...
      {
         return this.var_1169.questTracker.isVisible();
      }
