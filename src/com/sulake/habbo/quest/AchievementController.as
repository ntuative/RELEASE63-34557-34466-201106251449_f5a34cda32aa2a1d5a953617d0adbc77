package com.sulake.habbo.quest
{
   ...
   public class AchievementController implements IDisposable, IUpdateReceiver
   {
      ...
      private static const const_1498:int = 8;
      ...
      private static const const_1489:int = 180;
      
      private static const const_1490:int = 246;
      
      private static const const_1496:int = 45;
      
      private static const const_1488:Point = new Point(115,93);
      
      private static const const_1495:Point = new Point(72,1);
      ...
      private static const const_1494:int = 10;
      ...
      private var var_1499:IWindowContainer;
      
      private var var_992:IWindowContainer;
      ...
      private var var_1215:Matrix;
      
      private var var_1835:ColorMatrixFilter;
      
      private var var_1500:AchievementData;
      
      private var var_803:Timer;
      
      private var var_638:Dictionary;
      
      private var var_804:AchievementLevelUp;
      ...
      public function AchievementController(param1:HabboQuestEngine)
      {
         ...
         this.var_803 = new Timer(2000,1);
         this.var_803.addEventListener(TimerEvent.TIMER,this.switchIntoPendingLevel);
         this.var_804 = new AchievementLevelUp(this._questEngine);
         this.var_1215 = new Matrix();
         this.var_1835 = this.createGrayscaleFilter();
         this.var_638[16] = 1;
         this.var_638[28] = 6;
         this.var_638[38] = 4;
         this.var_638[39] = 3;
      ...
      public function dispose() : void
      {
         ...
         if(this.var_803)
         {
            this.var_803.removeEventListener(TimerEvent.TIMER,this.switchIntoPendingLevel);
            this.var_803.reset();
            this.var_803 = null;
         }
         if(this.var_639)
      ...
      public function onAchievement(param1:AchievementData) : void
      {
         ...
         if(this.var_116 != null)
         {
            _loc2_ = this.var_71 && this.var_71.type == param1.type;
            if(_loc2_ && param1.level > this.var_71.level)
            {
               this.var_71.setMaxProgress();
      ...
      private function refresh() : void
      {
         ...
         this._window.height = getLowestPoint(this._window.content) + const_1496;
      }
      ...
      private function refreshCategoryList() : void
      {
         ...
         var _loc1_:Array = this.var_116.method_5;
         var _loc2_:int = 0;
         while(true)
         {
      ...
      private function refreshCategoryListFooter() : void
      {
         if(this._category != null)
         {
            this.var_1214.visible = false;
            return;
         }
         this.var_1214.visible = true;
         this.var_800.refresh(this.var_116.getProgress(),this.var_116.getMaxProgress(),0);
      }
      ...
      private function refreshAchievementsHeader() : void
      {
         ...
         this.var_992.findChildByName("category_name_txt").caption = this._questEngine.getAchievementCategoryName(this._category.code);
         ...
         this._questEngine.setupAchievementCategoryImage(this.var_992,this._category,false);
      }
      ...
      private function refreshAchievementDetails() : void
      {
         ...
         var _loc1_:String = this.getAchievedBadgeId(this.var_71);
         ...
         this._questEngine.localization.registerParameter("achievements.details.level","level","" + (!!this.var_71.finalLevel ? this.var_71.level : this.var_71.level - 1));
         this._questEngine.localization.registerParameter("achievements.details.level","limit","" + this.var_71.levelCount);
         this._questEngine.refreshReward(!this.var_71.finalLevel,this.var_443,this.var_71.levelRewardPointType,this.var_71.levelRewardPoints);
         this.refreshBadgeImageLarge(this.var_443,this.var_71);
         this.var_639.refresh(this.var_71.currentPoints,this.var_71.scoreLimit,this.var_71.type * 10000 + this.var_71.level);
         this.var_639.visible = !this.var_71.finalLevel;
      }
      ...
      private function prepareWindow() : void
      {
         ...
         this.var_992 = IWindowContainer(this._window.findChildByName("achievements_header_cont"));
         ...
         this.var_1499 = IWindowContainer(this._window.findChildByName("achievements_footer_cont"));
         this.var_1214 = IWindowContainer(this._window.findChildByName("categories_footer_cont"));
         this.var_639 = new ProgressBar(this._questEngine,this.var_443,const_1489,"achievements.details.progress",true,const_1488);
         this.var_800 = new ProgressBar(this._questEngine,this.var_1214,const_1490,"achievements.categories.totalprogress",true,const_1495);
      }
      ...
      private function refreshCategoryEntry(param1:int, param2:AchievementCategory) : Boolean
      {
         ...
         if(_loc3_ == null)
         {
            ...
            _loc3_.x = (_loc3_.width + const_1498) * (param1 % const_688);
            _loc3_.y = (_loc3_.height + const_1497) * Math.floor(param1 / const_688) + const_1493;
         }
      ...
      private function refreshAchievementEntry(param1:int, param2:AchievementData) : Boolean
      {
         ...
         var _loc4_:int = Math.floor(param1 / const_1068);
         var _loc5_:* = _loc4_ < const_1491;
         if(_loc3_ == null)
         {
            if(param2 == null && !_loc5_)
            {
            ...
            _loc3_.x = _loc3_.width * (param1 % const_1068);
            _loc3_.y = _loc3_.height * _loc4_ + const_1492;
         ...
         if(param2)
         {
            _loc7_.visible = param2 != this.var_71;
            _loc8_.visible = param2 == this.var_71;
            _loc3_.visible = true;
         }
         else if(_loc5_)
         {
      ...
      private function onSelectCategory(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            this.pickCategory(this.var_116.method_5[_loc3_]);
         }
      ...
      private function pickCategory(param1:AchievementCategory) : void
      {
         ...
         this.var_71 = this._category.achievements[0];
      ...
      private function refreshMouseOver(param1:int) : void
      {
         ...
         while(_loc2_ < this.var_442.numChildren)
         {
            ...
            _loc4_.findChildByName("category_bg_act").visible = !_loc3_ && _loc2_ < this.var_116.method_5.length;
      ...
      private function onSelectAchievement(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:int = param2.id;
         this.var_71 = this._category.achievements[_loc3_];
         this.refresh();
         this._questEngine.send(new EventLogMessageComposer("Achievements","" + this.var_71.type,"Achievement selected"));
      }
      ...
      private function refreshBadgeImage(param1:IWindowContainer, param2:AchievementData) : void
      {
         ...
         var _loc5_:BitmapData = this.var_801[_loc4_];
         ...
         var _loc7_:int = const_1069 - _loc5_.height + this.getPositionFix(param2.type);
         var _loc8_:Point = new Point((_loc3_.width - _loc5_.width) / 2,!!_loc6_ ? Number(const_1494) : Number(_loc7_));
         ...
         {
            _loc3_.bitmap.applyFilter(_loc5_,_loc5_.rect,_loc8_,this.var_1835);
         }
         _loc3_.visible = false;
         _loc3_.visible = true;
      }
      ...
      private function refreshBadgeImageLarge(param1:IWindowContainer, param2:AchievementData) : void
      {
         ...
         var _loc6_:int = 2 * (const_1069 - _loc5_.height + this.getPositionFix(param2.type));
         this.var_1215.identity();
         this.var_1215.scale(2,2);
         this.var_1215.translate((_loc3_.width - _loc5_.width * 2) / 2,_loc6_);
         _loc3_.bitmap.fillRect(_loc3_.bitmap.rect,16777215);
         _loc3_.bitmap.draw(_loc5_,this.var_1215);
         if(!param2.firstLevelAchieved)
         {
            _loc3_.bitmap.applyFilter(_loc3_.bitmap,_loc3_.bitmap.rect,new Point(0,0),this.var_1835);
         }
         _loc3_.visible = false;
         _loc3_.visible = true;
      }
      ...
      {
         this.var_71 = this.var_1500;
         this.var_116.update(this.var_1500);
         this.var_1500 = null;
         this.refresh();
      }
