package com.sulake.habbo.quest
{
   ...
   public class QuestCompleted implements IDisposable
   {
      ...
      private static const const_1458:int = 5;
      ...
      public function prepare(param1:QuestMessageData) : void
      {
         ...
         this._window.findChildByName("catalog_link_txt").caption = this._questEngine.localization.getKey("quests.completed.cataloglink." + this.var_124.activityPointType);
         var _loc2_:String = "quests.completed.reward." + this.var_124.activityPointType;
         this._questEngine.localization.registerParameter(_loc2_,"amount",this.var_124.rewardCurrencyAmount.toString());
         this._window.findChildByName("reward_txt").caption = this._questEngine.localization.getKey(_loc2_,_loc2_);
         this._window.visible = false;
         this._window.findChildByName("congrats_txt").caption = this._questEngine.localization.getKey(!!this.var_124.lastQuestInCampaign ? "quests.completed.campaign.caption" : "quests.completed.quest.caption");
         this._window.findChildByName("more_quests_button").visible = this.var_124.lastQuestInCampaign;
         this._window.findChildByName("campaign_reward_icon").visible = this.var_124.lastQuestInCampaign;
         this._window.findChildByName("catalog_link_region").visible = !this.var_124.lastQuestInCampaign;
         this._window.findChildByName("next_quest_button").visible = !this.var_124.lastQuestInCampaign;
         this._window.findChildByName("reward_icon").visible = !this.var_124.lastQuestInCampaign;
         this._window.findChildByName("campaign_reward_icon").visible = this.var_124.lastQuestInCampaign;
         this._window.findChildByName("campaign_pic_bitmap").visible = this.var_124.lastQuestInCampaign;
         this.setWindowTitle(!!this.var_124.lastQuestInCampaign ? "quests.completed.campaign.title" : "quests.completed.quest.title");
         this._questEngine.setupCampaignImage(this._window,param1,this.var_124.lastQuestInCampaign);
         var _loc3_:ITextWindow = ITextWindow(this._window.findChildByName("desc_txt"));
         var _loc4_:int = _loc3_.height;
         this.setDesc(this.var_124.getQuestLocalizationKey() + ".completed");
         _loc3_.height = Math.max(const_1457,_loc3_.textHeight + const_1458);
      ...
      {
         this._questEngine.localization.registerParameter(param1,"category",this._questEngine.getCampaignName(this.var_124));
      ...
      private function onCatalogLink(param1:WindowEvent, param2:IWindow = null) : void
      {
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            this._questEngine.openCatalog(this.var_124);
         }
      }
      ...
      public function update(param1:uint) : void
      {
         if(this.var_1173 > 0)
         {
            ...
            if(this.var_1173 < 1)
            {
               ...
               if(this.var_124.lastQuestInCampaign)
               {
