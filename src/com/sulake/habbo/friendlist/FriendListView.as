package com.sulake.habbo.friendlist
{
   ...
   public class FriendListView
   {
      ...
      private static const const_1474:Point = new Point(110,50);
       
      
      private var _friendList:HabboFriendList;
      
      private var var_1791:FriendListTabsView;
      ...
      public function FriendListView(param1:HabboFriendList)
      {
         ...
         this.var_1791 = new FriendListTabsView(this._friendList);
      }
      ...
      public function openFriendList() : void
      {
         ...
         {
            this.prepare();
            this.var_17.position = const_1474;
         }
         else
         {
      ...
      private function prepare() : void
      {
         ...
         this.var_1103 = IWindowContainer(this.var_17.content.findChildByName("main_content"));
         this.var_294 = IWindowContainer(this.var_17.content.findChildByName("footer"));
         this.var_1791.prepare(this.var_1103);
         this.var_17.procedure = this.onWindow;
         this.var_17.content.setParamFlag(HabboWindowParam.const_1352,false);
         this.var_17.content.setParamFlag(HabboWindowParam.const_1204,true);
         this.var_17.header.setParamFlag(HabboWindowParam.const_1022,false);
         this.var_17.header.setParamFlag(HabboWindowParam.const_895,true);
         this.var_17.content.setParamFlag(HabboWindowParam.const_1022,false);
         this.var_17.content.setParamFlag(HabboWindowParam.const_895,true);
         this.var_17.findChildByName("open_edit_ctgs_but").procedure = this.onEditCategoriesButtonClick;
         this.var_1477 = ITextWindow(this.var_17.findChildByName("info_text"));
         this.var_1477.text = "";
      ...
      private function onWindow(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:int = this.var_1794 == -1 ? 0 : int(this.var_17.height - this.var_1794);
         var _loc4_:int = this.var_1793 == -1 ? 0 : int(this.var_17.width - this.var_1793);
      ...
      private function refreshWindowSize() : void
      {
         ...
         this.var_294.y = Util.getLowestPoint(this.var_17.content);
         this.var_294.width = this._friendList.tabs.windowWidth;
         ...
         this.var_17.scaler.setParamFlag(HabboWindowParam.const_1262,this._friendList.tabs.findSelectedTab() != null);
         this.var_17.scaler.setParamFlag(HabboWindowParam.const_1022,false);
         this.var_17.scaler.setParamFlag(HabboWindowParam.const_1352,false);
         ...
         this.var_1794 = this.var_17.height;
         this.var_1793 = this.var_17.width;
