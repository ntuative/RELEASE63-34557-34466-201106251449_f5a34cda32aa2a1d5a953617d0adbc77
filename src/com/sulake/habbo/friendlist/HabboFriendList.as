package com.sulake.habbo.friendlist
{
   ...
   public class HabboFriendList extends Component implements IHabboFriendList, IAvatarImageListener
   {
      ...
      private var var_896:ISessionDataManager;
      
      private var var_2904:FriendListLookAndFeel;
      
      private var var_433:FriendListTabs;
      
      private var _view:FriendListView;
      
      private var var_2117:OpenedToWebPopup;
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_722.stop();
            this.var_722.removeEventListener(TimerEvent.TIMER,this.sendFriendListUpdate);
            this.var_722 = null;
         }
         ...
         if(this.var_1014)
         {
            this.var_1014.release(new IIDHabboNotifications());
            this.var_1014 = null;
         }
         if(this._toolbar)
         {
         ...
         if(this.var_896)
         {
            this.var_896.release(new IIDSessionDataManager());
            this.var_896 = null;
         }
         super.dispose();
      }
      ...
      public function openHabboWebPage(param1:String, param2:Dictionary, param3:int, param4:int) : void
      {
         ...
         {
            this.var_2117 = new OpenedToWebPopup(this);
         }
         this.var_2117.show(x,y);
      }
      ...
      {
         this.openFriendListWithTab(FriendListTab.const_432);
      }
      ...
      {
         var _loc2_:IAvatarImage = this.var_602.createAvatarImage(param1,AvatarScaleType.const_113,null,this);
         if(!_loc2_)
         {
            return null;
         }
      ...
      public function isEmbeddedMinimailEnabled() : Boolean
      {
         ...
         return _loc1_ == "CanCreateRoomEvent";
      }
      ...
      {
         this.var_1014 = param2 as IHabboNotifications;
      ...
      {
         this.var_896 = param2 as ISessionDataManager;
      }
      ...
      private function onMessengerInit(param1:IMessageEvent) : void
      {
         ...
         this.var_116.addCategory(new FriendCategory(FriendCategory.const_1288,this.getText("friendlist.friends")));
         this.var_116.addCategory(new FriendCategory(FriendCategory.const_424,this.getText("friendlist.friends.offlinecaption")));
         for each(_loc4_ in this.getSortedFriends(_loc2_.friends))
         {
            this.var_116.addFriend(new Friend(_loc4_));
         }
         this.var_433 = new FriendListTabs(new FriendListTabsDeps(this));
         if(!this.var_722)
         {
            this.var_722 = new Timer(120000);
            this.var_722.addEventListener(TimerEvent.TIMER,this.sendFriendListUpdate);
            this.var_722.start();
         }
         ...
         {
            _loc5_ = this.var_116.findCategory(FriendCategory.const_424);
            if(_loc5_)
            {
               _loc5_.setOpen(true);
            }
      ...
      private function onBuddyRequests(param1:IMessageEvent) : void
      {
         ...
         {
            this.var_433.findTab(FriendListTab.const_94).setNewMessageArrived(true);
         }
      ...
      private function onNewBuddyRequest(param1:IMessageEvent) : void
      {
         ...
         var _loc4_:FriendListTab = this.var_433.findTab(FriendListTab.const_94);
      ...
      private function onHabboSearchResult(param1:IMessageEvent) : void
      {
         ...
         this.var_2118.searchReceived(_loc2_.friends,_loc2_.others);
      ...
      {
         var _loc2_:FriendListTab = this.var_433.findTab(FriendListTab.const_94);
         if(!_loc2_)
         {
            return;
         }
      ...
      {
         var _loc1_:FriendListTab = this.var_433.findTab(FriendListTab.const_94);
         if(!_loc1_)
         {
            return;
         }
      ...
      {
         if(!this.var_896 || !this.var_120)
         {
            return;
         }
         var _loc2_:int = 0;
         if(this.var_896.hasUserRight("fuse_super_extended_buddylist",HabboClubLevelEnum.const_46))
         {
            _loc2_ = this.var_120.vipLimit;
         }
         else if(this.var_896.hasUserRight("fuse_extended_buddylist",HabboClubLevelEnum.const_35))
         {
