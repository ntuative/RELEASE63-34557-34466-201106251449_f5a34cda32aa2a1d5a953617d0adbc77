package com.sulake.habbo.localization
{
   ...
   public class HabboLocalizationManager extends CoreLocalizationManager implements IHabboLocalizationManager
   {
      ...
      public function HabboLocalizationManager(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_2342 = ["I","II","III","IV","V","VI","VII","VIII","IX","X","XI","XII","XIII","XIV","XV","XVI","XVII","XVIII","XIX","XX"];
         super(param1,param2,param3);
         this.var_1766 = (param2 & 0) > 0;
         if(!this.var_1766)
         {
            lock();
         }
         ...
         if(param2 != null)
         {
            ...
            if(!this.var_1766)
            {
               if("false" == this.var_161.getKey("use.default.localizations","false"))
               {
                  ...
                  events.addEventListener(LocalizationEvent.const_198,this.onLocalizationLoaded);
      ...
      {
         var _loc2_:* = null;
         events.removeEventListener(LocalizationEvent.const_198,this.onLocalizationLoaded);
         if(this.var_161.keyExists("external.override.texts.txt"))
         {
            _loc2_ = this.var_161.getKey("external.override.texts.txt");
            events.addEventListener(LocalizationEvent.const_198,this.onLocalizationOverrideLoaded);
      ...
      {
         events.removeEventListener(LocalizationEvent.const_198,this.onLocalizationOverrideLoaded);
         unlock();
      }
      ...
      {
         return this.var_2342[Math.max(0,param1 - 1)];
      }
