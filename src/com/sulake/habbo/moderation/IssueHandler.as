package com.sulake.habbo.moderation
{
   ...
   public class IssueHandler implements TrackedWindow
   {
      ...
      private var var_177:IssueBundle;
      
      private var _window:IFrameWindow;
      
      private var var_556:UserInfoCtrl;
      
      private var var_1280:UserInfoCtrl;
      ...
      private function createView() : void
      {
         ...
         var _loc3_:IssueMessageData = this.var_177.getHighestPriorityIssue();
         this.var_556 = new UserInfoCtrl(this._window,this.var_74,_loc3_.message);
         this.var_1280 = new UserInfoCtrl(this._window,this.var_74,_loc3_.message);
         ...
         if(this.var_177.reportedUserId > 0)
         {
            this.var_1280.load(_loc4_,this.var_177.reportedUserId);
         }
         else
         {
         ...
         Logger.log("HARASSER: " + this.var_177.reportedUserId);
      ...
      private function updateIssueList() : void
      {
         ...
         var _loc2_:Array = this.var_177.issues;
         var _loc3_:int = 0;
      ...
      {
         if(this.var_74 != null && this.var_74.issueManager != null && this.var_177 != null)
         {
            this.var_74.issueManager.removeHandler(this.var_177.id);
         }
         this.dispose();
      }
      ...
      private function onCloseUseless(param1:WindowMouseEvent) : void
      {
         ...
         this.var_74.issueManager.closeBundle(this.var_177.id,1);
      ...
      private function onCloseAbusive(param1:WindowMouseEvent) : void
      {
         ...
         this.var_74.issueManager.closeBundle(this.var_177.id,2);
         this.checkAutoHandling();
         this.dispose();
      }
      ...
      private function onCloseResolved(param1:WindowMouseEvent) : void
      {
         ...
         this.var_74.issueManager.closeBundle(this.var_177.id,3);
         this.checkAutoHandling();
         this.dispose();
      }
      ...
      private function onRelease(param1:WindowMouseEvent) : void
      {
         ...
         this.var_74.issueManager.releaseBundle(this.var_177.id);
         this.checkAutoHandling();
         this.dispose();
      }
      ...
      private function onShowChatlog(param1:WindowMouseEvent) : void
      {
         ...
         var _loc2_:int = this.var_177.getHighestPriorityIssue().issueId;
         this.var_74.windowTracker.show(new ChatlogCtrl(new GetCfhChatlogMessageComposer(_loc2_),this.var_74,WindowTracker.const_1387,_loc2_),this._window,false,false,true);
      }
      ...
      private function onReporterClicked(param1:WindowMouseEvent) : void
      {
         ...
         if(_loc2_ != 0)
         {
            ...
            _loc3_ = this.var_177.getHighestPriorityIssue();
            this.var_556 = new UserInfoCtrl(this._window,this.var_74,_loc3_.message);
