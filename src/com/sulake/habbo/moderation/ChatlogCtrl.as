package com.sulake.habbo.moderation
{
   ...
   public class ChatlogCtrl implements IDisposable, TrackedWindow
   {
      ...
      private static var var_2194:int = 1000;
      
      private static var var_1134:Array = [];
      
      private static var var_2195:int = 200;
      ...
      private var var_1746:IMessageComposer;
      ...
      {
         this.var_919 = IWindowContainer(this.var_36.getXmlWindow("chatlog_roomheader"));
         this.var_918 = IWindowContainer(this.var_36.getXmlWindow("chatlog_chatline"));
         ...
         this.var_36.connection.send(this.var_1746);
      ...
      private function getChatLineWindow() : IWindowContainer
      {
         ...
         return IWindowContainer(this.var_918.clone());
      }
      
      private function storeChatLineWindow(param1:IWindowContainer) : void
      {
         var _loc2_:* = null;
         if(var_1135.length < var_2194)
         {
            ...
            param1.width = this.var_918.width;
            param1.height = this.var_918.height;
      ...
      private function populateChatline(param1:IItemListWindow, param2:ChatlineData, param3:Boolean) : void
      {
         ...
         _loc4_.color = this.var_2196[param2.chatterId] != null ? (!!param3 ? 4294623571 : uint(4294959680)) : (!!param3 ? 4288861930 : uint(4294967295));
         ...
         if(param2.chatterId > 0)
         {
            ...
            if(!this.var_1694.getValue(param2.chatterName))
            {
               this.var_1694.add(param2.chatterName,param2.chatterId);
            }
         }
      ...
      private function onChatLogUserClick(param1:WindowMouseEvent) : void
      {
         ...
         var _loc3_:int = this.var_1694.getValue(_loc2_);
      ...
      public function dispose() : void
      {
         ...
         for each(_loc1_ in this.var_1693)
         {
