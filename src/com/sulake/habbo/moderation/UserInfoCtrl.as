package com.sulake.habbo.moderation
{
   ...
   public class UserInfoCtrl implements IDisposable
   {
      ...
      private static const const_1144:int = 60;
      
      private static const const_1146:int = 3600;
      
      private static const const_1145:int = 86400;
      
      private static const const_1147:int = 31536000;
      ...
      public static function formatTime(param1:int) : String
      {
         ...
         {
            return Math.round(param1 / const_1144) + " mins ago";
         }
         ...
         {
            return Math.round(param1 / const_1145) + " days ago";
         }
         return Math.round(param1 / const_1147) + " years ago";
      }
      ...
      {
         var _loc1_:IWindowContainer = IWindowContainer(this.var_1356.findChildByName("user_info"));
         if(_loc1_ == null)
         {
            _loc1_ = IWindowContainer(this.var_36.getXmlWindow("user_info"));
            this.var_1356.addChild(_loc1_);
      ...
      private function onChatlogButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_36.windowTracker.show(new ChatlogCtrl(new GetUserChatlogMessageComposer(this._data.userId),this.var_36,WindowTracker.const_1276,this._data.userId),this._callerFrame,this.var_1355,false,true);
      }
      ...
      private function onRoomVisitsButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_36.windowTracker.show(new RoomVisitsCtrl(this.var_36,this._data.userId),this._callerFrame,this.var_1355,false,true);
      }
      ...
      private function onMessageButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_36.windowTracker.show(new SendMsgsCtrl(this.var_36,this._data.userId,this._data.userName,this.var_1632),this._callerFrame,this.var_1355,false,true);
      }
      ...
      private function onModActionButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_36.windowTracker.show(new ModActionCtrl(this.var_36,this._data.userId,this._data.userName,this.var_1632),this._callerFrame,this.var_1355,false,true);
      }
