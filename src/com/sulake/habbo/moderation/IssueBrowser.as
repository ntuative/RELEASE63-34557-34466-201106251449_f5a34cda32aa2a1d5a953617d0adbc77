package com.sulake.habbo.moderation
{
   ...
   public class IssueBrowser
   {
      ...
      private const const_2368:String = "my_issues";
      
      private const const_2369:String = "open_issues";
      
      private const const_2370:String = "picked_issues";
      
      private const const_2384:String = "closed_issues";
      ...
      private var var_389:IIssueBrowserView;
      
      private var var_1955:IIssueBrowserView;
      
      private var var_1953:IIssueBrowserView;
      
      private var var_1954:PickedIssuesView;
      ...
      private function selectView(param1:String) : void
      {
         ...
         if(this.var_389 == _loc2_)
         {
            return;
         }
         if(this.var_389 != null)
         {
            this.var_389.visible = false;
         }
         this.var_389 = _loc2_;
         if(this.var_389 == null)
         {
         ...
         this.var_389.view.width = this.var_284.container.width;
         this.var_389.view.height = this.var_284.container.height;
      ...
      private function getView(param1:String) : IIssueBrowserView
      {
         switch(param1)
         {
            case this.const_2368:
               if(this.var_1955 == null)
               {
                  this.var_1955 = new MyIssuesView(this.issueManager,this,this.var_284.container);
               }
               return this.var_1955;
            case this.const_2369:
               if(this.var_1953 == null)
               {
                  this.var_1953 = new OpenIssuesView(this.issueManager,this,this.var_284.container);
               }
               return this.var_1953;
            case this.const_2370:
               if(this.var_1954 == null)
               {
                  this.var_1954 = new PickedIssuesView(this.issueManager,this,this.var_284.container);
               }
