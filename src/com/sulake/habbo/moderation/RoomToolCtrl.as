package com.sulake.habbo.moderation
{
   ...
   public class RoomToolCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_1468:ICheckBoxWindow;
      
      private var var_1469:ICheckBoxWindow;
      ...
      public function show() : void
      {
         ...
         this.var_36.connection.send(new GetModeratorRoomInfoMessageComposer(this.var_378));
         Logger.log("BEGINNING TO SHOW: " + this.var_378);
      }
      ...
      {
         Logger.log("GOT ROOM INFO: " + param1.flatId + ", " + this.var_378);
         if(param1.flatId != this.var_378)
         {
            Logger.log("NOT THE SAME FLAT: " + param1.flatId + ", " + this.var_378);
            return;
         }
         this._data = param1;
         this.populate();
      ...
      public function populate() : void
      {
         ...
         this.var_1468 = ICheckBoxWindow(this._frame.findChildByName("lock_check"));
         this.var_1469 = ICheckBoxWindow(this._frame.findChildByName("changename_check"));
      ...
      private function act(param1:Boolean) : void
      {
         ...
         this.var_36.connection.send(new ModeratorActionMessageComposer(ModeratorActionMessageComposer.const_1835,_loc2_,this.var_582.text,"",""));
         if(this.var_1468.isSelected || this.var_1469.isSelected || this.var_967.isSelected)
         {
            this.var_36.connection.send(new ModerateRoomMessageComposer(this._data.flatId,this.var_1468.isSelected,this.var_1469.isSelected,this.var_967.isSelected));
         }
         this.dispose();
      }
      ...
      private function determineAction(param1:Boolean, param2:Boolean) : int
      {
         if(param2)
         {
            return !!param1 ? 0 : int(ModeratorActionMessageComposer.const_1793);
         }
         return !!param1 ? 0 : int(ModeratorActionMessageComposer.const_1801);
      }
      ...
      private function onSelectTemplate(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:String = this.var_36.initMsg.roomMessageTemplates[this.var_1184.selection];
         if(_loc3_ != null)
         {
            this.var_690 = false;
