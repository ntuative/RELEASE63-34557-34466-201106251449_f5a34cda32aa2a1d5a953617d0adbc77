package com.sulake.habbo.moderation
{
   ...
   public class ModActionCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_1346:IDropMenuWindow;
      ...
      private var var_1091:OffenceCategoryData;
      
      private var var_1092:OffenceData;
      ...
      public function ModActionCtrl(param1:ModerationManager, param2:int, param3:String, param4:String)
      {
         ...
         this.var_1345 = IButtonWindow(this.var_36.getXmlWindow("modact_offence"));
         this.var_1344 = IButtonWindow(this.var_36.getXmlWindow("modact_offencectg"));
      }
      ...
      public function show() : void
      {
         ...
         this._frame.caption = "Mod action on: " + this.var_1838;
         ...
         this.var_1346 = IDropMenuWindow(this._frame.findChildByName("banLengthSelect"));
         this.prepareBanSelect(this.var_1346);
      ...
      public function refreshCategorization() : void
      {
         ...
         _loc1_.findChildByName("change_categorization_but").visible = this.var_1091 != null;
         if(this.var_1092 != null)
         {
            this._frame.findChildByName("offence_txt").caption = this.var_1092.name;
            this._frame.findChildByName("offence_category").visible = true;
         }
         else if(this.var_1091 != null)
         {
            this.refreshButtons("offences_cont",2,this.var_1091.offences,this.var_1345,this.onOffenceButton);
         }
         else
         {
            this.refreshButtons("offence_categories_cont",3,this.var_36.initMsg.offenceCategories,this.var_1344,this.onOffenceCtgButton);
      ...
      {
         return WindowTracker.const_1848;
      }
      ...
      private function onSendCautionButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_36.connection.send(new ModAlertMessageComposer(this.var_1631,this.var_582.text,this.var_1632));
         this.dispose();
      }
      ...
      private function onOffenceCtgButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_1091 = this.var_36.initMsg.offenceCategories[_loc3_];
         this.refreshCategorization();
      }
      ...
      private function onOffenceButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:int = int(param2.name);
         this.var_1092 = this.var_1091.offences[_loc3_];
         this.var_582.text = this.var_1092.msg;
         this.var_690 = false;
         this.refreshCategorization();
      }
      ...
      private function onKickButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_36.connection.send(new ModKickMessageComposer(this.var_1631,this.var_582.text,this.var_1632));
         this.dispose();
      }
      ...
      private function onBanButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(this.var_1346.selection < 0)
         {
            this.var_36.windowManager.alert("Alert","You must select ban lenght",0,this.onAlertClose);
            return;
         }
         this.var_36.connection.send(new ModBanMessageComposer(this.var_1631,this.var_582.text,this.getBanLength(),this.var_1632));
         this.dispose();
      }
      ...
      {
         var _loc1_:int = this.var_1346.selection;
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_1345.destroy();
            this.var_1345 = null;
         }
         if(this.var_1344 != null)
         {
            this.var_1344.destroy();
            this.var_1344 = null;
         }
         this.var_1346 = null;
         this.var_582 = null;
