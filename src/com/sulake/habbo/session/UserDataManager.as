package com.sulake.habbo.session
{
   ...
   public class UserDataManager implements IUserDataManager
   {
      ...
      private static const const_2070:int = 3;
      ...
      {
         return this.getUserDataByType(param1,const_1472);
      }
      ...
      public function getUserBadges(param1:int) : Array
      {
         ...
         var _loc2_:* = this.var_973.getValue(param1) as Array;
         if(_loc2_ == null)
         {
            _loc2_ = [];
         }
      ...
      {
         this.var_973.remove(param1);
         this.var_973.add(param1,param2);
      }
      ...
      {
         return this.getUserDataByType(param1,const_1473);
      }
