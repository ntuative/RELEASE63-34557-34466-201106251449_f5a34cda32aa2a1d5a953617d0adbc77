package com.sulake.habbo.session
{
   ...
   public class RoomSession implements IRoomSession
   {
      ...
      private const const_2375:int = 2500;
      ...
      {
         if(this._state == RoomSessionEvent.const_294 && this._connection != null)
         {
      ...
      {
         this._connection.send(new ChatMessageComposer(param1,this.var_1576));
         this.var_1575.add(this.var_1576,getTimer());
         ++this.var_1576;
      }
      ...
      {
         var _loc3_:int = 0;
         var _loc2_:Object = this.var_1575.remove(param1);
         if(_loc2_ != null)
         {
            _loc3_ = getTimer();
            if(_loc3_ - int(_loc2_) > this.const_2375)
            {
