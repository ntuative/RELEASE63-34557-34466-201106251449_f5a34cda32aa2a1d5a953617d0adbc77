package com.sulake.habbo.session.facebook
{
   ...
   public class FaceBookSession implements IDisposable
   {
      ...
      private static const const_1080:String = "FlashExternalInterface.authenticateFacebook";
      
      private static const const_1539:String = "sendAccessTokenToServer";
      
      private static const const_1540:String = "fbKLogOut";
      ...
      private function onAuthenticate(param1:FaceBookAuthenticateEvent) : void
      {
         ...
         if(false)
         {
            ...
            ExternalInterface.addCallback(const_1540,this.jsFaceBookLogOutCallback);
            Logger.log("-- -- ADDED JAVASCRIPT CALLBACK HOOKS!");
            ExternalInterface.call(const_1080);
            Logger.log("-- -- CALLED JAVASCRIPT METHOD " + const_1080);
         }
      }
