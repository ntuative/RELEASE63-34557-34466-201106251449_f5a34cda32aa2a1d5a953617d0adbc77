package com.sulake.habbo.inventory.items
{
   ...
   public class GroupItem implements IGetImageListener
   {
      ...
      private static const const_1544:int = 13421772;
      
      private static const const_1545:int = 10275685;
      ...
      private const const_2086:Number = 1;
      ...
      public function GroupItem(param1:int, param2:String, param3:int, param4:IWindowContainer, param5:IRoomEngine, param6:BitmapData, param7:Boolean, param8:String = null, param9:Number = NaN, param10:BitmapData = null, param11:Boolean = false)
      {
         ...
         this.var_2613 = this._window.findChildByName("outline");
      ...
      public function initImage(param1:Boolean = true) : void
      {
         ...
         if(this.var_2252 == FurniModelCategory.const_36)
         {
            _loc2_ = this._roomEngine.getFurnitureIcon(this._type,this,String(this.var_1628));
         }
         else
         {
            _loc2_ = this._roomEngine.getWallItemIcon(this._type,this,this.var_2242);
         }
         if(_loc2_.id > 0)
         {
            if(param1)
      ...
      public function updateThumbData() : void
      {
         ...
         if(_loc1_)
         {
            ...
            {
               this._window.blend = this.const_2086;
               _loc1_.blend = this.const_2086;
            }
         }
         this.var_1527.color = !!this.var_1551 ? uint(const_1545) : uint(const_1544);
         this.var_2613.visible = this.isSelected;
