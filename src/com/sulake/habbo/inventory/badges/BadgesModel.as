package com.sulake.habbo.inventory.badges
{
   ...
   public class BadgesModel implements IInventoryModel
   {
      ...
      public function BadgesModel(param1:HabboInventory, param2:IHabboWindowManager, param3:IHabboCommunicationManager, param4:IAssetLibrary, param5:ISessionDataManager)
      {
         ...
         this.var_417 = param5;
         this.var_417.events.addEventListener(BadgeImageReadyEvent.const_218,this.onBadgeImageReady);
         this._view = new BadgesView(this,param2,param4);
         this.var_713 = [];
         this.var_1357 = new Map();
      }
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_417.events.removeEventListener(BadgeImageReadyEvent.const_218,this.onBadgeImageReady);
            this.var_417 = null;
         }
      }
      ...
      public function updateBadge(param1:String, param2:Boolean, param3:int = 0) : void
      {
         ...
         if(param3 > 0)
         {
            this.var_1357.add(param1,param3);
         }
         ...
         else
         {
            ...
            _loc10_ = this.var_713.indexOf(param3) != -1;
            _loc11_ = new Badge(param1,_loc7_,_loc10_);
            _loc11_.iconImage = this.var_417.getBadgeImage(param1);
            if(_loc10_)
            {
               this.var_260.unshift(_loc11_);
            }
            else
            {
               this.var_260.push(_loc11_);
            }
            if(param2)
            {
      ...
      public function saveBadgeSelection() : void
      {
         ...
         var _loc2_:Array = this.getBadges(const_373);
         var _loc3_:int = 0;
      ...
      public function setBadgeSelected(param1:String) : void
      {
         ...
         while(_loc2_ < this.var_260.length)
         {
            _loc3_ = this.var_260[_loc2_] as Badge;
            if(_loc3_ != null)
            {
      ...
      public function forceSelection() : void
      {
         ...
         var _loc2_:Array = this.getBadges(const_549);
         ...
         var _loc3_:Array = this.getBadges(const_373);
      ...
      {
         return this.getItemInIndex(param1,const_373);
      }
      
      public function getBadgeFromInactive(param1:int) : Badge
      {
         return this.getItemInIndex(param1,const_549);
      }
      ...
      public function addUnseenBadges(param1:Array) : void
      {
         ...
         {
            if(this.var_713.indexOf(_loc2_) == -1)
            {
               this.var_713.push(_loc2_);
            }
         }
      }
      ...
      public function resetUnseenItems() : void
      {
         ...
         if(this.var_713 && this.var_713.length > 0)
         {
            _loc1_.send(new ResetUnseenItemsComposer(UnseenItemCategoryEnum.const_1224));
            this.var_713 = [];
