package com.sulake.habbo.inventory.badges
{
   ...
   public class BadgesView implements IInventoryView
   {
      ...
      public function BadgesView(param1:BadgesModel, param2:IHabboWindowManager, param3:IAssetLibrary)
      {
         ...
         this.var_678 = this._view.findChildByName("inactive_items") as IItemGridWindow;
         this.var_678.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onInactiveBadgeClick);
      ...
      private function updateListViews() : void
      {
         ...
         var _loc1_:Number = this.var_678.scrollV;
         this.var_678.removeGridItems();
         this.var_1034.removeGridItems();
         var _loc2_:Array = this.var_77.getBadges(BadgesModel.const_549);
         var _loc4_:int = 0;
         while(_loc4_ < _loc2_.length)
         {
            ...
            if(!_loc3_.isInUse)
            {
               this.var_678.addGridItem(_loc3_.window);
         ...
         if(_loc1_ > 0)
         {
            this.var_678.scrollV = _loc1_;
         }
         var _loc5_:Array = this.var_77.getBadges(BadgesModel.const_373);
         _loc4_ = 0;
      ...
      public function updateActionView() : void
      {
         ...
         else
         {
            ...
            _loc3_ = this.var_77.getBadges(BadgesModel.const_373);
      ...
      {
         var _loc2_:int = this.var_678.getGridItemIndex(param1.window);
