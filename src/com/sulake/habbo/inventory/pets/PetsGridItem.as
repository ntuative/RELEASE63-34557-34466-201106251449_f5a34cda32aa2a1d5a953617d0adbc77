package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsGridItem
   {
      ...
      private function eventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         switch(param1.type)
         {
            case WindowMouseEvent.const_45:
               this.var_1582.setSelectedGridItem(this);
               this.var_1583 = true;
               break;
            ...
            case WindowMouseEvent.const_25:
               ...
               {
                  this.var_1583 = false;
                  this.var_1582.placePetToRoom(this._petData.id,true);
               }
         }
      }
      ...
      public function setSelected(param1:Boolean) : void
      {
         ...
         if(!this._window || !this.var_1527)
         {
            return;
         }
         this.var_1527.color = !!this.var_1655 ? uint(const_1545) : uint(const_1544);
         this.var_2613.visible = param1;
      }
