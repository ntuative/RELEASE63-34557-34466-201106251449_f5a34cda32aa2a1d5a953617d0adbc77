package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsView implements IInventoryView, IPetImageListener, IGetImageListener
   {
      ...
      private const const_1078:int = 1;
      
      private const const_1099:int = 2;
      ...
      {
         var _loc2_:PetsGridItem = this.var_545.remove(param1) as PetsGridItem;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      {
         if(this.var_545 == null || this.var_545.length == 0)
         {
            this.updatePreview();
            return;
         }
         this.setSelectedGridItem(this.var_545.getWithIndex(0));
      }
      ...
      public function addPet(param1:PetData) : void
      {
         ...
         if(this.var_545.getValue(param1.id) != null)
         {
            return;
         }
         ...
         if(_loc2_ != null)
         {
            ...
            this.var_545.add(param1.id,_loc2_);
      ...
      public function updateState() : void
      {
         ...
         {
            _loc2_ = this.const_1078;
         }
         else if(!_loc1_ || _loc1_.length == 0)
         {
            _loc2_ = this.const_1099;
         }
         else
         {
            _loc2_ = this.const_1100;
         }
         ...
         switch(_loc2_)
         {
            case this.const_1078:
               _loc3_.visible = true;
               _loc4_.visible = false;
               _loc5_.visible = false;
               _loc6_.visible = false;
               break;
            case this.const_1099:
               _loc3_.visible = false;
               _loc4_.visible = true;
               _loc5_.visible = false;
               _loc6_.visible = false;
               break;
            case this.const_1100:
               _loc3_.visible = false;
               _loc4_.visible = false;
               _loc5_.visible = true;
               _loc6_.visible = true;
      ...
      public function updateCategoryButtons() : void
      {
         ...
         _loc1_.visible = this.var_77.furniModel.getUnseenItemCount(UnseenItemCategoryEnum.const_435) > 0;
         _loc1_ = this._view.findChildByTag("unseen_symbol_wall");
         _loc1_.visible = this.var_77.furniModel.getUnseenItemCount(UnseenItemCategoryEnum.const_410) > 0;
