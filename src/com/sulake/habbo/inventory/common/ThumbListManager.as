package com.sulake.habbo.inventory.common
{
   ...
   public class ThumbListManager
   {
      ...
      private var var_1509:IThumbListDataProvider;
      ...
      public function ThumbListManager(param1:IAssetLibrary, param2:IThumbListDataProvider, param3:String, param4:String, param5:int, param6:int)
      {
         ...
         if(_loc7_ != null)
         {
            this.var_641 = BitmapData(_loc7_.content);
         }
         ...
         this._thumbWidth = this.var_641.width;
         this.var_104 = this.var_641.height;
         this.var_1220 = param5;
         this.var_995 = param6;
         this.var_243 = Math.floor(this.var_1220 / this._thumbWidth);
         this.var_29 = new BitmapData(this.var_1220,this.var_995);
      }
      ...
      public function updateImageFromList() : void
      {
         ...
         this.var_29 = new BitmapData(Math.max(this.var_243 * this._thumbWidth,this.var_1220),Math.max(this.var_642 * this.var_104,this.var_995),true,16777215);
      ...
      public function addItemAsFirst(param1:IThumbListDrawableItem) : void
      {
         ...
         if(_loc3_.x == this.var_243 && this.var_29.height < _loc3_.y * this.var_104)
         {
         ...
         _loc4_ = new Rectangle(0,0,this._thumbWidth * (this.var_243 - 1),this.var_104);
         ...
         _loc4_ = new Rectangle(0,this.var_104,this._thumbWidth * (this.var_243 - 1),this.var_29.height - this.var_104);
      ...
      private function getList() : Array
      {
         ...
         {
            _loc1_ = this.var_1509.getDrawableList();
         }
      ...
      private function removeItemInImage(param1:Point) : void
      {
         ...
         if(this.var_29.height < this.var_995)
         {
            _loc12_ = new BitmapData(this.var_29.width,this.var_995);
      ...
      {
         var _loc4_:* = null;
         var _loc3_:BitmapData = new BitmapData(this.var_641.width,this.var_641.height);
         if(param2)
         {
            _loc3_.copyPixels(this._itemBgImageSelected,this.var_641.rect,new Point(0,0),null,null,false);
         }
         else
         {
            _loc3_.copyPixels(this.var_641,this.var_641.rect,new Point(0,0),null,null,false);
         }
         if(param1 != null)
         {
