package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingModel implements IInventoryModel, IGetImageListener
   {
      ...
      public static const const_1755:uint = 9;
      ...
      public static const const_359:uint = 3;
      ...
      public function startTrading(param1:int, param2:String, param3:Boolean, param4:int, param5:String, param6:Boolean) : void
      {
         ...
         this.var_60.updateItemList(this.var_877);
         this.var_60.updateItemList(this.var_1624);
      ...
      public function close() : void
      {
         if(this.var_780)
         {
            if(this._state != const_221 && this._state != const_282)
            {
      ...
      {
         this.var_60.setMinimized(param1 != InventoryCategory.const_69);
         this.var_13.updateSubView();
      }
      
      public function set state(param1:uint) : void
      {
         Logger.log("OLD STATE: " + this._state + " NEW STATE: " + param1 + " OWN: " + this.var_876 + " OTHER: " + this.var_1338);
         ...
         {
            case const_221:
               if(param1 == const_223 || param1 == const_282)
               {
                  this._state = param1;
                  _loc2_ = true;
               }
      ...
      public function handleMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(param1 is TradingAlreadyOpenEvent)
         {
            ...
            this.var_60.alertPopup(TradingView.const_1225);
         }
         else if(param1 is TradingAcceptEvent)
         {
            ...
            {
               this.var_876 = TradingAcceptEvent(param1).userAccepts != 0;
            }
            else
            {
               this.var_1338 = TradingAcceptEvent(param1).userAccepts != 0;
            }
            this.var_60.updateUserInterface();
         }
         ...
         else if(param1 is TradingCloseEvent)
         {
            ...
            {
               this.var_60.alertPopup(TradingView.const_1265);
            }
            this.close();
         }
      ...
      public function requestAddItemToTrading(param1:int, param2:int, param3:int, param4:Boolean, param5:String = "") : Boolean
      {
         ...
         if(this.var_292.length < const_1755)
         {
         ...
         else
         {
            ...
            if(param3 == FurniCategory.const_219)
            {
