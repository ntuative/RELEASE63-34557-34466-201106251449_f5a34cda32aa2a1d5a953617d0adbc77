package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingView implements IInventoryView, IGetImageListener
   {
      ...
      private static const const_1060:uint = 4284532064;
      ...
      private var var_620:ItemPopupCtrl;
      ...
      public function TradingView(param1:TradingModel, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IRoomEngine, param5:IHabboLocalizationManager, param6:IHabboSoundManager)
      {
         ...
         this.var_620 = new ItemPopupCtrl(_loc9_,this._assetLibrary);
      ...
      public function getWindowContainer() : IWindowContainer
      {
         ...
         {
            this.var_1773 = this.createMinimizedWindow();
         }
         if(!this.var_1154)
         {
            return this.var_78;
      ...
      public function updateUserInterface() : void
      {
         ...
         if(this.var_78)
         {
            ...
            if(_loc1_)
            {
               _loc1_.color = !!this.var_20.ownUserAccepts ? uint(const_1060) : uint(const_1061);
            }
            ...
            if(_loc1_)
            {
               _loc1_.color = !!this.var_20.otherUserAccepts ? uint(const_1060) : uint(const_1061);
            }
      ...
      private function thumbEventProc(param1:WindowEvent, param2:IWindow, param3:Boolean) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            ...
            if(_loc5_.category == FurniCategory.const_1902)
            {
            ...
            this.var_620.updateContent(param2 as IWindowContainer,_loc7_,_loc6_,ItemPopupCtrl.const_612);
            this.var_620.show();
         }
         else if(param1.type == WindowMouseEvent.const_25)
         {
            this.var_620.hideDelayed();
         }
      }
      ...
      private function getTraxSongFurniName(param1:GroupItem, param2:String, param3:Boolean, param4:uint = 1.0, param5:Boolean = false) : String
      {
         ...
         else if(param3)
         {
            ...
            this.var_191.push(param4);
            this.var_191.push(param1);
            this.var_191.push(param5);
      ...
      private function onSongInfoReceivedEvent(param1:SongInfoReceivedEvent) : void
      {
         ...
         if(this.var_191.length > 0)
         {
            _loc2_ = this.var_191.pop();
            _loc3_ = this.var_191.pop();
            _loc4_ = uint(this.var_191.pop());
            _loc5_ = _loc3_.peek();
            if(_loc5_.extra == param1.id)
            {
               if(_loc2_ && this.var_20.ownUserItems.getWithIndex(_loc4_) == _loc3_ || !_loc2_ && this.var_20.otherUserItems.getWithIndex(_loc4_) == _loc3_)
               {
                  ...
                  this.var_620.updateContent(_loc8_ as IWindowContainer,_loc6_,_loc7_,ItemPopupCtrl.const_612);
               }
            }
            else
            {
               this.var_191.push(_loc4_);
               this.var_191.push(_loc3_);
