package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniModel extends FurniModelCategory implements IInventoryModel
   {
      ...
      private static const const_1688:int = 100;
      ...
      private var var_1639:Vector.<Array>;
      ...
      public function FurniModel(param1:HabboInventory, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IHabboCommunicationManager, param5:IAssetLibrary, param6:IRoomEngine, param7:IHabboCatalog, param8:IHabboSoundManager)
      {
         ...
         this.var_488 = [];
         this.var_489 = [];
         this.var_708 = new Timer(const_1688,1);
         this.var_708.addEventListener(TimerEvent.TIMER_COMPLETE,this.onImageUpdateTimerEvent);
         var _loc9_:IAsset = this._assets.getAssetByName("inventory_thumb_xml");
         var _loc10_:XmlAsset = XmlAsset(_loc9_);
         this.var_2872 = XML(_loc10_.content);
         this.clearFurniList();
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this._roomEngine != null)
            {
               ...
               {
                  this._roomEngine.events.removeEventListener(RoomEngineObjectEvent.const_179,this.onObjectPlaced);
               }
            ...
            {
               this.var_708.removeEventListener(TimerEvent.TIMER_COMPLETE,this.onImageUpdateTimerEvent);
               this.var_708.stop();
               this.var_708 = null;
            }
      ...
      public function insertFurniList(param1:String, param2:Array, param3:int, param4:int) : void
      {
         ...
         if(param3 >= param4 && param3 > 1)
         {
            if(param1 == const_36)
            {
               ...
               {
                  this.var_1639 = new Vector.<Array>(param3,true);
               }
               _loc15_ = this.var_1639;
            }
            else
            {
         ...
         this.var_27.setInventoryCategoryInit(InventoryCategory.const_69);
      ...
      public function createNewGroupItemTemplate(param1:int, param2:String, param3:int, param4:String = null, param5:Number = NaN, param6:Boolean = false) : GroupItem
      {
         ...
         var _loc12_:* = null;
         var _loc13_:* = null;
         if(param3 == FurniCategory.const_352)
         {
         ...
         if(this.var_882 == null)
         {
            this.var_882 = this._windowManager.buildFromXML(this.var_2872) as IWindowContainer;
            _loc12_ = this._assets.getAssetByName("thumb_selected_outline_png") as BitmapDataAsset;
            _loc13_ = this.var_882.findChildByName("outline") as IBitmapWrapperWindow;
            _loc13_.bitmap = _loc12_.content as BitmapData;
            _loc13_.disposesBitmap = false;
         }
         var _loc11_:IWindowContainer = this.var_882.clone() as IWindowContainer;
      ...
      {
         if(param1 == InventoryCategory.const_69 && this.var_27.isVisible)
         {
      ...
      public function clearFurniList() : void
      {
         ...
         this.var_709.add(const_36,new Array());
         this.var_709.add(const_44,new Array());
         if(this._view != null)
         {
      ...
      public function addFurniAt(param1:IItem, param2:Boolean = false, param3:int = -1, param4:Boolean = false) : void
      {
         ...
         {
            _loc6_ = const_36;
            _loc5_ = this.var_488.indexOf(param1.ref) > -1;
         }
         else
         {
            ...
            _loc6_ = const_44;
            _loc5_ = this.var_489.indexOf(param1.ref) > -1;
         }
         ...
         else
         {
            ...
            for(; _loc10_ < _loc8_.length; _loc10_++)
            {
               ...
               if(_loc9_.type == param1.type)
               {
                  if(param1.category != FurniCategory.const_219)
                  {
                     _loc7_ = _loc9_;
                  }
      ...
      {
         return getTimer() < this.var_2871 + const_1689;
      }
      ...
      {
         return this.var_27.getSubCategoryViewId() == InventorySubCategory.const_381;
      }
      ...
      public function requestSelectedFurniPlacement(param1:Boolean = false) : Boolean
      {
         ...
         if(_loc3_.category == FurniCategory.const_333 || _loc3_.category == FurniCategory.const_352 || _loc3_.category == FurniCategory.const_356)
         {
            if(param1)
            {
               return false;
      ...
      {
         return this.var_709.getValue(param1);
      }
      ...
      public function subCategorySwitch(param1:String) : void
      {
         switch(param1)
         {
            case InventorySubCategory.const_381:
               this.cancelFurniInMover();
               if(this._view != null)
               {
                  this._view.updateActionView();
      ...
      public function getAllStripIds(param1:String, param2:Array) : void
      {
         ...
         var _loc5_:int = 0;
         var _loc6_:int = 0;
         var _loc3_:Array = this.var_709.getValue(param1) as Array;
         if(_loc3_ != null)
         {
            for each(_loc4_ in _loc3_)
            {
               _loc5_ = _loc4_.getTotalCount();
               if(_loc4_.category == FurniCategory.const_793)
               {
                  _loc5_ = 1;
               }
               _loc6_ = 0;
      ...
      public function addUnseenFloorItems(param1:Array) : void
      {
         ...
         {
            if(this.var_488.indexOf(_loc2_) == -1)
            {
               this.var_488.push(_loc2_);
            }
         }
      }
      ...
      public function addUnseenWallItems(param1:Array) : void
      {
         ...
         for each(_loc2_ in param1)
         {
            if(this.var_489.indexOf(_loc2_) == -1)
            {
               this.var_489.push(_loc2_);
            }
         }
      }
      ...
      public function resetUnseenItems(param1:String = null) : void
      {
         ...
         {
            case const_44:
               if(this.var_489 && this.var_489.length > 0)
               {
               ...
               break;
            case const_36:
               if(this.var_488 && this.var_488.length > 0)
               {
                  _loc2_.send(new ResetUnseenItemsComposer(UnseenItemCategoryEnum.const_435));
                  this.var_488 = [];
                  _loc3_ = this.getCategoryContent(param1);
               }
         }
