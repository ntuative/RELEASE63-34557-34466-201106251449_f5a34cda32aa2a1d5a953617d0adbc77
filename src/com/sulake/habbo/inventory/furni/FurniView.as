package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniView implements IInventoryView, IGetImageListener
   {
      ...
      private static const const_2097:int = 0;
      ...
      private static const const_1098:int = 42;
      
      private static const const_1097:int = 120;
      ...
      private var var_787:MarketplaceModel;
      ...
      public function FurniView(param1:FurniModel, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IAssetLibrary, param5:IRoomEngine, param6:IHabboSoundManager)
      {
         ...
         this.var_219.add(FurniModelCategory.const_36,new FurniGridView(this.var_77,FurniModelCategory.const_36,this._windowManager,this._assetLibrary,this._roomEngine));
         this.var_219.add(FurniModelCategory.const_44,new FurniGridView(this.var_77,FurniModelCategory.const_44,this._windowManager,this._assetLibrary,this._roomEngine));
      ...
      private function addUnseenItemSymbols() : void
      {
         ...
         for each(_loc5_ in ["floor","wall","pets"])
         {
            ...
            _loc3_.x = _loc4_.rectangle.right - _loc3_.width - const_1073;
            _loc3_.y = _loc4_.y + const_1073;
      ...
      private function showCategoryGrid(param1:String = null) : void
      {
         ...
         var _loc3_:FurniGridView = this.var_219.getValue(this.var_474);
         if(_loc3_)
         {
      ...
      {
         var _loc2_:int = 0;
         var _loc1_:Array = this.var_77.getCategoryContent(this.var_474);
      ...
      public function updateCategoryButtons() : void
      {
         ...
         _loc1_.visible = this.var_77.getUnseenItemCount(UnseenItemCategoryEnum.const_435) > 0;
         _loc1_ = this._view.findChildByTag("unseen_symbol_wall");
         _loc1_.visible = this.var_77.getUnseenItemCount(UnseenItemCategoryEnum.const_410) > 0;
      ...
      public function updateActionView() : void
      {
         ...
         _loc4_ = this.var_77.getGroupItemInIndex(_loc3_,this.var_474);
         if(_loc3_ > -1 && _loc4_ != null && _loc4_.peek() != null)
         {
            _loc5_ = _loc4_.peek();
            _loc1_ = true;
            _loc16_ = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_224);
            ...
            _loc18_ = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_220);
            ...
            if(_loc5_.category == FurniCategory.const_352)
            {
            ...
            {
               if(_loc5_.category == FurniCategory.const_219)
               {
         ...
         if(_loc11_)
         {
            if(_loc1_ && this.var_787 && this.var_787.isEnabled && _loc5_.sellable)
            {
               _loc11_.enable();
            }
            else
         ...
         if(_loc5_ != null)
         {
            if(_loc5_.category == FurniCategory.const_1215)
            {
      ...
      private function setPreviewImage(param1:BitmapData) : void
      {
         ...
         if(_loc3_ > const_1097)
         {
            _loc3_ = const_1097;
         }
         else if(_loc3_ < const_1098)
         {
            _loc3_ = const_1098;
         }
         else
