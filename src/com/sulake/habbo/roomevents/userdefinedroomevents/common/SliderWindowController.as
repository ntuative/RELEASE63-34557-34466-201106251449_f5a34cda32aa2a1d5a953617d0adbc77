package com.sulake.habbo.roomevents.userdefinedroomevents.common
{
   ...
   public class SliderWindowController extends EventDispatcher
   {
      ...
      private var var_1403:Number = 1.0;
      ...
      public function setValue(param1:Number, param2:Boolean = true) : void
      {
         ...
         param1 = Math.min(this.var_1403,param1);
      ...
      private function updateSliderPosition() : void
      {
         ...
         if(_loc1_ != null)
         {
            _loc1_.x = this.getSliderPosition(this.var_1136);
         }
      ...
      {
         return int(this.var_1842 * (Number(param1 - this._minValue) / (this.var_1403 - this._minValue)));
      }
      
      private function getValueAtPosition(param1:Number) : Number
      {
         return param1 / this.var_1842 * (this.var_1403 - this._minValue) + this._minValue;
      }
      ...
      private function sliderProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(this.var_1137)
         {
            if(param1.type == WindowMouseEvent.const_56 || param1.type == WindowMouseEvent.const_256)
            {
               this.var_1137 = false;
            }
         }
         if(!this.var_1137 || param1.type != WindowEvent.const_405)
         {
            return;
         }
         if(this.var_743 != 0)
         {
            ...
            _loc4_ = Math.round(_loc3_ / this.var_743) * this.var_743;
      ...
      private function sliderButtonRightProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            if(this.var_743 != 0)
            {
               _loc3_ = this.var_1136 + this.var_743;
      ...
      private function displaySlider() : void
      {
         ...
         if(_loc2_ != null && this.var_805 != null)
         {
            _loc2_.bitmap = new BitmapData(this.var_805.width,this.var_805.height,true,16777215);
            _loc2_.bitmap.copyPixels(this.var_805,this.var_805.rect,new Point(0,0),null,null,true);
         }
      ...
      private function storeAssets(param1:IAssetLibrary) : void
      {
         ...
         this.var_805 = BitmapData(_loc2_.content);
