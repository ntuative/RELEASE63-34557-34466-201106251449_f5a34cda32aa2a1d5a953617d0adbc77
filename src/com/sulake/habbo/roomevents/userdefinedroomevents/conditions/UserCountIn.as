package com.sulake.habbo.roomevents.userdefinedroomevents.conditions
{
   ...
   public class UserCountIn implements ConditionType
   {
      ...
      {
         this.var_92 = param2;
         this.var_1217 = new SliderWindowController(param2,this.getMinInput(param1),param2.assets,1,50,1);
         this.var_1217.addEventListener(Event.CHANGE,this.onMinSliderChange);
         this.var_1217.setValue(1);
