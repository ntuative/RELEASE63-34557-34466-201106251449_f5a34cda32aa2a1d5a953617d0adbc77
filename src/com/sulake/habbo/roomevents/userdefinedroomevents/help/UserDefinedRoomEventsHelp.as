package com.sulake.habbo.roomevents.userdefinedroomevents.help
{
   ...
   public class UserDefinedRoomEventsHelp
   {
      ...
      private function prepareWindow() : void
      {
         ...
         this.var_1951 = IWindowContainer(this.find(this._window,"help_container"));
         this.var_1264 = this.var_1951.findChildByName("button_previous") as IContainerButtonWindow;
         if(this.var_1264)
         {
            this.var_1264.procedure = this.onButtonClick;
         }
         this.var_1263 = this.var_1951.findChildByName("button_next") as IContainerButtonWindow;
         if(this.var_1263)
         {
            this.var_1263.procedure = this.onButtonClick;
         }
      ...
      {
         if(this.var_283 >= this.var_73.length - 1)
         {
            this.var_1263.disable();
         }
         else
         {
            this.var_1263.enable();
         }
         if(this.var_283 <= 0)
         {
      ...
      {
         ++this.var_283;
         this.var_283 = Math.min(this.var_283,this.var_73.length - 1);
         this.openPage();
      }
      ...
      private function localize() : void
      {
         ...
         if(_loc1_)
         {
            _loc1_.text = ILocalization(this.var_73[this.var_283][0]).value;
         }
         if(_loc2_)
         {
            _loc2_.text = ILocalization(this.var_73[this.var_283][2]).value;
         }
         if(_loc3_)
         {
            _loc4_ = ILocalization(this.var_73[this.var_283][1]).value;
