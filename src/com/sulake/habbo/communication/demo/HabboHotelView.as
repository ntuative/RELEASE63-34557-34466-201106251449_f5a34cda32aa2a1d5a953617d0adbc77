package com.sulake.habbo.communication.demo
{
   ...
   public class HabboHotelView implements IDisposable
   {
      ...
      private var var_1041:IDesktopWindow;
      
      private var _disposed:Boolean = false;
      
      private var var_1313:Function;
      
      private var var_1312:Function;
      
      private var var_856:IAssetLibrary;
      ...
      public function HabboHotelView(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IEventDispatcher, param4:Boolean = true)
      {
         ...
         this.var_856 = param2;
         this._events = param3;
         this.var_1041 = param1.getDesktop(0);
      ...
      {
         var _loc3_:AssetLoaderStruct = this.var_856.loadAssetFromFile("hotelview_png",new URLRequest(param1),"image/png");
         if(param2 == null)
         {
      ...
      private function hotelViewLoadedHandler(param1:AssetLoaderEvent) : void
      {
         ...
         var _loc3_:IAsset = this.var_856.getAssetByName(_loc2_.assetName);
      ...
      private function hotelViewLoadedCallbackHandler(param1:AssetLoaderEvent) : void
      {
         ...
         else if(param1.type == AssetLoaderEvent.ASSET_LOADER_EVENT_COMPLETE)
         {
            if(this._events != null)
            {
               this._events.dispatchEvent(new Event(HabboHotelViewEvent.const_565));
            }
            _loc4_ = BitmapDataAsset(_loc3_).content as BitmapData;
      ...
      {
         var _loc3_:AssetLoaderStruct = this.var_856.loadAssetFromFile("hotel_view_banner_" + this.var_1311,new URLRequest(param1),"image/png");
         if(param2 == null)
         {
         ...
         else
         {
            if(this._events != null)
            {
               this._events.dispatchEvent(new Event(HabboHotelViewEvent.const_938));
            }
      ...
      public function show() : void
      {
         if(this._window && !this._window.disposed)
         {
            this.var_1041.addChildAt(this._window,0);
         }
      }
      ...
      public function hide() : void
      {
         if(this._window && !this._window.disposed)
         {
            this.var_1041.removeChild(this._window);
         }
      }
   }
}
