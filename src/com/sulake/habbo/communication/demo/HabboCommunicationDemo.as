package com.sulake.habbo.communication.demo
{
   ...
   public class HabboCommunicationDemo extends Component
   {
      ...
      private var var_2730:PseudoRandom;
      ...
      private const const_2096:String = "fuselogin";
      ...
      public function setSSOTicket(param1:String) : void
      {
         ...
         {
            this.var_687 = param1;
            this.var_65.initConnection(HabboConnectionType.const_281);
         }
      }
      ...
      private function onRoomSessionManagerReady(param1:IID, param2:IUnknown) : void
      {
         ...
         this.var_16.events.addEventListener(RoomSessionEvent.const_86,this.onRoomSessionEnded);
         this.checkRequirements();
      }
      ...
      {
         if(this.var_65 && this.var_153 && this.var_16 && this._windowManager)
         {
      ...
      private function componentsAreRunning() : void
      {
         ...
         this.var_687 = this.var_153.getKey("sso.ticket",null);
         this.var_2002 = this.var_153.getKey("flash.client.url","");
         this.var_2731 = this.var_153.getKey("external.variables.txt","");
         if(this.var_251 == null)
         {
            this.var_251 = new HabboHotelView(this._windowManager,assets,Component(context).events,_loc1_);
         }
         ...
         else if(this._windowManager != null)
         {
            ...
            if(_loc5_)
            {
               ...
               this._view.addEventListener(HabboLoginDemoView.const_881,this.onInitConnection);
            }
            else
            {
               Core.crash("Login without an SSO ticket is not supported",Core.const_1746);
            }
         }
      }
      ...
      private function onInitConnection(param1:Event = null) : void
      {
         ...
         else
         {
            ...
            {
               this.var_65.mode = HabboConnectionType.const_1385;
            }
         }
         this.var_65.initConnection(HabboConnectionType.const_281);
      }
      ...
      private function onInitCrypto(param1:IMessageEvent) : void
      {
         ...
         this.var_2730 = new PseudoRandom(parseInt(_loc4_.substring(_loc4_.length - 4),16),65536);
         switch(this.var_65.mode)
         {
            case HabboConnectionType.const_99:
               ...
               this.var_1580 = _loc4_;
               this.var_251.loadBannerImage(_loc7_ + "?token=" + this.var_1580,this.onHotelViewBannerLoaded);
               break;
            case HabboConnectionType.const_1385:
               this.sendConnectionParameters(_loc2_);
               break;
            case HabboConnectionType.const_1927:
               this.var_1042 = this.generateRandomHexString(30);
               this.var_558 = new DiffieHellman(new BigInteger(this.var_153.getKey("connection.development.prime"),16),new BigInteger(this.var_153.getKey("connection.development.generator"),16));
               this.var_558.init(this.var_1042);
      ...
      private function onSecretKeyEvent(param1:IMessageEvent) : void
      {
         ...
         var _loc7_:IEncryption = new RC4_R27(_loc6_,this.var_2730);
      ...
      private function sendConnectionParameters(param1:IConnection) : void
      {
         ...
         this.var_1581 = true;
         this.dispatchLoginStepEvent(HabboCommunicationEvent.const_317);
         connection.send(new VersionCheckMessageComposer(401,this.var_2002,this.var_2731));
         var machineId:String = "";
         try
         {
            so = SharedObject.getLocal(this.const_2096,"/");
      ...
      private function onSessionParamsEvent(param1:IMessageEvent) : void
      {
         ...
         if(this.var_687 != null)
         {
            _loc4_ = new SSOTicketMessageComposer(this.var_687);
            _loc2_.send(_loc4_);
      ...
      private function onAuthenticationOK(param1:IMessageEvent) : void
      {
         ...
         this.dispatchLoginStepEvent(HabboCommunicationEvent.const_288);
      }
      ...
      private function onConnectionDisconnected(param1:Event) : void
      {
         ...
         if(param1.type == Event.CLOSE && !this.var_2732)
         {
      ...
      private function onHotelViewBannerLoaded(param1:BitmapData) : void
      {
         ...
         var _loc4_:String = xor(_loc3_,this.var_1580);
