package com.sulake.habbo.communication.demo
{
   ...
   public class HabboLoginDemoView extends EventDispatcher
   {
      ...
      public static const const_881:String = "InitConnection";
      ...
      private function createWindow() : void
      {
         ...
         this._window = this.var_141.windowManager.createWindow("habbo_login_window","Login",HabboWindowType.const_157,HabboWindowStyle.const_47,0 | 0,new Rectangle(10,10,320,240),null) as IFrameWindow;
         ...
         var _loc7_:SharedObject = SharedObject.getLocal(this.const_2096,"/");
         if(_loc5_ != null)
         {
         ...
         if(_loc8_)
         {
            ...
            {
               if(this.var_141.habboConfiguration.getKey("use.sso","false") == "CanCreateRoomEvent")
               {
                  _loc8_.select();
               }
            }
         ...
         if(this.var_141.habboConfiguration && this.var_141.habboConfiguration.getKey("try.existing.session","false") == "CanCreateRoomEvent")
         {
            this.var_1691 = true;
            this._window.visible = false;
            this.windowEventProcessor(WindowEvent.allocate(WindowEvent.const_159,this._window,null,false));
         }
      }
      ...
      private function windowEventProcessor(param1:WindowEvent = null, param2:IWindow = null) : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            _loc6_ = SharedObject.getLocal(this.const_2096,"/");
         ...
         {
            dispatchEvent(new Event(const_881));
         }
      }
      ...
      private function initSSOTicket(param1:Boolean) : void
      {
         ...
         {
            this.var_162.removeEventListener(SSOTicket.const_446,this.onParsedTicketSuccess);
            this.var_162.removeEventListener(SSOTicket.const_370,this.onParsedTicketFailure);
            this.var_162 = null;
         }
         var _loc2_:String = "";
         ...
         this.var_162 = new SSOTicket(this.var_141.assets,_loc3_,_loc2_,param1);
         this.var_162.addEventListener(SSOTicket.const_446,this.onParsedTicketSuccess);
         this.var_162.addEventListener(SSOTicket.const_370,this.onParsedTicketFailure);
      }
      ...
      private function onParsedTicketSuccess(param1:Event) : void
      {
         ...
         this.var_141.flashClientUrl = this.var_162.flashClientUrl;
         this.var_141.ssoTicket = this.var_162.ticket;
         this.var_162.removeEventListener(SSOTicket.const_446,this.onParsedTicketSuccess);
         this.var_162.removeEventListener(SSOTicket.const_370,this.onParsedTicketFailure);
         this.var_162 = null;
         dispatchEvent(new Event(const_881));
