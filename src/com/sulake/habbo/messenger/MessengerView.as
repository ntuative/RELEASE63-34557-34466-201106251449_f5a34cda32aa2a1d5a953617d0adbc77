package com.sulake.habbo.messenger
{
   ...
   public class MessengerView implements IDisposable
   {
      ...
      private var var_1440:ConversationView;
      ...
      public function addMsgToView(param1:Conversation, param2:Message) : void
      {
         ...
         this.var_1440.addMessage(param2);
      }
      
      private function prepareContent() : void
      {
         this.var_17 = IFrameWindow(this.var_157.getXmlWindow("main_window"));
         ...
         this.var_946 = new ConversationsTabView(this.var_157,this.var_17);
         this.var_946.refresh();
         this.var_945 = ITextFieldWindow(this.var_17.findChildByName("message_input"));
         this.var_945.addEventListener(WindowKeyboardEvent.const_181,this.onMessageInput);
         this.var_1440 = new ConversationView(this.var_157,this.var_17);
         this.var_17.scaler.setParamFlag(HabboWindowParam.const_812,false);
         this.var_17.scaler.setParamFlag(HabboWindowParam.const_1262,true);
         this.var_17.center();
      }
      ...
      private function onMessageInput(param1:WindowKeyboardEvent) : void
      {
         ...
         {
            _loc2_ = 120;
            _loc3_ = this.var_945.text;
            if(_loc3_.length > _loc2_)
            {
               this.var_945.text = _loc3_.substring(0,_loc2_);
            }
         }
      }
      ...
      {
         var _loc1_:String = this.var_945.text;
         ...
         this.var_945.text = "";
         this.var_157.conversations.addMessageAndUpdateView(new Message(Message.const_969,_loc2_.id,_loc1_,Util.getFormattedNow()));
      }
