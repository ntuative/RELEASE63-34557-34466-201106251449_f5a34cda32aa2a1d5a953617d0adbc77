package com.sulake.habbo.messenger
{
   ...
   public class ConversationView
   {
      ...
      private var var_2820:IScrollbarWindow;
      
      private var var_2058:IContainerButtonWindow;
      ...
      public function ConversationView(param1:HabboMessenger, param2:IWindowContainer)
      {
         super();
         this.var_157 = param1;
         this.var_2058 = this.initButton("follow_friend",this.onFollowButtonClick,param2);
         this.var_62 = IItemListWindow(param2.findChildByName("msg_list"));
         this.var_2820 = IScrollbarWindow(param2.findChildByName("scroller"));
      ...
      public function addMessage(param1:Message) : void
      {
         ...
         if(_loc2_ >= const_1131 + const_1655)
         {
            this.refreshList();
            this.afterResize();
         }
      ...
      public function refresh() : void
      {
         ...
         if(this.var_576 == null || _loc1_.id != this.var_576.id)
         {
            this.var_576 = _loc1_;
            this.refreshList();
            this.afterResize();
      ...
      {
         if(this.var_576.followingAllowed)
         {
            this.var_2058.enable();
         }
         else
         {
            this.var_2058.disable();
         }
      }
      ...
      private function refreshList() : void
      {
         ...
         this.var_62.autoArrangeItems = false;
         var _loc1_:int = 0;
         var _loc2_:int = Math.max(0,this.var_576.messages.length - const_1131);
         _loc1_ = 0;
         while(_loc1_ + _loc2_ < this.var_576.messages.length)
         {
            this.refreshEntry(true,_loc1_,this.var_576.messages[_loc1_ + _loc2_]);
            _loc1_++;
         }
         while(true)
         {
      ...
      private function refreshEntry(param1:Boolean, param2:int, param3:Message) : Boolean
      {
         ...
         _loc4_.visible = true;
         var _loc5_:String = param3.type == Message.const_969 || param3.type == Message.const_885 ? param3.time + ": " : "";
      ...
      private function onMinimailButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         _loc3_["recipientid"] = "" + this.var_576.id;
      ...
      private function onFollowButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_157.send(new FollowFriendMessageComposer(this.var_576.id));
      ...
      {
         if(param1 == Message.const_969)
         {
            return 4294967295;
         }
         if(param1 == Message.const_885)
         {
            return 4292801535;
         }
