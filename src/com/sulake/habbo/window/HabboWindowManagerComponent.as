package com.sulake.habbo.window
{
   ...
   public class HabboWindowManagerComponent extends Component implements IHabboWindowManager, ICoreWindowManager, IWindowFactory, IUpdateReceiver, IWindowContextStateListener
   {
      ...
      private static const const_488:uint = 3;
      
      private static const const_1717:uint = 1;
      ...
      private var var_1669:IEventDispatcher;
      
      private var var_1384:Boolean = false;
      
      private var var_2152:ProfilerOutput;
      
      private var var_1671:ProfilerAgentTask;
      
      private var var_1670:ProfilerAgentTask;
      ...
      private function initialize(param1:IID, param2:IUnknown) : void
      {
         ...
         this.var_231 = new Array(const_488);
         ...
         this.var_633 = this.var_231[const_1717];
         unlock();
      ...
      private function receiveProfilerInterface(param1:IID, param2:IUnknown) : void
      {
         ...
         if(_loc3_ != null)
         {
            if(!this.var_2152)
            {
               this.var_2152 = new ProfilerOutput(context,this,this._windowRenderer);
            }
            this.var_2152.profiler = _loc3_;
            this.var_1671 = new ProfilerAgentTask("Update","Event processing");
            _loc3_.getProfilerAgentForReceiver(this).addSubTask(this.var_1671);
            this.var_1670 = new ProfilerAgentTask("Redraw","Window rasterizer");
            _loc3_.getProfilerAgentForReceiver(this).addSubTask(this.var_1670);
            this.var_1384 = true;
         }
      }
      ...
      {
         return this.var_633.create(param1,param7,param2,param3,param4,param5,param6,param10,param8,param11,param9);
      }
      ...
      {
         return this.var_633.getWindowParser().windowToXMLString(param1);
      }
      ...
      {
         return this.var_231[param1].getDesktopWindow().getChildAt(this.var_633.getDesktopWindow().numChildren - 1);
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         {
            this.var_1669.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_INPUT));
            _loc2_ = const_488 - 1;
            while(_loc2_ >= 0)
            {
         ...
         this.var_1669.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_RENDER));
         _loc2_ = 0;
         while(_loc2_ < const_488)
         {
         ...
         this.var_1669.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_SLEEP));
      }
      ...
      public function mouseEventReceived(param1:String, param2:IWindow) : void
      {
         if(param2 != null)
         {
            if(param1 == MouseEvent.CLICK)
            {
               ...
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1759,param2.name + ": " + param2.toString());
            }
            else if(param1 == MouseEvent.MOUSE_UP)
            {
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1904,new Date().getTime().toString());
