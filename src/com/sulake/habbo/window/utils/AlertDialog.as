package com.sulake.habbo.window.utils
{
   ...
   public class AlertDialog implements IAlertDialog, INotify
   {
      ...
      protected static const const_619:String = "_alert_button_ok";
      
      protected static const const_1035:String = "_alert_button_cancel";
      
      protected static const const_1278:String = "_alert_button_custom";
      ...
      protected var var_1875:String = "";
      
      protected var _disposed:Boolean = false;
      
      protected var var_308:Function = null;
      ...
      public function AlertDialog(param1:IHabboWindowManager, param2:XML, param3:String, param4:String, param5:uint, param6:Function)
      {
         ...
         if(_loc7_)
         {
            ...
            if(!(param5 & 0))
            {
               _loc8_ = _loc7_.getListItemByName(const_1278);
               _loc8_.dispose();
            }
         }
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               case const_619:
                  ...
                  {
                     _loc3_ = WindowEvent.allocate(WindowEvent.const_159,null,null);
                     this.var_308(this,_loc3_);
                     _loc3_.recycle();
                  }
                  else
                  {
               ...
               case const_1413:
                  if(this.var_308 != null)
                  {
                     _loc3_ = WindowEvent.allocate(WindowEvent.const_539,null,null);
                     this.var_308(this,_loc3_);
                     _loc3_.recycle();
                  }
                  else
         ...
         if(!this._disposed)
         {
            switch(param1)
            {
               case HabboAlertDialogFlag.const_619:
                  _loc2_ = this._window.findChildByName(const_619) as IInteractiveWindow;
                  break;
               case HabboAlertDialogFlag.const_1035:
                  _loc2_ = this._window.findChildByName(const_1035) as IInteractiveWindow;
                  break;
               case HabboAlertDialogFlag.const_1278:
                  _loc2_ = this._window.findChildByName(const_1278) as IInteractiveWindow;
            }
         }
      ...
      public function set summary(param1:String) : void
      {
         ...
         if(this._window)
         {
            ITextWindow(this._window.findChildByTag("DESCRIPTION")).text = this.var_1875;
         }
      }
