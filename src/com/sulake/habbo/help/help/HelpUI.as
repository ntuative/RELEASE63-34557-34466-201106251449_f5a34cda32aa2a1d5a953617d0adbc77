package com.sulake.habbo.help.help
{
   ...
   public class HelpUI
   {
      ...
      private var var_2046:String = "HHVE_HELP_FRONTPAGE";
      ...
      public function HelpUI(param1:HabboHelp, param2:IAssetLibrary, param3:IHabboWindowManager)
      {
         ...
         this._windowManager.registerLocalizationParameter("info.client.version","version",new String(201106251443));
         this.var_131 = new Map();
         this.var_131.add(HabboHelpViewEnum.const_1926,IHelpViewController(new PlaceholderView(this,this._windowManager,this._assetLibrary)));
         this.var_131.add(HabboHelpViewEnum.const_234,IHelpViewController(new HelpMainView(this,this._windowManager,this._assetLibrary)));
         this.var_131.add(HabboHelpViewEnum.const_639,IHelpViewController(new FaqBrowseTopView(this,this._windowManager,this._assetLibrary)));
         this.var_131.add(HabboHelpViewEnum.const_334,IHelpViewController(new FaqBrowseCategoryView(this,this._windowManager,this._assetLibrary)));
         this.var_131.add(HabboHelpViewEnum.const_274,IHelpViewController(new FaqBrowseEntry(this,this._windowManager,this._assetLibrary)));
         this.var_131.add(HabboHelpViewEnum.const_449,IHelpViewController(new CallForHelpTopicSelection(this,this._windowManager,this._assetLibrary)));
         this.var_131.add(HabboHelpViewEnum.const_842,IHelpViewController(new CallForHelpTextInput(this,this._windowManager,this._assetLibrary)));
         this.var_131.add(HabboHelpViewEnum.const_277,IHelpViewController(new CallForHelpSentView(this,this._windowManager,this._assetLibrary,"help_cfh_thanks")));
         this.var_131.add(HabboHelpViewEnum.const_1408,IHelpViewController(new CallForHelpSentView(this,this._windowManager,this._assetLibrary,"help_cfh_abusive")));
         this.var_131.add(HabboHelpViewEnum.const_1390,IHelpViewController(new CallForHelpPendingItemView(this,this._windowManager,this._assetLibrary)));
         this.var_131.add(HabboHelpViewEnum.const_866,IHelpViewController(new CallForHelpReportUserSelection(this,this._windowManager,this._assetLibrary)));
      }
      ...
      public function showUI(param1:String = null, param2:Boolean = true) : void
      {
         ...
         if(param1 == this.var_2046)
         {
            this.var_570 = new Array();
         }
         else if(param2)
         {
            if(this.var_570.length == 0 || param1 != this.var_398)
            {
               this.var_570.push(this.var_398);
            }
         }
         this.var_398 = param1;
         ...
         if(_loc3_ == null)
         {
            Logger.log("* No view controller found for " + this.var_398);
            return;
         }
      ...
      public function showCallForHelpResult(param1:String) : void
      {
         switch(param1)
         {
            case CallForHelpResultEnum.const_277:
               this.showUI(HabboHelpViewEnum.const_277);
               break;
            case CallForHelpResultEnum.const_1279:
               this.showUI(HabboHelpViewEnum.const_1390);
               break;
            case CallForHelpResultEnum.const_1216:
               this.showUI(HabboHelpViewEnum.const_1408);
         }
      }
      ...
      public function updateCallForGuideBotUI(param1:Boolean) : void
      {
         ...
         var _loc2_:IHelpViewController = this.var_131.getValue(HabboHelpViewEnum.const_234) as IHelpViewController;
      ...
      public function handleCallGuideBot() : void
      {
         ...
         this.hideUI();
         this.var_23.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_674));
      }
      ...
      {
         return this.var_131.getValue(this.var_398);
      }
      ...
      private function createWindow() : void
      {
         ...
         this.var_2606 = this._window.width - _loc3_.width;
      ...
      public function updateWindowDimensions() : void
      {
         ...
         this._window.width = _loc1_.width + this.var_2606;
      }
      ...
      private function onBack(param1:WindowMouseEvent) : void
      {
         ...
         {
            this.showUI(this.var_570.pop(),false);
         }
      }
      ...
      {
         var _loc3_:* = null;
         if(this.var_398 == HabboHelpViewEnum.const_234)
         {
            return;
         }
         if(this.var_696.length < 2)
         {
            _loc3_ = this._assetLibrary.getAssetByName("back_png") as BitmapDataAsset;
            this.var_696.push(_loc3_.content as BitmapData);
            _loc3_ = this._assetLibrary.getAssetByName("back_hi_png") as BitmapDataAsset;
            this.var_696.push(_loc3_.content as BitmapData);
         }
         var _loc2_:IBitmapWrapperWindow = this.var_397.findChildByName("back_image") as IBitmapWrapperWindow;
         if(_loc2_ == null)
         {
            return;
         }
         ...
         if(param1)
         {
            _loc2_.bitmap.copyPixels(this.var_696[1],this.var_696[1].rect,new Point(0,0));
         }
         else
         {
            _loc2_.bitmap.copyPixels(this.var_696[0],this.var_696[0].rect,new Point(0,0));
         }
      }
      ...
      private function addBackButtonWindow() : void
      {
         ...
         var _loc3_:* = null;
         var _loc4_:* = null;
         if(this.var_398 == HabboHelpViewEnum.const_234 || this.var_570.length == 0)
         {
            return;
         }
         if(this.var_397 == null)
         {
            ...
            this.var_397 = this._windowManager.buildFromXML(XML(_loc2_.content)) as IWindowContainer;
            _loc3_ = this.var_397.findChildByName("back_image");
            if(_loc3_ != null)
            {
            ...
            _loc4_ = this.var_397.findChildByName("back_text");
            if(_loc4_ != null)
            {
         ...
         var _loc1_:IItemListWindow = this._window.findChildByName("content_list") as IItemListWindow;
         if(_loc1_ == null || this.var_397 == null)
         {
            return;
         }
         if(_loc1_.getListItemIndex(this.var_397 as IWindow) > -1)
         {
            return;
         }
         _loc1_.addListItem(this.var_397 as IWindow);
         this.setBackButtonActiveState(false);
      }
   }
}
