package com.sulake.habbo.help.tutorial
{
   ...
   public class TutorialUI implements INameChangeUI
   {
      ...
      public function TutorialUI(param1:HabboHelp, param2:Boolean = true)
      {
         ...
         this.var_36.events.addEventListener(HabboHelpTutorialEvent.const_597,this.onTaskDoneEvent);
         this.var_36.events.addEventListener(HabboHelpTutorialEvent.const_518,this.onTaskDoneEvent);
         if(this.var_36.sessionDataManager != null)
         {
            this.var_36.sessionDataManager.events.addEventListener(HabboSessionFigureUpdatedEvent.const_360,this.onFigureUpdate);
         }
      }
      ...
      {
         return this.var_1244 && this.var_1243 && this.var_1544;
      }
      ...
      public function dispose() : void
      {
         ...
         if(this.var_36)
         {
            ...
            this.var_36.events.removeEventListener(HabboHelpTutorialEvent.const_597,this.onTaskDoneEvent);
            this.var_36.events.removeEventListener(HabboHelpTutorialEvent.const_518,this.onTaskDoneEvent);
            if(this.var_36.sessionDataManager != null)
            {
               this.var_36.sessionDataManager.events.removeEventListener(HabboSessionFigureUpdatedEvent.const_360,this.onFigureUpdate);
            }
            this.var_36 = null;
         }
      }
      ...
      public function onTaskDoneEvent(param1:HabboHelpTutorialEvent) : void
      {
         switch(param1.type)
         {
            case HabboHelpTutorialEvent.const_674:
               this.var_1544 = true;
               if(this.var_54 != null && this.var_54.id == const_513)
               {
                  this.showView(const_97);
               }
               break;
            case HabboHelpTutorialEvent.const_597:
               if(this.var_54 != null && this.var_54.id == const_422)
               {
                  this.var_1915 = true;
                  this.disposeWindow();
               }
      ...
      public function showView(param1:String) : void
      {
         ...
         if(this._window == null)
         {
            ...
            this.var_2606 = this._window.width - _loc2_.width;
         ...
         this._window.width = _loc2_.width + this.var_2606;
         if(_loc3_)
         {
            if(this._window == null)
            {
      ...
      public function onUserNameChanged(param1:String) : void
      {
         ...
         if(this.var_54 != null && (this.var_54.id == const_335 || this.var_54.id == const_97))
         {
            this.showView(const_97);
         }
      }
      ...
      {
         this.var_1244 = true;
         if(this.var_54 != null && (this.var_54.id == const_422 || this.var_54.id == const_97))
         {
            this.showView(const_97);
         }
      }
