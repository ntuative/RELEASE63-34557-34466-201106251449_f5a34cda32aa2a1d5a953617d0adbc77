package com.sulake.habbo.help.tutorial
{
   ...
   public class NameChangeView
   {
      ...
      private static var var_1734:uint = 11129827;
      ...
      private var var_1165:NameSuggestionListRenderer;
      ...
      public function showMainView() : void
      {
         if(!this._window)
         {
            ...
            this.var_1735 = this._window.content.getChildAt(0) as IWindowContainer;
         }
      ...
      public function setNameNotAvailableView(param1:int, param2:String, param3:Array) : void
      {
         ...
         switch(param1)
         {
            ...
            case ChangeUserNameResultMessageEvent.var_925:
               break;
            case ChangeUserNameResultMessageEvent.var_922:
         ...
         _loc5_.visible = true;
         this.var_1165 = new NameSuggestionListRenderer(this.var_27);
         var _loc6_:int = this.var_1165.render(param3,_loc5_);
         var _loc7_:int = 0;
