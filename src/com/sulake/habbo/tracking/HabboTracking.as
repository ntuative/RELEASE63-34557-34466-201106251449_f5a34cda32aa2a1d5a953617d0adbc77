package com.sulake.habbo.tracking
{
   ...
   public class HabboTracking extends Component implements IHabboTracking, IUpdateReceiver
   {
      ...
      private static const const_1153:uint = 11;
      ...
      private var var_1374:IHabboWindowManager;
      
      private var _toolbar:IHabboToolbar;
      
      private var var_208:IHabboHelp;
      
      private var var_1654:Array;
      
      private var _crashed:Boolean = false;
      
      private var var_301:PerformanceTracker = null;
      
      private var var_495:FramerateTracker = null;
      
      private var var_300:LatencyTracker = null;
      
      private var var_729:LagWarningLogger = null;
      ...
      public function HabboTracking(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_301 = new PerformanceTracker();
         this.var_495 = new FramerateTracker();
         this.var_300 = new LatencyTracker();
         this.var_729 = new LagWarningLogger();
         this.var_496 = new ToolbarClickTracker(this);
         this.var_1654 = new Array(const_1153);
         var _loc4_:int = 0;
         while(_loc4_ < const_1153)
         {
            this.var_1654[_loc4_] = 0;
            _loc4_++;
         }
         ...
         if(_loc5_ != null)
         {
            ...
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_2028,new Date().getTime().toString());
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1779,!true ? ExternalInterface.call("window.navigator.userAgent.toString") : "unknown");
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1914,Capabilities.serverString);
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_790,String(false));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1378,String(0));
         }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            ...
            if(this.var_1374)
            {
               this.var_1374.release(new IIDHabboWindowManager());
               this.var_1374 = null;
            }
            if(this.var_325)
            {
            ...
            if(this._navigator)
            {
               if(!this._navigator.disposed)
               {
                  ...
                  this._navigator.events.removeEventListener(HabboNavigatorEvent.const_357,this.onZoomToggle);
               }
            ...
            if(this.var_230)
            {
               if(!this.var_230.disposed)
               {
                  ...
                  Component(this.var_230).events.removeEventListener(HabboFriendListTrackingEvent.const_516,this.onFriendlistTrackingEvent);
               }
            ...
            if(this.var_208)
            {
               ...
               {
                  this.var_208.events.removeEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_CLOSED,this.onHelpTrackingEvent);
                  this.var_208.events.removeEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_DEFAULT,this.onHelpTrackingEvent);
               }
               this.var_208.release(new IIDHabboHelp());
               this.var_208 = null;
            }
            if(this._toolbar)
            {
            ...
            if(this._roomEngine)
            {
               ...
               {
                  this._roomEngine.events.removeEventListener(RoomObjectRoomAdEvent.const_230,this.onRoomAdClick);
                  this._roomEngine.events.removeEventListener(RoomEngineEvent.const_191,this.onRoomAction);
                  this._roomEngine.events.removeEventListener(RoomEngineEvent.const_369,this.onRoomAction);
               }
            ...
            {
               this.var_341.stop();
               this.var_341.removeEventListener(TimerEvent.TIMER,this.onRoomActionTimerEvent);
               this.var_341 = null;
            }
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(this.var_161)
         {
            if(this.var_300 != null)
            {
               this.var_300.configuration = this.var_161;
            }
            if(this.var_301 != null)
            {
               this.var_301.configuration = this.var_161;
            }
            ...
            if(this.var_161)
            {
               ...
               {
                  this.var_729.configure(this.var_161);
               }
               if(this.var_495 != null)
               {
                  this.var_495.configure(this.var_161);
               }
               if(this.var_496 != null)
               {
                  this.var_496.configure(this.var_161);
               }
            }
         }
      }
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(context).events.addEventListener(HabboCommunicationEvent.const_317,this.onConnectionEvent);
         ...
         Component(context).events.addEventListener(HabboCommunicationEvent.const_288,this.onConnectionEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_938,this.onHotelViewEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_70,this.onHotelViewEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_565,this.onHotelViewEvent);
      }
      ...
      private function onConnectionReady(param1:IConnection) : void
      {
         ...
         if(param1 != null)
         {
            ...
            if(this.var_729 != null)
            {
               this.var_729.connection = param1;
            }
         }
      }
      ...
      {
         if(param1.type == HabboHotelViewEvent.const_938)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1985);
         }
         else if(param1.type == HabboHotelViewEvent.const_565)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1893);
         }
      ...
      private function onConnectionEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            case HabboCommunicationEvent.INIT:
               this.trackLoginStep(HabboLoginTrackingStep.const_1952);
               break;
            case HabboCommunicationEvent.const_998:
               this.trackLoginStep(HabboLoginTrackingStep.const_2000,String(this._communication.port));
               break;
            case HabboCommunicationEvent.const_317:
               this.trackLoginStep(HabboLoginTrackingStep.const_317);
               break;
            ...
            case HabboCommunicationEvent.const_207:
               ...
               break;
            case HabboCommunicationEvent.const_288:
               this.setErrorContextFlag(3,0);
               this.trackLoginStep(HabboLoginTrackingStep.const_288);
               if(this.var_300 != null)
               {
                  this.var_300.init();
               }
      ...
      {
         this.var_1374 = IHabboWindowManager(param2);
         if(this.var_1374)
         {
         ...
         if(param1.critical && !this._crashed)
         {
            ...
            if(this.var_161)
            {
               if(this.var_161.keyExists("client.fatal.error.url"))
               {
                  ...
                  _loc8_ = "";
                  for each(_loc9_ in this.var_1654)
                  {
                  ...
                  if(this.var_301 != null)
                  {
                     _loc4_["null"] = this.var_301.flashVersion;
                     _loc4_["null"] = this.var_301.averageUpdateInterval;
                  }
      ...
      {
         this.trackLoginStep(HabboLoginTrackingStep.const_1239);
         if(context && false)
         {
            context.root.events.removeEventListener(HabboLoginTrackingStep.const_1239,this.onCoreRunning);
         }
      }
      ...
      private function onNavigatorReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this._navigator.events.addEventListener(HabboNavigatorEvent.const_357,this.onZoomToggle);
      }
      ...
      private function onFriendlistReady(param1:IID, param2:IUnknown) : void
      {
         ...
         Component(this.var_230).events.addEventListener(HabboFriendListTrackingEvent.const_516,this.onFriendlistTrackingEvent);
      }
      ...
      private function onFriendlistTrackingEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            ...
            case HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST:
               ...
               break;
            case HabboFriendListTrackingEvent.const_516:
      ...
      {
         this.var_208 = param2 as IHabboHelp;
         this.var_208.events.addEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_CLOSED,this.onHelpTrackingEvent);
         this.var_208.events.addEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_DEFAULT,this.onHelpTrackingEvent);
      }
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         ...
         {
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1378,String(_loc2_.guestRoomId));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_790,String(true));
      ...
      private function onRoomEngineReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(this._roomEngine).events.addEventListener(RoomObjectRoomAdEvent.const_230,this.onRoomAdClick);
         Component(this._roomEngine).events.addEventListener(RoomEngineEvent.const_191,this.onRoomAction);
         Component(this._roomEngine).events.addEventListener(RoomEngineEvent.const_369,this.onRoomAction);
      }
      
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         this.var_325 = param2 as IAdManager;
         this.var_325.events.addEventListener(AdEvent.const_503,this.onRoomAdLoad);
      }
      ...
      private function onRoomAction(param1:RoomEngineEvent) : void
      {
         if(param1.type == RoomEngineEvent.const_191)
         {
            if(this.var_2129 < 1)
            {
               if(!this.var_341)
               {
                  this.var_341 = new Timer(60000,1);
                  this.var_341.addEventListener(TimerEvent.TIMER,this.onRoomActionTimerEvent);
                  this.var_341.start();
               }
            }
         }
         else if(param1.type == RoomEngineEvent.const_369)
         {
            if(this.var_341)
            {
               this.var_341.removeEventListener(TimerEvent.TIMER,this.onRoomActionTimerEvent);
      ...
      {
         this.var_729.chatLagDetected(param1);
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         {
            ++this.var_2130;
            ErrorReportStorage.addDebugData("Invalid time counter","Invalid times: " + this.var_2130);
         }
         if(this.var_593 > -1 && _loc2_ - this.var_593 > 15000)
         {
            ++this.var_2128;
            ErrorReportStorage.addDebugData("Time leap counter","Time leaps: " + this.var_2128);
         }
         this.var_593 = _loc2_;
         if(this.var_301 != null)
         {
            this.var_301.update(param1,this.var_593);
         }
         if(this.var_300 != null)
         {
         ...
         if(this.var_495 != null)
         {
            this.var_495.trackUpdate(param1,this,this.var_593);
         }
         if(this.var_729 != null)
         {
            this.var_729.update(this.var_593);
         }
      }
   }
}
