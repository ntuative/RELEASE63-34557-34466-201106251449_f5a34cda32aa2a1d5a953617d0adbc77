package com.sulake.habbo.tracking
{
   ...
   public class LatencyTracker
   {
      ...
      public function init() : void
      {
         ...
         this.var_1903 = int(this.var_161.getKey("latencytest.interval"));
         this.var_1906 = int(this.var_161.getKey("latencytest.report.index"));
         this.var_2576 = int(this.var_161.getKey("latencytest.report.delta"));
      ...
      public function update(param1:uint, param2:int) : void
      {
         ...
         if(param2 - this.var_1904 > this.var_1903)
         {
            this.testLatency();
         }
      }
      ...
      private function testLatency() : void
      {
         ...
         this.var_663.add(this.var_1540,this.var_1904);
         this._connection.send(new LatencyPingRequestMessageComposer(this.var_1540));
         ++this.var_1540;
      }
      ...
      private function onPingResponse(param1:IMessageEvent) : void
      {
         ...
         if(this.var_247.length == this.var_1906 && this.var_1906 > 0)
         {
            _loc5_ = 0;
            _loc6_ = 0;
            _loc7_ = 0;
            ...
            if(Math.abs(_loc9_ - this.var_1905) > this.var_2576 || this.var_1905 == 0)
            {
               this.var_1905 = _loc9_;
