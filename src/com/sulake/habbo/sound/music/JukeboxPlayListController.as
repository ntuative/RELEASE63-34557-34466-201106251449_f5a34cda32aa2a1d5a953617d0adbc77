package com.sulake.habbo.sound.music
{
   ...
   public class JukeboxPlayListController implements IPlayListController
   {
      ...
      public function JukeboxPlayListController(param1:HabboSoundManagerFlash10, param2:HabboMusicController, param3:IEventDispatcher, param4:IConnection)
      {
         ...
         this.var_829 = [];
         this.var_829.push(new NowPlayingMessageEvent(this.onNowPlayingMessage));
         this.var_829.push(new JukeboxSongDisksMessageEvent(this.onJukeboxSongDisksMessage));
         this.var_829.push(new JukeboxPlayListFullMessageEvent(this.onJukeboxPlayListFullMessage));
      ...
      private function onNowPlayingMessage(param1:IMessageEvent) : void
      {
         ...
         this.var_683 = _loc3_.currentSongId != -1;
         if(_loc3_.currentSongId >= 0)
         {
            this.var_254.playSong(_loc3_.currentSongId,HabboMusicPrioritiesEnum.const_126,_loc3_.syncCount / 1000,0,1,1);
         ...
         this.var_1983 = _loc3_.currentPosition;
         this._soundManager.events.dispatchEvent(new NowPlayingEvent(NowPlayingEvent.const_103,HabboMusicPrioritiesEnum.const_126,_loc3_.currentSongId,_loc3_.currentPosition));
      }
      ...
      private function onJukeboxPlayListFullMessage(param1:IMessageEvent) : void
      {
         ...
         this._events.dispatchEvent(new PlayListStatusEvent(PlayListStatusEvent.const_174));
      }
