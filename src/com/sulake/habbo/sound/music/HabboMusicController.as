package com.sulake.habbo.sound.music
{
   ...
   public class HabboMusicController implements IHabboMusicController, IDisposable
   {
      ...
      private static const const_1508:int = HabboMusicPrioritiesEnum.const_126;
      ...
      public function HabboMusicController(param1:HabboSoundManagerFlash10, param2:IEventDispatcher, param3:IEventDispatcher, param4:IConnection)
      {
         ...
         this.var_829.push(new TraxSongInfoMessageEvent(this.onSongInfoMessage));
         this.var_829.push(new UserSongDisksInventoryMessageEvent(this.onSongDiskInventoryMessage));
         for each(_loc5_ in this.var_829)
         {
            this._connection.addMessageEvent(_loc5_);
         }
         this.var_92.addEventListener(RoomEngineSoundMachineEvent.const_831,this.onJukeboxInit);
         this.var_92.addEventListener(RoomEngineSoundMachineEvent.const_301,this.onJukeboxDispose);
         this.var_92.addEventListener(RoomEngineSoundMachineEvent.const_741,this.onSoundMachineInit);
         this.var_92.addEventListener(RoomEngineSoundMachineEvent.const_791,this.onSoundMachineDispose);
         this.var_1222 = new Timer(1000);
         this.var_1222.start();
         this.var_1222.addEventListener(TimerEvent.TIMER,this.sendNextSongRequestMessage);
      ...
      protected function onSongFinishedPlayingEvent(param1:SoundCompleteEvent) : void
      {
         ...
         {
            if(this.getTopRequestPriority() == this._priorityPlaying && this.getSongRequestCountAtPriority(this._priorityPlaying) == this.var_1852)
            {
               this.resetSongStartRequest(this._priorityPlaying);
            }
            _loc2_ = this._priorityPlaying;
            this.playSongWithHighestPriority();
            if(_loc2_ >= HabboMusicPrioritiesEnum.const_444)
            {
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            ...
            if(this._connection)
            {
               for each(_loc1_ in this.var_829)
               {
            ...
            if(this.var_92)
            {
               this.var_92.removeEventListener(RoomEngineSoundMachineEvent.const_831,this.onJukeboxInit);
               this.var_92.removeEventListener(RoomEngineSoundMachineEvent.const_301,this.onJukeboxDispose);
               this.var_92.removeEventListener(RoomEngineSoundMachineEvent.const_741,this.onSoundMachineInit);
               this.var_92.removeEventListener(RoomEngineSoundMachineEvent.const_791,this.onSoundMachineDispose);
            }
      ...
      private function getSongIdRequestedAtPriority(param1:int) : int
      {
         ...
         var _loc2_:SongStartRequestData = this.var_323[param1];
      ...
      {
         var _loc1_:int = this.var_323.length - 1;
         while(_loc1_ >= 0)
         {
            if(this.var_323[_loc1_] != null)
            {
               return _loc1_;
            }
            _loc1_--;
      ...
      private function requestSong(param1:int, param2:Boolean) : void
      {
         ...
         {
            this.var_644.add(param1,param2);
      ...
      {
         if(param1 >= 0 && param1 < this.var_382.length)
         {
            return this.var_382.getKey(param1);
         }
         return -1;
      }
      ...
      public function getSongDiskInventorySongId(param1:int) : int
      {
         if(param1 >= 0 && param1 < this.var_382.length)
         {
            return this.var_382.getWithIndex(param1);
         }
         return -1;
      }
      ...
      public function samplesUnloaded(param1:Array) : void
      {
         ...
         while(_loc2_ < this.var_275.length)
         {
            ...
            if(_loc3_.id != this.var_1510 && _loc4_ != null && _loc4_.ready)
            {
      ...
      public function get samplesIdsInUse() : Array
      {
         ...
         {
            if(this.var_323[_loc2_] != null)
            {
               _loc3_ = this.var_323[_loc2_];
      ...
      private function playSongObject(param1:int, param2:int) : Boolean
      {
         ...
         this.var_1852 = this.getSongRequestCountAtPriority(param1);
         this.var_1510 = param2;
         if(this._priorityPlaying <= const_1508)
         {
      ...
      private function notifySongPlaying(param1:SongDataEntry) : void
      {
         ...
         if(param1.length >= 8000 && (this.var_2487 != param1.id || _loc3_ > this.var_2488 + 8000))
         {
            this._soundManager.notifyPlayedSong(param1.name,param1.creator);
            this.var_2487 = param1.id;
      ...
      private function onSongDiskInventoryMessage(param1:IMessageEvent) : void
      {
         ...
         while(_loc4_ < _loc3_.songDiskCount)
         {
            ...
            this.var_382.add(_loc5_,_loc6_);
      ...
      private function onSoundMachineInit(param1:Event) : void
      {
         ...
         this.var_541 = new SoundMachinePlayListController(this._soundManager,this,this._events,this.var_92,this._connection) as IPlayListController;
      }
