package com.sulake.habbo.sound.music
{
   ...
   public class SoundMachinePlayListController implements IPlayListController
   {
      ...
      public function SoundMachinePlayListController(param1:HabboSoundManagerFlash10, param2:HabboMusicController, param3:IEventDispatcher, param4:IEventDispatcher, param5:IConnection)
      {
         ...
         this.var_254 = param2;
         this.var_829 = [];
         this.var_829.push(new PlayListMessageEvent(this.onPlayListMessage));
         this.var_829.push(new PlayListSongAddedMessageEvent(this.onPlayListSongAddedMessage));
         for each(_loc6_ in this.var_829)
         {
         ...
         this.var_92.addEventListener(RoomEngineSoundMachineEvent.const_1021,this.onSoundMachinePlayEvent);
         this.var_92.addEventListener(RoomEngineSoundMachineEvent.const_764,this.onSoundMachineStopEvent);
      }
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            ...
            if(this.var_92)
            {
               this.var_92.removeEventListener(RoomEngineSoundMachineEvent.const_1021,this.onSoundMachinePlayEvent);
               this.var_92.removeEventListener(RoomEngineSoundMachineEvent.const_764,this.onSoundMachineStopEvent);
               this.var_92 = null;
            }
            this._disposed = true;
         }
      ...
      public function stopPlaying() : void
      {
         this.var_468 = -1;
         this.var_683 = false;
         this.var_254.stop(HabboMusicPrioritiesEnum.const_126);
      }
      ...
      private function playCurrentSongAndNotify(param1:int) : void
      {
         ...
         if(this.var_254.playSong(param1,HabboMusicPrioritiesEnum.const_126,_loc3_,0,0,0))
         {
