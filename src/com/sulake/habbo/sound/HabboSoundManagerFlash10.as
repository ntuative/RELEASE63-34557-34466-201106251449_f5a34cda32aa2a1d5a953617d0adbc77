package com.sulake.habbo.sound
{
   ...
   public class HabboSoundManagerFlash10 extends Component implements IHabboSoundManager, IUpdateReceiver
   {
      ...
      private static const const_1536:int = 60;
      
      private static const const_1535:int = 25165823;
      
      private static const const_1534:int = 16777215;
      ...
      public function HabboSoundManagerFlash10(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null, param4:Boolean = true)
      {
         ...
         this.var_1235 = new Map();
         this.var_1528 = new ByteArray();
         ...
         events.addEventListener(TraxSongLoadEvent.const_758,this.onTraxLoadComplete);
         ...
         if(_loc2_ == null)
         {
            ...
            switch(param1)
            {
               case HabboSoundTypesEnum.const_1357:
                  ...
                  break;
               case HabboSoundTypesEnum.const_2025:
               ...
               case HabboSoundTypesEnum.const_1208:
                  ...
                  break;
               case HabboSoundTypesEnum.const_1388:
                  _loc3_ = "sound_catalogue_cash";
                  break;
               case HabboSoundTypesEnum.const_1981:
      ...
      private function loadSample(param1:int) : void
      {
         ...
         _loc4_.load(_loc3_);
         this.var_653.add(_loc4_,param1);
      }
      ...
      private function addTraxSongForDownload(param1:int, param2:String) : IHabboSound
      {
         ...
         if(!_loc3_.ready)
         {
            this.var_1235.add(param1,_loc3_);
         }
         return _loc3_;
      }
      ...
      public function notifyPlayedSong(param1:String, param2:String) : void
      {
         ...
         this.var_1014.addSongPlayingNotification(param1,param2);
      }
      ...
      private function onNotificationsReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1014 = IHabboNotifications(param2);
      }
      ...
      {
         if(this.var_161 == null || this._connection == null || this._roomEngine == null || this.var_254 != null)
         {
            return;
         }
      ...
      {
         events.dispatchEvent(new TraxSongLoadEvent(TraxSongLoadEvent.const_1735,this.var_822));
         this.var_822 = -1;
         this.var_821 = null;
      }
      ...
      private function storeVolumeSetting() : void
      {
         ...
         {
            this._connection.send(new SetSoundSettingsComposer(int(this.var_1003 * 100)));
         }
      }
      ...
      private function updateVolumeSetting(param1:Number) : void
      {
         ...
         this.var_254.updateVolume(this.var_1003);
      }
      ...
      private function processLoadedSample(param1:Sound) : void
      {
         ...
         var _loc4_:* = null;
         if(this.var_653.getValue(param1) != null)
         {
            _loc2_ = this.var_653.remove(param1);
            if(this.var_276.getValue(_loc2_) == null)
            {
               this.var_1528.clear();
               _loc3_ = param1.length;
               param1.extract(this.var_1528,int(_loc3_ * 44.1));
               _loc4_ = new TraxSample(this.var_1528,_loc2_,TraxSample.const_2008,TraxSample.const_2032);
      ...
      private function processLoadedSamples() : void
      {
         ...
         var _loc3_:* = null;
         var _loc4_:int = 0;
         if(this.var_1236.length > 0)
         {
            _loc1_ = getTimer();
            _loc2_ = _loc1_;
            while(_loc2_ - _loc1_ < const_1536 && this.var_1236.length > 0)
            {
               _loc3_ = this.var_1236.splice(0,1)[0];
               this.processLoadedSample(_loc3_);
               _loc2_ = getTimer();
            }
            if(this.var_653.length == 0 && this.var_822 != -1)
            {
               this.var_821.ready = true;
               _loc4_ = this.var_822;
               this.var_822 = -1;
               this.var_821 = null;
               events.dispatchEvent(new TraxSongLoadEvent(TraxSongLoadEvent.const_758,_loc4_));
               if(this.var_2546)
               {
      ...
      private function loadNextSong() : void
      {
         var _loc1_:int = 0;
         var _loc2_:* = null;
         if(this.var_821 == null && this.var_1235.length > 0)
         {
            _loc1_ = this.var_1235.getKey(0);
            _loc2_ = this.var_1235.remove(_loc1_);
            if(_loc2_ != null && !_loc2_.disposed)
            {
               this.validateSampleAvailability(_loc2_,true);
               if(_loc2_.ready)
               {
                  events.dispatchEvent(new TraxSongLoadEvent(TraxSongLoadEvent.const_758,_loc1_));
               }
               else
               {
                  this.var_821 = _loc2_;
      ...
      private function processSampleMemoryUsage() : void
      {
         ...
         if(_loc1_ > const_1535)
         {
            ...
            _loc8_ = 0;
            _loc9_ = 0;
            while(_loc8_ < _loc1_ - const_1534 && _loc9_ < _loc2_.length)
            {
