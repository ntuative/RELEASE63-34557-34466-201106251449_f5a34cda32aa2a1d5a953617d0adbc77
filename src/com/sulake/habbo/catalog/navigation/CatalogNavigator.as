package com.sulake.habbo.catalog.navigation
{
   ...
   public class CatalogNavigator implements ICatalogNavigator
   {
      ...
      private var var_3103:String = "magic.credits";
      
      private var var_3069:String = "magic.pixels";
      
      private var var_3070:String = "catalog.page.club";
      ...
      public function CatalogNavigator(param1:IHabboCatalog, param2:IWindowContainer)
      {
         ...
         if(this._scrollBar != null)
         {
            ...
            this._scrollBar.addEventListener(WindowEvent.const_933,this.activateScrollbar);
            this._scrollBar.addEventListener(WindowEvent.const_283,this.activateScrollbar);
            this._scrollBar.addEventListener(WindowEvent.const_992,this.deActivateScrollbar);
            this._scrollBar.addEventListener(WindowEvent.const_306,this.deActivateScrollbar);
         }
      }
      ...
      {
         this.openPage(this.var_3069);
      }
      
      private function openClubPage() : void
      {
         this._catalog.openCatalogPage(this.var_3070,true);
      }
