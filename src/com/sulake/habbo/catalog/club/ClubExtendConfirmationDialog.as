package com.sulake.habbo.catalog.club
{
   ...
   public class ClubExtendConfirmationDialog
   {
      ...
      private static const const_387:int = 7;
      
      private static const const_1480:String = "your_price_icon";
      
      private static const const_1479:String = "http://images.habbo.com/c_images/catalogue/vip_extend_tsr.png";
      
      private static const const_1482:String = "image/png";
      
      private static const const_1481:int = 2000;
      
      private static const const_1483:int = 75;
      
      protected static const const_2047:uint = 0;
      ...
      private var var_630:IRegionWindow;
      
      private var var_629:ITextWindow;
      
      private var var_377:IBitmapWrapperWindow;
      
      private var var_632:Vector.<BitmapData>;
      ...
      public function ClubExtendConfirmationDialog(param1:ClubExtendController, param2:ClubOfferExtendData)
      {
         ...
         this.var_27 = param1;
         this.var_103 = param2;
         this.var_632 = new Vector.<BitmapData>(const_387);
      }
      ...
      public function dispose() : void
      {
         ...
         if(this.var_630)
         {
            this.var_630.removeEventListener(WindowMouseEvent.const_25,this.onMouseOutLaterRegion);
            this.var_630.removeEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER,this.onMouseOverLaterRegion);
            this.var_630 = null;
         }
         if(this.var_629)
         {
         ...
         if(this.var_632)
         {
            while(_loc1_ < const_387)
            {
               this.var_632[_loc1_].dispose();
               this.var_632[_loc1_] = null;
               _loc1_++;
            }
            this.var_632 = null;
         }
      ...
      public function showConfirmation() : void
      {
         ...
         {
            _loc1_.registerParameter("catalog.club.extend.expiration_days_left","day",this.var_103.subscriptionDaysLeft.toString());
         ...
         this.var_630 = this._view.findChildByName("maybe_later_region") as IRegionWindow;
         this.var_629 = this._view.findChildByName("maybe_later_link") as ITextWindow;
         if(!this.var_630 || !this.var_629)
         {
            return;
         }
         this.var_630.addEventListener(WindowMouseEvent.const_25,this.onMouseOutLaterRegion);
         this.var_630.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER,this.onMouseOverLaterRegion);
         ...
         _loc4_.height = 144;
         _loc4_.width = 133;
         this.loadAssetFromUrl("club_teaser","club_teaser",const_1479,const_1482,this.onTeaserLoaded);
      ...
      private function onMouseOutLaterRegion(param1:WindowMouseEvent) : void
      {
         if(this.var_629)
         {
            this.var_629.textColor = const_2047;
         }
      }
      ...
      private function onMouseOverLaterRegion(param1:WindowMouseEvent) : void
      {
         if(this.var_629)
         {
            this.var_629.textColor = LINK_COLOR_HOVER;
         }
      }
      ...
      private function startAnimation() : void
      {
         ...
         this.var_791 = new Timer(const_1481);
         this.var_791.addEventListener(TimerEvent.TIMER,this.onAnimationTrigger);
         this.var_791.start();
      }
      ...
      private function setAnimationFrame() : void
      {
         ...
         if(this.var_377.bitmap)
         {
            this.var_377.bitmap.dispose();
         }
         if(this.var_631 < const_387)
         {
            this.var_377.bitmap = new BitmapData(this.var_377.width,this.var_377.height,true,0);
            this.var_377.bitmap.copyPixels(this.var_632[this.var_631],this.var_632[this.var_631].rect,new Point(0,0));
         }
         else
         {
            Logger.log("Animation frame " + this.var_631);
         }
      }
      
      private function startAnimationFrame() : void
      {
         this.var_440 = new Timer(const_1483,const_387 - 1);
         this.var_440.addEventListener(TimerEvent.TIMER,this.onAnimationFrame);
         this.var_440.addEventListener(TimerEvent.TIMER_COMPLETE,this.onAnimationFrameComplete);
         this.var_440.start();
      }
