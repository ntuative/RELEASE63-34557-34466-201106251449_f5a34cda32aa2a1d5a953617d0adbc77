package com.sulake.habbo.catalog
{
   ...
   public class HabboCatalog extends Component implements IHabboCatalog, IProductDataListener, IUpdateReceiver
   {
      ...
      private var var_1121:IAvatarRenderManager;
      ...
      private var var_232:CatalogViewer;
      ...
      private var var_2985:GiftWrappingConfiguration;
      
      private var var_1391:ClubGiftController;
      
      private var var_598:ClubBuyController;
      
      private var var_737:ClubExtendController;
      
      private var var_910:Map;
      
      private var var_1392:Boolean = false;
      
      private var var_909:IPurchasableOffer;
      
      private var var_1679:IDragAndDropDoneReceiver;
      ...
      private var var_738:RoomPreviewer;
      
      private const const_2067:Point = new Point(100,20);
      ...
      public function HabboCatalog(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         queueInterface(new IIDHabboFriendList(),this.method_7);
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_1121)
         {
            this.var_1121.release(new IIDAvatarRenderManager());
            this.var_1121 = null;
         }
         if(this.var_161)
         {
      ...
      private function reset(param1:Boolean = false) : void
      {
         ...
         if(!param1)
         {
            ...
            {
               Core.crash("Could not reload product data after reset() because _sessionDataManager was null",Core.const_1979);
               return;
            }
            events.dispatchEvent(new CatalogEvent(CatalogEvent.CATALOG_NOT_READY));
            _loc2_ = this.var_417.loadProductData(this);
            if(_loc2_)
            {
               this.init();
            }
      ...
      public function showPurchaseConfirmation(param1:IPurchasableOffer, param2:int, param3:String = "", param4:Boolean = true) : void
      {
         ...
         {
            this.var_598.showConfirmation(param1 as ClubBuyOfferData,param2);
         }
      }
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_2983 = this.isNewItemsNotificationEnabled();
      ...
      private function sessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_417.loadProductData(this);
      }
      ...
      private function onRoomEngineReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this._roomEngine.events.addEventListener(RoomEngineObjectEvent.const_179,this.onObjectPlaced);
         this.initializeRoomPreviewer();
      }
      ...
      {
         if(this._roomEngine != null && this.var_161 != null && this.var_161.getKey("catalog.furniture.animation","false") == "CanCreateRoomEvent")
         {
            if(this.var_738 == null)
            {
               this.var_738 = new RoomPreviewer(this._roomEngine);
            }
         }
      }
      ...
      public function openCreditsHabblet() : void
      {
         ...
         var _loc1_:* = this.var_161.getKey("client.credits.embed.enabled","false") == "CanCreateRoomEvent";
         if(false && _loc1_)
         {
      ...
      {
         return this.var_417.getProductData(param1);
      }
      ...
      public function getFurnitureData(param1:int, param2:String) : IFurnitureData
      {
         ...
         {
            _loc3_ = this.var_417.getFloorItemData(param1);
         }
         if(param2 == ProductTypeEnum.const_63)
         {
            _loc3_ = this.var_417.getWallItemData(param1);
         }
         return _loc3_;
      }
      ...
      {
         var _loc2_:Array = this.var_910.getValue(param1);
         if(_loc2_ != null)
         {
            return _loc2_.slice();
         }
      ...
      private function getCurrentLayoutCode() : String
      {
         ...
         return this.var_232.getCurrentLayoutCode();
      }
      ...
      private function createCatalogViewer() : void
      {
         ...
         this.var_232 = new CatalogViewer(this,_loc1_,this._roomEngine);
         this.var_232.habboCatalog = this;
      }
      ...
      private function createMainWindow() : void
      {
         ...
         this._mainContainer.position = this.const_2067;
         this.hideMainWindow();
         ...
         _loc3_.setParamFlag(WindowParam.const_308,false);
      ...
      private function onRoomSessionEvent(param1:RoomSessionEvent) : void
      {
         switch(param1.type)
         {
            case RoomSessionEvent.const_73:
               this.var_2166 = param1.session.isPrivateRoom;
      ...
      private function createClubGiftController() : void
      {
         ...
         {
            this.var_1391 = new ClubGiftController(this);
         }
      }
      ...
      private function createClubBuyController() : void
      {
         if(this.var_598 == null)
         {
            this.var_598 = new ClubBuyController(this);
         }
      }
      ...
      private function createClubExtendController() : void
      {
         if(this.var_737 == null)
         {
            this.var_737 = new ClubExtendController(this);
         }
      }
      ...
      private function onWindowClose(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(this.var_232 != null)
         {
            this.var_232.catalogWindowClosed();
         }
         if(this.var_106 != null && this.getCurrentLayoutCode() == "recycler")
         {
            this.var_106.cancel();
      ...
      private function onCatalogIndex(param1:IMessageEvent) : void
      {
         ...
         this.var_1678 = (param1 as CatalogIndexMessageEvent).newAdditionsAvailable;
         this.var_349.buildCatalogIndex(_loc2_);
         if(this.var_911 && this.var_911 != "")
         {
            this.var_349.openPage(this.var_911);
            this.var_911 = "";
            this.var_1124 = -1;
         }
         else if(this.var_1124 > -1)
         {
            this.var_349.openPageById(this.var_1124,this.var_2167);
            this.var_1124 = -1;
            this.var_2167 = -1;
            this.var_911 = "";
         }
         else if(this.var_1678 && this.var_2983)
         {
            events.dispatchEvent(new CatalogEvent(CatalogEvent.CATALOG_NEW_ITEMS_SHOW));
            this.var_349.loadNewAdditionsPage(this.getLocalizedPageName(CatalogPageName.const_1937));
         }
         else
         {
            this.var_349.loadFrontPage();
         }
      }
      ...
      private function onCatalogPage(param1:IMessageEvent) : void
      {
         ...
         this.var_232.showCatalogPage(_loc4_,_loc5_,_loc8_,_loc3_.offers,_loc9_);
      }
      ...
      {
         if(param1 == null || this.var_232 == null)
         {
            return;
         }
         var _loc2_:ApproveNameMessageParser = param1.getParser();
         this.var_232.dispatchWidgetEvent(new CatalogWidgetApproveNameResultEvent(_loc2_.result,_loc2_.nameValidationInfo));
      }
      ...
      private function onCreditBalance(param1:IMessageEvent) : void
      {
         ...
         this.updatePurse();
         if(!this.var_2986 && this._soundManager != null)
         {
            this._soundManager.playSound(HabboSoundTypesEnum.const_1388);
         }
         this.var_2986 = false;
         ...
         events.dispatchEvent(new PurseEvent(PurseEvent.const_116,this.var_115.credits));
      ...
      private function onActivityPointNotification(param1:IMessageEvent) : void
      {
         ...
         this.updatePurse();
         if(!this.var_2984 && this._soundManager != null)
         {
         ...
         {
            events.dispatchEvent(new PurseEvent(PurseEvent.const_266,_loc2_.amount));
         }
         if(_loc2_.type == ActivityPointTypeEnum.const_1002)
         {
            events.dispatchEvent(new PurseEvent(PurseEvent.const_303,_loc2_.amount));
         }
         events.dispatchEvent(new PurseUpdateEvent());
      }
      ...
      private function onActivityPoints(param1:IMessageEvent) : void
      {
         ...
         {
            events.dispatchEvent(new PurseEvent(PurseEvent.const_266,_loc2_.points["null"]));
         }
         if(_loc2_.points["null"] != null)
         {
            events.dispatchEvent(new PurseEvent(PurseEvent.const_303,_loc2_.points["null"]));
         }
         events.dispatchEvent(new PurseUpdateEvent());
      }
      ...
      private function onSubscriptionInfo(param1:IMessageEvent) : void
      {
         ...
         this.var_115.isExpiring = _loc2_.responseType == ScrSendUserInfoMessageParser.const_1402 ? true : false;
         this.updatePurse();
      ...
      private function onClubGiftInfo(param1:ClubGiftInfoEvent) : void
      {
         ...
         this.var_1391.setInfo(_loc2_.daysUntilNextGift,_loc2_.giftsAvailable,_loc2_.offers,_loc2_.giftData);
      }
      ...
      private function onGiftWrappingConfiguration(param1:GiftWrappingConfigurationEvent) : void
      {
         ...
         this.var_2985 = new GiftWrappingConfiguration(param1);
      }
      ...
      private function onHabboClubOffers(param1:HabboClubOffersMessageEvent) : void
      {
         if(this.var_598 != null)
         {
            this.var_598.onOffers(param1);
         }
      }
      
      private function onHabboClubExtendOffer(param1:HabboClubExtendOfferMessageEvent) : void
      {
         if(this.var_737 != null && this.var_161.getBoolean("club.membership.extend.promotion.enabled",false))
         {
            this.var_737.onOffer(param1);
         }
      }
      ...
      private function onSellableBreeds(param1:SellablePetBreedsMessageEvent) : void
      {
         ...
         this.var_910.remove(_loc2_.productCode);
         var _loc3_:Array = _loc2_.sellableBreeds;
         if(_loc3_ != null)
         {
            this.var_910.add(_loc2_.productCode,_loc3_.slice());
            this.var_232.dispatchWidgetEvent(new CatalogWidgetSellablePetBreedsEvent(_loc2_.productCode,_loc3_.slice()));
         }
      }
      ...
      private function noCreditsConfirmDialogEventProcessor(param1:IConfirmDialog, param2:WindowEvent) : void
      {
         ...
         {
            if(false && "CanCreateRoomEvent" == this.var_161.getKey("client.credits.embed.enabled"))
            {
               ExternalInterface.call("FlashExternalInterface.openHabblet","credits");
            }
            else
      ...
      {
         if(!this.var_161.keyExists("catalog.drag_and_drop") || this.var_161.getKey("catalog.drag_and_drop") != "CanCreateRoomEvent")
         {
            return false;
         }
         ...
         {
            case ProductTypeEnum.const_188:
               _loc3_ = false;
               break;
      ...
      {
         var _loc3_:String = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_224);
         ...
         var _loc5_:String = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_220);
      ...
      private function onObjectPlaced(param1:RoomEngineObjectPlacedEvent) : void
      {
         ...
         var _loc5_:* = null;
         var _loc6_:* = null;
         if(this.var_1392 && param1.type == RoomEngineObjectEvent.const_179)
         {
            this.resetPlacedOfferData(true);
            if(this.var_909 == null || this.var_909.disposed)
            {
               this.resetObjectMover();
               return;
            }
            _loc2_ = param1.category;
            _loc3_ = this.var_909.productContainer.firstProduct;
            _loc4_ = false;
            ...
            this.var_67 = new PlacedObjectPurchaseData(param1.roomId,param1.roomCategory,param1.objectId,param1.category,param1.wallLocation,param1.x,param1.y,param1.direction,this.var_909);
            _loc5_ = this.var_1679;
            if(_loc5_ != null)
            {
            ...
            if(this.var_67.roomCategory == this._roomEngine.activeRoomCategory && this.var_67.roomId == this._roomEngine.activeRoomId)
            {
               ...
               switch(param1.category)
               {
                  ...
                  case FurniCategory.const_352:
                     _loc9_ = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_224);
                  ...
                  case FurniCategory.const_356:
                     _loc10_ = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_220);
      ...
      public function update(param1:uint) : void
      {
         if(this.var_738 != null)
         {
            this.var_738.updatePreviewRoomView();
         }
      }
   }
}
