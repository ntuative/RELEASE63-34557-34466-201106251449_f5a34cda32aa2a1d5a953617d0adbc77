package com.sulake.habbo.catalog.recycler
{
   ...
   public class RecyclerLogic implements IRecycler
   {
      ...
      {
         return this.var_727 != const_1151;
      }
      
      private function get systemActive() : Boolean
      {
         return this.var_2121 != RecyclerStatusMessageEvent.const_1322;
      }
      
      private function get ready() : Boolean
      {
         return this.active && this.var_727 == const_487;
      }
      ...
      {
         this.var_727 = const_1152;
         this.var_134 = new Array(const_237);
         if(param1 == null)
         {
            return;
         }
      ...
      public function cancel() : void
      {
         ...
         var _loc1_:int = 0;
         while(_loc1_ < const_237)
         {
            this.releaseSlot(_loc1_);
            _loc1_++;
         }
         this.var_727 = const_1151;
      }
      ...
      public function setSystemStatus(param1:int, param2:int) : void
      {
         ...
         switch(this.var_2121)
         {
            case RecyclerStatusMessageEvent.const_1787:
               this.var_727 = const_487;
               ...
               this.updateRecyclerButton();
               break;
            case RecyclerStatusMessageEvent.const_1322:
               if(this._view == null || this._view.disposed)
               {
                  return;
               }
               ...
               this._catalog.setupInventoryForRecycler(false);
               break;
            case RecyclerStatusMessageEvent.const_1874:
               if(this._view == null || this._view.disposed)
               {
                  return;
               }
      ...
      public function setFinished(param1:int, param2:int) : void
      {
         ...
         switch(status)
         {
            case RecyclerFinishedMessageEvent.const_1294:
               if(this._view != null)
               {
                  this._view.displayFinishedView();
               }
               break;
            case RecyclerFinishedMessageEvent.const_2015:
      ...
      public function placeObjectAtSlot(param1:int, param2:int, param3:int, param4:int, param5:String) : void
      {
         ...
         if(this.var_134.length > 0)
         {
            ...
            newSlotId = 0;
            while(oldObjectData != null && newSlotId < const_237)
            {
      ...
      private function isPoolFull() : Boolean
      {
         ...
         if(this.var_134.length < const_237)
         {
            return false;
         }
         var _loc1_:int = 0;
