package com.sulake.habbo.catalog.purchase
{
   ...
   public class PurchaseConfirmationDialog implements IGetImageListener, IDisposable
   {
      ...
      private const const_2083:uint = 4.293848814E9;
      
      private const const_2084:uint = 4.294967295E9;
      
      private const const_1681:uint = 4.291613146E9;
      ...
      private function showGiftDialog() : void
      {
         ...
         if(_loc6_ != null)
         {
            ...
            _loc6_.addEventListener(WindowKeyboardEvent.const_354,this.onNameInputKeyUp);
         }
         ...
         if(_loc7_ != null)
         {
            ...
            _loc7_.addEventListener(WindowEvent.const_367,this.onMessageInputFocus);
         }
         this.var_2107 = true;
         this.var_2106 = true;
         if(_loc1_.isEnabled)
         {
            ...
            if(_loc12_ != null)
            {
               _loc12_.addEventListener(WindowEvent.const_372,this.onFreeWrappingSelected);
               _loc12_.addEventListener(WindowEvent.const_633,this.onFreeWrappingUnSelect);
            }
            ...
            this.var_1912 = _loc1_.stuffTypes;
            this.var_891 = _loc1_.boxTypes;
            this.var_893 = _loc1_.ribbonTypes;
            this.var_1361 = this.var_1912[0];
            this.var_409 = this.var_891[0];
            this.var_411 = this.var_893[0];
            this.initColorGrid();
      ...
      private function updatePreview() : void
      {
         if(this.var_411 < 0)
         {
            this.var_411 = this.var_893.length - 1;
         }
         if(this.var_411 > this.var_893.length - 1)
         {
            this.var_411 = 0;
         }
         if(this.var_409 < 0)
         {
            this.var_409 = this.var_891.length - 1;
         }
         if(this.var_409 > this.var_891.length - 1)
         {
            this.var_409 = 0;
         }
         var _loc1_:int = this.var_891[this.var_409] * 1000 + this.var_893[this.var_411];
         if(this._window == null)
         {
            return;
         }
         ...
         var _loc2_:ImageResult = this._roomEngine.getFurnitureImage(this.var_1361,new Vector3d(180),64,this,0,_loc1_.toString());
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function initColorGrid() : void
      {
         ...
         for each(_loc3_ in this.var_1912)
         {
      ...
      private function giveGift() : void
      {
         ...
         var _loc7_:int = !!_loc6_ ? 0 : int(this.var_1361);
         var _loc8_:int = !!_loc6_ ? 0 : int(this.var_891[this.var_409]);
         var _loc9_:int = !!_loc6_ ? 0 : int(this.var_893[this.var_411]);
         this._catalog.purchaseProductAsGift(this.var_1649,this.var_1360,this.var_1650,_loc2_,_loc4_,_loc7_,_loc8_,_loc9_);
      }
      
      private function onBuyButtonClick(param1:WindowEvent) : void
      {
         this._catalog.purchaseProduct(this.var_1649,this.var_1360,this.var_1650);
         this.dispose();
      }
      ...
      private function updateSuggestions(param1:Array) : void
      {
         ...
         if(this.var_892 == null)
         {
            this.var_892 = this.createWindow("suggestion_list_item") as IWindowContainer;
         }
         if(this.var_297 == null || this.var_892 == null)
         {
            return;
         }
         ...
         {
            _loc5_ = this.var_892.clone() as IWindowContainer;
            if(_loc5_ != null)
            {
      ...
      private function highlightSuggestion(param1:int) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.color = this.const_1681;
         }
      }
      
      private function getColor(param1:int) : uint
      {
         return param1 % 2 == 0 ? uint(this.const_2083) : uint(this.const_2084);
      }
      ...
      {
         this.var_1361 = param1.target.id;
         this.updateColorGrid();
         this.updatePreview();
      }
      ...
      private function updateColorGrid() : void
      {
         ...
         while(_loc4_ < _loc1_.numGridItems)
         {
            ...
            if(_loc2_ != null)
            {
               ...
               if(_loc3_ != null)
               {
                  _loc3_.visible = _loc2_.id == this.var_1361;
               }
            }
            _loc4_++;
         }
