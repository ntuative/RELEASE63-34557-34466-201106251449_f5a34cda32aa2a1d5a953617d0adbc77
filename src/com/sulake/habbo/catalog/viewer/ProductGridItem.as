package com.sulake.habbo.catalog.viewer
{
   ...
   public class ProductGridItem implements IGridItem
   {
      ...
      private static const const_1084:String = "bg";
      ...
      {
         this._view.getChildByName(const_1084).style = HabboWindowStyle.const_31;
      }
      
      public function deActivate() : void
      {
         this._view.getChildByName(const_1084).style = 3;
      }
      ...
      public function setDraggable(param1:Boolean) : void
      {
         ...
         {
            (this._view as IInteractiveWindow).setMouseCursorForState(WindowState.const_89,MouseCursorType.const_994);
            (this._view as IInteractiveWindow).setMouseCursorForState(0 | 0,MouseCursorType.const_994);
         }
      }
      ...
      private function eventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.const_25 && this.var_560 != null && this.var_560 == param2)
         {
