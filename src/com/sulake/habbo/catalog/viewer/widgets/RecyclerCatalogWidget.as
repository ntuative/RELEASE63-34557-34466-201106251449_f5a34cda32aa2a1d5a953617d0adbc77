package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RecyclerCatalogWidget extends CatalogWidget implements ICatalogWidget, IRecyclerVisualization
   {
      ...
      private var var_303:CatalogObjectMover;
      ...
      private function renderSlotGraphics() : void
      {
         ...
         _loc2_ = 1;
         while(_loc2_ <= RecyclerLogic.const_237)
         {
      ...
      public function updateSlots() : void
      {
         ...
         var _loc1_:int = 0;
         while(_loc1_ < RecyclerLogic.const_237)
         {
      ...
      private function onMainContainerEvent(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param1.type)
         {
            case WindowMouseEvent.const_25:
               if(this.var_303 != null)
               {
                  this.var_303.resetIcon();
               }
               break;
            case WindowMouseEvent.const_196:
               if(this.var_303 != null)
               {
                  this.var_303.onMainContainerEvent(param1,param2,_loc4_);
               }
               break;
            case WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER:
               if(this.var_303 == null)
               {
                  this.var_303 = new CatalogObjectMover();
                  this.var_303.mainContainer = window;
                  this.var_303.roomEngine = _loc3_;
               }
         }
      }
      ...
      private function onSlotMouseEvent(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(event.type == WindowMouseEvent.const_196)
         {
