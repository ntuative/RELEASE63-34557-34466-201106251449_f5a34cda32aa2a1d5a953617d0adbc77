package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class NewPetsCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      override public function init() : Boolean
      {
         ...
         this.var_581 = this.getPetTypeIndexFromProduct(_loc2_.localizationId);
         if(this.var_581 < 8)
         {
            return false;
         }
         this.var_2437 = _loc2_.localizationId;
         this.updateAvailableBreeds(_loc2_.localizationId);
         if(this.var_211 != null && this.var_211.length > 0)
         {
            this.var_405 = this.var_211[0];
         }
         else
         {
            this.var_405 = -1;
         }
         this._offers.add(this.var_581,_loc2_);
      ...
      private function initializeBreedSelection() : void
      {
         ...
         if(this.var_211 != null)
         {
            _loc1_ = [];
            _loc2_ = 0;
            while(_loc2_ < const_1683 && _loc2_ < this.var_211.length)
            {
               _loc3_ = (page.viewer.catalog as HabboCatalog).roomEngine.getPetColor(this.var_581,this.var_211[_loc2_]);
               if(_loc3_ != null)
               {
      ...
      private function selectedBreed(param1:int) : void
      {
         if(this.var_211 != null && this.var_211.length > 0)
         {
            ...
            this.var_405 = this.var_211[param1];
            this.updateImage();
         }
      }
      ...
      private function getPetLocalization() : String
      {
         ...
         if(page != null && false)
         {
            ...
            {
               return _loc1_.localization.getKey(this.getRaceLocalizationKey(this.var_581,this.var_405),this.getRaceLocalizationKey(this.var_581,this.var_405));
            }
         }
         return this.getRaceLocalizationKey(this.var_581,this.var_405);
      }
      ...
      private function updateImage() : void
      {
         ...
         if(_loc1_ == null || this.var_405 < 0)
         {
            return;
         }
         var _loc2_:int = this.var_581;
         var _loc3_:int = this.var_405;
      ...
      private function getPurchaseParameters() : String
      {
         ...
         var p:String = this._name + String.fromCharCode(10) + this.var_405 + String.fromCharCode(10) + this.addZeroPadding(color.toString(16).toUpperCase(),6);
         return p;
      }
