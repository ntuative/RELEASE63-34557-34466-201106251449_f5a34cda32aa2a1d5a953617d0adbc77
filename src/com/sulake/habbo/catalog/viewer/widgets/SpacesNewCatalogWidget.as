package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class SpacesNewCatalogWidget extends ItemGridCatalogWidget implements IDisposable, ICatalogWidget, IItemGrid
   {
      ...
      private var var_433:ISelectorWindow;
      ...
      public function SpacesNewCatalogWidget(param1:IWindowContainer, param2:ISessionDataManager)
      {
         ...
         super(param1,param2);
         this.var_433 = _window.findChildByName("groups") as ISelectorWindow;
         if(this.var_433)
         {
            _loc3_ = 0;
            while(_loc3_ < this.var_433.numSelectables)
            {
               _loc4_ = this.var_433.getSelectableAt(_loc3_);
      ...
      override public function init() : Boolean
      {
         ...
         this.switchCategory(this.var_116[this.var_562]);
      ...
      {
         var _loc2_:int = this.var_656[this.var_562];
         var _loc3_:Offer = this.var_218[this.var_562][_loc2_];
      ...
      public function selectIndex(param1:int) : void
      {
         ...
         {
            _loc2_ = this.var_218[this.var_562][param1];
      ...
      override public function select(param1:IGridItem) : void
      {
         ...
         this.var_656[this.var_562] = (this.var_218[this.var_562] as Array).indexOf(_loc2_);
         this.updateRoomPreview();
      }
      
      private function updateRoomPreview() : void
      {
         var _loc1_:int = this.var_656[0];
         var _loc2_:int = this.var_656[1];
         var _loc3_:int = this.var_656[2];
         var _loc4_:Offer = this.var_218[0][_loc1_];
         var _loc5_:Offer = this.var_218[1][_loc2_];
         var _loc6_:Offer = this.var_218[2][_loc3_];
      ...
      private function createOfferGroups() : Boolean
      {
         ...
         {
            if(!(_loc1_.pricingModel == Offer.const_416 || _loc1_.pricingModel == Offer.const_411))
            {
               continue;
            }
            ...
            if(!(_loc2_.productType == ProductTypeEnum.const_63 || _loc2_.productType == ProductTypeEnum.const_76))
            {
               continue;
            }
            ...
            while(this.var_218.length < this._groupNames.length)
            {
               this.var_218.push(new Array());
            }
            switch(_loc4_)
            {
               case "floor":
                  (this.var_218[_loc5_] as Array).push(_loc1_);
                  break;
               case "wallpaper":
                  (this.var_218[_loc5_] as Array).push(_loc1_);
                  break;
      ...
      private function onSelectGroup(param1:WindowEvent) : void
      {
         ...
         if(_loc2_)
         {
            _loc3_ = this.var_433.getSelectableIndex(_loc2_);
      ...
      private function switchCategory(param1:String) : void
      {
         ...
         this.var_433.setSelected(this.var_433.getSelectableByName(param1));
         var _loc2_:int = -1;
         switch(param1)
         {
            case "group.walls":
         ...
         if(_loc2_ > -1)
         {
            ...
            page.replaceOffers(this.var_218[this.var_562],false);
            resetTimer();
            populateItemGrid();
            ...
            _loc3_ = this.var_656[this.var_562];
