package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RedeemItemCodeCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_1076.removeEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onRedeem);
            this.var_1076 = null;
         }
         if(this.var_1077 != null)
         {
            this.var_1077.removeEventListener(WindowKeyboardEvent.const_181,this.windowKeyEventProcessor);
            this.var_1077 = null;
         }
      }
      ...
      override public function init() : Boolean
      {
         ...
         this.var_1076 = _window.findChildByName("redeem") as IButtonWindow;
         if(this.var_1076 != null)
         {
            this.var_1076.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onRedeem);
         }
         this.var_1077 = _window.findChildByName("voucher_code") as ITextFieldWindow;
         if(this.var_1077 != null)
         {
            this.var_1077.addEventListener(WindowKeyboardEvent.const_181,this.windowKeyEventProcessor);
         }
         return true;
      }
