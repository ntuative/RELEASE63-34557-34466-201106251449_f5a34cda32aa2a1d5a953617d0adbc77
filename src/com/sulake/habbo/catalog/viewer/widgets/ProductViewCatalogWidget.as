package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ProductViewCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_2150:Point;
      
      private var var_596:IItemGridWindow;
      
      private var var_1666:IScrollbarWindow;
      
      protected var var_1874:XML;
      
      private var var_2968:Array;
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_204.removeEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onClickRoomView);
            this.var_204 = null;
         }
      }
      ...
      override public function init() : Boolean
      {
         ...
         this.var_1117 = _window.findChildByName("ctlg_product_name") as ITextWindow;
         this.var_1382 = _window.findChildByName("ctlg_description") as ITextWindow;
         this.var_100 = _window.findChildByName("ctlg_teaserimg_1") as IBitmapWrapperWindow;
         this.var_204 = _window.findChildByName("room_canvas_container") as IWindowContainer;
         if(this.var_204 != null)
         {
            this.var_204.visible = false;
            this.var_595 = this.var_204.findChildByName("room_canvas") as IDisplayObjectWrapper;
            _loc3_ = (page.viewer.catalog as HabboCatalog).roomPreviewer;
            if(this.var_595 != null && _loc3_ != null)
            {
               this.var_204.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onClickRoomView);
               _loc3_.reset();
         ...
         this.var_2150 = new Point(this.var_100.x,this.var_100.y);
         this.var_596 = _window.findChildByName("bundleGrid") as IItemGridWindow;
      ...
      private function onPreviewProduct(param1:SelectProductEvent) : void
      {
         ...
         this.var_1117.text = _loc4_;
         this.var_1382.text = _loc5_;
         this.var_1117.height = this.var_1117.textHeight + 5;
         this.var_1382.y = this.var_1117.y + this.var_1117.height;
         this.var_1382.height = Math.max(130,this.var_1382.textHeight + 5);
         ...
         else
         {
            ...
            switch(_loc2_.pricingModel)
            {
               ...
               case Offer.const_411:
                  ...
                  if(this.var_204 != null)
                  {
                     if(_loc9_.productType == ProductTypeEnum.const_76 || _loc9_.productType == ProductTypeEnum.const_63 || _loc9_.productType == ProductTypeEnum.const_188)
                     {
                        ...
                        else
                        {
                           ...
                           if(_loc17_.avatarRenderManager != null)
                           {
                              ...
                              if(_loc18_ != null)
                              {
                                 ...
                                 _loc18_.appendAction(AvatarAction.const_342,AvatarAction.const_663);
      ...
      {
         var _loc1_:* = null;
         for each(_loc1_ in this.var_2968)
         {
            _window.removeChild(_loc1_);
            _loc1_.dispose();
            _loc1_ = null;
         }
         this.var_2968 = new Array();
      }
      ...
      private function setPreviewImage(param1:BitmapData, param2:Boolean, param3:Point = null) : void
      {
         ...
         if(this.var_100 != null && true)
         {
            ...
            this.var_100.x = this.var_2150.x;
            this.var_100.y = this.var_2150.y;
            if(param3 != null)
            {
