   ...
   public class MarketPlaceOwnItemsCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener, IMarketPlaceVisualization
   {
      ...
      override public function init() : Boolean
      {
         ...
         if(_loc3_ != null)
         {
            ...
            if(_loc2_)
            {
               this.var_1335.add(MarketPlaceOfferState.const_1218,_loc2_);
            }
         }
         ...
         if(_loc3_ != null)
         {
            ...
            if(_loc2_)
            {
               this.var_1335.add(MarketPlaceOfferState.const_526,_loc2_);
            }
         }
         ...
         if(_loc3_ != null)
         {
            ...
            if(_loc2_)
            {
               this.var_1335.add(MarketPlaceOfferState.const_1185,_loc2_);
            }
         }
      ...
      private function updateList(param1:Map) : void
      {
         ...
         while(_loc7_ < _loc6_.length)
         {
            ...
            if(_loc11_.status == MarketPlaceOfferState.const_526)
            {
               _loc5_++;
            }
