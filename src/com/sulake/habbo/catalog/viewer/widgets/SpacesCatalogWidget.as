package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class SpacesCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      private var var_1547:String = "1.1";
      ...
      override public function init() : Boolean
      {
         ...
         this.var_1024 = this.parseElements(_loc2_.floors.pattern);
         this.var_1248 = this.parseElements(_loc2_.walls.pattern);
         this.var_1246 = this.parseElements(_loc2_.landscapes.pattern);
         for each(_loc3_ in page.offers)
         {
            ...
            {
               case "floor":
                  for(_loc10_ in this.var_1024)
                  {
                     _loc11_ = this.var_1024[_loc10_];
                     if(this.var_669.indexOf(_loc10_) == -1)
                     {
                        this.var_669.push(_loc10_);
         ...
         events.dispatchEvent(new CatalogWidgetUpdateRoomPreviewEvent(this._floorType,this.var_1548,this.var_1547,64));
         return true;
      }
      ...
      private function onClick(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc2_.name)
         {
            ...
            case "ctlg_wall_color_next":
               ...
               break;
            case "ctlg_buy_wall":
               _loc3_ = this.var_1247[this.var_453];
               if(_loc3_ != null)
               {
            ...
            case "ctlg_floor_color_next":
               ...
               break;
            case "ctlg_buy_floor":
               _loc3_ = this.var_1249[this.var_456];
               if(_loc3_ != null)
               {
            ...
            case "ctlg_buy_landscape":
               ...
               if(_loc3_ != null)
               {
                  (page.viewer.catalog as HabboCatalog).showPurchaseConfirmation(_loc3_,page.pageId,this.var_1547);
               }
               break;
            default:
      ...
      private function updateConfiguration() : void
      {
         ...
         var _loc2_:String = this.var_669[this.var_456];
         var _loc3_:Array = this.var_1024[_loc2_];
         ...
         var _loc4_:Offer = this.var_1249[this.var_456];
         if(_loc4_ != null)
         {
         ...
         var _loc5_:String = this.var_831[this.var_453];
         var _loc6_:Array = this.var_1248[_loc5_];
         if(_loc6_ != null && this.var_457 >= 0)
         {
            _loc13_ = _loc6_[this.var_457];
            if(_loc13_ != null)
            {
               this.var_1548 = _loc13_;
            }
         }
         var _loc7_:Offer = this.var_1247[this.var_453];
         if(_loc7_ != null)
         {
         ...
         var _loc8_:String = this.var_830[this.var_455];
         var _loc9_:Array = this.var_1246[_loc8_];
         if(_loc9_ != null && this.var_452 >= 0)
         {
            _loc15_ = _loc9_[this.var_452];
            if(_loc15_ != null)
            {
               this.var_1547 = _loc15_;
            }
         }
      ...
      private function changePattern(param1:String, param2:int) : void
      {
         ...
         switch(param1)
         {
            case const_111:
               ...
               if(this.var_456 < 0)
               {
                  this.var_456 = this.var_669.length - 1;
               }
               if(this.var_456 >= this.var_669.length)
               {
                  this.var_456 = 0;
               }
               this.var_454 = 0;
               this.var_1025 = 0;
               _loc5_ = this.var_669[this.var_456];
               _loc6_ = this.var_1024[_loc5_];
               if(_loc6_ != null)
               {
                  this.var_1025 = _loc6_.length;
               }
            ...
            case const_245:
               ...
               if(this.var_453 < 0)
               {
                  this.var_453 = this.var_831.length - 1;
               }
               if(this.var_453 == this.var_831.length)
               {
                  this.var_453 = 0;
               }
               this.var_457 = 0;
               this.var_1022 = 0;
               _loc7_ = this.var_831[this.var_453];
               _loc8_ = this.var_1248[_loc7_];
               if(_loc8_ != null)
               {
                  this.var_1022 = _loc8_.length;
               }
            ...
            case TYPE_LANDSCAPE:
               ...
               if(this.var_455 < 0)
               {
                  this.var_455 = this.var_830.length - 1;
               }
               if(this.var_455 >= this.var_830.length)
               {
                  this.var_455 = 0;
               }
               this.var_452 = 0;
               this.var_1023 = 0;
               _loc9_ = this.var_830[this.var_455];
               _loc10_ = this.var_1246[_loc9_];
               if(_loc10_ != null)
               {
