package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class SongDiskProductViewCatalogWidget extends ProductViewCatalogWidget
   {
      ...
      private var var_439:IButtonWindow;
      ...
      {
         super(param1);
         this.var_439 = _window.findChildByName("listen") as IButtonWindow;
         this.var_1291 = _window.findChildByName("ctlg_song_length") as ITextWindow;
         if(this.var_439 != null)
         {
            this.var_439.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onClickPlay);
            this.var_439.disable();
         }
      ...
      override public function dispose() : void
      {
         if(this.var_439 != null)
         {
            this.var_439.removeEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onClickPlay);
         }
         if(this._soundManager != null && this._soundManager.musicController != null)
         {
            this._soundManager.musicController.stop(HabboMusicPrioritiesEnum.const_213);
      ...
      private function onClickPlay(param1:WindowMouseEvent) : void
      {
         if(this._soundManager != null && this._soundManager.musicController != null)
         {
            ...
            this.forceNoFadeoutOnPlayingSong(HabboMusicPrioritiesEnum.const_213);
            this._soundManager.musicController.playSong(this.var_1048,HabboMusicPrioritiesEnum.const_213,15,40,0.5,2);
         }
      }
      ...
      private function onSelectProduct(param1:SelectProductEvent) : void
      {
         ...
         {
            this.var_1048 = parseInt(_loc2_.extraParam);
            if(this.var_1290 != null)
            {
      ...
      private function getSongLength() : int
      {
         ...
         if(this._soundManager != null && this._soundManager.musicController != null)
         {
            _loc1_ = this._soundManager.musicController.getSongInfo(this.var_1048);
            if(_loc1_ != null)
            {
               return _loc1_.length / 1000;
            }
            this._soundManager.musicController.requestSongInfoWithoutSamples(this.var_1048);
         }
         return -1;
      }
