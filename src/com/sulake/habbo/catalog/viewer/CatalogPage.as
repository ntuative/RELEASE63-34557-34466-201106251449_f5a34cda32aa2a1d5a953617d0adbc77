package com.sulake.habbo.catalog.viewer
{
   ...
   public class CatalogPage implements ICatalogPage
   {
      ...
      protected static const const_2054:String = "ctlg_";
       
      
      protected var var_2255:XML;
      ...
      private var var_555:EventDispatcher;
      ...
      public function CatalogPage(param1:ICatalogViewer, param2:int, param3:String, param4:IPageLocalization, param5:Array, param6:HabboCatalog)
      {
         ...
         this.var_555 = new EventDispatcher();
      ...
      {
         var _loc2_:String = const_2054 + param1;
         ...
         this.var_2255 = _loc3_.content as XML;
         this._window = this.viewer.catalog.windowManager.buildFromXML(this.var_2255) as IWindowContainer;
         if(this._window == null)
         {
      ...
      private function createWidget(param1:IWindowContainer) : void
      {
         ...
         switch(param1.name)
         {
            ...
            case CatalogWidgetEnum.const_1780:
               ...
               break;
            case CatalogWidgetEnum.const_1953:
            ...
            case CatalogWidgetEnum.const_1866:
               ...
               break;
            case CatalogWidgetEnum.const_2019:
            ...
            case CatalogWidgetEnum.const_1920:
               ...
               break;
            case CatalogWidgetEnum.const_2040:
      ...
      private function initializeWidgets() : void
      {
         ...
         this.var_555.dispatchEvent(new CatalogWidgetsInitializedEvent());
      }
      ...
      public function dispatchWidgetEvent(param1:Event) : Boolean
      {
         if(this.var_555 != null)
         {
            return this.var_555.dispatchEvent(param1);
         }
         return false;
      }
