package com.sulake.habbo.room.object
{
   ...
   public class RoomPlaneParser
   {
      ...
      private static const const_714:Number = 0.25;
      
      private static const const_1236:Number = 0.25;
      
      public static const const_79:int = -110;
      ...
      private var var_1461:Number = 1.0;
      
      private var var_1073:Number = 1.0;
      ...
      public function initializeTileMap(param1:int, param2:int) : Boolean
      {
         ...
         while(_loc3_ < param2)
         {
            ...
            while(_loc7_ < param1)
            {
               _loc4_[_loc7_] = const_79;
               _loc5_[_loc7_] = const_79;
               _loc6_[_loc7_] = false;
               _loc7_++;
            }
            this.var_121.push(_loc4_);
            this._tileMatrixOriginal.push(_loc5_);
            this.var_572.push(_loc6_);
            _loc3_++;
         }
         this.var_223 = param1;
         this._height = param2;
      ...
      public function setTileHeight(param1:int, param2:int, param3:Number) : Boolean
      {
         ...
         if(param1 >= 0 && param1 < this.var_223 && param2 >= 0 && param2 < this._height)
         {
            ...
            else
            {
               ...
               if(param2 == this.var_482 || param2 == this.var_481)
               {
                  _loc7_ = false;
                  _loc8_ = this._minX;
      ...
      public function initializeFromTileData(param1:Boolean = false) : Boolean
      {
         ...
         while(_loc3_ < this._height)
         {
            ...
            while(_loc2_ < this.var_223)
            {
               if(this.var_572[_loc3_][_loc2_])
               {
                  this.var_121[_loc3_][_loc2_] = const_118;
               }
               _loc2_++;
            }
            _loc3_++;
      ...
      private function initialize(param1:Point, param2:Boolean) : Boolean
      {
         ...
         if(param1 != null)
         {
            ...
            this.setTileHeight(param1.x,param1.y,const_79);
         }
         this.var_1083 = getFloorHeight(this.var_121);
         if(!param2)
         {
      ...
      private function addWall(param1:IVector3d, param2:IVector3d, param3:IVector3d, param4:IVector3d, param5:Boolean, param6:Boolean, param7:Boolean) : void
      {
         ...
         this.addPlane(RoomPlaneData.const_457,param1,param2,param3,[param4]);
         var _loc8_:Number = const_1236 * this.var_1461;
         var _loc9_:Number = const_714 * this.var_1073;
      ...
      private function addFloor(param1:IVector3d, param2:IVector3d, param3:IVector3d, param4:Boolean, param5:Boolean, param6:Boolean, param7:Boolean, param8:Number, param9:Number, param10:Number, param11:Number, param12:Boolean, param13:Boolean) : void
      {
         ...
         if(_loc14_)
         {
            _loc18_ = const_714 * this.var_1073;
            _loc19_ = _loc18_;
            if(this.var_1073 > 1)
            {
               _loc19_ = const_714;
      ...
      public function getXML() : XML
      {
         ...
         var _loc13_:int = 0;
         var _loc14_:* = null;
         var _loc1_:XML = <tileMap width="{this.var_223}" height="{this._height}" wallHeight="{this.var_1611}"/>;
         var _loc2_:int = 0;
         ...
         {
            _loc12_ = this.var_335.getWithIndex(_loc4_);
            if(_loc12_ != null)
            {
               _loc13_ = this.var_335.getKey(_loc4_);
      ...
      public function getPlaneType(param1:int) : int
      {
         if(param1 < 0 || param1 >= this.planeCount)
         {
            return RoomPlaneData.const_1235;
         }
         var _loc2_:RoomPlaneData = this.var_148[param1] as RoomPlaneData;
         if(_loc2_ != null)
         {
      ...
      public function addFloorHole(param1:int, param2:int, param3:int, param4:int, param5:int) : void
      {
         ...
         this.var_335.add(param1,_loc6_);
      }
      
      public function removeFloorHole(param1:int) : void
      {
         this.var_335.remove(param1);
      }
      ...
      private function initializeHoleMap() : void
      {
         ...
         while(_loc4_ < this.var_335.length)
         {
            _loc5_ = this.var_335.getWithIndex(_loc4_);
            if(_loc5_ != null)
            {
               _loc6_ = _loc5_.x;
