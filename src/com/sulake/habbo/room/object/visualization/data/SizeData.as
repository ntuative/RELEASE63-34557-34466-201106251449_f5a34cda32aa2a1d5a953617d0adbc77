package com.sulake.habbo.room.object.visualization.data
{
   ...
   public class SizeData
   {
      ...
      public static const const_438:int = 1000;
      
      public static const const_1875:int = 0;
       
      
      private var var_626:int = 0;
      
      private var var_1586:int = 360;
      ...
      private var var_1289:DirectionData = null;
      ...
      public function dispose() : void
      {
         ...
         if(this.var_287 != null)
         {
            ...
            {
               _loc2_ = this.var_287.getWithIndex(_loc1_) as DirectionData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      public function defineDirections(param1:XML) : Boolean
      {
         ...
         while(_loc5_ < _loc4_.length())
         {
            ...
            _loc8_ = _loc6_.layer;
            if(this.var_287.getValue(String(_loc7_)) != null)
            {
               return false;
            }
            ...
            this.var_287.add(String(_loc7_),_loc3_);
            this.var_2011 = -1;
            this.var_1289 = null;
            _loc5_++;
         }
      ...
      private function defineDirection(param1:DirectionData, param2:XMLList) : Boolean
      {
         ...
         while(_loc4_ < param2.length())
         {
            ...
            {
               case "ADD":
                  param1.setInk(_loc6_,LayerData.const_1398);
                  break;
               case "SUBTRACT":
                  param1.setInk(_loc6_,LayerData.const_1336);
                  break;
               case "DARKEN":
      ...
      public function getDirectionValue(param1:int) : int
      {
         var _loc6_:int = 0;
         var _loc7_:int = 0;
         var _loc2_:int = (param1 % 360 + 360 + this.var_1586 / 2) % 360 / this.var_1586;
         if(this.var_287.getValue(String(_loc2_)) != null)
         {
            return _loc2_;
         }
         ...
         var _loc4_:int = -1;
         var _loc5_:int = 0;
         while(_loc5_ < this.var_287.length)
         {
            _loc6_ = int(this.var_287.getKey(_loc5_)) * this.var_1586;
         ...
         if(_loc4_ >= 0)
         {
            return int(this.var_287.getKey(_loc4_));
         }
         return const_1875;
      }
      ...
      {
         if(param1 == this.var_2011)
         {
            return this.var_1289;
         }
         var _loc2_:* = null;
         _loc2_ = this.var_287.getValue(String(param1)) as DirectionData;
         if(_loc2_ == null)
         {
            _loc2_ = this.var_846;
         }
