package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurniturePlane
   {
      ...
      private var var_854:Vector3d = null;
      ...
      public function FurniturePlane(param1:IVector3d, param2:IVector3d, param3:IVector3d)
      {
         ...
         this.var_854 = new Vector3d();
         this.var_854.assign(param2);
         this.var_853 = new Vector3d();
         this.var_853.assign(param3);
      ...
      public function setRotation(param1:Boolean) : void
      {
         if(param1 != this.var_2767)
         {
            if(!param1)
            {
               this.var_329.assign(this.var_854);
               this.var_330.assign(this.var_853);
            }
            else
            {
               this.var_329.assign(this.var_854);
               this.var_329.mul(this.var_853.length / this.var_854.length);
               this.var_330.assign(this.var_853);
               this.var_330.mul(this.var_854.length / this.var_853.length);
            }
            this.var_1767 = -1;
            this.var_1591 = this.var_1591 - 1;
      ...
      public function update(param1:IRoomGeometry, param2:int) : Boolean
      {
         ...
         var _loc9_:* = null;
         if(param1 == null || this.var_105 == null && this.var_1242 != null || this.var_329 == null || this.var_330 == null || this._normal == null)
         {
            return false;
         }
         ...
         if(param1.updateId != this.var_1767)
         {
            ...
            if(_loc4_ != null && (_loc4_.x != this.var_1591 || _loc4_.y != this.var_2348 || _loc4_.z != this.var_2346 || param1.scale != this.var_1770))
            {
               this.var_1591 = _loc4_.x;
               this.var_2348 = _loc4_.y;
               this.var_2346 = _loc4_.z;
               ...
               _loc7_ = _loc6_.z;
               _loc8_ = Math.max(this.var_174.z - _loc7_,this.var_126.z - _loc7_,this.var_98.z - _loc7_,this.var_127.z - _loc7_);
               this.var_2589 = _loc8_;
