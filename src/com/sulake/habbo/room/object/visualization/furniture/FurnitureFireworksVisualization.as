package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureFireworksVisualization extends AnimatedFurnitureVisualization
   {
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_664)
         {
            for each(_loc1_ in this.var_664)
            {
               _loc1_.dispose();
            }
            this.var_664 = null;
      ...
      override protected function updateObject(param1:Number, param2:Number) : Boolean
      {
         ...
         if(super.updateObject(param1,param2))
         {
            ...
            {
               this.readDefinition();
               this.var_248 = this.var_664[param1];
               _loc3_ = true;
            }
      ...
      private function readDefinition() : Boolean
      {
         ...
         var _loc3_:String = _loc2_.getString(RoomObjectVariableEnum.const_1405);
         if(_loc3_.length == 0)
         {
