package com.sulake.habbo.room.object.visualization.pet
{
   ...
   public class AnimatedPetVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private static const const_1722:String = "head";
      
      private static const const_731:int = 1;
      
      private static const const_1165:int = 1000;
      
      private static const const_1723:String = "pet_experience_bubble_png";
      
      private static const const_1724:int = 0;
      
      private static const const_1725:int = 1;
      ...
      override public function initialize(param1:IRoomObjectVisualizationData) : Boolean
      {
         ...
         {
            _loc3_ = this._animationData.commonAssets.getAssetByName(const_1723) as BitmapDataAsset;
            if(_loc3_ != null)
            {
               _loc2_ = (_loc3_.content as BitmapData).clone();
               this.var_420 = new ExperienceData(_loc2_);
            }
         }
      ...
      override protected function updateAnimation(param1:Number) : int
      {
         ...
         if(_loc2_ != null)
         {
            ...
            if(_loc3_ != this.var_3018)
            {
               this.var_3018 = _loc3_;
      ...
      override protected function updateModel(param1:Number) : Boolean
      {
         ...
         if(_loc3_.getUpdateID() != var_146)
         {
            ...
            this.var_2143 = _loc3_.getNumber(RoomObjectVariableEnum.const_291) > 0;
            _loc8_ = _loc3_.getNumber(RoomObjectVariableEnum.const_226);
            if(!isNaN(_loc8_))
            {
               this.var_2188 = _loc8_;
            }
            else
            {
               this.var_2188 = direction;
            }
            this.var_1486 = _loc3_.getNumber(RoomObjectVariableEnum.AVATAR_EXPERIENCE_TIMESTAMP);
            this.var_2411 = _loc3_.getNumber(RoomObjectVariableEnum.const_400);
            _loc9_ = _loc3_.getNumber(RoomObjectVariableEnum.const_845);
            if(_loc9_ != this.var_2189)
            {
               this.var_2189 = _loc9_;
               this.var_3019 = this.var_2189.toString();
            }
      ...
      private function updateExperienceBubble(param1:int) : void
      {
         ...
         if(this.var_420 != null)
         {
            ...
            if(this.var_1486 > 0)
            {
               _loc2_ = param1 - this.var_1486;
               if(_loc2_ < const_1165)
               {
                  this.var_420.alpha = int(Math.sin(_loc2_ / const_1165 * 0) * 255);
               ...
               if(_loc3_ != null)
               {
                  ...
                  {
                     _loc3_.asset = this.var_420.image;
                     _loc3_.offsetX = -20;
                     _loc3_.offsetY = -80;
                     _loc3_.alpha = this.var_420.alpha;
                     _loc3_.visible = true;
                  }
                  else
                  {
      ...
      {
         return super.getAdditionalSpriteCount() + const_731;
      }
      ...
      override protected function getAsset(param1:String) : IGraphicAsset
      {
         ...
         {
            return assetCollection.getAssetWithPalette(param1,this.var_3019);
         }
         return null;
      }
      ...
      override protected function getSpriteAssetName(param1:int, param2:int) : String
      {
         ...
         if(param2 < _loc3_ - const_731)
         {
            _loc4_ = getSize(param1);
            if(param2 < _loc3_ - (1 + const_731))
            {
               if(param2 >= FurnitureVisualizationData.const_554.length)
               {
                  return null;
               }
               _loc5_ = FurnitureVisualizationData.const_554[param2];
               if(_loc4_ == 1)
               {
      ...
      private function getDirection(param1:int, param2:int) : int
      {
         ...
         {
            return this._animationData.getDirectionValue(param1,this.var_2188);
         }
         return direction;
      }
      ...
      private function isHeadSprite(param1:int) : Boolean
      {
         ...
         {
            if(this._animationData.getTag(var_102,DirectionData.USE_DEFAULT_DIRECTION,param1) == const_1722)
            {
               this.var_1128[param1] = true;
            }
            else
            {
               this.var_1128[param1] = false;
            }
         }
