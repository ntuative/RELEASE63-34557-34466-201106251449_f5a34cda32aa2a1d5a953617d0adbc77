package com.sulake.habbo.room.object.visualization.pet
{
   ...
   public class PetAnimationSizeData extends AnimationSizeData
   {
      ...
      public function definePostures(param1:XML) : Boolean
      {
         ...
         {
            this.var_897 = param1.@defaultPosture;
         }
         else
         {
            this.var_897 = null;
         ...
         while(_loc4_ < _loc3_.length())
         {
            ...
            this.var_726.add(_loc6_,_loc7_);
         ...
         if(this.var_726.getValue(this.var_897) == null)
         {
            return false;
         }
         return true;
      ...
      public function defineGestures(param1:XML) : Boolean
      {
         ...
         while(_loc4_ < _loc3_.length())
         {
            ...
            _loc6_ = String(_loc5_.@id);
            _loc7_ = int(_loc5_.@animationId);
            this.var_898.add(_loc6_,_loc7_);
            _loc4_++;
         }
         return true;
      }
      ...
      {
         if(this.var_898.getValue(param1) == null)
         {
            return const_778;
         }
         return int(this.var_898.getValue(param1));
      }
      
      public function getPostureForAnimation(param1:int) : String
      {
         if(param1 >= 0 && param1 < this.var_726.length)
         {
            return this.var_726.getKey(param1);
         }
         return this.var_897;
      }
      ...
      {
         if(param1 >= 0 && param1 < this.var_898.length)
         {
            return this.var_898.getKey(param1);
         }
         return null;
      }
