package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomVisualization extends RoomObjectSpriteVisualization
   {
      ...
      public static const const_1996:int = 13421772;
      ...
      public static const const_1832:int = 13421772;
      
      public static const const_1736:int = 10066329;
      ...
      private var var_770:Rectangle = null;
      
      private var var_528:RoomPlaneBitmapMaskParser = null;
      ...
      private var var_1073:Number = NaN;
      
      private var var_1461:Number = NaN;
      
      private var var_2350:Number = NaN;
      
      private var var_1768:String = null;
      
      private var var_1178:uint = 16777215;
      
      private var var_2349:int = 255;
      
      private var var_2347:int = 255;
      
      private var var_2345:int = 255;
      ...
      private const const_2347:int = 250;
      
      private var var_1767:int = -1;
      
      private var var_1591:Number = 0.0;
      
      private var var_2348:Number = 0.0;
      ...
      public function RoomVisualization()
      {
         ...
         this.var_528 = new RoomPlaneBitmapMaskParser();
      ...
      override public function get boundingRectangle() : Rectangle
      {
         ...
         {
            this.var_770 = super.boundingRectangle;
         }
         return new Rectangle(this.var_770.x,this.var_770.y,this.var_770.width,this.var_770.height);
      }
      ...
      protected function initializeRoomPlanes() : void
      {
         ...
         if(!isNaN(this.var_1073))
         {
            this._planeParser.floorThicknessMultiplier = this.var_1073;
         }
         if(!isNaN(this.var_1461))
         {
            this._planeParser.wallThicknessMultiplier = this.var_1461;
         }
         var _loc2_:String = _loc1_.getModel().getString(RoomObjectVariableEnum.const_761);
         ...
         while(_loc7_ < this._planeParser.planeCount)
         {
            ...
            else if(_loc12_ == RoomPlaneData.const_457)
            {
               ...
               {
                  _loc13_.color = const_1832;
               }
               else
               {
                  _loc13_.color = const_1736;
               }
               if(this._data != null)
               {
            ...
            else if(_loc12_ == RoomPlaneData.const_1886)
            {
               _loc13_ = new RoomPlane(_loc1_.getLocation(),_loc8_,_loc9_,_loc10_,RoomPlane.const_75,true,_loc11_,_loc6_);
               if(_loc9_.length < 1 || _loc10_.length < 1)
               {
      ...
      private function getLandscapeWidth() : Number
      {
         ...
         while(_loc2_ < this._planeParser.planeCount)
         {
            ...
            if(_loc3_ == RoomPlaneData.const_457)
            {
      ...
      override public function update(param1:IRoomGeometry, param2:int, param3:Boolean, param4:Boolean) : void
      {
         ...
         if(_loc9_ < this._lastUpdateTime + this.const_2347 && !_loc6_ && !_loc8_)
         {
            return;
         }
            ...
            while(_loc10_ < this.var_368.length)
            {
               ...
               if(_loc12_ != null && _loc13_ != null && _loc13_.type != RoomPlane.TYPE_LANDSCAPE)
               {
                  if(this.var_1769)
                  {
                     ...
                     _loc15_ = uint((_loc14_ & 255) * this.var_2345 / 255);
                     _loc16_ = uint((_loc14_ >> 8 & 255) * this.var_2347 / 255);
                     _loc17_ = uint((_loc14_ >> 16 & 255) * this.var_2349 / 255);
      ...
      private function updateGeometry(param1:IRoomGeometry) : Boolean
      {
         ...
         if(param1.updateId != this.var_1767)
         {
            this.var_1767 = param1.updateId;
            this.var_770 = null;
            _loc3_ = param1.direction;
            if(_loc3_ != null && (_loc3_.x != this.var_1591 || _loc3_.y != this.var_2348 || _loc3_.z != this.var_2346 || param1.scale != this.var_1770))
            {
               this.var_1591 = _loc3_.x;
               this.var_2348 = _loc3_.y;
               this.var_2346 = _loc3_.z;
               this.var_1770 = param1.scale;
               _loc2_ = true;
            }
         }
         return _loc2_;
      ...
      private function updateMasksAndColors(param1:IRoomObjectModel) : Boolean
      {
         ...
         {
            _loc3_ = param1.getString(RoomObjectVariableEnum.const_1304);
            if(_loc3_ != this.var_1768)
            {
               this.updatePlaneMasks(_loc3_);
               this.var_1768 = _loc3_;
               _loc2_ = true;
            }
            _loc4_ = uint(param1.getNumber(RoomObjectVariableEnum.const_1018));
            if(_loc4_ != this.var_1178)
            {
               this.var_1178 = _loc4_;
               this.var_2345 = this.var_1178 & 255;
               this.var_2347 = this.var_1178 >> 8 & 255;
               this.var_2349 = this.var_1178 >> 16 & 255;
               _loc2_ = true;
            }
            _loc5_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_1384));
      ...
      private function updatePlaneTexturesAndVisibilities(param1:IRoomObjectModel) : Boolean
      {
         ...
         if(var_146 != param1.getUpdateID())
         {
            _loc2_ = param1.getString(RoomObjectVariableEnum.const_224);
            _loc3_ = param1.getString(RoomObjectVariableEnum.const_215);
            _loc4_ = param1.getString(RoomObjectVariableEnum.const_220);
            this.updatePlaneTextureTypes(_loc3_,_loc2_,_loc4_);
            _loc5_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_822));
      ...
      private function updatePlaneThicknesses(param1:IRoomObjectModel) : Boolean
      {
         ...
         if(var_146 != param1.getUpdateID())
         {
            _loc2_ = param1.getNumber(RoomObjectVariableEnum.const_1260);
            _loc3_ = param1.getNumber(RoomObjectVariableEnum.const_1189);
            if(!isNaN(_loc2_) && !isNaN(_loc3_) && (_loc2_ != this.var_1073 || _loc3_ != this.var_1461))
            {
      ...
      private function updateFloorHoles(param1:IRoomObjectModel) : Boolean
      {
         ...
         if(var_146 != param1.getUpdateID())
         {
            _loc2_ = param1.getNumber(RoomObjectVariableEnum.const_1252);
            if(!isNaN(_loc2_) && _loc2_ != this.var_2350)
            {
      ...
      private function updateSprite(param1:IRoomObjectSprite, param2:RoomPlane, param3:String, param4:Number) : void
      {
         ...
         param1.assetName = param3 + "_" + this.var_1177;
      }
      ...
      protected function updatePlaneMasks(param1:String) : void
      {
         ...
         this.var_528.initialize(_loc2_);
         var _loc3_:* = null;
         var _loc4_:* = [];
         var _loc5_:* = [];
         var _loc6_:Boolean = false;
         ...
         var _loc8_:int = 0;
         while(_loc8_ < this.var_528.maskCount)
         {
            _loc10_ = this.var_528.getMaskType(_loc8_);
            _loc11_ = this.var_528.getMaskLocation(_loc8_);
            _loc12_ = this.var_528.getMaskCategory(_loc8_);
            if(_loc11_ != null)
            {
               _loc13_ = 0;
                     ...
                     if(_loc3_ != null && _loc3_.location != null && _loc3_.normal != null)
                     {
                        ...
                        if(_loc15_ < 0.01)
                        {
                           if(_loc3_.leftSide != null && _loc3_.rightSide != null)
                           {
                              ...
                              if(_loc3_.type == RoomPlane.const_75 || _loc3_.type == RoomPlane.TYPE_LANDSCAPE && _loc12_ == RoomPlaneBitmapMaskData.const_312)
                              {
