package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomPlane
   {
      ...
      private var var_1018:IPlaneRasterizer = null;
      ...
      private var var_2590:Number = 0;
      
      private var var_2587:Number = 0;
      
      private var var_2586:Number = 0;
      
      private var var_215:Map = null;
      
      private var var_450:PlaneBitmapData = null;
      ...
      public function copyBitmapData(param1:BitmapData) : BitmapData
      {
         if(this.visible)
         {
            if(this._bitmapData != null && param1 != null)
            {
               ...
               {
                  param1.copyPixels(this._bitmapData,this._bitmapData.rect,const_693);
                  return param1;
               }
            }
         }
      ...
      private function getTextureIdentifier(param1:Number) : String
      {
         ...
         {
            return this.var_1018.getTextureIdentifier(param1,this.normal);
         }
      ...
      private function needsNewTexture(param1:IRoomGeometry, param2:int) : Boolean
      {
         ...
         var _loc3_:PlaneBitmapData = this.var_450;
         if(_loc3_ == null)
         {
         ...
         if(this.var_828 && (_loc3_ == null || _loc3_.timeStamp >= 0 && param2 > _loc3_.timeStamp || this.var_384))
         {
            return true;
         }
         return false;
      ...
      private function getTexture(param1:IRoomGeometry, param2:int) : BitmapData
      {
         ...
         if(this.needsNewTexture(param1,param2))
         {
            ...
            if(this.var_1018 != null)
            {
               _loc3_ = this.var_1018.render(_loc8_,this._id,_loc5_,_loc6_,param1.scale,_loc7_,this.var_1911,this.var_2588,this.var_2590,this.var_2587,this.var_2586,param2);
               if(_loc3_ != null)
               {
      ...
      public function update(param1:IRoomGeometry, param2:int) : Boolean
      {
         ...
         if(this.var_1767 != geometry.updateId)
         {
         ...
         if(geometryChanged)
         {
            ...
            originZ = originPos.z;
            relativeDepth = Math.max(this.var_174.z - originZ,this.var_126.z - originZ,this.var_98.z - originZ,this.var_127.z - originZ);
            if(this._type == TYPE_LANDSCAPE)
            {
               relativeDepth += 0.02;
            }
            this.var_2589 = relativeDepth;
            this._isVisible = true;
            this.var_1767 = geometry.updateId;
         }
         if(geometryChanged || this.needsNewTexture(geometry,timeSinceStartMs))
         {
            ...
            Randomizer.setSeed(this.var_2591);
      ...
      private function updateCorners(param1:IRoomGeometry) : void
      {
         ...
         this.var_126.assign(param1.getScreenPosition(Vector3d.sum(this.var_105,this.var_330)));
         this.var_98.assign(param1.getScreenPosition(Vector3d.sum(Vector3d.sum(this.var_105,this.var_329),this.var_330)));
         this.var_127.assign(param1.getScreenPosition(Vector3d.sum(this.var_105,this.var_329)));
         ...
         var _loc2_:Number = Math.min(this.var_174.x,this.var_126.x,this.var_98.x,this.var_127.x);
         var _loc3_:Number = Math.max(this.var_174.x,this.var_126.x,this.var_98.x,this.var_127.x);
         var _loc4_:Number = Math.min(this.var_174.y,this.var_126.y,this.var_98.y,this.var_127.y);
         var _loc5_:Number = Math.max(this.var_174.y,this.var_126.y,this.var_98.y,this.var_127.y);
         _loc3_ -= _loc2_;
      ...
      {
         if(this.var_174 == null || this.var_126 == null || this.var_98 == null || this.var_127 == null || param2 == null || this._bitmapData == null)
         {
            return;
         }
         var _loc3_:Number = this.var_127.x - this.var_98.x;
         var _loc4_:Number = this.var_127.y - this.var_98.y;
         var _loc5_:Number = this.var_126.x - this.var_98.x;
         var _loc6_:Number = this.var_126.y - this.var_98.y;
      ...
      public function addRectangleMask(param1:Number, param2:Number, param3:Number, param4:Number) : Boolean
      {
         ...
         if(this.var_1017)
         {
            _loc5_ = null;
            _loc6_ = 0;
            while(_loc6_ < this.var_385.length)
            {
               _loc5_ = this.var_385[_loc6_] as RoomPlaneRectangleMask;
               if(_loc5_ != null)
               {
      ...
      private function updateMaskChangeStatus() : void
      {
         ...
         var _loc4_:* = null;
         if(this.var_279.length == this.var_1019.length)
         {
         ...
         if(this.var_385.length > this.var_1542.length)
         {
            _loc3_ = false;
         }
         if(_loc3_)
      ...
      private function updateMask(param1:BitmapData, param2:IRoomGeometry) : void
      {
         ...
         var _loc13_:int = 0;
         var _loc14_:int = 0;
         if(!this.var_1017 || this.var_279.length == 0 && this.var_385.length == 0 && !this.var_384 || this.var_762 == null)
         {
            return;
         }
         ...
         if(this.var_384)
         {
            ...
            while(_loc5_ < this.var_279.length)
            {
               ...
               if(_loc3_ != null)
               {
                  ...
                  _loc12_ = _loc3_.type;
                  this.var_762.updateMask(this.var_79,_loc12_,param2.scale,_loc9_,_loc10_,_loc11_);
            ...
            while(_loc6_ < this.var_385.length)
            {
               _loc4_ = this.var_385[_loc6_] as RoomPlaneRectangleMask;
               if(_loc4_ != null)
               {
      ...
      private function combineTextureMask(param1:BitmapData, param2:BitmapData) : void
      {
         ...
         if(this.var_249 != null && (this.var_249.width != param1.width || this.var_249.height != param1.height))
         {
            this.var_249.dispose();
            this.var_249 = null;
         }
         if(this.var_249 == null)
         {
            this.var_249 = new BitmapData(param1.width,param1.height,true,4294967295);
         }
         this.var_249.copyChannel(param1,param1.rect,const_693,BitmapDataChannel.ALPHA,BitmapDataChannel.RED);
         this.var_249.draw(param2,null,null,BlendMode.DARKEN);
         param1.copyChannel(this.var_249,this.var_249.rect,const_693,BitmapDataChannel.RED,BitmapDataChannel.ALPHA);
      }
   }
}
