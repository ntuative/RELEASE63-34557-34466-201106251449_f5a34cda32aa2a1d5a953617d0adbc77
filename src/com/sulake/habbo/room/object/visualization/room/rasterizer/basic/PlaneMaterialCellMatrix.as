package com.sulake.habbo.room.object.visualization.room.rasterizer.basic
{
   ...
   public class PlaneMaterialCellMatrix
   {
      ...
      public static const const_1883:int = const_453;
      ...
      public static const ALIGN_DEFAULT:int = const_136;
      ...
      public function render(param1:BitmapData, param2:int, param3:int, param4:IVector3d, param5:Boolean, param6:int, param7:Boolean) : BitmapData
      {
         ...
         if(this.isStatic)
         {
            if(this.var_34 != null)
            {
               if(this.var_34.width == param2 && this.var_34.height == param3 && Vector3d.isEqual(this._cachedBitmapNormal,param4))
               {
                  if(param1 != null)
                  {
                     this.copyCachedBitmapOnCanvas(param1,this.var_740,param6,param7);
                     return param1;
                  }
                  return this.var_34;
               }
         ...
         else if(this.var_34 != null)
         {
            if(this.var_34.width == param2 && this.var_34.height == param3)
            {
               this.var_34.fillRect(this.var_34.rect,16777215);
            }
            else
            {
               this.var_34.dispose();
         ...
         if(!param5)
         {
            ...
            if(this.var_34 == null)
            {
               this.var_34 = new BitmapData(param2,param3,true,4294967295);
            }
            else
            {
               this.var_34.fillRect(this.var_34.rect,4294967295);
            }
            if(param1 != null)
            {
         ...
         {
            this.var_740 = param3;
            this.var_34 = new BitmapData(param2,param3,true,16777215);
         }
         var _loc8_:* = [];
         var _loc9_:int = 0;
         ...
         var _loc10_:int = 0;
         switch(this.var_2042)
         {
            case const_270:
               _loc10_ = this.renderRepeatBorders(this.var_34,_loc8_);
               break;
            case const_305:
               _loc10_ = this.renderRepeatCenter(this.var_34,_loc8_);
               break;
            case const_315:
               _loc10_ = this.renderRepeatFirst(this.var_34,_loc8_);
               break;
            case const_290:
               _loc10_ = this.renderRepeatLast(this.var_34,_loc8_);
               break;
            case const_772:
               _loc10_ = this.renderRepeatRandom(this.var_34,_loc8_);
               break;
            default:
               _loc10_ = this.renderRepeatAll(this.var_34,_loc8_);
         }
         this.var_740 = _loc10_;
         if(param1 != null)
         {
      ...
      {
         if(param1 == null || this.var_34 == null || param1 == this.var_34)
         {
            return;
         }
         if(!param4)
         ...
         var _loc5_:* = null;
         if(this._align == const_136)
         {
            _loc5_ = new Rectangle(0,0,this.var_34.width,this.var_740);
         }
         else
         {
            _loc5_ = new Rectangle(0,this.var_34.height - this.var_740,this.var_34.width,this.var_740);
         }
         param1.copyPixels(this.var_34,_loc5_,new Point(0,param3),null,null,true);
      }
