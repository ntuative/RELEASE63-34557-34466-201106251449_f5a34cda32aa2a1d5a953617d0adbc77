package com.sulake.habbo.room.object.visualization.room.rasterizer.basic
{
   ...
   public class PlaneMaterialCell
   {
      ...
      private var var_34:BitmapData = null;
      
      private var var_643:PlaneTexture;
      ...
      public function PlaneMaterialCell(param1:PlaneTexture, param2:Array = null, param3:Array = null, param4:int = 0)
      {
         ...
         if(param2 != null && param2.length > 0 && param4 > 0)
         {
            ...
            while(_loc5_ < param2.length)
            {
               ...
               if(_loc6_ != null)
               {
                  this.var_996.push(_loc6_);
               }
               _loc5_++;
            }
            if(this.var_996.length > 0)
            {
               if(param3 != null)
               {
                  _loc5_ = 0;
      ...
      public function getHeight(param1:IVector3d) : int
      {
         ...
         if(this.var_643 != null)
         {
            _loc2_ = this.var_643.getBitmap(param1);
            if(_loc2_ != null)
            {
         ...
         if(this.var_643 != null)
         {
            ...
            if(_loc2_ != null)
            {
               if(!this.isStatic)
               {
                  if(this.var_34 != null)
                  {
                     if(this.var_34.width != _loc2_.width || this.var_34.height != _loc2_.height)
                     {
                        this.var_34.dispose();
                        this.var_34 = null;
                     }
                     ...
                     {
                        this.var_34.copyPixels(_loc2_,_loc2_.rect,new Point(0,0));
                     }
                  }
                  if(this.var_34 == null)
                  {
                     this.var_34 = _loc2_.clone();
                  }
                  _loc3_ = Math.min(this.var_1221,this._extraItemOffsets.length);
                  _loc4_ = Math.max(this.var_1221,this._extraItemOffsets.length);
                  _loc5_ = Randomizer.getArray(this.var_1221,_loc4_);
                  _loc6_ = 0;
                  while(_loc6_ < _loc3_)
                  {
                     _loc7_ = this._extraItemOffsets[_loc5_[_loc6_]] as Point;
                     _loc8_ = this.var_996[_loc6_ % this.var_996.length] as IGraphicAsset;
                     if(_loc7_ != null && _loc8_ != null)
                     {
                        ...
                        if(_loc9_ != null)
                        {
                           ...
                           if(_loc10_ != null)
                           {
                              ...
                              this.var_34.draw(_loc10_,_loc12_);
                           }
                        }
                     }
                     _loc6_++;
