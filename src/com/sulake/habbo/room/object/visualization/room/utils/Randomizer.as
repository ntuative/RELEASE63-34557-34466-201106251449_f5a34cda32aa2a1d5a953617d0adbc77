package com.sulake.habbo.room.object.visualization.room.utils
{
   public class Randomizer
   {
      ...
      public static const const_2334:int = 1;
      
      public static const const_2136:int = 16777216;
      ...
      private var var_1883:int = 16777216;
      
      private var var_3077:int = 69069;
      
      private var var_3076:int = 5;
      ...
      {
         var _loc1_:int = this.var_3077 * this.var_1882 + this.var_3076;
         if(_loc1_ < 0)
         {
            _loc1_ = -_loc1_;
         }
         _loc1_ %= this.var_1883;
         this.var_1882 = _loc1_;
         return _loc1_;
      }
      ...
      private function iterateScaled(param1:int, param2:int) : int
      {
         ...
         return int(param1 + _loc3_ / this.var_1883 * param2);
      }
   }
}
