package com.sulake.habbo.room.object.logic.room
{
   ...
   public class RoomLogic extends ObjectLogicBase
   {
      ...
      private var var_1634:uint = 16777215;
      
      private var var_2071:int = 255;
      
      private var var_1348:uint = 16777215;
      
      private var var_2072:int = 255;
      
      private var var_1347:int = 0;
      
      private var var_2070:int = 1500;
      ...
      {
         var _loc1_:Array = [RoomObjectMouseEvent.const_519,RoomObjectMouseEvent.const_165];
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.setString(RoomObjectVariableEnum.const_761,param1.toString());
            _loc2_.setNumber(RoomObjectVariableEnum.const_1018,16777215);
         ...
         if(this.var_1633)
         {
            if(object != null)
            {
               ...
               if(_loc2_ != null)
               {
                  ...
                  _loc2_.setString(RoomObjectVariableEnum.const_761,_loc3_.toString());
                  _loc2_.setNumber(RoomObjectVariableEnum.const_1252,param1);
      ...
      private function updateBackgroundColor(param1:int) : void
      {
         ...
         if(this.var_1347)
         {
            _loc2_ = param1;
            _loc3_ = this._color;
            _loc4_ = this.var_2007;
            if(_loc2_ - this.var_1347 >= this.var_2070)
            {
               _loc3_ = this.var_1348;
               _loc4_ = this.var_2072;
               this.var_1347 = 0;
            }
            else
            {
               _loc7_ = this.var_1634 >> 16 & 255;
               _loc8_ = this.var_1634 >> 8 & 255;
               _loc9_ = this.var_1634 & 255;
               _loc10_ = this.var_1348 >> 16 & 255;
               _loc11_ = this.var_1348 >> 8 & 255;
               _loc12_ = this.var_1348 & 255;
               _loc13_ = (_loc2_ - this.var_1347) / this.var_2070;
               _loc7_ += (_loc10_ - _loc7_) * _loc13_;
               _loc8_ += (_loc11_ - _loc8_) * _loc13_;
               _loc9_ += (_loc12_ - _loc9_) * _loc13_;
               _loc3_ = (_loc7_ << 16) + (_loc8_ << 8) + _loc9_;
               _loc4_ = this.var_2071 + (this.var_2072 - this.var_2071) * _loc13_;
               this._color = _loc3_;
            ...
            _loc6_.setNumber(RoomObjectVariableEnum.const_1018,_loc3_);
         }
      }
      ...
      private function updatePlaneTypes(param1:RoomObjectRoomUpdateMessage, param2:IRoomObjectModelController) : void
      {
         switch(param1.type)
         {
            case RoomObjectRoomUpdateMessage.const_948:
               param2.setString(RoomObjectVariableEnum.const_215,param1.value);
               break;
            case RoomObjectRoomUpdateMessage.const_967:
               param2.setString(RoomObjectVariableEnum.const_224,param1.value);
               break;
      ...
      private function updatePlaneMasks(param1:RoomObjectRoomMaskUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomMaskUpdateMessage.const_548:
               _loc5_ = "null";
               if(param1.maskCategory == RoomObjectRoomMaskUpdateMessage.const_312)
               {
                  _loc5_ = "null";
               }
               this.var_528.addMask(param1.maskId,param1.maskType,param1.maskLocation,_loc5_);
               _loc4_ = true;
               break;
            case RoomObjectRoomMaskUpdateMessage.const_797:
               _loc4_ = this.var_528.removeMask(param1.maskId);
         }
         if(_loc4_)
         {
            _loc6_ = this.var_528.getXML();
            _loc7_ = _loc6_.toXMLString();
            param2.setString(RoomObjectVariableEnum.const_1304,_loc7_);
         }
      }
      ...
      private function updatePlaneProperties(param1:RoomObjectRoomPlanePropertyUpdateMessage, param2:IRoomObjectModelController) : void
      {
         switch(param1.type)
         {
            case RoomObjectRoomPlanePropertyUpdateMessage.const_714:
               param2.setNumber(RoomObjectVariableEnum.const_1260,param1.value);
               break;
            case RoomObjectRoomPlanePropertyUpdateMessage.const_1236:
               param2.setNumber(RoomObjectVariableEnum.const_1189,param1.value);
         }
      }
      ...
      private function updateColors(param1:RoomObjectRoomColorUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         param2.setNumber(RoomObjectVariableEnum.const_1384,int(param1.bgOnly));
         this.var_1634 = this._color;
         this.var_2071 = this.var_2007;
         this.var_1348 = _loc3_;
         this.var_2072 = _loc4_;
         this.var_1347 = getTimer();
         this.var_2070 = 1500;
      }
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         if(_loc5_ < 1 || _loc5_ > this._planeParser.planeCount)
         {
            ...
            {
               _loc4_.setNumber(RoomObjectVariableEnum.const_658,0);
            }
            return;
         }
         _loc5_--;
         ...
         {
            _loc4_.setNumber(RoomObjectVariableEnum.const_1800,_loc19_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1924,_loc20_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1928,_loc21_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_658,_loc5_ + 1);
            var _loc22_:String = "";
            var _loc23_:int = 0;
            var _loc24_:* = null;
            switch(param1.type)
            {
               ...
               case MouseEvent.CLICK:
                  ...
                  if(eventDispatcher != null)
                  {
                     ...
                     else if(_loc12_ == RoomPlaneData.const_284 || _loc12_ == RoomPlaneData.const_457)
                     {
                        _loc26_ = 90;
                        if(_loc11_ != null)
                        {
