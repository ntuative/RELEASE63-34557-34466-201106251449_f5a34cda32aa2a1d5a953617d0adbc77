package com.sulake.habbo.room.object.logic.furniture
{
   ...
   public class FurnitureSoundMachineLogic extends FurnitureMultiStateLogic
   {
      ...
      {
         var _loc1_:Array = [RoomObjectFurnitureActionEvent.const_575,RoomObjectFurnitureActionEvent.const_512,RoomObjectFurnitureActionEvent.const_671,RoomObjectFurnitureActionEvent.const_559];
      ...
      override public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         ...
         if(_loc3_ != this.var_1268)
         {
            this.var_1268 = _loc3_;
            if(_loc3_ == 1)
            {
      ...
      private function requestPlayList() : void
      {
         ...
         this.var_2019 = true;
         var _loc1_:RoomObjectFurnitureActionEvent = new RoomObjectFurnitureActionEvent(RoomObjectFurnitureActionEvent.const_575,object.getId(),object.getType());
         eventDispatcher.dispatchEvent(_loc1_);
      }
      ...
      private function requestDispose() : void
      {
         ...
         var _loc1_:RoomObjectFurnitureActionEvent = new RoomObjectFurnitureActionEvent(RoomObjectFurnitureActionEvent.const_671,object.getId(),object.getType());
         eventDispatcher.dispatchEvent(_loc1_);
      }
   }
}
