package com.sulake.habbo.room.object.logic.furniture
{
   ...
   public class FurnitureJukeboxLogic extends FurnitureMultiStateLogic
   {
      ...
      {
         var _loc1_:Array = [RoomObjectFurnitureActionEvent.const_568,RoomObjectFurnitureActionEvent.const_522,RoomObjectFurnitureActionEvent.const_520,RoomObjectFurnitureActionEvent.const_651,RoomObjectWidgetRequestEvent.const_143];
      ...
      override public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         ...
         if(object.getModelController().getNumber(RoomObjectVariableEnum.const_759) == 1)
         {
            object.getModelController().setString(RoomWidgetInfostandExtraParamEnum.const_456,RoomWidgetInfostandExtraParamEnum.const_589);
      ...
      private function requestInit() : void
      {
         ...
         this.var_2019 = true;
         var _loc1_:RoomObjectFurnitureActionEvent = new RoomObjectFurnitureActionEvent(RoomObjectFurnitureActionEvent.const_651,object.getId(),object.getType());
