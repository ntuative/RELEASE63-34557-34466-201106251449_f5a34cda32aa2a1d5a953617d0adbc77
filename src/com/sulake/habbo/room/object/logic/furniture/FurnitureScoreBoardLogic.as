package com.sulake.habbo.room.object.logic.furniture
{
   ...
   public class FurnitureScoreBoardLogic extends FurnitureLogic
   {
      ...
      private function updateScore(param1:int) : void
      {
         ...
         if(this.var_843 != _loc2_)
         {
            _loc3_ = this.var_843 - _loc2_;
            if(_loc3_ < 0)
            {
               _loc3_ = -_loc3_;
            }
            if(_loc3_ * const_474 > const_1090)
            {
               this.var_1080 = const_1090 / _loc3_;
            }
            else
            {
               this.var_1080 = const_474;
            }
            this.var_1574 = getTimer();
         }
      }
      ...
      override public function update(param1:int) : void
      {
         ...
         if(object != null)
         {
            ...
            if(_loc2_ != this.var_843 && param1 >= this.var_1574 + this.var_1080)
            {
               _loc3_ = param1 - this.var_1574;
               ...
               if(_loc4_ > _loc5_ * (this.var_843 - _loc2_))
               {
                  _loc4_ = _loc5_ * (this.var_843 - _loc2_);
               }
               object.setState(_loc2_ + _loc5_ * _loc4_,0);
               this.var_1574 = param1 - (_loc3_ - _loc4_ * this.var_1080);
            }
         }
      }
   }
