   ...
   public class FurnitureIceStormLogic extends FurnitureMultiStateLogic
   {
      ...
      private function handleDataUpdateMessage(param1:RoomObjectDataUpdateMessage) : void
      {
         ...
         else
         {
            ...
            this.var_2528 = param1.extra;
            this.var_1228 = lastUpdateTime + _loc3_;
         }
      }
      ...
      {
         var _loc2_:* = null;
         if(this.var_1228 > 0 && param1 >= this.var_1228)
         {
            this.var_1228 = 0;
            _loc2_ = new RoomObjectDataUpdateMessage(this.var_1877,String(this.var_1877),this.var_2528);
