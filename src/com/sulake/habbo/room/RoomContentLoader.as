package com.sulake.habbo.room
{
   ...
   public class RoomContentLoader implements IRoomContentLoader, IFurniDataListener, IDisposable
   {
      ...
      public static const const_934:String = "RCL_LOADER_READY";
      
      private static const const_390:String = "RCL_PUBLICROOM_";
      
      private static const const_2081:int = 0;
      
      private static const const_1078:int = 1;
      
      private static const name_5:int = 2;
      
      private static const const_478:String = "place_holder";
      
      private static const const_691:String = "wall_place_holder";
      
      private static const const_690:String = "pet_place_holder";
      
      private static const PLACE_HOLDER_DEFAULT:String = const_478;
      
      private static const const_692:String = "room";
      ...
      private var var_1530:IEventDispatcher = null;
      ...
      public function RoomContentLoader(param1:String)
      {
         ...
         this.var_2553 = ["hh_people_pool","hh_people_pool_calippo","hh_paalu","hh_people_paalu"];
         this.var_2550 = ["room_public","room_public_park","room_public_pool"];
         super();
      ...
      public function initialize(param1:IEventDispatcher, param2:IHabboConfigurationManager) : void
      {
         ...
         this.var_2551 = param2.getKey("flash.dynamic.download.url","furniture/");
         this.var_2549 = param2.getKey("flash.dynamic.download.name.template","%typeid%.swf");
      ...
      private function initFurnitureData() : void
      {
         ...
         var _loc1_:Array = this.var_417.getFurniData(this);
         if(_loc1_ == null)
         {
            return;
         }
      ...
      private function populateFurniData(param1:Array) : void
      {
         ...
         for each(_loc2_ in param1)
         {
            ...
            {
               this.var_824.add(_loc4_,_loc6_);
            }
            _loc7_ = _loc2_.name;
            if(_loc2_.type == "s")
            {
               this.var_449.add(_loc3_,_loc4_);
            ...
            else if(_loc2_.type == "i")
            {
               ...
               this.var_654.add(_loc3_,_loc4_);
               if(this._wallItems[_loc7_] == null)
               {
                  this._wallItems[_loc7_] = 1;
               }
            }
            _loc8_ = this.var_655.getValue(_loc7_);
            if(_loc5_ > _loc8_)
            {
               this.var_655.remove(_loc7_);
               this.var_655.add(_loc7_,_loc5_);
            }
         }
      }
      ...
      private function continueInitilization() : void
      {
         if(this.var_2552)
         {
            ...
            {
               this.var_1530.dispatchEvent(new Event(const_934));
            }
         }
      }
      ...
      public function getObjectCategory(param1:String) : int
      {
         ...
         {
            return RoomObjectCategoryEnum.const_350;
         }
         return RoomObjectCategoryEnum.const_169;
      }
      ...
      {
         return [const_478,const_691,const_690,const_692,TILE_CURSOR,const_1077];
      }
      
      public function getActiveObjectType(param1:int) : String
      {
         var _loc2_:String = this.var_449.getValue(param1) as String;
         return this.getObjectType(_loc2_);
      }
      
      public function getWallItemType(param1:int, param2:String = null) : String
      {
         var _loc3_:String = this.var_654.getValue(param1) as String;
      ...
      {
         var _loc2_:String = this.var_654.getValue(param1) as String;
         return this.getObjectColorIndex(_loc2_);
      }
      ...
      public function getRoomObjectAdURL(param1:String) : String
      {
         ...
         {
            return this.var_824.getValue(param1);
         }
         return "";
      }
      ...
      {
         if(param1 == RoomObjectVisualizationEnum.const_300 || param1 == RoomObjectVisualizationEnum.const_58 || param1 == RoomObjectVisualizationEnum.BOT)
         {
            return true;
         }
         return false;
      ...
      public function insertObjectContent(param1:int, param2:int, param3:IAssetLibrary) : Boolean
      {
         ...
         if(_loc5_)
         {
            ...
            if(this.initializeGraphicAssetCollection(_loc4_,param3))
            {
               ...
               _loc6_ = new RoomContentLoadedEvent(RoomContentLoadedEvent.const_395,_loc4_);
      ...
      public function loadObjectContent(param1:String, param2:IEventDispatcher) : Boolean
      {
         ...
         if(this.var_1531.getValue(param1) != null)
         {
            this.var_214 = this.var_1531.getValue(param1) as PublicRoomData;
         }
      ...
      public function loadLegacyContent(param1:String, param2:IEventDispatcher) : Array
      {
         ...
         {
            if(_loc3_[_loc5_].toString().length > 0 && this.var_2553.indexOf(_loc3_[_loc5_]) == -1)
            {
      ...
      private function onContentLoadError(param1:Event) : void
      {
         ...
         for each(_loc4_ in _loc3_)
         {
            ...
            {
               Core.crash("Failed to load asset: " + _loc2_.url,Core.const_1744);
               return;
            }
         }
      }
      ...
      private function onContentLoaded(param1:Event) : void
      {
         ...
         if(_loc4_)
         {
            if(this.var_2550.indexOf(this.getVisualizationType(_loc5_)) >= 0)
            {
         ...
         {
            _loc3_ = new RoomContentLoadedEvent(RoomContentLoadedEvent.const_580,_loc5_);
         }
      ...
      private function extractPublicRoomDataFromLoadedContent(param1:String, param2:IAssetLibrary) : void
      {
         ...
         this.var_1531.add(param1,_loc4_);
         this.var_214 = _loc4_;
      ...
      public function extractObjectContent(param1:String, param2:String) : Boolean
      {
         ...
         this.var_823.add(param2,param1);
         if(this.initializeGraphicAssetCollection(param2,_loc3_))
         {
            return true;
         }
         this.var_823.remove(param2);
         return false;
      }
      ...
      private function getAssetLibrary(param1:String) : IAssetLibrary
      {
         ...
         if(_loc3_ == null)
         {
            _loc4_ = this.var_823.getValue(_loc2_);
            if(_loc4_ != null)
            {
      ...
      private function createGraphicAssetCollection(param1:String, param2:IAssetLibrary) : IGraphicAssetCollection
      {
         ...
         _loc3_ = this.var_590.createGraphicAssetCollection();
         if(_loc3_ != null)
         {
      ...
      {
         if(this.getObjectCategory(const_390 + param1) == RoomObjectCategoryEnum.const_84)
         {
            return true;
         }
         return false;
      ...
      public function setActiveObjectType(param1:int, param2:String) : void
      {
         ...
         this.var_449.add(param1,param2);
      }
   }
}
