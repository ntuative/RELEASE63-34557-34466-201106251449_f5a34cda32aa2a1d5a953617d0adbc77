package com.sulake.habbo.room.utils
{
   ...
   public class RoomInstanceData
   {
      ...
      private var var_773:TileHeightMap = null;
      
      private var var_1181:LegacyWallGeometry = null;
      
      private var var_1182:RoomCamera = null;
      
      private var var_774:SelectedRoomObjectData = null;
      ...
      public function addFurnitureData(param1:FurnitureData) : void
      {
         if(param1 != null)
         {
            this.var_531.remove(param1.id);
            this.var_531.add(param1.id,param1);
         }
      }
      ...
      public function getFurnitureData() : FurnitureData
      {
         ...
         {
            return this.getFurnitureDataWithId(this.var_531.getKey(0));
         }
         return null;
      }
      ...
      {
         return this.var_531.remove(param1);
      }
