package com.sulake.habbo.room
{
   ...
   public class RoomMessageHandler
   {
      ...
      private var var_1557:int = -1.0E9;
      ...
      {
         if(this.var_1031 != 0 || this.var_1032 != 0)
         {
            if(this.var_12 != null)
            {
               this.var_12.disposeRoom(this.var_1031,this.var_1032);
            }
         }
      ...
      private function onRoomReady(param1:IMessageEvent) : void
      {
         ...
         if(this.var_1031 != _loc3_.roomId || this.var_1032 != _loc3_.roomCategory)
         {
      ...
      private function onFloorHeightMap(param1:IMessageEvent) : void
      {
         ...
         while(_loc15_ < _loc8_)
         {
            ...
            while(_loc19_ < _loc7_)
            {
               ...
               if(!_loc13_)
               {
                  if((_loc15_ > 0 && _loc15_ < _loc8_ - 1 || _loc19_ > 0 && _loc19_ < _loc7_ - 1) && _loc20_ != RoomPlaneParser.const_79)
                  {
                     if(_loc3_.getTileHeight(_loc19_,_loc15_ - 1) == RoomPlaneParser.const_79 && _loc3_.getTileHeight(_loc19_ - 1,_loc15_) == RoomPlaneParser.const_79 && _loc3_.getTileHeight(_loc19_,_loc15_ + 1) == RoomPlaneParser.const_79)
                     {
                     ...
                     if(_loc3_.getTileHeight(_loc19_,_loc15_ - 1) == RoomPlaneParser.const_79 && _loc3_.getTileHeight(_loc19_ - 1,_loc15_) == RoomPlaneParser.const_79 && _loc3_.getTileHeight(_loc19_ + 1,_loc15_) == RoomPlaneParser.const_79)
                     {
      ...
      private function onUserUpdate(param1:IMessageEvent) : void
      {
         ...
         var _loc7_:Number = _loc6_.getNumber(RoomVariableEnum.const_924);
         var _loc8_:int = 0;
               ...
               for each(_loc18_ in _loc9_.actions)
               {
                  switch(_loc18_.actionType)
                  {
                     case "flatctrl":
                        ...
                        break;
                     case "sign":
                        this.var_12.updateObjectUserAction(_loc4_,_loc5_,_loc9_.id,RoomObjectVariableEnum.const_443,int(_loc18_.actionParameter));
                        break;
                     case "gst":
      ...
      private function onWave(param1:IMessageEvent) : void
      {
         ...
         this.var_12.updateObjectUserAction(_loc4_,_loc5_,_loc3_.userId,RoomObjectVariableEnum.const_296,_loc6_);
      }
      ...
      private function onDance(param1:IMessageEvent) : void
      {
         ...
         var _loc4_:int = this.getRoomId(_loc3_.roomId);
         var _loc5_:int = this.getRoomCategory(_loc3_.roomCategory);
         this.var_12.updateObjectUserAction(_loc4_,_loc5_,_loc3_.userId,RoomObjectVariableEnum.const_511,_loc3_.danceStyle);
      }
      ...
      private function onAvatarSleep(param1:IMessageEvent) : void
      {
         ...
         this.var_12.updateObjectUserAction(_loc4_,_loc5_,_loc3_.userId,RoomObjectVariableEnum.const_291,_loc6_);
      }
      ...
      private function onCarryObject(param1:IMessageEvent) : void
      {
         ...
         if(param1 is CarryObjectMessageEvent)
         {
            ...
            this.var_12.updateObjectUserAction(_loc3_,_loc4_,_loc2_.userId,RoomObjectVariableEnum.const_344,_loc2_.itemType,_loc2_.itemName);
         }
      }
      ...
      private function onSlideUpdate(param1:IMessageEvent) : void
      {
         ...
         if(param1 is SlideObjectBundleMessageEvent)
         {
            ...
            if(_loc2_.avatar != null)
            {
               ...
               {
                  case SlideObjectMessageData.const_1305:
                     _loc9_ = "mv";
                     break;
      ...
      private function onChat(param1:IMessageEvent) : void
      {
         ...
         this.var_12.updateObjectUserAction(_loc3_,_loc4_,_loc2_.userId,RoomObjectVariableEnum.const_195,Math.ceil(_loc2_.text.length / 10));
      }
      ...
      private function onTypingStatus(param1:IMessageEvent) : void
      {
         ...
         this.var_12.updateObjectUserAction(_loc4_,_loc5_,_loc3_.userId,RoomObjectVariableEnum.const_543,_loc6_);
      }
      ...
      private function onPetExperience(param1:PetExperienceEvent) : void
      {
         ...
         var _loc3_:int = this.getRoomId(_loc2_.roomId);
         var _loc4_:int = this.getRoomCategory(_loc2_.roomCategory);
         this.var_12.updateObjectUserAction(_loc3_,_loc4_,_loc2_.petRoomIndex,RoomObjectVariableEnum.const_400,_loc2_.gainedExperience);
      }
      ...
      private function onParkBusDoor(param1:IMessageEvent) : void
      {
         ...
         if(_loc7_ != null)
         {
            _loc7_.setNumber(RoomObjectVariableEnum.const_1383,_loc3_.status);
         }
      }
      ...
      private function onGamePlayerNumberValue(param1:IMessageEvent) : void
      {
         ...
         if(param1 is GamePlayerValueMessageEvent)
         {
            ...
            _loc3_ = this.getRoomId(_loc2_.roomId);
            _loc4_ = this.getRoomCategory(_loc2_.roomCategory);
            this.var_12.updateObjectUserAction(_loc3_,_loc4_,_loc2_.userId,RoomObjectVariableEnum.const_455,_loc2_.value);
         }
      }
   }
}
