package com.sulake.habbo.notifications
{
   ...
   public class HabboNotifications extends Component implements IHabboNotifications, IUpdateReceiver, IGetImageListener
   {
      ...
      private static const const_1635:String = "pixelbalance";
      
      private static const const_1636:String = "badges";
      
      private static const const_1639:String = "selectbadge";
      
      private static const const_1640:String = "inventory";
      
      private static const const_1642:String = "selectfurni";
      
      private static const UILINK_CREDITS:String = "credits";
      
      private static const const_1637:String = "friendlist";
      
      private static const const_1638:String = "pet_inventory";
      
      private static const const_1641:String = "go_to_room";
      ...
      private var var_399:HabboNotificationViewManager;
      
      private var var_257:HabboAlertDialogManager;
      
      private var var_862:ParkBusDialogManager;
      ...
      public function HabboNotifications(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         if(_loc5_ != null)
         {
            XMLVariableParser.parseVariableList(XML(_loc5_.content).children(),this.var_1069);
         }
         var _loc6_:Map = this.var_1069["styles"];
         if(_loc6_ != null)
         {
            _loc7_ = 0;
      ...
      private function addItem(param1:String, param2:String, param3:BitmapData, param4:String = null) : int
      {
         ...
         var _loc5_:Map = this.var_1069["styles"];
         if(_loc5_ == null)
         {
            return 0;
         }
      ...
      public function setQuestTrackerHeight(param1:int) : void
      {
         if(this.var_399)
         {
            this.var_399.topMarginIncrease = param1;
         }
      }
      ...
      {
         this.var_399 = new HabboNotificationViewManager(this._assetLibrary,this._windowManager,this._config,this.var_1069["styles"],this.var_1069["view"]);
         ...
         registerUpdateReceiver(this.var_399,1);
         registerUpdateReceiver(this,2);
         this.var_417.events.addEventListener(BadgeImageReadyEvent.const_218,this.onBadgeImage);
      ...
      function onRespectNotification(param1:IMessageEvent) : void
      {
         ...
         if(this.var_417.userId == _loc2_.userId)
         {
            ...
            if(_loc3_)
            {
               this.addItem(_loc3_.value,NotificationType.const_1229,null);
            }
            if(_loc4_)
            {
               this.addItem(_loc4_.value,NotificationType.const_1229,null);
            }
         }
      }
      ...
      public function addSongPlayingNotification(param1:String, param2:String) : void
      {
         ...
         if(_loc3_)
         {
            this.addItem(_loc3_.value,NotificationType.const_2026,null);
         }
      }
      
      public function showGenericNotification(param1:String) : void
      {
         this.addItem(param1,NotificationType.const_971,null);
      }
      ...
      private function onPurchaseOK(param1:IMessageEvent) : void
      {
         ...
         for each(_loc6_ in _loc4_.products)
         {
            if(_loc6_)
            {
               ...
               {
                  _loc7_ = this.var_417.getFloorItemData(_loc6_.furniClassId);
               }
               else if(_loc6_.productType == CatalogPageMessageProductData.const_63)
               {
                  _loc7_ = this.var_417.getWallItemData(_loc6_.furniClassId);
               }
               ...
               {
                  _loc9_ = this.var_417.getProductData(_loc4_.localizationId);
                  if(_loc9_)
                  {
      ...
      private function getProductImage(param1:String, param2:int, param3:String) : BitmapData
      {
         ...
         switch(param1)
         {
            ...
            case CatalogPageMessageProductData.const_63:
               ...
               break;
            case CatalogPageMessageProductData.const_188:
      ...
      private function onRecyclerFinished(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_ == null || _loc2_.recyclerFinishedStatus != RecyclerFinishedMessageEvent.const_1294)
         {
            return;
         }
         ...
         if(_loc3_)
         {
            this.addItem(_loc3_.value,NotificationType.const_1888,null);
         }
      ...
      {
         var _loc2_:* = null;
         if(this.var_399.isSpaceAvailable() && this.var_1326.length > 0)
         {
            _loc2_ = this.getNextItemFromQueue();
            if(!this.var_399.showItem(_loc2_))
            {
               _loc2_.dispose();
            }
         }
      ...
      {
         if(param1 != null && this.var_399 != null)
         {
            this.var_399.replaceIcon(param1);
         }
      }
      ...
      private function onParkBusMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(this.var_862 == null)
         {
            this.var_862 = new ParkBusDialogManager(this._windowManager,assets,this._localization);
         }
         if(_loc2_ != null || this.var_862 != null)
         {
            this.var_862.handleParkBusCannotEnter(_loc2_.reason);
         }
      }
      ...
      private function getPetImage(param1:int, param2:int, param3:String) : BitmapData
      {
         ...
         if(param1 < 8)
         {
            ...
            _loc6_ = this.var_1121.createPetImage(param1,param2,_loc5_,AvatarScaleType.const_62);
            if(_loc6_ != null)
            {
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         ...
         if(!this.var_2809)
         {
            ...
            this.addItem(_loc2_,NotificationType.const_971,null);
            this.var_2809 = true;
      ...
      {
         if(param2.type == WindowEvent.const_159 || param2.type == WindowEvent.const_539)
         {
            param1.dispose();
         }
      }
      ...
      private function onClubGiftSelected(param1:ClubGiftSelectedEvent) : void
      {
         ...
         this.addItem(_loc5_,NotificationType.const_971,_loc6_);
      }
   }
}
