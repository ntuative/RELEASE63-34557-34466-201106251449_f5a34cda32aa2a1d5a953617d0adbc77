package com.sulake.core.utils
{
   ...
   public class LibraryLoader extends EventDispatcher implements IDisposable
   {
      ...
      protected static const const_2057:uint = 3;
      ...
      public static const const_1331:Boolean = false;
      
      public static const const_1894:int = 2;
      
      private static var var_1118:Array = new Array();
      ...
      protected var var_3060:String = "";
      
      protected var var_3058:String = "";
      
      protected var var_2264:int;
      
      protected var var_1427:int;
      
      protected var var_1426:int;
      
      protected var var_3123:uint = 0;
      
      protected var var_3059:Boolean = true;
      ...
      protected static function queue(param1:LibraryLoader) : void
      {
         if(const_1331)
         {
            if(var_1118.indexOf(param1) == -1)
            {
               var_1118.push(param1);
            }
            throttle();
         }
         else
      ...
      protected static function throttle() : void
      {
         ...
         if(const_1331)
         {
            ...
            while(var_906.length < const_1894 && false)
            {
               _loc1_ = var_1118.shift() as LibraryLoader;
      ...
      {
         return !!this.var_1151 ? uint(this.var_1427 - this.var_2264) : uint(getTimer() - this.var_2264);
      }
      ...
      {
         if(this.var_1150 && !_disposed)
         {
            this.var_1150 = false;
            if(!this.var_1151 && this.var_266)
            {
               this.var_1427 = -1;
               this.var_2264 = getTimer();
               queue(this);
            }
         }
      }
      ...
      {
         if(!this.var_1151 && !_disposed && this.var_1426 > 0)
         {
            try
            {
               this.var_45.close();
            ...
            this.addRequestCounterToUrlRequest(this.var_266,const_1864 - this.var_1426);
            if(this.var_3059)
            {
      ...
      protected function loadEventHandler(param1:Event) : void
      {
         ...
         if(this.var_512 == LibraryLoader.const_2057)
         {
      ...
      protected function prepareLibrary() : Boolean
      {
         ...
         this.var_615 = this.getDefinition(this._name) as Class;
         ...
         try
         {
            xmlClass = this.var_615.manifest as Class;
            if(xmlClass == null)
            {
               return false;
            }
