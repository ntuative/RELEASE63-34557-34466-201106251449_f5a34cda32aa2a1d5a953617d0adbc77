package com.sulake.core.utils.debug
{
   ...
   public class GarbageMonitor implements IDisposable
   {
      ...
      private var var_1098:Dictionary;
      
      public function GarbageMonitor()
      {
         super();
         this.var_1098 = new Dictionary(true);
      }
      ...
      {
         this.var_1098[param1] = param2 == null ? param1.toString() : param2;
      }
      ...
      public function get list() : Array
      {
         ...
         for each(_loc2_ in this.var_1098)
         {
            _loc1_.push(_loc2_);
         }
         return _loc1_;
