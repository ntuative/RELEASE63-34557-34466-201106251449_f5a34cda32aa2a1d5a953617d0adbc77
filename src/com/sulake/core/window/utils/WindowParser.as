package com.sulake.core.window.utils
{
   ...
   public class WindowParser implements IWindowParser
   {
      ...
      public static const const_2189:String = "_INCLUDE";
      
      public static const const_2161:String = "_TEMP";
      
      private static const const_1604:String = "layout";
      
      private static const const_1106:String = "window";
      
      private static const const_1107:String = "variables";
      
      private static const const_1105:String = "filters";
      
      private static const const_684:String = "name";
      
      private static const const_1614:String = "style";
      
      private static const const_703:String = "params";
      
      private static const const_1616:String = "tags";
      ...
      private static const const_1608:String = "visible";
      
      private static const const_1615:String = "caption";
      
      private static const ID:String = "id";
      
      private static const const_4:String = "background";
      
      private static const const_1363:String = "blend";
      
      private static const const_1609:String = "clipping";
      
      private static const COLOR:String = "color";
      
      private static const const_1602:String = "treshold";
      
      private static const const_1613:String = "children";
      
      private static const const_1607:String = "width_min";
      
      private static const WIDTH_MAX:String = "width_max";
      
      private static const const_1610:String = "height_min";
      
      private static const const_1605:String = "height_max";
      
      private static const const_704:String = "CanCreateRoomEvent";
      
      private static const const_185:String = "0";
      
      private static const const_1612:String = "$";
      
      private static const const_1611:String = ",";
      
      private static const const_50:String = "";
      
      private static const const_1606:RegExp = /^(\s|\n|\r|\t|\v)*/m;
      
      private static const const_1603:RegExp = /(\s|\n|\r|\t|\v)*$/;
       
      
      protected var var_1421:Dictionary;
      
      protected var var_1422:Dictionary;
      
      protected var var_1147:Dictionary;
      
      protected var var_1708:Dictionary;
      
      protected var var_2261:Map;
      ...
      public function WindowParser(param1:IWindowContext)
      {
         ...
         TypeCodeTable.fillTables(this.var_1421,this.var_1422);
         this.var_1147 = new Dictionary();
         this.var_1708 = new Dictionary();
         ParamCodeTable.fillTables(this.var_1147,this.var_1708);
         this.var_2261 = new Map();
      }
      
      private static function trimWhiteSpace(param1:String) : String
      {
         param1 = param1.replace(const_1603,const_50);
         return param1.replace(const_1606,const_50);
      }
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            ...
            for(_loc1_ in this.var_1422)
            {
               delete this.var_1422[_loc1_];
            }
            for(_loc1_ in this.var_1147)
            {
               delete this.var_1147[_loc1_];
            }
            for(_loc1_ in this.var_1708)
            {
               delete this.var_1708[_loc1_];
            }
            this.var_2261.dispose();
            this.var_2261 = null;
            this._context = null;
            this._disposed = true;
         }
      ...
      public function parseAndConstruct(param1:XML, param2:IWindow, param3:Map) : IWindow
      {
         ...
         var _loc12_:* = null;
         var _loc13_:int = 0;
         if(param1.localName() == const_1604)
         {
            _loc8_ = param1.child(const_1107);
            if(_loc8_.length() > 0)
            {
               _loc10_ = _loc8_[0];
            ...
            _loc9_ = param1.child(const_1105).children();
            if(_loc9_.length() > 0)
            {
               _loc12_ = new Array();
               _loc13_ = 0;
            ...
            _loc4_ = param1.child(const_1106);
         ...
         if(param1.localName() == const_1106)
         {
      ...
      private function parseSingleWindowEntity(param1:XML, param2:WindowController, param3:Map) : IWindow
      {
         ...
         style = uint(this.parseAttribute(xml,const_1614,variables,style));
         params = uint(this.parseAttribute(xml,const_703,variables,params));
         tag = unescape(String(this.parseAttribute(xml,const_1616,variables,tag)));
         rect = new Rectangle();
         ...
         visible = this.parseAttribute(xml,const_1608,variables,visible.toString()) == const_704;
         id = int(this.parseAttribute(xml,ID,variables,id.toString()));
         if(xml.child(const_703).length() > 0)
         {
            list = xml.child(const_703).children();
            length = list.length();
            i = 0;
            while(i < length)
            {
               ...
               if(this.var_1147[param] == null)
               {
                  throw new Error("Unknown window parameter \"" + String(node.attribute(const_684)) + "\"!");
               }
               params |= this.var_1147[param];
               i++;
            }
         }
         caption = !!(params & 0) ? (!!parent ? parent.caption : const_50) : const_50;
         caption = unescape(String(this.parseAttribute(xml,const_1615,variables,caption)));
         if(tag != const_50)
         {
            tags = tag.split(const_1611);
            length = tags.length;
            i = 0;
            while(i < length)
            {
         ...
         window = this._context.create(name,null,type,style,params,rect,null,parent is IIterable ? null : parent,id,this.parseProperties(xml.child(const_1107)[0]),tags) as WindowController;
         window.limits.minWidth = int(this.parseAttribute(xml,const_1607,variables,window.limits.minWidth));
         window.limits.maxWidth = int(this.parseAttribute(xml,WIDTH_MAX,variables,window.limits.maxWidth));
         window.limits.minHeight = int(this.parseAttribute(xml,const_1610,variables,window.limits.minHeight));
         window.limits.maxHeight = int(this.parseAttribute(xml,const_1605,variables,window.limits.maxHeight));
         background = this.parseAttribute(xml,const_4,variables,window.background.toString()) == const_704;
         blend = Number(this.parseAttribute(xml,const_1363,variables,window.blend.toString()));
         clipping = this.parseAttribute(xml,const_1609,variables,window.clipping.toString()) == const_704;
         color = String(this.parseAttribute(xml,COLOR,variables,window.color.toString()));
         treshold = uint(this.parseAttribute(xml,const_1602,variables,window.mouseThreshold.toString()));
         ...
         list = xml.child(const_1105).children();
         length = list.length();
         if(length > 0)
         {
            filters = new Array();
         ...
         if(window != null)
         {
            if(parent != null)
            {
               if(parent is IIterable)
               {
                  ...
                  {
                     if((params & 0) == WindowParam.const_236)
                     {
                        window.x = rect.x;
                     }
      ...
      public function windowToXMLString(param1:IWindow) : String
      {
         ...
         var _loc2_:* = const_50;
         var _loc3_:String = this.var_1422[param1.type];
