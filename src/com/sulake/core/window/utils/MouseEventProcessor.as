package com.sulake.core.window.utils
{
   ...
   public class MouseEventProcessor implements IEventProcessor, IDisposable
   {
      ...
      protected static var var_313:Array;
      
      protected static var var_432:Point = new Point();
      ...
      public function MouseEventProcessor()
      {
         ...
         {
            var_361 = new Array();
            var_361[0] = MouseCursorType.const_362;
            var_361[1] = MouseCursorType.const_31;
            var_361[2] = MouseCursorType.const_362;
            var_361[3] = MouseCursorType.const_362;
            var_361[4] = MouseCursorType.const_362;
            var_361[5] = MouseCursorType.const_31;
            var_361[6] = MouseCursorType.const_362;
         }
         if(var_313 == null)
         {
            var_313 = new Array();
            var_313[0] = WindowState.const_92;
            var_313[1] = WindowState.const_91;
            var_313[2] = WindowState.const_89;
            var_313[3] = WindowState.const_72;
            var_313[4] = WindowState.const_55;
            var_313[5] = WindowState.const_96;
            var_313[6] = WindowState.const_93;
         }
      }
      ...
      protected static function convertMouseEventType(param1:MouseEvent, param2:IWindow, param3:IWindow) : WindowMouseEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case MouseEvent.MOUSE_UP:
               ...
               _loc4_ = !!_loc6_ ? "null" : WindowMouseEvent.const_256;
               break;
      ...
      public function process(param1:EventProcessorState, param2:IEventQueue) : void
      {
         ...
         this.var_70 = state.var_1407 as WindowController;
         this.var_190 = state.var_1405 as WindowController;
         this.var_186 = state.renderer;
         this.var_937 = state.var_1404;
         eventQueue.begin();
         this.var_756.x = -1;
         this.var_756.y = -1;
         ...
         while(true)
         {
            ...
            if(event.stageX != this.var_756.x || event.stageY != this.var_756.y)
            {
               ...
               array = new Array();
               this.var_95.groupParameterFilteredChildrenUnderPoint(this.var_756,array,WindowParam.const_30);
            }
            ...
            if(index == 0)
            {
               if(event.type == MouseEvent.MOUSE_MOVE)
               {
                  ...
                  {
                     this.var_70.getGlobalPosition(var_432);
               ...
               if(child != null && child.visible)
               {
                  if(event.type == MouseEvent.MOUSE_MOVE)
                  {
                     if(child != this.var_70)
                     {
                        ...
                        if(!child.disposed)
                        {
                           child.getGlobalPosition(var_432);
                  ...
                  else if(event.type == MouseEvent.MOUSE_UP || event.type == MouseEvent.CLICK)
                  {
                     if(this.var_70 && !this.var_70.disposed)
                     {
                        ...
                        {
                           this.var_937.mouseEventReceived(event.type,this.var_70);
                        }
                     }
                  }
                  temp = child.parent;
         ...
         state.var_1407 = this.var_70;
         state.var_1405 = this.var_190;
         state.renderer = this.var_186;
         state.var_1404 = this.var_937;
      }
      ...
      private function passMouseEvent(param1:WindowController, param2:MouseEvent, param3:Boolean = false) : WindowController
      {
         ...
         if(param1.testParamFlag(WindowParam.const_602))
         {
