package com.sulake.core.window.events
{
   ...
   public class WindowMouseEvent extends WindowEvent
   {
      ...
      public static const const_142:String = "WME_DOUBLE_CLICK";
      
      public static const const_45:String = "WME_DOWN";
      
      public static const const_2133:String = "WME_MIDDLE_CLICK";
      
      public static const const_2129:String = "WME_MIDDLE_DOWN";
      
      public static const const_2304:String = "WME_MIDDLE_UP";
      ...
      public static const const_256:String = "WME_UP_OUTSIDE";
      
      public static const const_380:String = "WME_WHEEL";
      
      public static const const_2273:String = "WME_RIGHT_CLICK";
      
      public static const const_2217:String = "WME_RIGHT_DOWN";
      
      public static const const_2266:String = "WME_RIGHT_UP";
      
      public static const const_2035:String = "WME_ROLL_OUT";
      
      public static const const_2033:String = "WME_ROLL_OVER";
      
      public static const const_2264:String = "WME_HOVERING";
      ...
      public static function allocate(param1:String, param2:IWindow, param3:IWindow, param4:Number, param5:Number, param6:Number, param7:Number, param8:Boolean, param9:Boolean, param10:Boolean, param11:Boolean, param12:int) : WindowMouseEvent
      {
         ...
         _loc13_.var_752 = param3;
         _loc13_.var_164 = false;
         _loc13_.var_753 = POOL;
      ...
      {
         return "WindowMouseEvent { type: " + _type + " cancelable: " + var_510 + " window: " + _window + " localX: " + this.localX + " localY: " + this.localY + " }";
      }
   }
}
