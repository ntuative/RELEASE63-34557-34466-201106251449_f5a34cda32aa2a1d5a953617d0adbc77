package com.sulake.core.window.components
{
   ...
   public class TextController extends WindowController implements ITextWindow, ITextFieldContainer, ILocalizable
   {
      ...
      protected var var_1142:Boolean = false;
      ...
      protected static function setTextFormatting(param1:TextField, param2:String, param3:TextStyle) : void
      {
         ...
         {
            _loc5_.underline = _loc4_.textDecoration == TextStyle.const_808 ? true : null;
         }
      ...
      {
         return new Rectangle(this.var_933 * this.maxScrollH,this.var_606 * this.maxScrollV,width,height);
      }
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct(PropertyDefaults.const_1000,this._field.antiAliasType,PropertyStruct.const_51,this._field.antiAliasType != _loc2_.antiAliasType,PropertyDefaults.const_1241));
         _loc1_.push(this._autoSize != PropertyDefaults.const_1353 ? new PropertyStruct(PropertyDefaults.const_760,this._autoSize,PropertyStruct.const_51,true,PropertyDefaults.const_1205) : PropertyDefaults.const_1828);
         ...
         _loc1_.push(new PropertyStruct("font_size",this.defaultTextFormat.size,PropertyStruct.const_295,this.defaultTextFormat.size != _loc2_.fontSize));
         _loc1_.push(this._field.gridFitType != PropertyDefaults.const_1337 ? new PropertyStruct(PropertyDefaults.const_1268,this._field.gridFitType,PropertyStruct.const_51,true,PropertyDefaults.const_1200) : PropertyDefaults.const_1833);
         _loc1_.push((_loc2_.color != null ? this._field.textColor != _loc2_.color : this._field.textColor != PropertyDefaults.const_860) ? new PropertyStruct(PropertyDefaults.const_412,this._field.textColor,PropertyStruct.const_150,true) : PropertyDefaults.const_1332);
         _loc1_.push(this.var_464 != TextStyleManager.const_225 ? new PropertyStruct(PropertyDefaults.const_462,this.var_464,PropertyStruct.const_51,true,PropertyDefaults.const_816) : PropertyDefaults.const_1267);
         _loc1_.push(this.var_44.left != PropertyDefaults.const_826 ? new PropertyStruct(PropertyDefaults.const_299,this.var_44.left,PropertyStruct.const_38,true) : PropertyDefaults.const_985);
         _loc1_.push(this.var_44.top != PropertyDefaults.const_823 ? new PropertyStruct(PropertyDefaults.const_254,this.var_44.top,PropertyStruct.const_38,true) : PropertyDefaults.const_765);
         _loc1_.push(this.var_44.right != PropertyDefaults.const_752 ? new PropertyStruct(PropertyDefaults.const_269,this.var_44.right,PropertyStruct.const_38,true) : PropertyDefaults.const_972);
         _loc1_.push(this.var_44.bottom != PropertyDefaults.const_802 ? new PropertyStruct(PropertyDefaults.const_257,this.var_44.bottom,PropertyStruct.const_38,true) : PropertyDefaults.const_767);
         _loc1_.push(this._field.mouseWheelEnabled != PropertyDefaults.const_1373 ? new PropertyStruct(PropertyDefaults.const_818,this._field.mouseWheelEnabled,PropertyStruct.const_37,true) : PropertyDefaults.const_1892);
         ...
         _loc1_.push(new PropertyStruct("sharpness",this._field.sharpness,PropertyStruct.const_122,this._field.sharpness != 0));
         _loc1_.push(new PropertyStruct("thickness",this._field.thickness,PropertyStruct.const_122,this._field.thickness != 0));
         ...
         _loc1_.push(new PropertyStruct("spacing",this._field.defaultTextFormat.letterSpacing,PropertyStruct.const_122,this._field.defaultTextFormat.letterSpacing != 0));
         return _loc1_;
      }
   }
}
