package com.sulake.core.window.components
{
   ...
   public class TextFieldController extends TextController implements ITextFieldWindow
   {
      ...
      protected var var_1704:uint = 500;
      
      protected var var_1411:String = "";
      
      protected var var_1424:Boolean = false;
      
      protected var var_848:Boolean = false;
      ...
      {
         this.var_1411 = param1 == null ? "" : param1;
      }
      ...
      override public function getGraphicContext(param1:Boolean) : IGraphicContext
      {
         if(param1 && !var_22)
         {
            var_22 = new GraphicContext("GC {" + _name + "}",GraphicContext.const_1238,var_11);
         }
         return var_22;
      }
      ...
      protected function refreshAutoSize() : void
      {
         ...
         var _loc2_:* = null;
         var _loc3_:* = null;
         if(this.var_848 && autoSize != TextFieldAutoSize.NONE)
         {
            if(false)
            {
      ...
      private function onKeyUpEvent(param1:KeyboardEvent) : void
      {
         ...
         {
            var_18 = _field.text;
            windowEvent = WindowKeyboardEvent.allocate(WindowKeyboardEvent.const_354,event,this,null);
            this.update(this,windowEvent);
            windowEvent.recycle();
         }
         catch(e:Error)
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(true ? new PropertyStruct(PropertyDefaults.const_993,false,PropertyStruct.const_37,true) : PropertyDefaults.const_1792);
         _loc1_.push(this.var_1424 != PropertyDefaults.const_1406 ? new PropertyStruct(PropertyDefaults.const_879,this.var_1424,PropertyStruct.const_37,true) : PropertyDefaults.const_1805);
         _loc1_.push(_field.selectable != PropertyDefaults.const_1367 ? new PropertyStruct(PropertyDefaults.const_884,_field.selectable,PropertyStruct.const_37,true) : PropertyDefaults.const_1777);
         _loc1_.push(_field.displayAsPassword != PropertyDefaults.const_1320 ? new PropertyStruct("display_as_password",_field.displayAsPassword,PropertyStruct.const_37,true) : PropertyDefaults.const_1890);
         return _loc1_;
      }
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               case PropertyDefaults.const_879:
                  this.var_1424 = _loc2_.value as Boolean;
                  if(this.var_1424)
                  {
               ...
               case PropertyDefaults.const_884:
                  ...
                  break;
               case PropertyDefaults.const_993:
                  _field.type = !!_loc2_.value ? "null" : TextFieldType.DYNAMIC;
                  break;
               case PropertyDefaults.const_1381:
