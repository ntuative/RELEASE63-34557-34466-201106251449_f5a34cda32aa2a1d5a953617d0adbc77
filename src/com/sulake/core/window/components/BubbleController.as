package com.sulake.core.window.components
{
   ...
   public class BubbleController extends FrameController implements IBubbleWindow
   {
      ...
      private static const const_2103:String = "_POINTER_UP";
      
      private static const const_2104:String = "_POINTER_DOWN";
      
      private static const const_2101:String = "_POINTER_LEFT";
      
      private static const const_2102:String = "_POINTER_RIGHT";
      ...
      public function set direction(param1:String) : void
      {
         ...
         if(param1 != this._direction)
         {
            ...
            this.pointerOffset = this.var_878;
         }
      }
      ...
      override public function get properties() : Array
      {
         ...
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_862,this._direction,PropertyStruct.const_51,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1862);
         }
         if(this.var_878 != 0)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_807,this.var_878,PropertyStruct.const_38,true));
         }
         else
         {
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               case PropertyDefaults.const_862:
                  ...
                  break;
               case PropertyDefaults.const_807:
