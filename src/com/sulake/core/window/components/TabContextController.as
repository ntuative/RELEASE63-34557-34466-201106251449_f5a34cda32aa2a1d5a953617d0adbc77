package com.sulake.core.window.components
{
   ...
   public class TabContextController extends WindowController implements ITabContextWindow, IIterable
   {
      ...
      private static const const_1732:String = "_SELECTOR";
      
      private static const const_1731:String = "_CONTENT";
      ...
      public function get selector() : ITabSelectorWindow
      {
         ...
         {
            this.var_1153 = findChildByTag(const_1732) as ITabSelectorWindow;
            if(this.var_1153 != null)
            {
      ...
      public function get container() : IWindowContainer
      {
         ...
         {
            this.var_2268 = findChildByTag(const_1731) as IWindowContainer;
         }
      ...
      {
         return !!this.var_848 ? this.selector.iterator : null;
      }
