package com.sulake.core.window.components
{
   ...
   public class InteractiveController extends WindowController implements IInteractiveWindow
   {
      ...
      {
         if(param1.toolTipCaption != PropertyDefaults.const_624)
         {
      ...
      public static function writeInteractiveWindowProperties(param1:IInteractiveWindow, param2:Array) : Array
      {
         if(param1.toolTipCaption != PropertyDefaults.const_624)
         {
            param2.push(new PropertyStruct(PropertyDefaults.const_873,param1.toolTipCaption,PropertyStruct.const_51,true));
         }
         else
         {
            param2.push(PropertyDefaults.const_1969);
         }
         if(param1.toolTipDelay != PropertyDefaults.const_1375)
         {
            param2.push(new PropertyStruct(PropertyDefaults.const_749,param1.toolTipDelay,PropertyStruct.const_295,true));
         }
         else
         {
      ...
      {
         this.var_1411 = param1 == null ? "null" : param1;
      }
