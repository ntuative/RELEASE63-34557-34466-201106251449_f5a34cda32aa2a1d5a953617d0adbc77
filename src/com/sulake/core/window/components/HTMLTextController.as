package com.sulake.core.window.components
{
   ...
   public class HTMLTextController extends TextFieldController implements IHTMLTextWindow
   {
      ...
      private static var var_964:String = PropertyDefaults.HTML_LINK_TARGET_VALUE;
       
      
      private var var_965:String = "default";
      
      private var var_1183:String = null;
      
      private var var_1780:StyleSheet = null;
      ...
      private static function setHtmlStyleSheetString(param1:HTMLTextController, param2:String) : void
      {
         ...
         if(param1.var_1183 == param2)
         {
            return;
         }
         param1.var_1183 = param2;
         param1.var_1780 = null;
         if(param1.var_1183 != null)
         {
            _loc3_ = new StyleSheet();
            _loc3_.parseCSS(param1.var_1183);
            param1.var_1780 = _loc3_;
         }
      }
      ...
      {
         if(PropertyDefaults.const_1009.indexOf(param1) > -1)
         {
            this.var_965 = param1;
         }
      }
      ...
      {
         return this.var_965 == LinkTarget.const_31 ? defaultLinkTarget : this.var_965;
      }
      ...
      override public function set htmlText(param1:String) : void
      {
         ...
         {
            _field.htmlText = convertLinksToEvents(var_18);
            _field.styleSheet = this.var_1780;
            refreshTextImage();
         }
      }
      ...
      override protected function immediateClickHandler(param1:Event) : void
      {
         ...
         if(param1 is TextEvent)
         {
            ...
            if(!_loc2_.isWindowOperationPrevented() && this.linkTarget != LinkTarget.const_1361)
            {
      ...
      override public function get properties() : Array
      {
         ...
         if(this.var_965 != PropertyDefaults.HTML_LINK_TARGET_VALUE)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_850,this.var_965,PropertyStruct.const_51,true,PropertyDefaults.const_1009));
         }
         else
         {
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         {
            if(_loc2_.key == PropertyDefaults.const_850)
            {
               this.var_965 = _loc2_.value as String;
               break;
            }
