package com.sulake.core.window.components
{
   ...
   public class TextLabelController extends WindowController implements ILabelWindow, ILocalizable
   {
      ...
      private function refresh(param1:Boolean = false) : void
      {
         ...
         this.var_2960 = _loc2_.textWidth;
         this.var_2961 = _loc2_.textHeight;
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push((_loc2_.color != null ? this.var_415 != _loc2_.color : this.var_415 != null && this.var_415 != PropertyDefaults.const_860) ? new PropertyStruct(PropertyDefaults.const_412,this.var_415,PropertyStruct.const_150,true) : PropertyDefaults.const_1332);
         if(this.var_44)
         {
            if(this.var_44.left != PropertyDefaults.const_826)
            {
               _loc1_.push(new PropertyStruct(PropertyDefaults.const_299,this.var_44.left,PropertyStruct.const_38,true));
            }
            else
            {
               _loc1_.push(PropertyDefaults.const_985);
            }
            if(this.var_44.top != PropertyDefaults.const_823)
            {
               _loc1_.push(new PropertyStruct(PropertyDefaults.const_254,this.var_44.top,PropertyStruct.const_38,true));
            }
            else
            {
               _loc1_.push(PropertyDefaults.const_765);
            }
            if(this.var_44.right != PropertyDefaults.const_752)
            {
               _loc1_.push(new PropertyStruct(PropertyDefaults.const_269,this.var_44.right,PropertyStruct.const_38,true));
            }
            else
            {
               _loc1_.push(PropertyDefaults.const_972);
            }
            if(this.var_44.bottom != PropertyDefaults.const_802)
            {
               _loc1_.push(new PropertyStruct(PropertyDefaults.const_257,this.var_44.bottom,PropertyStruct.const_38,true));
            }
            else
            {
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               case PropertyDefaults.const_462:
