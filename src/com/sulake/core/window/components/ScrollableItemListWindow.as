package com.sulake.core.window.components
{
   ...
   public class ScrollableItemListWindow extends WindowController implements IScrollableListWindow
   {
      ...
      private var var_498:IScrollbarWindow;
      ...
      override public function dispose() : void
      {
         if(this.var_498)
         {
            this.var_498.removeEventListener(WindowEvent.const_283,this.scrollBarEventProc);
            this.var_498.removeEventListener(WindowEvent.const_306,this.scrollBarEventProc);
            this.var_498 = null;
         }
         if(this.var_1387)
         {
      ...
      protected function get _itemList() : IItemListWindow
      {
         if(!this.var_1387)
         {
            this.var_1387 = findChildByTag("_ITEMLIST") as IItemListWindow;
         }
      ...
      protected function get _scrollBar() : IScrollbarWindow
      {
         if(!this.var_498)
         {
            this.var_498 = findChildByTag("_SCROLLBAR") as IScrollbarWindow;
            if(this.var_498)
            {
               this.var_498.addEventListener(WindowEvent.const_283,this.scrollBarEventProc);
               this.var_498.addEventListener(WindowEvent.const_306,this.scrollBarEventProc);
            }
         }
         return this.var_498;
      }
      ...
      private function scrollBarEventProc(param1:WindowEvent) : void
      {
         ...
         else if(param1.type == WindowEvent.const_306)
         {
            this.hideScrollBar();
         }
      }
