package com.sulake.core.window.components
{
   ...
   public class ScrollbarController extends InteractiveController implements IScrollbarWindow, ITouchAwareWindow
   {
      ...
      private static const const_1592:String = "increment";
      
      private static const const_1593:String = "decrement";
      
      private static const const_1096:String = "slider_track";
      
      private static const const_700:String = "slider_bar";
      ...
      public function set scrollable(param1:IScrollableWindow) : void
      {
         if(this.var_19 != null && !this.var_19.disposed)
         {
            ...
            this.var_19.removeEventListener(WindowEvent.const_495,this.onScrollableScrolled);
         }
         this.var_19 = param1;
         if(this.var_19 != null && !this.var_19.disposed)
         {
            this.var_19.addEventListener(WindowEvent.const_40,this.onScrollableResized);
            this.var_19.addEventListener(WindowEvent.const_495,this.onScrollableScrolled);
            this.updateLiftSizeAndPosition();
         }
      }
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         while(_loc4_ < _loc2_)
         {
            ...
            {
               this.var_1056 = _loc3_.value as String;
               this.var_19 = null;
            }
            _loc4_++;
         }
      ...
      {
         return findChildByName(const_1096) as WindowController;
      }
      
      protected function get lift() : WindowController
      {
         return this.track.findChildByName(const_700) as WindowController;
      }
      ...
      override public function update(param1:WindowController, param2:WindowEvent) : Boolean
      {
         switch(param1.name)
         {
            case ScrollbarController.const_700:
         ...
         if(param2.type == WindowEvent.const_506)
         {
            if(this.var_19 == null)
            {
      ...
      private function scrollButtonEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.const_45 || param1.type == WindowTouchEvent.const_736)
         {
            ...
            else if(param2.name == const_1593)
            {
               if(this.var_19)
               {
                  this.var_1303 = true;
            ...
            else if(param2.name == const_1096)
            {
               ...
               _loc6_ = WindowController(param2).getChildByName(ScrollbarController.const_700).rectangle;
               if(this._horizontal)
               {
                  if(_loc4_ < _loc6_.x)
                  {
      ...
      private function resolveScrollTarget() : Boolean
      {
         ...
         {
            _loc1_ = findParentByName(this.var_1056) as IScrollableWindow;
            if(_loc1_ == null && _parent is IWindowContainer)
            {
               _loc1_ = IWindowContainer(_parent).findChildByName(this.var_1056) as IScrollableWindow;
               if(_loc1_)
               {
