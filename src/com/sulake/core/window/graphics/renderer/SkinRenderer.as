package com.sulake.core.window.graphics.renderer
{
   ...
   public class SkinRenderer implements ISkinRenderer
   {
      ...
      protected var var_601:Dictionary;
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            ...
            {
               ISkinLayout(this.var_601[_loc1_]).dispose();
               delete this.var_601[_loc1_];
            }
            this.var_601 = null;
            this.var_505 = null;
            for(_loc1_ in this.var_426)
            {
               ISkinTemplate(this.var_426[_loc1_]).dispose();
               delete this.var_426[_loc1_];
            }
            this.var_426 = null;
      ...
      {
         var _loc3_:ISkinLayout = this.var_601[param2];
         if(_loc3_ == null)
         {
      ...
      {
         var _loc3_:ISkinTemplate = this.var_426[param2];
         if(_loc3_ == null)
         {
      ...
      {
         this.var_601[param1.name] = param1;
         return param1;
      }
      ...
      public function removeLayout(param1:ISkinLayout) : ISkinLayout
      {
         var _loc2_:* = null;
         var _loc3_:* = 0;
         param1 = this.var_426[param1.name];
         if(param1 != null)
         {
            ...
            delete this.var_601[param1.name];
         }
         return param1;
      }
      ...
      {
         this.var_426[param1.name] = param1;
         return param1;
      }
      ...
      public function removeTemplate(param1:ISkinTemplate) : ISkinTemplate
      {
         ...
         if(param1 != null)
         {
            ...
            delete this.var_426[param1.name];
         }
         return param1;
      }
   }
