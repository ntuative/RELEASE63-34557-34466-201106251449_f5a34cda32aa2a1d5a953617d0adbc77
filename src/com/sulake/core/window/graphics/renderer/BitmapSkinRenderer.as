package com.sulake.core.window.graphics.renderer
{
   ...
   public class BitmapSkinRenderer extends SkinRenderer implements ISkinRenderer
   {
      ...
      protected var var_927:Dictionary;
      ...
      {
         super(param1);
         this.var_926 = new Dictionary(false);
         this.var_927 = new Dictionary(false);
      ...
      override public function dispose() : void
      {
         ...
         if(!disposed)
         {
            ...
            this.var_267 = null;
            this.var_760 = null;
            for(_loc1_ in this.var_926)
            {
               _loc2_ = this.var_926[_loc1_] as BitmapData;
               _loc2_.dispose();
               delete this.var_926[_loc1_];
            }
            this.var_926 = null;
            for(_loc1_ in this.var_927)
            {
               _loc2_ = this.var_927[_loc1_] as BitmapData;
               _loc2_.dispose();
               delete this.var_927[_loc1_];
            }
            this.var_927 = null;
         }
      }
      ...
      override public function draw(param1:IWindow, param2:IBitmapDrawable, param3:Rectangle, param4:uint, param5:Boolean) : void
      {
         ...
         if(_loc7_ != null && _loc9_ > 0)
         {
            ...
            if(_loc16_)
            {
               this.var_760.redMultiplier = ((param1.color & 16711680) >> 16) / 255;
               this.var_760.greenMultiplier = ((param1.color & 65280) >> 8) / 255;
               this.var_760.blueMultiplier = (param1.color & 255) / 255;
               this.var_760.alphaMultiplier = 1;
            }
            _loc17_ = 0;
            while(_loc17_ < _loc9_)
            {
               ...
               if(_loc11_ != null)
               {
                  ...
                  if(_loc16_ && _loc10_.colorize)
                  {
                     ...
                     _loc18_.colorTransform(_loc18_.rect,this.var_760);
                  }
                  _loc12_ = false;
                  _loc13_ = false;
                  ...
                  if(_loc10_.var_354 == SkinLayoutEntity.const_325)
                  {
                     REGION.x += _loc14_;
                  }
                  else if(_loc10_.var_354 == SkinLayoutEntity.const_606)
                  {
                     _loc12_ = true;
                  ...
                  else if(_loc10_.var_354 == SkinLayoutEntity.const_347)
                  {
                     _loc12_ = true;
                     REGION.right += _loc14_;
                     if(true)
                  ...
                  else if(_loc10_.var_354 == SkinLayoutEntity.const_621)
                  {
                     REGION.x = param3.width / 2 - 0;
                  }
                  if(_loc10_.var_352 == SkinLayoutEntity.const_325)
                  {
                     REGION.y += _loc15_;
                  }
                  else if(_loc10_.var_352 == SkinLayoutEntity.const_606)
                  {
                     _loc13_ = true;
                  ...
                  else if(_loc10_.var_352 == SkinLayoutEntity.const_347)
                  {
                     _loc13_ = true;
                     REGION.bottom += _loc15_;
                     if(true)
                  ...
                  else if(_loc10_.var_352 == SkinLayoutEntity.const_621)
                  {
                  ...
                  else if(_loc10_.var_352 == SkinLayoutEntity.const_347 || _loc10_.var_354 == SkinLayoutEntity.const_347)
                  {
      ...
      protected function drawStaticLayoutEntity(param1:BitmapData, param2:Rectangle, param3:ISkinLayout, param4:SkinLayoutEntity, param5:ISkinTemplate, param6:ISkinTemplateEntity) : void
      {
         ...
         switch(param6.type)
         {
            case "bitmap":
               ...
               if(param4.var_354 == SkinLayoutEntity.const_325)
               {
                  _loc7_.x += param2.width - param3.width;
               }
               if(param4.var_352 == SkinLayoutEntity.const_325)
               {
      ...
      private function getBitmapFromCache(param1:ISkinTemplate, param2:String) : BitmapData
      {
         ...
         var _loc4_:BitmapData = this.var_926[_loc3_];
         if(_loc4_ == null)
         {
      ...
      private function getAlphaFromCache(param1:ISkinTemplate, param2:String) : BitmapData
      {
         ...
         var _loc6_:* = null;
         var _loc3_:String = param2 + "@" + param1.name;
         var _loc4_:BitmapData = this.var_927[_loc3_];
         if(_loc4_ == null)
         {
            _loc5_ = param1.getChildByName(param2) as ISkinTemplateEntity;
            if(_loc5_ == null)
