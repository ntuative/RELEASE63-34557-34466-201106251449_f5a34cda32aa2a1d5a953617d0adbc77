package com.sulake.core.window.graphics
{
   ...
   public class WindowRendererItem implements IDisposable
   {
      ...
      private static const const_713:uint = 0;
      
      private static const const_1125:uint = 1;
      
      private static const const_1126:uint = 2;
       
      
      private var var_130:BitmapData;
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            {
               this._drawBufferAllocator.free(this.var_130);
               this.var_130 = null;
            }
         }
      }
      ...
      public function render(param1:IWindow, param2:Point, param3:Rectangle) : Boolean
      {
         ...
         var _loc5_:uint = !!param1.background ? uint(const_1126) : uint(const_713);
         var _loc6_:Boolean = this.var_200.width > 0 && this.var_200.height > 0;
         var _loc7_:ISkinRenderer = this.resolveSkinRenderer(param1);
         if(_loc7_ != null)
         {
            if(_loc7_.isStateDrawable(this.var_1067))
            {
               _loc5_ = const_1125;
            }
         }
         ...
         if(_loc5_ != const_713)
         {
            if(this.var_130 == null)
            {
               this.var_130 = this._drawBufferAllocator.allocate(_loc8_,_loc9_,true,param1.color);
               this.var_695 = true;
               _loc6_ = true;
               _loc10_ = false;
            }
            else if(this.var_130.width != _loc8_ || this.var_130.height != _loc9_)
            {
               this._drawBufferAllocator.free(this.var_130);
               this.var_130 = this._drawBufferAllocator.allocate(_loc8_,_loc9_,true,param1.color);
               this.var_695 = true;
         ...
         if(_loc5_ != const_713)
         {
            this.var_1603 = this.var_1067;
            _loc4_ = param1.fetchDrawBuffer() as BitmapData;
            if(_loc4_ != null)
            {
               _loc4_.lock();
               if(_loc5_ == const_1125)
               {
                  _loc6_ = true;
                  ...
                  if(this.var_695)
                  {
                     ...
                     if(_loc10_)
                     {
                        this.var_130.fillRect(this.var_130.rect,param1.color);
                     }
                     _loc7_.draw(param1,this.var_130,this.var_130.rect,this.var_1067,false);
                  }
                  if(param1.blend < 1 && param1.testParamFlag(WindowParam.const_33))
                  {
                     this.var_1149.tx = param2.x;
                     this.var_1149.ty = param2.y;
                     this.var_760.alphaMultiplier = param1.blend;
                     param3.offset(param2.x,param2.y);
                     _loc4_.draw(this.var_130,this.var_1149,this.var_760,null,param3,false);
                     param3.offset(-param2.x,-param2.y);
                  }
                  else
                  {
                     _loc4_.copyPixels(this.var_130,param3,param2,null,null,true);
                  }
               }
               else if(_loc5_ == const_1126)
               {
                  _loc6_ = true;
                  if(param1.testParamFlag(WindowParam.const_33))
                  {
      ...
      {
         return this._skinContainer.getTheActualState(param1.type,param1.style,param1.state) != this.var_1603;
      }
      ...
      public function invalidate(param1:IWindow, param2:Rectangle, param3:uint) : Boolean
      {
         ...
         switch(param3)
         {
            ...
            case WindowRedrawFlag.const_905:
               this.var_1067 = this._skinContainer.getTheActualState(param1.type,param1.style,param1.state);
               if(this.var_1067 != this.var_1603)
               {
                  this.var_695 = true;
                  _loc4_ = true;
               }
               break;
            case WindowRedrawFlag.const_1363:
               if(param1.testParamFlag(WindowParam.const_33))
               {
                  this.var_695 = true;
                  _loc4_ = true;
               ...
               break;
            case WindowRedrawFlag.const_1358:
               _loc4_ = true;
         }
         if(_loc4_)
         {
