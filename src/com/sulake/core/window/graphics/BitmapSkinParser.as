package com.sulake.core.window.graphics
{
   ...
   public class BitmapSkinParser
   {
      ...
      protected static function parseLayout(param1:ISkinRenderer, param2:XML, param3:Dictionary, param4:Map) : void
      {
         ...
         var _loc6_:* = param2.attribute("transparent") == "CanCreateRoomEvent";
      ...
      protected static function parseLayoutEntity(param1:XML, param2:Map) : SkinLayoutEntity
      {
         ...
         _loc5_.colorize = _loc6_ == "" ? true : _loc6_ == "CanCreateRoomEvent";
         _loc6_ = null;
         ...
         if(_loc8_.length() > 0)
         {
            ...
            {
               case "fixed":
                  _loc5_.var_354 = SkinLayoutEntity.const_574;
                  break;
               case "move":
                  _loc5_.var_354 = SkinLayoutEntity.const_325;
                  break;
               case "strech":
                  _loc5_.var_354 = SkinLayoutEntity.const_606;
                  break;
               case "tiled":
                  _loc5_.var_354 = SkinLayoutEntity.const_347;
                  break;
               case "center":
                  _loc5_.var_354 = SkinLayoutEntity.const_621;
            }
            ...
            {
               case "fixed":
                  _loc5_.var_352 = SkinLayoutEntity.const_574;
                  break;
               case "move":
                  _loc5_.var_352 = SkinLayoutEntity.const_325;
                  break;
               case "strech":
                  _loc5_.var_352 = SkinLayoutEntity.const_606;
                  break;
               case "tiled":
                  _loc5_.var_352 = SkinLayoutEntity.const_347;
                  break;
               case "center":
                  _loc5_.var_352 = SkinLayoutEntity.const_621;
            }
         }
