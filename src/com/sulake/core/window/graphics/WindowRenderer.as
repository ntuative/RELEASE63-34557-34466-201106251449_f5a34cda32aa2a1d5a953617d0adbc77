package com.sulake.core.window.graphics
{
   ...
   public class WindowRenderer implements IWindowRenderer
   {
      ...
      private var var_1776:Point;
      
      private var var_1465:Rectangle;
      
      private var var_318:Rectangle;
      ...
      public function WindowRenderer(param1:ISkinContainer)
      {
         ...
         this.var_1776 = new Point();
         this.var_1465 = new Rectangle();
         this.var_318 = new Rectangle();
      ...
      public function addToRenderQueue(param1:IWindow, param2:Rectangle, param3:uint) : void
      {
         ...
         if(this.getWindowRendererItem(param1).invalidate(param1,param2,param3))
         {
            ...
            this.var_318.x = param2.x - param1.x;
            this.var_318.y = param2.y - param1.y;
            this.var_318.width = param2.width;
            this.var_318.height = param2.height;
            if(param1.testParamFlag(WindowParam.const_33))
            {
               while(param1.testParamFlag(WindowParam.const_33))
               {
                  ...
                  this.var_318.offset(param1.x,param1.y);
                  param1 = _loc4_;
               }
            }
            this.getWindowRendererItem(param1).invalidate(param1,this.var_318,WindowRedrawFlag.const_1358);
            if(this.var_772.indexOf(param1) == -1)
            {
               this.var_772.push(param1);
            }
         }
      }
      ...
      public function registerRenderable(param1:IWindow) : void
      {
         ...
         if(_loc2_ == null)
         {
            ...
            param1.addEventListener(WindowDisposeEvent.const_940,this.windowDisposedCallback);
         }
      }
      
      public function removeRenderable(param1:IWindow) : void
      {
         param1.removeEventListener(WindowDisposeEvent.const_940,this.windowDisposedCallback);
         var _loc2_:WindowRendererItem = this.var_370[param1] as WindowRendererItem;
         if(_loc2_ != null)
         {
            _loc2_.dispose();
      ...
      public function render() : void
      {
         ...
         var _loc3_:* = null;
         var _loc4_:int = 0;
         var _loc2_:uint = this.var_772.length;
         _loc4_ = 0;
         while(_loc4_ < _loc2_)
         {
            _loc1_ = this.var_772.pop() as WindowController;
            if(!_loc1_.disposed)
            {
               _loc3_ = this.getWindowRendererItem(_loc1_);
               this.var_318.x = _loc3_.dirty.x;
               this.var_318.y = _loc3_.dirty.y;
               this.var_318.width = _loc3_.dirty.width;
               this.var_318.height = _loc3_.dirty.height;
               this.renderWindowBranch(_loc1_,this.var_318,_loc1_.rectangle.clone());
            }
            _loc4_++;
         }
      }
      ...
      private function renderWindowBranch(param1:WindowController, param2:Rectangle, param3:Rectangle) : void
      {
         ...
         if(param1.visible)
         {
            if(getDrawLocationAndClipRegion(param1,param2,this.var_1776,this.var_1465))
            {
               if(this.getWindowRendererItem(param1).render(param1,this.var_1776,this.var_1465))
               {
            ...
            else if(!param1.testParamFlag(WindowParam.const_33))
            {
               ...
               {
                  param1.getGraphicContext(true).setDrawRegion(param1.rectangle,false,this.var_1465);
