package com.sulake.core.assets
{
   ...
   public class AssetLibrary extends EventDispatcher implements IAssetLibrary
   {
      ...
      public static const const_1382:String = "AssetLibraryReady";
      
      public static const const_740:String = "AssetLibraryLoaded";
      
      public static const const_1831:String = "AssetLibraryUnloaded";
      
      public static const const_1936:String = "AssetLibraryLoadError";
      
      private static const const_684:String = "name";
      
      private static const const_1049:String = "asset";
      
      private static const const_1051:String = "param";
      ...
      private static var var_1727:LazyAssetProcessor = new LazyAssetProcessor();
      
      private static var var_521:uint = 0;
      
      private static var var_944:Array = new Array();
      ...
      public function AssetLibrary(param1:String)
      {
         ...
         this.var_520 = new Dictionary(false);
      ...
      private static function fetchLibraryContents(param1:AssetLibrary, param2:XML, param3:Class) : Boolean
      {
         ...
         if(param3 == null)
         {
            throw new Error("Library " + param1.var_614 + " doesn\'t contain valid resource class!");
         }
         ...
         if(_loc5_ != null)
         {
            ...
            while(_loc15_ < _loc12_)
            {
               ...
               if(_loc9_ != null)
               {
                  ...
                  _loc11_ = _loc6_.child(const_1051);
                  if(_loc11_.length())
                  {
               ...
               {
                  Logger.log("Failed to extract asset " + _loc7_ + " from Library " + param1.var_614 + "!");
               }
               _loc15_++;
            }
         }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            this.unload();
            super.dispose();
            var_944.splice(var_944.indexOf(this),1);
            --var_521;
            this.var_520 = null;
            this.var_942 = null;
            this.var_169 = null;
      ...
      {
         if(this.var_614 == param1.url && this.var_941)
         {
            if(!this.var_943 && param2)
            {
               AssetLibrary.fetchLibraryContents(this,this._manifest,this.var_615);
            }
            this.var_943 = param2;
            dispatchEvent(new Event(AssetLibrary.const_1382));
         }
         else
         {
      ...
      public function unload() : void
      {
         ...
         this.var_941 = false;
         this.var_614 = null;
         dispatchEvent(new Event(AssetLibrary.const_1831));
      }
      
      public function getClass(param1:String) : Class
      {
         var _loc2_:Class = this.var_942[param1];
         if(_loc2_ != null)
         {
            return _loc2_;
         }
      ...
      public function loadAssetFromFile(param1:String, param2:URLRequest, param3:String = null) : AssetLoaderStruct
      {
         ...
         var _loc4_:AssetLoaderStruct = this.var_520[param2.url];
         if(_loc4_ != null)
         {
         ...
         _loc6_.addEventListener(AssetLoaderEvent.const_1213,this.assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_1174,this.assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_1181,this.assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_1272,this.assetLoadEventHandler);
         _loc4_ = new AssetLoaderStruct(param1,_loc6_);
         this.var_520[param2.url] = _loc4_;
         return _loc4_;
      }
      ...
      private function assetLoadEventHandler(param1:AssetLoaderEvent) : void
      {
         ...
         var struct:AssetLoaderStruct = this.var_520[loader.url];
         if(struct == null)
         {
         ...
         switch(e.type)
         {
            case AssetLoaderEvent.ASSET_LOADER_EVENT_COMPLETE:
               ...
               if(decl != null)
               {
                  ...
                  {
                     ++this.var_435;
                     this.var_434.push(struct.assetName);
                  }
         ...
         if(remove)
         {
            if(!_disposed && loader)
            {
               delete this.var_520[loader.url];
            }
            if(struct)
            {
               struct.dispose();
      ...
      {
         return param1 < this.var_434.length ? this.getAssetByName(this.var_434[param1]) : null;
      }
      ...
      public function getAssetIndex(param1:IAsset) : int
      {
         ...
         for(_loc2_ in this.var_169)
         {
            ...
            {
               return this.var_434.indexOf(_loc2_);
            }
         }
         return -1;
      }
      ...
      {
         return this.var_169[param1] != null || (this.var_615 != null ? this.var_615[param1] != null : false);
      }
      ...
      public function setAsset(param1:String, param2:IAsset, param3:Boolean = true) : Boolean
      {
         ...
         if((param3 || _loc4_) && param2)
         {
            ...
            {
               var_1727.push(param2 as ILazyAsset);
            }
            return true;
         }
         return false;
      ...
      public function removeAsset(param1:IAsset) : IAsset
      {
         ...
         if(param1)
         {
            for(_loc2_ in this.var_169)
            {
               if(this.var_169[_loc2_] == param1)
               {
                  this.var_434.splice(this.var_434.indexOf(_loc2_),1);
      ...
      public function registerAssetTypeDeclaration(param1:AssetTypeDeclaration, param2:Boolean = true) : Boolean
      {
         ...
         {
            if(this.var_436.hasOwnProperty(param1.mimeType))
            {
               throw new Error("Asset type " + param1.mimeType + " already registered!");
            }
            this.var_436[param1.mimeType] = param1;
         }
         return true;
      }
      ...
      public function getAssetTypeDeclarationByMimeType(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         return AssetTypeDeclaration(this.var_436[param1]);
      }
      ...
      public function getAssetTypeDeclarationByClass(param1:Class, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         for(_loc4_ in this.var_436)
         {
            _loc3_ = AssetTypeDeclaration(this.var_436[_loc4_]);
            if(_loc3_ != null)
            {
               if(_loc3_.assetClass == param1)
               {
      ...
      public function getAssetTypeDeclarationByFileName(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         for(_loc5_ in this.var_436)
         {
            _loc4_ = AssetTypeDeclaration(this.var_436[_loc5_]);
            if(_loc4_ != null)
            {
               if(_loc4_.fileTypes.indexOf(_loc3_))
               {
      ...
      private function libraryLoadedHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         this.var_615 = _loc2_.resource;
         this.var_614 = _loc2_.url;
         if(this.var_943)
         {
            AssetLibrary.fetchLibraryContents(this,this._manifest,this.var_615);
         }
            ...
            if(_loc2_ != null)
            {
               ...
               while(_loc8_ < _loc7_)
               {
                  ...
                  if(_loc3_.attribute(const_684) && _loc3_.attribute(const_684).toString() == param1)
                  {
                     ...
                     if(_loc4_ == null)
                     {
                        throw new Error("Failed to extract asset " + param1 + " from Library " + this.var_614 + "!");
                     }
                     _loc5_ = new _loc4_.assetClass(_loc4_) as IAsset;
                     _loc5_.setUnknownContent(this.var_615[param1]);
                     _loc6_ = _loc3_.child(const_1051);
