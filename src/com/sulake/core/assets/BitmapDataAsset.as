package com.sulake.core.assets
{
   ...
   public class BitmapDataAsset implements ILazyAsset
   {
      ...
      protected static var var_526:uint = 0;
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this._bitmap)
            {
               try
               {
                  var_526 -= this._bitmap.width * this._bitmap.height * 4;
      ...
      public function prepareLazyContent() : void
      {
         ...
         if(this.var_118 is BitmapDataAsset)
         {
            ...
            this.var_1504 = BitmapDataAsset(this.var_118).var_1504;
            this.var_1503 = BitmapDataAsset(this.var_118).var_1503;
            if(this._bitmap != null)
            {
               this.var_118 = null;
               return;
         ...
         while(_loc2_ < param1.length())
         {
            ...
            switch(_loc3_)
            {
               case "offset":
                  ...
                  break;
               case "flipH":
                  this.var_1504 = _loc4_ == "1" || _loc4_ == "CanCreateRoomEvent";
                  break;
               case "flipV":
                  this.var_1503 = _loc4_ == "1" || _loc4_ == "CanCreateRoomEvent";
                  break;
            }
            _loc2_++;
         }
