package com.sulake.core.runtime
{
   ...
   public final class CoreComponentContext extends ComponentContext implements ICore
   {
      ...
      private static const const_1645:String = "service-libraries";
      
      private static const const_1649:String = "library";
      
      private static const const_1651:String = "component-libraries";
      
      private static const const_1648:String = "library";
      
      private static const const_1646:String = "error_data";
      
      private static const const_1650:String = "error_cat";
      
      private static const const_1647:String = "error_desc";
       
      
      private var var_402:LibraryLoaderQueue;
      
      private var var_866:IEventDispatcher;
      
      private var var_575:uint;
      ...
      public function CoreComponentContext(param1:DisplayObjectContainer, param2:uint)
      {
         ...
         switch(param2 & 0)
         {
            ...
            case Core.const_1025:
               ...
               var_429.addChild(new ProfilerViewer(this.var_224));
               break;
            case Core.const_599:
      ...
      {
         return this.var_575 - this.getNumberOfFilesPending();
      }
      ...
      override public function dispose() : void
      {
         ...
         if(!disposed)
         {
            ...
            try
            {
               ...
               {
                  receivers = this.var_291[i] as Array;
      ...
      override public function error(param1:String, param2:Boolean, param3:int = -1, param4:Error = null) : void
      {
         if(param4)
         {
            ErrorReportStorage.setParameter(const_1646,String(param4.getStackTrace()));
         }
         ErrorReportStorage.setParameter(const_1650,String(param3));
         ErrorReportStorage.setParameter(const_1647,param1);
      ...
      public function readConfigDocument(param1:XML, param2:IEventDispatcher = null) : void
      {
         ...
         this.var_866 = loadingEventDelegate;
         if(this.var_402 == null)
         {
         ...
         {
            error("Failed to parse asset libraries from config xml!",true,Core.const_217,e);
         }
         try
         {
            node = config.child(const_1645)[0];
            if(node != null)
            {
               list = node.child(const_1649);
               for each(item in list)
               {
                  url = item.attribute("url").toString();
                  loader = new LibraryLoader(context,true,_debug);
         ...
         {
            error("Failed to parse interfaces from config xml!",true,Core.const_217,e);
         }
         try
         {
            node = config.child(const_1651)[0];
            if(node != null)
            {
         ...
         {
            error("Failed to parse components from config xml!",true,Core.const_217,e);
         }
         if(!disposed)
         {
      ...
      private function errorInLoadingProcess(param1:LibraryLoaderEvent = null) : void
      {
         ...
         this.error("Failed to download library \"" + _loc2_.url + "\" HTTP status " + param1.status + ": " + _loc2_.getLastErrorMessage(),true,Core.const_1308);
         if(!disposed)
         {
      ...
      private function finalizeLoadingEventDelegate() : void
      {
         if(this.var_866)
         {
            this.var_866.dispatchEvent(new Event(Event.COMPLETE));
         }
      }
      ...
      private function updateLoadingProgress(param1:LibraryLoaderEvent = null) : void
      {
         ...
         if(this.var_866)
         {
            ...
            this.var_866.dispatchEvent(new LibraryProgressEvent(_loc2_.url,param1.bytesLoaded,param1.bytesTotal,_loc2_.elapsedTime));
         }
      }
         ...
         if(param1 != null)
         {
            if(param1.type == LibraryLoaderEvent.LIBRARY_LOADER_EVENT_COMPLETE || param1.type == LibraryLoaderEvent.LIBRARY_LOADER_EVENT_ERROR)
            {
               ...
               if(!disposed)
               {
                  if(this.var_866)
                  {
                     this.var_866.dispatchEvent(new LibraryProgressEvent(_loc2_.url,this.var_575 - this.var_402.length,this.var_575,_loc2_.elapsedTime));
                  }
               }
            }
         }
      ...
      override public function registerUpdateReceiver(param1:IUpdateReceiver, param2:uint) : void
      {
         ...
         var _loc3_:int = !!this.var_224 ? 0 : this.var_1617 & 0;
         if(_loc3_ == Core.const_599)
         {
            this.var_291[param2].push(new UpdateDelegate(param1,this,param2));
         }
         else
         {
            this.var_291[param2].push(param1);
         }
      }
      ...
      override public function removeUpdateReceiver(param1:IUpdateReceiver) : void
      {
         ...
         var _loc3_:* = null;
         var _loc6_:* = null;
         var _loc4_:int = !!this.var_224 ? 0 : this.var_1617 & 0;
         var _loc5_:int = 0;
         while(_loc5_ < CoreComponentContext.const_107)
         {
            _loc3_ = this.var_291[_loc5_] as Array;
            if(_loc4_ == Core.const_599)
            {
      ...
      private function simpleFrameUpdateHandler(param1:uint, param2:uint) : void
      {
         ...
         while(priority < CoreComponentContext.const_107)
         {
            ...
            receivers = this.var_291[priority];
            index = 0;
            length = receivers.length;
            while(index != length)
            {
