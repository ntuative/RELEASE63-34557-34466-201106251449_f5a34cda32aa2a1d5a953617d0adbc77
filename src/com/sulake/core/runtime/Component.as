package com.sulake.core.runtime
{
   ...
   public class Component implements IUnknown
   {
      ...
      public static const const_2323:uint = 1;
      
      public static const COMPONENT_FLAG_CONTEXT:uint = 2;
      
      public static const const_1376:uint = 4;
       
      
      protected var var_816:uint = 0;
      
      protected var var_1408:String = "";
      ...
      public function release(param1:IID) : uint
      {
         ...
         if(_loc2_ == null)
         {
            this.var_1408 = "Attempting to release unknown interface:" + param1 + "!";
            throw new Error(this.var_1408);
         }
         var _loc3_:uint = _loc2_.release();
         if(this.var_1617 & const_1376)
         {
            if(_loc3_ == 0)
            {
      ...
      {
         return "[component " + getQualifiedClassName(this) + " refs: " + this.var_816 + "]";
      }
