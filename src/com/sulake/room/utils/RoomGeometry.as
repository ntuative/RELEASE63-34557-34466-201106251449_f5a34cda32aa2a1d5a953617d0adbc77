package com.sulake.room.utils
{
   ...
   public class RoomGeometry implements IRoomGeometry
   {
      ...
      public static const const_570:Number = 64;
      
      public static const const_1201:Number = 32;
      ...
      private var var_1919:Number = 1.0;
      
      private var var_1918:Number = 1.0;
      
      private var var_1917:Number = 1.0;
      ...
      private var var_3078:Number = 500.0;
      ...
      public function RoomGeometry(param1:Number, param2:IVector3d, param3:IVector3d, param4:IVector3d = null)
      {
         ...
         this.var_1251 = new Vector3d();
         this.var_1919 = 1;
         this.var_1918 = 1;
         this.x_scale = 1;
         this.y_scale = 1;
         this.var_1917 = Math.sqrt(0.5) / Math.sqrt(0.75);
         this.z_scale = 1;
      ...
      {
         this.var_461.assign(this.var_105);
         this.var_461.x *= this.var_459;
         this.var_461.y *= this.var_462;
         this.var_461.z *= this.var_460;
         return this.var_461;
      }
      ...
      {
         if(this.var_459 != param1 * this.var_1919)
         {
            this.var_459 = param1 * this.var_1919;
            ++this.var_175;
         }
      }
      ...
      {
         if(this.var_462 != param1 * this.var_1918)
         {
            this.var_462 = param1 * this.var_1918;
            ++this.var_175;
         }
      }
      ...
      {
         if(this.var_460 != param1 * this.var_1917)
         {
            this.var_460 = param1 * this.var_1917;
            ++this.var_175;
         }
      }
      ...
      public function set location(param1:IVector3d) : void
      {
         ...
         this.var_105.y /= this.var_462;
         this.var_105.z /= this.var_460;
      ...
      public function set direction(param1:IVector3d) : void
      {
         ...
         var _loc2_:Number = this.var_458.x;
         var _loc3_:Number = this.var_458.y;
         var _loc4_:Number = this.var_458.z;
         this.var_458.assign(param1);
         this._direction.assign(param1);
         if(this.var_458.x != _loc2_ || this.var_458.y != _loc3_ || this.var_458.z != _loc4_)
         {
            ++this.var_175;
         }
         ...
         if(_loc10_ != 0)
         {
            ...
            this.var_1250.assign(this.var_173);
         }
         else
         {
      ...
      private function getDisplacenent(param1:IVector3d) : IVector3d
      {
         ...
         if(this.var_552 != null)
         {
            ...
            return this.var_552.getValue(_loc2_);
         }
         return null;
      }
      ...
      public function setDepthVector(param1:IVector3d) : void
      {
         ...
         if(_loc7_ != 0)
         {
            ...
            this.var_1251.assign(_loc22_);
         }
         else
         {
            this.var_1251.assign(_loc17_);
         }
         ++this.var_175;
      }
      ...
      public function getScreenPosition(param1:IVector3d) : IVector3d
      {
         ...
         _loc2_.y *= this.var_462;
         _loc2_.z *= this.var_460;
         var _loc3_:Number = Vector3d.scalarProjection(_loc2_,this.var_1251);
         if(_loc3_ < this.var_3079 || _loc3_ > this.var_3078)
         {
            return null;
         }
         ...
         if(_loc6_ != null)
         {
            ...
            _loc2_.y *= this.var_462;
            _loc2_.z *= this.var_460;
            _loc3_ = Vector3d.scalarProjection(_loc2_,this.var_1251);
         }
         _loc2_.x = _loc4_;
         _loc2_.y = _loc5_;
         _loc2_.z = _loc3_;
      ...
      public function getPlanePosition(param1:Point, param2:IVector3d, param3:IVector3d, param4:IVector3d) : Point
      {
         ...
         var _loc8_:Vector3d = new Vector3d(this.var_105.x * this.var_459,this.var_105.y * this.var_462,this.var_105.z * this.var_460);
         _loc8_.add(_loc7_);
         var _loc9_:IVector3d = this.var_173;
         var _loc10_:Vector3d = new Vector3d(param2.x * this.var_459,param2.y * this.var_462,param2.z * this.var_460);
         var _loc11_:Vector3d = new Vector3d(param3.x * this.var_459,param3.y * this.var_462,param3.z * this.var_460);
         var _loc12_:Vector3d = new Vector3d(param4.x * this.var_459,param4.y * this.var_462,param4.z * this.var_460);
      ...
      public function performZoom() : void
      {
         if(this.isZoomedIn())
         {
            this.scale = const_1201;
         }
         else
         {
            this.scale = const_570;
         }
      }
      
      public function isZoomedIn() : Boolean
      {
         return this.scale == const_570;
      }
