package com.sulake.room.renderer.cache
{
   ...
   public class RoomObjectLocationCacheItem
   {
      ...
      public function getScreenLocation(param1:IRoomObject, param2:IRoomGeometry) : IVector3d
      {
         ...
         if(param2.updateId != this.var_1767 || param1.getUpdateID() != this.var_2638)
         {
            this.var_2638 = param1.getUpdateID();
            if(param2.updateId != this.var_1767 || _loc4_.x != this.var_1260.x || _loc4_.y != this.var_1260.y || _loc4_.z != this.var_1260.z)
            {
         ...
         if(_loc3_)
         {
            ...
            if(isNaN(_loc6_) || _loc6_ == 0)
            {
               ...
               if(_loc7_.x != _loc4_.x || _loc7_.y != _loc4_.y)
               {
                  ...
                  this.var_388.assign(_loc5_);
                  if(_loc8_ != null)
                  {
                     this.var_388.z = _loc8_.z;
                  }
               }
               else
               {
            ...
            this.var_388.x = Math.round(this.var_388.x);
            this.var_388.y = Math.round(this.var_388.y);
         }
         return this.var_388;
      }
   }
