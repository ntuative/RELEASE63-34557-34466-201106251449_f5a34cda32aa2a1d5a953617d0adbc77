package com.sulake.room.renderer
{
   ...
   public class RoomSpriteCanvas implements IRoomRenderingCanvas
   {
      ...
      private static const const_693:Point = new Point(0,0);
      
      private static const const_394:int = 50;
      
      private static const const_1694:int = 50;
      
      private static const const_1148:Number = 60;
      
      private static const const_1693:Number = 50;
      ...
      private var var_720:RoomObjectCache;
      
      private var var_587:Array;
      
      private var var_716:Array;
      
      private var var_1652:IRoomRenderingCanvasMouseListener = null;
      ...
      private var var_2898:Number = -1.0E7;
      
      private var var_2902:Number = -1.0E7;
      ...
      private var var_3094:Boolean = false;
      
      private var var_2899:Array;
      ...
      public function RoomSpriteCanvas(param1:IRoomSpriteCanvasContainer, param2:String, param3:int, param4:int, param5:int)
      {
         ...
         this.var_720 = new RoomObjectCache(_loc6_);
         this.var_760 = new ColorTransform();
         this.var_717 = new Matrix();
      ...
      {
         this.var_588.x -= param1 - this.var_719;
         this.var_719 = param1;
      }
      
      public function set screenOffsetY(param1:int) : void
      {
         this.var_588.y -= param1 - this.var_718;
         this.var_718 = param1;
      }
      ...
      public function set useMask(param1:Boolean) : void
      {
         ...
         {
            this.var_1017 = true;
            if(this.var_158 != null && !this.var_298.contains(this.var_158))
            {
               this.var_298.addChild(this.var_158);
               this.var_112.mask = this.var_158;
            }
         }
         else if(!param1 && this.var_1017)
         {
            this.var_1017 = false;
            if(this.var_158 != null && this.var_298.contains(this.var_158))
            {
               this.var_298.removeChild(this.var_158);
      ...
      public function dispose() : void
      {
         ...
         {
            while(this.var_298.numChildren > 0)
            {
               this.var_298.removeChildAt(0);
            }
            this.var_298 = null;
         }
         this.var_112 = null;
         ...
         if(this.var_716 != null)
         {
            ...
            {
               this.cleanSprite(this.var_716[_loc1_] as ExtendedSprite,true);
               _loc1_++;
            }
            this.var_716 = [];
         }
      ...
      {
         this.var_720.method_4(param1);
      }
      
      public function render(param1:int) : void
      {
         this.var_2109 = !this.var_2109;
         if(this._container == null || this._geometry == null)
         {
            return;
         }
         if(param1 == this.var_1651)
         {
            return;
         }
         ...
         if(this.var_586 != this.var_2896 || this.var_589 != this.var_2901)
         {
            _loc8_ = true;
         }
         if(this.var_112.x != this.var_719 || this.var_112.y != this.var_718)
         {
            this.var_112.x = this.var_719;
            this.var_112.y = this.var_718;
            _loc8_ = true;
         }
         _loc4_ = 0;
         while(_loc4_ < _loc3_)
         ...
         this.var_587.sortOn("z",0 | 0);
         if(_loc5_ < this.var_587.length)
         {
            this.var_587.splice(_loc5_);
         }
         var _loc9_:* = null;
         _loc4_ = 0;
         while(_loc4_ < _loc5_)
         {
            _loc9_ = this.var_587[_loc4_] as SortableSprite;
            if(_loc9_ != null)
            {
         ...
         this.var_2896 = this.var_586;
         this.var_2901 = this.var_589;
      }
      ...
      private function calculateUpdateInterval(param1:int) : void
      {
         ...
         if(this.var_1651 > 0)
         {
            _loc2_ = param1 - this.var_1651;
            if(_loc2_ > const_1148 * 3)
            {
               Logger.log("Really slow frame update " + _loc2_ + "ms");
               this.var_2900 = _loc2_;
            }
            if(_loc2_ <= MAXIMUM_VALID_FRAME_UPDATE_INTERVAL)
            {
               ++this.var_894;
               if(this.var_894 == const_394 + 1)
               {
                  this.var_571 = _loc2_;
                  this.var_2108 = this.var_2897;
               }
               else if(this.var_894 > const_394 + 1)
               {
                  _loc3_ = Number(this.var_894 - const_394);
                  this.var_571 = this.var_571 * (_loc3_ - 1) / _loc3_ + Number(_loc2_) / _loc3_;
                  this.var_2108 = this.var_2108 * (_loc3_ - 1) / _loc3_ + Number(this.var_2897) / _loc3_;
                  if(this.var_894 > const_394 + const_1694)
                  {
                     this.var_894 = const_394;
                     if(!this.var_1363 && this.var_571 > const_1148)
                     {
                        this.var_1363 = true;
                        Logger.log("Room canvas updating really slow - now entering frame skipping mode...");
                     }
                     else if(this.var_1363 && this.var_571 < const_1693)
                     {
                        this.var_1363 = false;
      ...
      private function renderObject(param1:IRoomObject, param2:String, param3:int, param4:Boolean, param5:int) : int
      {
         ...
         if(_loc6_ == null)
         {
            this.var_720.method_4(param2);
            return 0;
         }
         var _loc7_:RoomObjectCacheItem = this.var_720.getObjectCache(param2);
         ...
         _loc6_.update(this._geometry,param3,!_loc9_.isEmpty || param4,this.var_2109 && this.var_1363);
         ...
         while(_loc21_ < _loc12_)
         {
            ...
            if(_loc18_ != null && _loc18_.visible)
            {
               ...
               if(_loc22_ != null)
               {
                  _loc19_ = _loc13_ + _loc18_.offsetX + this.var_719;
                  _loc20_ = _loc14_ + _loc18_.offsetY + this.var_718;
                  if(this.rectangleVisible(_loc19_,_loc20_,_loc22_.width,_loc22_.height))
                  {
                     ...
                     if(_loc17_ == null)
                     {
                        ...
                        this.var_587.push(_loc17_);
                        _loc17_.name = param2;
                     }
                     _loc17_.sprite = _loc18_;
                     _loc17_.x = _loc19_ - this.var_719;
                     _loc17_.y = _loc20_ - this.var_718;
      ...
      {
         if(param1 < this.var_586 && param1 + param3 >= 0 && (param2 < this.var_589 && param2 + param4 >= 0))
         {
            if(!this.var_3094)
            {
               return true;
      ...
      private function rectangleVisibleWithExclusion(param1:int, param2:int, param3:int, param4:int) : Boolean
      {
         ...
         if(param1 + param3 >= this.var_586)
         {
            param3 -= this.var_586 + 1 - (param1 + param3);
         }
         if(param2 + param4 >= this.var_589)
         {
            param4 -= this.var_589 + 1 - (param2 + param4);
         }
         for each(_loc5_ in this.var_2899)
         {
      ...
      {
         if(param1 < 0 || param1 >= this.var_1105)
         {
            return null;
         }
      ...
      private function createSprite(param1:SortableSprite, param2:int = -1) : void
      {
         ...
         {
            _loc3_ = this.var_716.pop() as ExtendedSprite;
         }
         if(_loc3_ == null)
         {
         ...
         if(param2 < 0 || param2 >= this.var_1105)
         {
      ...
      private function cleanSprites(param1:int, param2:Boolean = false) : void
      {
         ...
         var _loc3_:* = null;
         if(param1 < this.var_895 || this.var_895 == 0)
         {
            _loc4_ = this.var_1105 - 1;
            while(_loc4_ >= param1)
            {
      ...
      {
         if(param1 < 0 || param1 >= this.var_587.length)
         {
            return null;
         }
         return this.var_587[param1] as SortableSprite;
      }
      ...
      private function getFlippedBitmapData(param1:BitmapData, param2:String, param3:Boolean = false, param4:Boolean = true, param5:Boolean = false) : ExtendedBitmapData
      {
         ...
         if(finalData == null)
         {
            ...
            this.var_717.identity();
            if(flipH)
            {
               this.var_717.scale(-1,1);
               this.var_717.translate(data.width,0);
            }
            if(flipV)
            {
               this.var_717.scale(1,-1);
               this.var_717.translate(0,data.height);
            }
            finalData.draw(data,this.var_717);
            if(name.length > 0)
            {
      ...
      private function getColoredBitmapData(param1:BitmapData, param2:String, param3:int, param4:Boolean = false) : ExtendedBitmapData
      {
         ...
         if(finalData == null)
         {
            ...
            {
               finalData = new ExtendedBitmapData(data.width,data.height,true,16777215);
               finalData.copyPixels(data,data.rect,const_693);
            }
            catch(e:Error)
            {
               finalData = new ExtendedBitmapData(1,1,true,16777215);
            }
            this.var_760.redMultiplier = tR;
            this.var_760.greenMultiplier = tG;
            this.var_760.blueMultiplier = tB;
            finalData.colorTransform(finalData.rect,this.var_760);
            if(name.length > 0)
            {
               this.var_299.addBitmapData(cacheName,finalData);
            }
      ...
      public function handleMouseEvent(param1:int, param2:int, param3:String, param4:Boolean, param5:Boolean, param6:Boolean, param7:Boolean) : Boolean
      {
         ...
         if(this.var_1362 > 0 && param3 == MouseEvent.MOUSE_MOVE)
         {
            return this.var_2110;
         }
         this.var_2110 = this.checkMouseHits(param1,param2,param3,param4,param5,param6,param7);
         ++this.var_1362;
         return this.var_2110;
      }
      ...
      {
         var _loc11_:Number = param1 - this.var_586 / 2;
         var _loc12_:Number = param2 - this.var_589 / 2;
         var _loc13_:* = null;
         return new RoomSpriteMouseEvent(param5,this._id + "_" + this.var_2111,this._id,param6,_loc11_,_loc12_,param3,param4,param8,param7,param9,param10);
      }
            ...
            if(_loc10_ != null && _loc10_.hitTestPoint(param1 - _loc10_.x,param2 - _loc10_.y))
            {
               if(!_loc10_.clickHandling || param3 != MouseEvent.CLICK && param3 != MouseEvent.DOUBLE_CLICK)
               {
                  ...
                  if(_loc12_.indexOf(_loc9_) < 0)
                  {
                     ...
                     if(param3 != MouseEvent.MOUSE_MOVE || param1 != this.var_2898 || param2 != this.var_2902)
                     {
                        this.bufferMouseEvent(_loc11_,_loc9_);
                     }
                     _loc12_.push(_loc9_);
      ...
      {
         if(this.var_412 != null && param1 != null)
         {
            this.var_412.add(param2,param1);
         }
      }
      ...
      private function processMouseEvents() : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         if(this._container == null || this.var_412 == null)
         {
            return;
         }
         var _loc1_:int = 0;
         ...
         {
            _loc2_ = this.var_412.getKey(_loc1_);
            _loc3_ = this.var_412.getWithIndex(_loc1_);
            if(_loc2_ != null && _loc3_ != null)
            {
               ...
               if(_loc4_ != null)
               {
                  ...
                  {
                     this.var_1652.processRoomCanvasMouseEvent(_loc3_,_loc4_,this.geometry);
                  }
                  else
                  {
