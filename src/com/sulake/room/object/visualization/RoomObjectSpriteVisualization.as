   ...
   public class RoomObjectSpriteVisualization implements IRoomObjectSpriteVisualization
   {
      ...
      public function dispose() : void
      {
         ...
         if(this.var_235 != null)
         {
            ...
            {
               _loc1_ = this.var_235[0] as RoomObjectSprite;
               if(_loc1_ != null)
               {
                  _loc1_.dispose();
               }
      ...
      public function set assetCollection(param1:IGraphicAssetCollection) : void
      {
         ...
         {
            this.var_920.removeReference();
         }
         this.var_920 = param1;
         if(this.var_920 != null)
         {
            this.var_920.addReference();
         }
      }
      ...
      {
         var _loc2_:* = null;
         while(this.var_235.length > param1)
         {
            _loc2_ = this.var_235[this.var_235.length - 1] as RoomObjectSprite;
            if(_loc2_ != null)
            {
               _loc2_.dispose();
            }
      ...
      {
         if(param1 >= 0 && param1 < this.var_235.length)
         {
