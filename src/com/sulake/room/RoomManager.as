package com.sulake.room
{
   ...
   public class RoomManager extends Component implements IRoomManager, IRoomInstanceContainer
   {
      ...
      private var var_183:IRoomManagerListener;
      
      private var var_3117:IRoomContentLoader;
      
      private var var_723:IRoomObjectFactory = null;
      ...
      public function RoomManager(param1:IContext, param2:uint = 0)
      {
         ...
         this.var_724 = [];
         this.var_725 = [];
         events.addEventListener(RoomContentLoadedEvent.const_395,this.onContentLoaded);
         events.addEventListener(RoomContentLoadedEvent.const_580,this.onContentLoaded);
         events.addEventListener(RoomContentLoadedEvent.const_878,this.onContentLoaded);
      }
      ...
      private function objectFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_723 = param2 as IRoomObjectFactory;
      ...
      {
         var _loc1_:* = null;
         if(this.var_723 == null || this.var_590 == null)
         {
            return;
         }
         this._state = const_1921;
         if(this.var_1368 != null)
         {
            _loc1_ = this.var_1368;
            this.var_1368 = null;
            this.initialize(_loc1_,this.var_183);
         }
      }
      ...
      public function createRoom(param1:String, param2:XML) : IRoomInstance
      {
         ...
         var _loc4_:int = this.var_725.length - 1;
         while(_loc4_ >= 0)
         {
            _loc5_ = this.var_725[_loc4_];
      ...
      public function createRoomObject(param1:String, param2:int, param3:String, param4:int) : IRoomObject
      {
         ...
         var _loc17_:IRoomObjectGraphicVisualization = this.var_590.createRoomObjectVisualization(_loc10_);
         if(_loc17_ == null)
         {
            _loc5_.disposeObject(param2,param4);
            return null;
         ...
         var _loc18_:* = null;
         _loc18_ = this.var_590.getRoomObjectVisualizationData(_loc12_,_loc10_,_loc8_);
         ...
         var _loc19_:IRoomObjectEventHandler = this.var_723.createRoomObjectLogic(_loc11_);
      ...
      public function createRoomObjectManager() : IRoomObjectManager
      {
         if(this.var_723 != null)
         {
            return this.var_723.createRoomObjectManager();
         }
         return null;
      }
      ...
      private function processInitialContentLoad(param1:String) : void
      {
         ...
         if(this.var_61.getGraphicAssetCollection(param1) != null)
         {
            ...
            {
               this._state = const_960;
               if(this.var_183 != null)
               {
                  this.var_183.roomManagerInitialized();
               }
            }
         }
         else
         {
            this._state = const_999;
            this.var_183.roomManagerInitialized(false);
         }
      }
      ...
      private function onContentLoaded(param1:RoomContentLoadedEvent) : void
      {
         ...
         if(_loc2_ == null)
         {
            if(this.var_183 != null)
            {
               this.var_183.contentLoaded(null,false);
            }
            return;
         }
         if(this.var_1110.indexOf(_loc2_) < 0)
         {
            this.var_1110.push(_loc2_);
         }
      }
      ...
      private function processLoadedContentTypes() : void
      {
         ...
         while(this.var_1110.length > 0)
         {
            _loc2_ = this.var_1110[0];
            this.var_1110.splice(0,1);
            _loc3_ = this.var_61.getVisualizationXML(_loc2_);
            if(_loc3_ == null)
            {
               if(this.var_183 != null)
               {
                  this.var_183.contentLoaded(_loc2_,false);
               }
               return;
            }
            ...
            if(this.var_183 != null)
            {
               this.var_183.contentLoaded(_loc2_,true);
            }
            if(this.var_724.length > 0)
            {
      ...
      private function updateObjectContents(param1:String) : void
      {
         ...
         if(this.var_61 == null || this.var_590 == null)
         {
            return;
         }
         ...
         var _loc7_:IRoomObjectVisualizationData = this.var_590.getRoomObjectVisualizationData(param1,_loc5_,_loc2_);
            ...
            if(_loc9_ != null)
            {
               ...
               for each(_loc12_ in _loc11_)
               {
                  ...
                  while(_loc14_ >= 0)
                  {
                     ...
                     if(_loc15_ != null)
                     {
                        _loc16_ = this.var_590.createRoomObjectVisualization(_loc5_);
                        if(_loc16_ != null)
                        {
                           ...
                           else
                           {
                              ...
                              _loc17_ = this.var_723.createRoomObjectLogic(_loc6_);
                              ...
                              if(this.var_183 != null)
                              {
                                 this.var_183.objectInitialized(_loc10_,_loc15_.getId(),_loc12_);
                              }
                           }
                        }
                        else
